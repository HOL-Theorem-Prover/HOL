...
(* The LSP hover reads this index too, through
   `tools-poly/lsp/help_init.ML' -- which owns everything that turns
   an entry into markdown, and is loaded only by a language server.
   Nothing in this file is LSP-aware. *)
