...
*   Fix soundess bug in the HolyHammer translations to first-order.
    ...
    were printed in the TPTP format as a global definition. In a few
    cases, the global definition captures some type variables causing
    a soundess issue. Now, local hypothesis are printed locally under
