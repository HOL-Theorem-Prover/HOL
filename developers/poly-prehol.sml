...
val _ = useB (HOLDIR ++ "tools" ++ "Holmake" ++ "hmf" ++ "parse_glob");
val _ = use (HOLDIR ++ "tools" ++ "Holmake" ++ "core" ++ "Holmake_tools_dtype.sml");
...
val _ = useB (HOLDIR ++ "tools" ++ "Holmake" ++ "core" ++ "Holmake_tools");
val _ = useB (HOLDIR ++ "tools" ++ "Holmake" ++ "hmf" ++ "internal_functions");
val _ = useB (HOLDIR ++ "tools" ++ "Holmake" ++ "hmf" ++ "Holmake_types");
val _ = useB (HOLDIR ++ "tools" ++ "Holmake" ++ "hmf" ++ "ReadHMF");
