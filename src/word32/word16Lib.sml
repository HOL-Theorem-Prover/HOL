structure word16Lib :> word16Lib =
struct

(* app load ["bossLib","bitsTheory","word16Theory"]; *)

open HolKernel boolLib computeLib bossLib 
     simpLib numLib bitsTheory word16Theory;
...
val WORD16_CONV = WORD_CONV
val WORD16_RULE = WORD_RULE
val WORD16_TAC = WORD_TAC
...
fun word16print sys gravs d pps t = let
   open Portable term_pp_types
   val (l,r) = dest_comb t
   val n = numSyntax.dest_numeral r
   val m = Arbnum.mod(n,Arbnum.fromString "65536")
in
  if l = Term `n2w` then
...
val _ = Parse.temp_add_user_printer ({Tyop = "word16", Thy = "word16"}, word16print);
