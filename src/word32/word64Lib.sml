structure word64Lib :> word64Lib =
struct

(* app load ["bossLib","bitsTheory","word64Theory"]; *)

open HolKernel boolLib computeLib bossLib 
     simpLib numLib bitsTheory word64Theory;
...
val WORD64_CONV = WORD_CONV
val WORD64_RULE = WORD_RULE
val WORD64_TAC = WORD_TAC
...
fun word64print sys gravs d pps t = let
   open Portable term_pp_types
   val (l,r) = dest_comb t
   val n = numSyntax.dest_numeral r
   val m = Arbnum.mod(n,Arbnum.fromString "18446744073709551616")
in
  if l = Term `n2w` then
...
val _ = Parse.temp_add_user_printer ({Tyop = "word64", Thy = "word64"}, word64print);
