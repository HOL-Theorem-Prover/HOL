...
CHANGED BY: Mario Castelán Castro, 2017
...
val RES_FORALL_DISJ_DIST = store_thm("RES_FORALL_DISJ_DIST",
    (“∀P Q R.
     (∀(i:'a)::λj. P j ∨ Q j. R i) = (∀i::P. R i) ∧ (∀i::Q. R i)”),
...
val RES_FORALL_NULL = store_thm
  ("RES_FORALL_NULL",
   “∀(p : 'a -> bool) m. RES_FORALL p (λx. m) = ((p = ∅) ∨ m)”,
...
val RES_DISJ_EXISTS_DIST = store_thm("RES_DISJ_EXISTS_DIST",
    (“∀P Q R.
     (∃(i:'a)::λi. P i ∨ Q i. R i) = (∃i::P. R i) ∨ (∃i::Q. R i)”),
    REPEAT STRIP_TAC >> REWRITE_TAC [RES_EXISTS, SPECIFICATION]
...
val RES_EXISTS_NULL = store_thm
  ("RES_EXISTS_NULL",
   “∀(p : 'a -> bool) m. RES_EXISTS p (λx. m) = (¬(p = ∅) ∧ m)”,
...
val RES_EXISTS_UNIQUE_NULL = store_thm
  ("RES_EXISTS_UNIQUE_NULL",
   “∀(p : 'a -> bool) m. RES_EXISTS_UNIQUE p (λx. m) = ((∃x. p = {x}) ∧ m)”,
