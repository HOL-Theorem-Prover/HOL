...
(*****************************************************************************)
  ...
  val tests = [
    ...
    (``(x:num) * 0 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``0 * (x:num) = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:num) * 1 = x``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``1 * (x:num) = x``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:num) * 42 = 42 * x``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),

    (``(0:num) DIV 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(1:num) DIV 1 = 1``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(42:num) DIV 1 = 42``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(0:num) DIV 42 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(1:num) DIV 42 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(42:num) DIV 42 = 1``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    ...
    (``(x:num) DIV 0 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:num) DIV 0 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:num) DIV 0 = 1``, [sat_CVC, sat_YO, sat_Z3, sat_Z3p, sat_CVCp]),
    (``(x:num) DIV 0 = x DIV 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),

    (``(0:num) MOD 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(1:num) MOD 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(42:num) MOD 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(0:num) MOD 42 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(1:num) MOD 42 = 1``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(42:num) MOD 42 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(x:num) MOD 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4]),
    (``(x:num) MOD 42 < 42``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4]),
    (``((x:num) MOD 42 = x) = (x < 42)``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4]),
    (``(x:num) MOD 0 = x``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:num) MOD 0 = 0``, [sat_CVC, sat_YO, sat_Z3, sat_Z3p, sat_CVCp]),
    (``(0:num) MOD 0 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:num) MOD 0 = 1``, [sat_CVC, sat_YO, sat_Z3, sat_Z3p, sat_CVCp]),
    (``(x:num) MOD 0 = x MOD 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    ...
    (``(x:num) ** 0 = 1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:num) ** 0 = 0``, [sat_CVC, sat_Z3, sat_Z3p, sat_CVCp]),
    (``(x:num) ** 1 = x``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:num) ** 1 = 1``, [sat_CVC, sat_Z3, sat_Z3p, sat_CVCp]),
    (``(1:num) ** x = 1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``0 <= (x:num) ** y``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``0 < (1:num) ** y``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``0 < (2:num) ** y``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``0 < (42:num) ** y``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(x:int) * 0 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``0 * (x:int) = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(x:int) * 1 = x``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``1 * (x:int) = x``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``(x:int) * ~1 = ~x``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    (``~1 * (x:int) = ~x``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    ...
    (``(~1:int) / ~1 = 1``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:int) / ~1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(1:int) / ~1 = ~1``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) / ~1 = ~42``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(~1:int) / 1 = ~1``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:int) / 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(1:int) / 1 = 1``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) / 1 = 42``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~42:int) / 42 = ~1``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(42:int) / 42 = 1``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) / 1 = x``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) / ~1 = ~x``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(x:int) / 0 = x / 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p, thm_CVCp]),
    ...
    (``(~42:int) quot ~42 = 1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~1:int) quot ~42 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:int) quot ~42 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(1:int) quot ~42 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) quot ~42 = ~1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~42:int) quot ~1 = 42``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~1:int) quot ~1 = 1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:int) quot ~1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(1:int) quot ~1 = ~1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) quot ~1 = ~42``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~42:int) quot 1 = ~42``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~1:int) quot 1 = ~1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(1:int) quot 42 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) quot 42 = 1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) quot 1 = x``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) quot ~1 = ~x``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(x:int) quot 0 = x quot 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p, thm_CVCp]),
    ...
    (``(~1:int) % 1 = 0``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:int) % 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(1:int) % 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) % 1 = 0``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~42:int) % 42 = 0``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(42:int) % 42 = 0``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) % 1 = 0``, [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) % ~1 = 0``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) % 42 < 42``,
      [thm_AUTO, thm_CVC, thm_YO, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(~42:int) rem ~42 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~1:int) rem ~42 = ~1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:int) rem ~42 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(1:int) rem ~42 = 1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) rem ~42 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~42:int) rem ~1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~1:int) rem ~1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(0:int) rem ~1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(1:int) rem ~1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) rem ~1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~42:int) rem 1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(~1:int) rem 1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(1:int) rem 42 = 1``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(42:int) rem 42 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) rem 1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) rem ~1 = 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    (``(x:int) rem 42 < 42``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p_v4, thm_CVCp]),
    ...
    (``(x:int) rem 0 = x rem 0``, [thm_AUTO, thm_CVC, thm_Z3, thm_Z3p, thm_CVCp]),
