...
sig
  ...
  val list_no_len_qp    : quantHeuristicsLibBase.quant_param
                            (* do not use LENGTH to unroll lists *)
  val list_len_qp       : quantHeuristicsLibBase.quant_param
                            (* use LENGTH for number > 1 to unroll lists *)
  ...
  (* A heuristic that considers just the conclusion of implications.
     This may lead to wrong guesses, but if used carefully, is a handy
     heuristic. *)
