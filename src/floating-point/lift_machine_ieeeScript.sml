...
val tac =
  simp_tac std_ss
     [fp16_to_real_value_def, fp16_isFinite_def, fp16_isZero_def,
      fp16_add_def, fp16_sub_def, fp16_mul_def, fp16_div_def,
      fp16_to_float_float_to_fp16,
      fp32_to_real_value_def, fp32_isFinite_def, fp32_isZero_def,
      fp32_add_def, fp32_sub_def, fp32_mul_def, fp32_div_def,
      fp32_to_float_float_to_fp32,
      fp64_to_real_value_def, fp64_isFinite_def,fp64_isZero_def,
