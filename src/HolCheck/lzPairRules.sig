signature lzPairRules =
sig
  include Abbrev

  val MK_PAIR                : thm * thm -> thm
  val lzPABS                   : term -> thm -> thm
  val lzPABS_CONV              : conv -> conv
  val PSUB_CONV              : conv -> conv
  val CURRY_CONV             : conv
  val UNCURRY_CONV           : conv
  val lzPBETA_CONV             : conv
  val lzPBETA_RULE             : thm -> thm
  val lzPBETA_TAC              : tactic
  ...
  val lzPETA_CONV              : conv
  val lzPALPHA_CONV            : term -> conv
  val lzGEN_PALPHA_CONV        : term -> conv
