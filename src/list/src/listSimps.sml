...
val list_rws = computeLib.add_thms
  [
   ...
   LIST_IGNORE_BIND_def, LIST_LIFT2_def, LLEX_def, LRC_def, LUPDATE_compute,
   MAP, MAP2, MEM, NOT_CONS_NIL, NOT_NIL_CONS, NULL_DEF, oEL_def,
   oHD_def,
...
val list_compset = computeLib.seal (list_rws reduceLib.num_compset)
