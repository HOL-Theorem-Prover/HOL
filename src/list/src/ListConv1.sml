...
fun thm_eq th1 th2 = pair_cmp (list_cmp eq) eq (Thm.dest_thm th1) (Thm.dest_thm th2);
...
val APPEND_EVAL_CONV = PURE_REWRITE_CONV [listTheory.APPEND_NIL, listTheory.APPEND];
