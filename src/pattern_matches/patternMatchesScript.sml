...
Theorem PMATCH_COND_SELECT_UNIQUE:
    !p g i.
...
Theorem PMATCH_ROW_COND_DEF_GSYM:
...
Theorem PMATCH_EXTEND_BASE:
  !v_old v_new. (PMATCH v_old [] = PMATCH v_new [])
Proof
SIMP_TAC std_ss [PMATCH_def]
QED

Theorem PMATCH_EXTEND_BOTH:
...
Theorem PMATCH_ROW_EXTEND_INPUT:
  !v v' f' f p g r p' .
  ((!x'. (v' = p' x') ==> (p (f x') = v)) /\
   (!x. (v = p x) ==> ?x'. (p' x' = v')) /\
   (!x y. (p x = p y) ==> (x = y))) ==>
...
Theorem PMATCH_ROW_REMOVE_FUN_VAR:
  !v v' f p g r p' .
  ((!x'. (v' = p' x') = (p (f x') = v)) /\
  ((!x. (v = p x) ==> ?x'. f x' = x)) /\
  ((!x y. (p x = p y) ==> (x = y)))) ==>
...
Theorem PMATCH_EQUIV_ROWS_EQUIV_EXPAND:
    PMATCH_EQUIV_ROWS v rows1 rows2 = (
...
Theorem PMATCH_EQUIV_ROWS_is_equiv_1:
...
Theorem PMATCH_EQUIV_ROWS_is_equiv_2:
...
Theorem PMATCH_EQUIV_ROWS_is_equiv_3:
    (!v rows1 rows2 rows3.
       (PMATCH_EQUIV_ROWS v rows1 rows2) ==>
...
Theorem PMATCH_EQUIV_ROWS_MATCH:
    PMATCH_EQUIV_ROWS v rows1 rows2 ==>
    (PMATCH v rows1 = PMATCH v rows2)
Proof
SIMP_TAC std_ss [PMATCH_EQUIV_ROWS_def]
...
Theorem PMATCH_EQUIV_ROWS_CONS_NONE:
  (row v = NONE) ==> (
...
Theorem PMATCH_ROWS_DROP_REDUNDANT_TRIVIAL_SOUNDNESS_EQUIV:
...
Theorem PMATCH_ROWS_DROP_REDUNDANT_TRIVIAL_SOUNDNESS:
  !v rows n. ((n < LENGTH rows) /\ (IS_SOME ((EL n rows) v))) ==>
...
Theorem PMATCH_ROWS_DROP_REDUNDANT:
...
Theorem PMATCH_ROWS_DROP_REDUNDANT_PMATCH_ROWS:
...
Theorem PMATCH_ROWS_DROP_SUBSUMED:
  !r1 r2 rows1 rows2 rows3 v.
...
Theorem PMATCH_ROWS_DROP_SUBSUMED_PMATCH_ROWS:
  !p g r p' g' r' rows1 rows2 rows3 v.
  ((!x. (v = p x) /\ (g x) ==> (?x'. (p x = p' x') /\ (g' x'))) /\
...
Theorem PMATCH_ROW_REDUNDANT_APPEND_LT:
    !v rs1 rs2 i.
    i < LENGTH rs1 ==>
...
Theorem PMATCH_ROW_REDUNDANT_APPEND_GE:
    !v rs1 rs2 i.
    ~(i < LENGTH rs1) ==>
    (PMATCH_ROW_REDUNDANT v (rs1 ++ rs2) i <=> (
...
Theorem IS_REDUNDANT_ROWS_INFO_NIL:
...
Theorem IS_REDUNDANT_ROWS_INFO_SNOC:
...
Theorem IS_REDUNDANT_ROWS_INFO_SNOC_PMATCH_ROW:
...
Theorem IS_REDUNDANT_ROWS_INFO_CONS:
...
Theorem APPLY_REDUNDANT_ROWS_INFO_THMS:
...
Theorem PMATCH_ROWS_DROP_REDUNDANT_ROWS_INFO_EQUIV:
...
Theorem REDUNDANT_ROWS_INFO_TO_PMATCH_EQ:
  !v c rows infos. IS_REDUNDANT_ROWS_INFO v rows c infos ==>
  (PMATCH v rows =
...
Theorem PMATCH_IS_EXHAUSTIVE_REWRITES:
...
Theorem IS_REDUNDANT_ROWS_INFO_EXTRACT_IS_EXHAUSTIVE:
    !v rows c infos.
    IS_REDUNDANT_ROWS_INFO v rows c infos ==>
...
Theorem REDUNDANT_ROWS_INFOS_CONJ_REWRITE:
...
Theorem REDUNDANT_ROWS_INFOS_CONJ_THM:
...
Theorem REDUNDANT_ROWS_INFOS_DISJ_THM:
  !v rows c infos c' infos'.
    IS_REDUNDANT_ROWS_INFO v rows c infos ==>
    IS_REDUNDANT_ROWS_INFO v rows c' infos' ==>
...
Theorem LENGTH_STRONGEST_REDUNDANT_ROWS_INFO_AUX:
    !v rows p infos.
...
Theorem FST_STRONGEST_REDUNDANT_ROWS_INFO_AUX:
    !v rows p infos.
...
Theorem EL1_STRONGEST_REDUNDANT_ROWS_INFO_AUX:
    !v rows p infos i.
      (i < LENGTH infos) ==>
...
Theorem EL2_STRONGEST_REDUNDANT_ROWS_INFO_AUX:
    !v rows p infos i.
...
Theorem LENGTH_STRONGEST_REDUNDANT_ROWS_INFO:
...
Theorem EL_STRONGEST_REDUNDANT_ROWS_INFO:
    !v rows i.
      (i < LENGTH rows) ==>
...
Theorem STRONGEST_REDUNDANT_ROWS_INFO_OK:
...
Theorem PMATCH_ROW_COND_EX_FULL_DEF:
...
Theorem PMATCH_ROW_COND_EX_WEAKEN:
  !f v p g p' g'.
...
Theorem PMATCH_ROW_COND_EX_FALSE:
  !v p g.
  (!x. ~(g x)) ==>
...
Theorem PMATCH_ROW_COND_EX_IMP_REWRITE:
  !v p g p' g' RES.
  PMATCH_ROW_COND_EX v p g ==>
...
(* Use this simple contradiction to bring
   ...
   automation *)
Theorem PMATCH_IS_EXHAUSTIVE_CONTRADICT:
  !v rs.
...
Theorem PMATCH_ROW_EVAL_COND_EX:
    PMATCH_ROW_COND_EX i p g ==>
...
(* If a variable is used multiple times in a pattern,
   ...
   var to the guard. *)
Theorem PMATCH_ROW_REMOVE_DOUBLE_BINDS_THM:
  !g p1 g1 r1 p2 g2 r2.
   ((!x y. (p1 x = p1 y) ==> (x = y)) /\
   (!x. (p2 (g x) = p1 x)) /\
   (!x'. g2 x' = (?x. (x' = g x) /\ g1 x)) /\
...
Theorem PMATCH_FLATTEN_FUN_PMATCH_ROW:
  !p.
  (!x1 x2. (p x1 = p x2) ==> (x1 = x2)) ==> (
...
Theorem PMATCH_ROW_COND_NOT_EX_OR_EQ_FIRST_ROW:
    !i r r' rows.
...
Theorem PMATCH_ROW_COND_NOT_EX_OR_EQ_NIL:
...
Theorem PMATCH_ROW_COND_NOT_EX_OR_EQ_NOT_FIRST_ROW:
...
Theorem PMATCH_PRED_UNROLL_NIL:
...
Theorem PMATCH_PRED_UNROLL_CONS:
  !P v r rows.
     P (PMATCH v (r::rows)) <=> (
       ((r v <> NONE) ==> P (THE (r v))) /\
...
Theorem PMATCH_EXPAND_PRED_THM_GEN:
...
Theorem PMATCH_EXPAND_PRED_THM:
  !P v rows.
         P (PMATCH v rows) <=>
...
Theorem PMATCH_IS_EXHAUSTIVE_LIFT:
    !f v rows.
    PMATCH_IS_EXHAUSTIVE v rows ==>
