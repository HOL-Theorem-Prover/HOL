...
sig
   ...
   val NOT_TY_FORALL_CONV       : conv
   val NOT_EXISTS_CONV          : conv
   val NOT_TY_EXISTS_CONV       : conv
   val EXISTS_NOT_CONV          : conv
   val TY_EXISTS_NOT_CONV       : conv
   val FORALL_NOT_CONV          : conv
   val TY_FORALL_NOT_CONV       : conv
   val FORALL_AND_CONV          : conv
   val TY_FORALL_AND_CONV       : conv
   val EXISTS_OR_CONV           : conv
   val TY_EXISTS_OR_CONV        : conv
   val AND_FORALL_CONV          : conv
   val AND_TY_FORALL_CONV       : conv
   val LEFT_AND_FORALL_CONV     : conv
   val LEFT_AND_TY_FORALL_CONV  : conv
   val RIGHT_AND_FORALL_CONV    : conv
   val RIGHT_AND_TY_FORALL_CONV : conv
   val OR_EXISTS_CONV           : conv
   val OR_TY_EXISTS_CONV        : conv
   val LEFT_OR_EXISTS_CONV      : conv
   val LEFT_OR_TY_EXISTS_CONV   : conv
   val RIGHT_OR_EXISTS_CONV     : conv
   val RIGHT_OR_TY_EXISTS_CONV  : conv
   val EXISTS_AND_CONV          : conv
   val TY_EXISTS_AND_CONV       : conv
   val EXISTS_AND_REORDER_CONV  : conv
   val TY_EXISTS_AND_REORDER_CONV : conv
   val AND_EXISTS_CONV          : conv
   val AND_TY_EXISTS_CONV       : conv
   val LEFT_AND_EXISTS_CONV     : conv
   val LEFT_AND_TY_EXISTS_CONV  : conv
   val RIGHT_AND_EXISTS_CONV    : conv
   val RIGHT_AND_TY_EXISTS_CONV : conv
   val FORALL_OR_CONV           : conv
   val TY_FORALL_OR_CONV        : conv
   val OR_FORALL_CONV           : conv
   val OR_TY_FORALL_CONV        : conv
   val LEFT_OR_FORALL_CONV      : conv
   val LEFT_OR_TY_FORALL_CONV   : conv
   val RIGHT_OR_FORALL_CONV     : conv
   val RIGHT_OR_TY_FORALL_CONV  : conv
   val FORALL_IMP_CONV          : conv
   val TY_FORALL_IMP_CONV       : conv
   val LEFT_IMP_EXISTS_CONV     : conv
   val LEFT_IMP_TY_EXISTS_CONV  : conv
   val RIGHT_IMP_FORALL_CONV    : conv
   val RIGHT_IMP_TY_FORALL_CONV : conv
   val EXISTS_IMP_CONV          : conv
   val TY_EXISTS_IMP_CONV       : conv
   val BOTH_EXISTS_IMP_CONV     : conv
   val BOTH_TY_EXISTS_IMP_CONV  : conv
   val LEFT_IMP_FORALL_CONV     : conv
   val LEFT_IMP_TY_FORALL_CONV  : conv
   val RIGHT_IMP_EXISTS_CONV    : conv
   val RIGHT_IMP_TY_EXISTS_CONV : conv
