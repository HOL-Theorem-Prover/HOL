...
Theorem IN = CONJ NOT_IN_EMPTY IN_INSERT;

Theorem UNION = CONJ UNION_EMPTY INSERT_UNION_EQ;

Theorem INTER = CONJ INTER_EMPTY INSERT_INTER;

Theorem DELETE = CONJ EMPTY_DELETE DELETE_INSERT;

Theorem SUBSET = CONJ EMPTY_SUBSET INSERT_SUBSET;

Theorem IMAGE = CONJ IMAGE_EMPTY IMAGE_INSERT;

Theorem DIFFF = CONJ DIFF_EMPTY DIFF_INSERT;
