...
int main(int argc, char **argv)
{
   ...
   if(argc < 2 || argc > 3)
   {
      ...
      cout << "       R -> enable reordering if R is 'win' or 'sift'\n";
   ...
   if (argc == 3)
   {
	 ...
	 reorder = BDD_REORDER_WIN2;
      else
      if (strcmp(argv[2], "winite") == 0)
	 reorder = BDD_REORDER_WIN2ITE;
      else
      if (strcmp(argv[2], "sift") == 0)
	 reorder = BDD_REORDER_SIFT;
      else
      if (strcmp(argv[2], "siftite") == 0)
	 reorder = BDD_REORDER_SIFTITE;
      else
      if (strcmp(argv[2], "rand") == 0)
	 reorder = BDD_REORDER_RANDOM;
   }
   ...
   for (n=0 ; n<N ; n++)
   {
      //bdd_addvarblock(bdd_ithvar(2*n) & bdd_ithvar(2*n+1),1);
      //bdd_addvarblock(bdd_ithvar(2*n),1);
