Theory ordinal
Ancestors
  option set_relation pred_set wellorder cardinal topology ordinalBasic
  sum pair
Libs
  boolSimps
...
Theorem countableOrds_uncountable:
...
Theorem dclose_cardleq_univinf:
...
Theorem epsilon0_least_fixpoint:
