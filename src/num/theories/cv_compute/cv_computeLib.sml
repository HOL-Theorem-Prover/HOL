(* -------------------------------------------------------------------------
 * This library instantiates the kernel compute primitive with the necessary
 * definitions and axioms required to use it with HOL4's standard :num
 * arithmetic.
 *
 * See the examples/ directory for help on how to use the primitive.
 * ------------------------------------------------------------------------- *)
 ...
 * deconstruct HOL terms. The terms are checked against their characteristic
 * equations (char_eqns; listed further down in this file).
 * ------------------------------------------------------------------------- *)
...
(* -------------------------------------------------------------------------
 * Characteristic equations and symbols for initializing the kernel compute
 * primitive.
 * ------------------------------------------------------------------------- *)
...
(* -------------------------------------------------------------------------
 * Entry-point to the compute primitive. Checking of constants, types and
 * equation theorems is cached.
 * ------------------------------------------------------------------------- *)
