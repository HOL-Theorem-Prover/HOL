...
"KDTY"  => (Tokens.KDTY(!pos,!pos));
"KDV"   => (Tokens.KDV(!pos,!pos));
"KDARR" => (Tokens.KDARR(!pos,!pos));
"TYV"   => (Tokens.TYV(!pos,!pos));
"TYC"   => (Tokens.TYC(!pos,!pos));
"TYAp"  => (Tokens.TYAp(!pos,!pos));
"TYAbs" => (Tokens.TYAbs(!pos,!pos));
"TYUni" => (Tokens.TYUni(!pos,!pos));
"TYExi" => (Tokens.TYExi(!pos,!pos));
"TMV"   => (Tokens.TMV(!pos,!pos));
"TMC"   => (Tokens.TMC(!pos,!pos));
"IDS"   => (Tokens.IDS(!pos,!pos));
"KINDS"   => (Tokens.KINDS(!pos,!pos));
