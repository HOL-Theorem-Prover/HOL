...
(* ----------------                                                          *)
(*                                                                           *)
(* Script for proving theorems in HolBddTheory.                              *)
(*****************************************************************************)
...
val ChainIn_def =
 Define
  `(ChainIn R B 0 s = B s)
   /\
   (ChainIn R B (SUC n) s = ?s_. ChainIn R B n s_ /\ R (s_, s)`;

val ChainIn_def =
 Define
  `(ChainIn R B 0 = B)
   /\
   (ChainIn R B (SUC n) = Next R (ChainIn R B n)`;

val Chain_def =
 Define
  `Chain R B state = !n. ChainIn R B n state`;
