...
\newindex{MLbn}{bnx}{bnd}{Index of ML bindings\\[-1mm]
(excluding \t{DerivedBddRules})}
...
\end{verbatim}\tyind{\texttt{varmap}}
...
\end{verbatim}%
\bnind{\texttt{Varmap.empty}}%
\bnind{\texttt{Varmap.insert}}%
\bnind{\texttt{Varmap.remove}}%
\bnind{\texttt{Varmap.peek}}%
\bnind{\texttt{Varmap.dest}}%
\bnind{\texttt{Varmap.eq}}
\bnind{\texttt{Varmap.size}}%
\bnind{\texttt{Varmap.extends}}%
...
\end{verbatim}%
\bnind{\texttt{dotBdd}}%
\bnind{\texttt{dotLabelledTermBdd}}%
\bnind{\texttt{dotTermBdd}}%
...
\end{verbatim}\tyind{\texttt{term\_bdd}}\tyind{\texttt{assums}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddExtendVarmap}}\bnind{\texttt{BddExtendVarmap}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddFreevarsContractVarmap}}\bnind{\texttt{BddFreevarsContractVarmap}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddSupportContractVarmap}}\bnind{\texttt{BddSupportContractVarmap}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddVar}}\bnind{\texttt{BddVar}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddCon}}\bnind{\texttt{BddCon}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddNot}}\bnind{\texttt{BddNot}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddIte}}\bnind{\texttt{BddIte}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddOp}}\bnind{\texttt{BddOp}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddForall}}\bnind{\texttt{BddForall}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddExists}}\bnind{\texttt{BddExists}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddAppall}}\bnind{\texttt{BddAppall}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddAppex}}\bnind{\texttt{BddAppex}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddCompose}}\bnind{\texttt{BddCompose}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddListCompose}}\bnind{\texttt{BddListCompose}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddRestrict}}\bnind{\texttt{BddRestrict}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddReplace}}\bnind{\texttt{BddReplace}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddSimplify}}\bnind{\texttt{BddSimplify}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddThmOracle}}\bnind{\texttt{BddThmOracle}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddEqMp}}\bnind{\texttt{BddEqMp}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\destructors}}\bnind{\texttt{destructors}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\inSupport}}\bnind{\texttt{inSupport}}
...
\end{minipage}
\end{lrbox}
\fbox{\usebox{\termApply}}\bnind{\texttt{termApply}}
...
The theory \t{DerivedBddRulesTheory} contained the HOL theoremes used
...
\begin{Verbatim}[commandchars=\$\&\%]
  (*  Definitions  *)
    val Eq_def : thm$bnind&\texttt{Eq\_def}%
    val Next_def : thm$bnind&\texttt{Next\_def}%
    val Prev_def : thm$bnind&\texttt{Prev\_def}%
    val ReachBy_def : thm$bnind&\texttt{ReachBy\_def}%
    val ReachIn_def : thm$bnind&\texttt{ReachIn\_def}%
    val Reachable_def : thm$bnind&\texttt{Reachable\_def}%
  
  (*  Theorems  *)
    val ReachBy_ReachIn : thm$bnind&\texttt{ReachBy\_ReachIn}%
    val ReachBy_fixedpoint : thm$bnind&\texttt{ReachBy\_fixedpoint}%
    val ReachBy_rec : thm$bnind&\texttt{ReachBy\_rec}%
    val ReachIn_rec : thm$bnind&\texttt{ReachIn\_rec}%
    val Reachable_ReachBy : thm$bnind&\texttt{Reachable\_ReachBy}%

   [list] Parent theory of "DerivedBddRules"
   
   [Eq_def]$bnind&\texttt{Eq\_def}%
   Definition
   |- !state0 state. Eq state0 state = (state0 = state)
   
   [Next_def]$bnind&\texttt{Next\_def}%
   Definition
   |- !R B state. Next R B state = ?state_. B state_ /\ R (state_,state)
   
   [Prev_def]$bnind&\texttt{Prev\_def}%
   Definition
   |- !R Q state. Prev R Q state = ?state'. R (state,state') /\ Q state'
   
   [ReachBy_def]$bnind&\texttt{ReachBy\_def}%
   Definition
   |- !R B n state. ReachBy R B n state = ?m. m <= n /\ ReachIn R B m state
   
   [ReachIn_def]$bnind&\texttt{ReachIn\_def}%
   Definition
   |- (!R B. ReachIn R B 0 = B) /\
      !R B n. ReachIn R B (SUC n) = Next R (ReachIn R B n)
   
   [Reachable_def]$bnind&\texttt{Reachable\_def}%
   Definition
   |- !R B state. Reachable R B state = ?n. ReachIn R B n state
   
   [ReachBy_ReachIn]$bnind&\texttt{ReachBy\_ReachIn}%
   Theorem
   ...
   [ReachBy_fixedpoint]$bnind&\texttt{ReachBy\_fixedpoint}%
   Theorem
   |- !R B n.
        (ReachBy R B n = ReachBy R B (SUC n)) ==>
        (Reachable R B = ReachBy R B n)
   
   [ReachBy_rec]$bnind&\texttt{ReachBy\_rec}%
   Theorem
   |- (!R B state. ReachBy R B 0 state = B state) /\
      !R B n state.
        ReachBy R B (SUC n) state =
   ...
   [ReachIn_rec]$bnind&\texttt{ReachIn\_rec}%
   Theorem
   ...
   [Reachable_ReachBy]$bnind&\texttt{Reachable\_ReachBy}%
   Theorem
