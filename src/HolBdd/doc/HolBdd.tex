...
\subsection{Rules for generating representation judgements}
...
$$\begin{array}{c}
\termbdd{\rho_1}{t}{b} \qquad {\footnotesize\t{Varmap.extends}}~\rho_1~\rho_2
\\ \hline
\termbdd{\rho_2}{t}{b}
\end{array}$$
...
$$\begin{array}{c}
\termbdd{\rho}{t}{b} \qquad \mbox{$v$ not free in $t$}
\\ \hline
\termbdd{({\footnotesize{\texttt{Varmap.remove~"}}}v{\footnotesize{\texttt{"}}}~\rho)}{t}{b}
\end{array}$$
...
$$\begin{array}{c}
\termbdd{\rho}{t}{b} \qquad \mbox{$\rho(v)$ does occur in $b$}
\\ \hline
\termbdd{({\footnotesize{\texttt{Varmap.remove~"}}}v{\footnotesize{\texttt{"}}}~\rho)}{t}{b}
\end{array}$$
...
$\begin{array}{c}
\termbdd{\rho}{t}{b} \qquad \termbdd{\rho_2}{t_1}{b_1} \qquad \termbdd{\rho_2}{t_2}{b_2}
\\ \hline
\termbdd{\rho}{\mbox{\footnotesize\t{(if~$t$~then~$t_1$~else~$t_2$)}}}{{\footnotesize\t{ITE}}~b~b_1~b_2}
\end{array}$
...
\begin{footnotesize}
Raises {\footnotesize\t{BddIteError}} if $\rho$, $\rho_1$ and $\rho_2$ are not all 
pointer equal
\end{footnotesize}
\end{minipage}
\end{lrbox}
...
$\begin{array}{c}
\termbdd{\rho_1}{t_1}{b_1} \qquad \termbdd{\rho_2}{t_2}{b_2}
\\ \hline
\termbdd{\rho_1}{{\footnotesize\t{(termApply}}~t_1~t_2~bddop{\footnotesize\t{)}}}{{\footnotesize\t{apply}}~b_1~b_2~bddop}
\end{array}$
...
{\footnotesize\t{BddOpError}} is raised if $\rho_1$ and $\rho_2$ are not pointer equal
\end{footnotesize}
\end{minipage}
\end{lrbox}
\fbox{\usebox{\BddOp}}
...
$\begin{array}{c}
\termbdd{\rho}{t}{b} \qquad \rho(v_1)=n_1,~ $\ldots$~,~ \rho(v_i)=n_i
\\ \hline
\termbdd{\rho}{({\footnotesize\forall} v_1~\cdots~v_i.~t)}%
...
\termbdd{\rho}{t}{b} \qquad \rho(v_1)=n_1,~ $\ldots$~,~ \rho(v_i)=n_i
\\ \hline
\termbdd{\rho}{({\footnotesize\exists} v_1~\cdots~v_i.~t)}%
...
$\begin{array}{c}
\termbdd{\rho_1}{t_1}{b_1} \qquad \termbdd{\rho_2}{t_2}{b_2} \qquad \rho_1(v_1)=n_1,~ $\ldots$~,~ \rho_1(v_i)=n_i
\\ \hline
\begin{array}{l}
{\rho_1}%
...
\begin{footnotesize}
Raises \t{BddAppallError} if $\rho_1$ and $\rho_2$ are not pointer equal, or
if any of the terms in the term list argument
are not boolean variables in the domain of $\rho_1$
\end{footnotesize}
\end{minipage}
\end{lrbox}
...
\begin{footnotesize}
Raises \t{BddAppexError} if $\rho_1$ and $\rho_2$ are not pointer equal, or
if any of the terms in the term list argument
are not boolean variables in the domain of $\rho_1$
\end{footnotesize}
\end{minipage}
