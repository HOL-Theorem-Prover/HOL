...
numLib.completeInduct_on `n` THEN
 ...
 [RW_TAC arith_ss [] THEN
    ...
    Q.PAT_X_ASSUM `BAG_GEN_PROD a b = BAG_GEN_PROD c d` MP_TAC THEN
 ...
 Q.PAT_X_ASSUM `p = q` MP_TAC THEN RW_TAC std_ss [BAG_GEN_PROD_REC] THEN
 ...
 Q.PAT_X_ASSUM `p = q` MP_TAC THEN RW_TAC arith_ss [BAG_GEN_PROD_REC] THEN
