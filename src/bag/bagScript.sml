...
val SET_OF_BAG_IMAGE = Q.store_thm(
  ...
  SRW_TAC [][] THENL [
    ...
    PROVE_TAC [],
    `FINITE_BAG b0` by PROVE_TAC [FINITE_BAG_INSERT_2] THEN
...
`FINITE sob ==> (BIG_BAG_UNION (sob DELETE b)
...
"BIG_BAG_UNION_UNION",
`FINITE s1 /\ FINITE s2 ==> (BIG_BAG_UNION (s1 UNION s2)
