...
structure tttNumber :> tttNumber =
struct

open HolKernel boolLib tttTools tttLexer

val ERR = mk_HOL_ERR "tttNumber"
...
fun number_token n s =
  ttt_lex ("(tttNumber.ttt_fst ( " ^ s ^ "," ^ int_to_string n ^ "))")
...
fun number_stac s =
  String.concatWith " " (number_tokenl 0 (ttt_lex s))
