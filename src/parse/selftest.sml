...
fun color_name Black       = "Black"
  | color_name RedBrown    = "RedBrown"
  | color_name Green       = "Green"
  | color_name BrownGreen  = "BrownGreen"
  | color_name DarkBlue    = "DarkBlue"
  | color_name Purple      = "Purple"
  | color_name BlueGreen   = "BlueGreen"
  | color_name DarkGrey    = "DarkGrey"
  | color_name LightGrey   = "LightGrey"
  | color_name OrangeRed   = "OrangeRed"
  | color_name VividGreen  = "VividGreen"
  | color_name Yellow      = "Yellow"
  | color_name Blue        = "Blue"
  | color_name PinkPurple  = "PinkPurple"
