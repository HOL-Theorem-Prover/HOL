...
val gen_overloaded_const :
  term_grammar.overload_info -> string -> Preterm.preterm
...
val make_vstruct : binder_in_env list
                    -> TCPretype.pretype option
                    -> binder_in_env
val make_constrained : preterm_in_env -> TCPretype.pretype -> preterm_in_env
