...
val _ = computeLib.add_persistent_funs [
     ("testbit", testbit),
     ("ops_to_v2w", ops_to_v2w),
     ("ops_to_n2w", ops_to_n2w),
     ("fixwidth", fixwidth),
     ("extend", extend),
     ("v2w_11", v2w_11),
     ("bit_v2w", bit_v2w),
     ...
     ("w2w_v2w", w2w_v2w),
     ("sw2sw_v2w", sw2sw_v2w),
     ("word_index_v2w", word_index_v2w),
     ("word_lsl_v2w", word_lsl_v2w),
     ("word_lsr_v2w", word_lsr_v2w),
     ("word_asr_v2w", word_asr_v2w),
     ("word_ror_v2w", word_ror_v2w),
     ("word_1comp_v2w", word_1comp_v2w),
     ("word_and_v2w", word_and_v2w),
     ("word_or_v2w", word_or_v2w),
     ("word_xor_v2w", word_xor_v2w),
     ("word_nand_v2w", word_nand_v2w),
     ("word_nor_v2w", word_nor_v2w),
     ("word_xnor_v2w", word_xnor_v2w),
     ("word_lsb_v2w", word_lsb_v2w),
     ("word_msb_v2w", word_msb_v2w),
     ("word_reverse_v2w", word_reverse_v2w),
     ("word_modify_v2w", word_modify_v2w),
     ("word_bits_v2w", word_bits_v2w),
     ("word_extract_v2w", word_extract_v2w),
     ("word_slice_v2w", word_slice_v2w),
     ("word_join_v2w", word_join_v2w_rwt),
     ("word_concat_v2w", word_concat_v2w_rwt),
     ("word_reduce_v2w", word_reduce_v2w),
     ("reduce_and_v2w", reduce_and_v2w),
     ("reduce_or_v2w", reduce_or_v2w)
  ];
