...
val (word_exp_tm, mk_word_exp, dest_word_exp, is_word_exp) = s "word_exp"
val (word_quot_tm, mk_word_quot, dest_word_quot, is_word_quot) = s "word_quot"
val (word_rem_tm, mk_word_rem, dest_word_rem, is_word_rem) = s "word_rem"
