...
val word_concat_tm  = prim_mk_const{Name = "@@", Thy="words"}
val word_slice_tm   = prim_mk_const{Name = "<>", Thy="words"}
val word_bit_tm     = prim_mk_const{Name = "word_bit", Thy="words"}
val word_bits_tm    = prim_mk_const{Name = "--", Thy="words"}
val word_extract_tm = prim_mk_const{Name = "><", Thy="words"}
val word_lsl_tm     = prim_mk_const{Name = "<<", Thy="words"}
val word_lsr_tm     = prim_mk_const{Name = ">>>", Thy="words"}
val word_asr_tm     = prim_mk_const{Name = ">>", Thy="words"}
val word_ror_tm     = prim_mk_const{Name = "#>>", Thy="words"}
val word_rol_tm     = prim_mk_const{Name = "#<<", Thy="words"}
val word_hi_tm      = prim_mk_const{Name = ">+", Thy="words"}
val word_lo_tm      = prim_mk_const{Name = "<+", Thy="words"}
val word_hs_tm      = prim_mk_const{Name = ">=+", Thy="words"}
val word_ls_tm      = prim_mk_const{Name = "<=+", Thy="words"}
val word_and_tm     = prim_mk_const{Name = "&&", Thy="words"}
val word_or_tm      = prim_mk_const{Name = "!!", Thy="words"}
val word_xor_tm     = prim_mk_const{Name = "??", Thy="words"}
