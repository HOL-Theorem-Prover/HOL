...
local
  ...
  val l1 =
     ["l2w", "w2l", "s2w", "w2s", "add_with_carry",
      ...
      "word_reduce", "reduce_and", "reduce_or", "reduce_xor", "reduce_nand",
      "reduce_nor", "reduce_xnor", "word_replicate", "concat_word_list",
      "bit_field_insert", "word_len", "w2w", "w2n", "sw2sw", "word_log2",
      "word_reverse", "word_lsb", "word_msb", "word_join", "word_concat",
      "word_bit", "word_bits", "word_signed_bits", "word_slice",
      ...
      "saturate_n2w", "saturate_w2w", "saturate_add", "saturate_sub",
      "saturate_mul", "word_min", "word_max", "word_smin", "word_smax",
      "word_abs", "word_div", "word_sdiv", "word_mod", "word_smod",
      "word_srem"]
