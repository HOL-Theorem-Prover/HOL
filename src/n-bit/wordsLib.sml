  ...
  simpLib.named_merge_ss "word mul lsl"
    [simpLib.std_conv_ss
      {conv = WORD_MUL_LSL_CONV,
       ...
       pats = [``words$word_mul (^n2w ^a) ^w:'a word``]}];
