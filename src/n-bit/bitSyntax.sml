...
val anbinop_syntax_fns = syntax_fns "ASCIInumbers" 2 HolKernel.dest_binop
   (fn (tm, (v1, v2)) => Term.list_mk_comb (tm, [v1, v2]))
...
val monop_syntax_fns =
    syntax_fns "bit" 1 HolKernel.dest_monop Term.mk_comb
val (lsb_tm,mk_lsb,dest_lsb,is_lsb)         = monop_syntax_fns "LSB"
val (log2_tm,mk_log2,dest_log2,is_log2)     = monop_syntax_fns "LOG2"

local
val monop_syntax_fns =
    syntax_fns "ASCIInumbers" 1 HolKernel.dest_monop Term.mk_comb
in
...
val (l2n_tm,mk_l2n,dest_l2n,is_l2n)     = anbinop_syntax_fns "l2n"
val (n2l_tm,mk_n2l,dest_n2l,is_n2l)     = anbinop_syntax_fns "n2l"
