...
followed by some combinational logic (the operators \DEF{PRECEDE} and
\DEF{FOLLOW} add combinational logic before and after the body of a
...
\noindent This theorem uses explicitly clocked registers \DEF{Dtype} and
\DEF{DtypeT} (defined in Section~\ref{secImplementation}) and states
...
%\mbox{}\hspace*{-5mm}\scalebox{0.45}%
%{\includegraphics[angle = -90, viewport = -5 5 100 800, clip = true]{dinotrace.epsi}}

\mbox{}\hspace*{-5mm}\scalebox{0.83}{\includegraphics[viewport = 0 30 500 110, clip = true]{gtkwave.epsi}}

%\mbox{}\hspace*{-5mm}\scalebox{0.83}{\includegraphics{gtkwave.epsi}}
...
\begin{figure}[htb]
   \centerline{
      \subfigure[$\DEF{POSEDGE}$]{
         \label{figPosedge}\input{posedge.eepic}\hspace*{0.3cm}}
      \subfigure[$\DEF{ATM}\ f$]{
         \label{figAtom}\input{atm.eepic}\hspace*{-0.4cm}}
