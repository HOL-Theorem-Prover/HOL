...
Theorem poly_mod_poly_mod_ring_ring:
...
Theorem poly_peval_X_eq_zero_root:
    !(r:'a ring) z. Ring r /\ ulead z ==>
...
*)
Theorem poly_mod_ring_has_monomials:
...
*)
Theorem poly_mod_ring_has_root_X:
...
*)
Theorem poly_mod_eq_peval_root:
    !(r:'a ring) z. Ring r /\ ulead z ==>
   !p q. poly p /\ poly q /\ (p == q) (pm z) ==>
   !t. poly t /\ (peval z t == |0|) (pm z) ==> (peval (p - q) t == |0|) (pm z)
Proof
...
*)
Theorem poly_mod_eq_peval_root_eq:
...
*)
Theorem poly_mod_eq_peval_root_2:
...
*)
Theorem poly_mod_eq_peval_root_eq_2:
    !r:'a ring z h. Ring r /\ ulead z /\ ulead h /\ (z % h = |0|) ==>
     !x. poly x /\ (peval z x == |0|) (pm h) ==>
       !p q. poly p /\ poly q /\ (p == q) (pm z) ==> (peval p x == peval q x) (pm h)
Proof
...
*)
Theorem poly_unity_root_exp_mod:
...
Theorem poly_pmod_X_exp_mod_eq:
    !r:'a ring z. Ring r /\ ulead z ==>
    !k. 0 < k /\ (X ** k == |1|) (pm z) ==>
    !n m. (n MOD k = m MOD k) ==> (X ** n == X ** m) (pm z)
Proof
...
*)
Theorem poly_peval_peval_X_exp:
...
*)
Theorem poly_peval_peval_X_exp_X_exp:
