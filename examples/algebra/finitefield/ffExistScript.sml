...
(* Definitions and Theorems (# are exported):
   ...
   ring_inj_image_field_homo    |- !r f. Field r /\ INJ f R univ(:'b) ==> FieldHomo f r (ring_inj_image r f)
   ring_inj_image_finite_field  |- !r f. FiniteField r /\ INJ f R univ(:'b) ==> FiniteField (ring_inj_image r f)
...
(* Define the image of ring injection, so that LINV f R makes sense. *)
val ring_inj_image_def = Define`
    ring_inj_image (r:'a ring) f =
    <| carrier := IMAGE f R;
           sum := <| carrier := IMAGE f R; op := (\x y. f ((LINV f R x) + LINV f R y)); id := f #0 |>;
          prod := <| carrier := IMAGE f R; op := (\x y. f ((LINV f R x) * LINV f R y)); id := f #1 |>
     |>
...
val ring_inj_image_carrier = store_thm(
  "ring_inj_image_carrier",
...
*)
val ring_inj_image_sum_monoid = store_thm(
  "ring_inj_image_sum_monoid",
...
*)
val ring_inj_image_sum_group = store_thm(
  "ring_inj_image_sum_group",
...
*)
val ring_inj_image_sum_abelian_group = store_thm(
  "ring_inj_image_sum_abelian_group",
...
*)
val ring_inj_image_prod_monoid = store_thm(
  "ring_inj_image_prod_monoid",
...
*)
val ring_inj_image_prod_abelian_monoid = store_thm(
  "ring_inj_image_prod_abelian_monoid",
...
*)
val ring_inj_image_ring = store_thm(
  "ring_inj_image_ring",
...
*)
val ring_inj_image_prod_nonzero_monoid = store_thm(
  "ring_inj_image_prod_nonzero_monoid",
...
(* Proof:
   ...
   Let xx = LINV f R x.
   By Group_def, this is to show:
   (1) Monoid ((ring_inj_image r f).prod excluding f #0), true by ring_inj_image_prod_nonzero_monoid
...
*)
val ring_inj_image_prod_nonzero_group = store_thm(
  "ring_inj_image_prod_nonzero_group",
...
(* Proof:
   ...
   (2) Group ((ring_inj_image r f).prod excluding (ring_inj_image r f).sum.id)
       ...
       The result follows                          by ring_inj_image_prod_nonzero_group
*)
val ring_inj_image_field = store_thm(
  "ring_inj_image_field",
  ...
  rw[ring_inj_image_prod_nonzero_group]);
...
(* Proof:
   ...
   (2) x IN R /\ y IN R ==> f (x + y) = f (LINV f R (f x) + LINV f R (f y))
       ...
       The result is true.
*)
val ring_inj_image_sum_group_homo = store_thm(
  "ring_inj_image_sum_group_homo",
...
(* Proof:
   ...
   (2) x IN R /\ y IN R ==> f (x * y) = f (LINV f R (f x) * LINV f R (f y))
       ...
       The result is true.
*)
val ring_inj_image_prod_monoid_homo = store_thm(
  "ring_inj_image_prod_monoid_homo",
...
(* Proof:
   ...
   (1) x IN R ==> f x IN (ring_inj_image r f).carrier
       Note (ring_inj_image r f).carrier = IMAGE f R       by ring_inj_image_def
...
*)
val ring_inj_image_ring_homo = store_thm(
  "ring_inj_image_ring_homo",
  ``!(r:'a field) f. Ring r /\ INJ f R univ(:'b) ==> RingHomo f r (ring_inj_image r f)``,
  rw_tac std_ss[RingHomo_def] >-
  rw[ring_inj_image_def, INJ_DEF] >-
...
(* Proof: by ring_inj_image_ring_homo *)
val ring_inj_image_field_homo = store_thm(
  "ring_inj_image_field_homo",
...
(* Proof:
   Note Field r /\ FINITE R                         by FiniteField_def
    ==> Field (ring_inj_image r f)                  by ring_inj_image_field
...
*)
val ring_inj_image_finite_field = store_thm(
  "ring_inj_image_finite_field",
  ``!(r:'a field) f. FiniteField r /\ INJ f R univ(:'b) ==> FiniteField (ring_inj_image r f)``,
  metis_tac[FiniteField_def, ring_inj_image_field, ring_inj_image_carrier, IMAGE_FINITE]);

(* Theorem: Field r /\ INJ f R univ(:'b) ==> ?r_:'b field. Field r_ /\ FieldIso f r r_ *)
(* Proof:
   Let r_ = ring_inj_image r f.
   Then Field r_          by ring_inj_image_field
