...
Theorem IS_PERMISSION_STRUCTURE_THM:
...
Theorem IS_SPLIT_PERMISSION_STRUCTURE_THM:
...
Theorem IS_SPLIT_PERMISSION_STRUCTURE_THM2:
  IS_PERMISSION_STRUCTURE (f, total_perm) =
...
Theorem VAR_RES_STACK_IS_SEPARATE___SYM:
...
Theorem VAR_RES_STACK_IS_SEPARATE___FEMPTY:
...
Theorem VAR_RES_STACK_COMBINE_REWRITE:
...
Theorem SOME___VAR_RES_STACK_COMBINE:
    (VAR_RES_STACK_COMBINE (SOME s1) (SOME s2) = SOME s) =
...
Theorem VAR_RES_STACK_COMBINE_EXPAND:
    (VAR_RES_STACK_IS_SEPARATE s1 s2 ==>
...
Theorem VAR_RES_STACK_COMBINE___EQ___FEMPTY:
...
Theorem IS_VAR_RES_SUBPERMISSION_THM:
...
Theorem VAR_RES_STACK_COMBINE___SEPARATE_TO_BOTH:
...
Theorem VAR_RES_STACK_COMBINE___IS_SEPARATION_ALGEBRA:
...
Theorem VAR_RES_STACK_COMBINE___IS_SEPARATION_COMBINATOR:
...
Theorem VAR_RES_STACK_COMBINE___COMM:
...
Theorem asl_emp___VAR_RES_STACK_COMBINE:
...
Theorem var_res_sl___value_perm_of___asl_star:
  !pvar v1 p1 v2 p2.
...
Theorem var_res_sl___value_of___asl_star:
  !pvar v1 v2.
...
Theorem var_res_sl___own___asl_star:
  !pvar p1 p2.
...
Theorem var_res_sl___has_read_write_permission___read:
  (var_res_sl___has_read_permission v s =
...
Theorem var_res_sl___has_read_permission_THM:
...
Theorem var_res_sl___has_write_permission_THM:
...
Theorem VAR_RES_STACK_IS_SUBSTATE_REWRITE:
...
Theorem VAR_RES_STACK_IS_SUBSTATE_INTRO:
  !x1 x2 x.
...
Theorem VAR_RES_STACK_IS_SUBSTATE___IS_PREORDER:
...
Theorem VAR_RES_STACK_IS_SUBSTATE___ANTISYM:
...
Theorem VAR_RES_STACK_SPLIT12___REWRITES:
...
Theorem VAR_RES_STACK_IS_SEPARATE___VAR_RES_STACK_SPLIT12:
...
Theorem VAR_RES_STACK_COMBINE___VAR_RES_STACK_SPLIT12:
...
Theorem VAR_RES_STACK_SPLIT12___read_writes:
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_PERMISSIONS___ALTERNATIVE_DEF:
  !st1 st2.
...
Theorem VAR_RES_STACK___UPDATE_PERMISSION___ALTERNATIVE_DEF:
    VAR_RES_STACK___UPDATE_PERMISSION v p st =
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_PERMISSIONS_THM:
...
Theorem VAR_RES_STACK___IS_SUBSTATE_UPTO_PERMISSIONS___COMBINE_EXISTS1:
...
Theorem VAR_RES_STACK___IS_SUBSTATE_UPTO_PERMISSIONS___COMBINE_EXISTS2:
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_PERMISSIONS___COMBINE_EXISTS:
...
Theorem VAR_RES_STACK___IS_SUBSTATE_UPTO_PERMISSIONS___FEMPTY:
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_PERMISSIONS___FEMPTY:
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_PERMISSIONS___VAR_RES_STACK_SPLIT:
...
Theorem VAR_RES_STACK_IS_SEPARATE___DRESTRICT:
...
Theorem VAR_RES_STACK_IS_SEPARATE___write_perm:
  !st1 st2 s.
VAR_RES_STACK_IS_SEPARATE st1 st2 /\
...
Theorem VAR_RES_STACK_IS_SEPARATE___UPDATE:
  !st1 st2 s v.
VAR_RES_STACK_IS_SEPARATE st1 st2 /\
var_res_sl___has_write_permission s st1 ==>
...
Theorem VAR_RES_STACK_IS_SEPARATE___COMBINE_UPDATE:
  !st1 st2 s v.
VAR_RES_STACK_IS_SEPARATE st1 st2 /\
var_res_sl___has_write_permission s st1 ==>
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_VALUES___TRANS:
  !st1 st2 st3.
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_VALUES___REFL:
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_VALUES___SYM:
...
Theorem IS_SEPARATION_ALGEBRA___VAR_RES_COMBINATOR:
...
Theorem IS_SEPARATION_COMBINATOR___VAR_RES_COMBINATOR:
...
Theorem asl_emp___VAR_RES_COMBINATOR:
...
Theorem IS_SEPARATION_COMBINATOR___IS_VAR_RES_COMBINATOR:
...
Theorem VAR_RES_COMBINATOR_WEAK_11:
  !f f'.
...
Theorem GET_VAR_RES_COMBINATOR_THM:
  !f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem GET_VAR_RES_COMBINATOR_THM2:
...
Theorem VAR_RES_WRITE_PERM___SUBSTATE:
  !f s1 s2 v.
...
Theorem VAR_RES_READ_PERM___SUBSTATE:
...
Theorem var_res_exp_const_EVAL:
...
Theorem var_res_exp_binop___const_eval:
...
Theorem var_res_exp_binop_REWRITE:
...
Theorem var_res_exp_binop_const___ALTERNATIVE_DEF:
  var_res_exp_binop_const bop e n =
...
Theorem var_res_exp_binop_const_REWRITE:
...
Theorem var_res_exp_op_CONS_CONST:
...
Theorem SOME___var_res_exp_const:
...
Theorem var_res_exp_add_sub_REWRITES:
...
Theorem var_res_exp_prop___CONST:
...
Theorem var_res_prop_expression___ALTERNATIVE_DEF:
  var_res_prop_expression f emp p eL =
...
Theorem var_res_prop_binexpression___ALTERNATIVE_DEF:
  var_res_prop_binexpression f emp p e1 e2 =
...
Theorem var_res_prop_weak_expression_TF:
...
Theorem var_res_prop_weak_binexpression___ALTERNATIVE_DEF:
  var_res_prop_weak_binexpression p e1 e2 =
...
Theorem var_res_exp_is_defined___const:
...
Theorem var_res_bool_proposition_TF:
...
Theorem asl_and___var_res_bool_proposition:
...
Theorem asl_star___var_res_bool_proposition:
...
Theorem var_res_prop_expression___NIL:
...
Theorem var_res_prop_expression___CONS_CONST:
...
Theorem var_res_prop_binexpression_REWRITES:
  (!p. irreflexive p ==>
...
Theorem var_res_prop_binexpression___emp___consts:
...
Theorem var_res_prop_binexpression_symmetric:
...
Theorem var_res_prop_equal_symmetric:
...
Theorem var_res_prop_unequal_symmetric:
...
Theorem var_res_prop_weak_equal_symmetric:
...
Theorem var_res_prop_weak_unequal_symmetric:
...
Theorem var_res_prop_equal_unequal_REWRITES:
...
Theorem var_res_prop_equal_unequal_EXPAND:
...
Theorem VAR_RES_IS_WEAK_STACK_PROPOSITION___weak_stack_proposition:
...
Theorem VAR_RES_IS_WEAK_STACK_PROPOSITION___asl_and:
  !p1 p2.
...
Theorem VAR_RES_IS_WEAK_STACK_PROPOSITION___asl_or:
  !p1 p2.
      (VAR_RES_IS_WEAK_STACK_PROPOSITION p1 /\
       VAR_RES_IS_WEAK_STACK_PROPOSITION p2) ==>
...
Theorem VAR_RES_IS_WEAK_STACK_PROPOSITION___asl_neg:
...
Theorem VAR_RES_IS_WEAK_STACK_PROPOSITION___ASL_INTUITIONISTIC_NEGATION:
...
Theorem VAR_RES_IS_PURE_PROPOSITION___pure_proposition:
...
Theorem VAR_RES_IS_PURE_PROPOSITION___asl_false:
...
Theorem VAR_RES_IS_PURE_PROPOSITION___asl_emp:
  !f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem VAR_RES_IS_PURE_PROPOSITION___asl_star:
  !f P1 P2.
...
Theorem VAR_RES_IS_PURE_PROPOSITION___asl_bigstar:
...
Theorem VAR_RES_IS_PURE_PROPOSITION___BASIC_PROPS:
...
Theorem VAR_RES_IS_PURE_PROPOSITION___var_res_bigstar:
  !f sfb. IS_SEPARATION_COMBINATOR f ==>
BAG_EVERY (VAR_RES_IS_PURE_PROPOSITION f) sfb ==>
...
Theorem VAR_RES_IS_PURE_PROPOSITION___EQ_REWRITE:
...
Theorem var_res_prop_binexpression_cond___CONST_REWRITE:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___ALTERNATIVE_DEF:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___ALTERNATIVE_DEF:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___ALTERNATIVE_DEF_2:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___SUBSTATE:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___IMP:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___SUBSET:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_false:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_false:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_true:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_true:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_bool_proposition:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_bool_proposition:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_stack_true:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_stack_true:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_emp:
  !f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_emp:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_or:
  !P1 P2.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_or:
  !exS P1 P2.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_and:
  !P1 P2.
(VAR_RES_IS_STACK_IMPRECISE P1 /\ VAR_RES_IS_STACK_IMPRECISE P2) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_and:
  !exS P1 P2.
(VAR_RES_IS_STACK_IMPRECISE___USED_VARS exS P1 /\
 VAR_RES_IS_STACK_IMPRECISE___USED_VARS exS P2) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___const:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___const:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_trivial_cond:
  !exS c P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_trivial_cond:
  !c P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___cond:
  !exS c P1 P2.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___cond:
  !c P1 P2.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_exists:
  !exS P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_exists:
  !P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_exists_direct:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_exists_direct:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_forall:
  !exS P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_forall:
  !P. (!x. VAR_RES_IS_STACK_IMPRECISE (P x)) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_star:
  !f exS P1 P2.
  (VAR_RES_IS_STACK_IMPRECISE___USED_VARS exS P1 /\
   VAR_RES_IS_STACK_IMPRECISE___USED_VARS exS P2) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_star:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_bigstar:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_bigstar:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___asl_bigstar_list:
  !f. IS_SEPARATION_COMBINATOR f ==>
!L exS. ((~(L = [])) /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE___asl_bigstar_list:
  !f. IS_SEPARATION_COMBINATOR f ==>
!L.((~(L = [])) /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_bigstar:
  !f sfb exS.
(IS_SEPARATION_COMBINATOR f /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_bigstar:
  !f sfb.
(IS_SEPARATION_COMBINATOR f /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_bigstar_list:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_bigstar_list:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_map:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_map:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_map___SIMPLE:
  !f P L exS. (IS_SEPARATION_COMBINATOR f /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_map___SIMPLE:
  !f P L. (IS_SEPARATION_COMBINATOR f /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_REL_11:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_THM:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_REL___REWRITE:
  !e vs.
  VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_REL e vs =
  FINITE vs /\
  (!st. IS_SOME (e st) = vs SUBSET (FDOM st)) /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_REL___EXPAND:
  !e vs.
  VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_REL e vs =
  FINITE vs /\
  (!st. IS_SOME (e st) = vs SUBSET (FDOM st)) /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___REWRITE:
  VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e =
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___UNIV_REWRITE:
...
Theorem IS_SOME___VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___REWRITE:
  IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e) =
  ?vs. VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_REL e vs
Proof
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___SUBSET:
  !vs1 vs2 e.
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___EXP_EQ:
  !st1 st2 vs e.
(VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___EXP_EQ_IS_SOME:
  !st1 st2 vs e.
(VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e /\
...
Theorem IS_SOME___VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___SUBSTATE_LEFT:
  !st1 st2 e.
(IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e) /\
 VAR_RES_STACK_IS_SUBSTATE st1 st2 /\
 IS_SOME (e st1)) ==>
...
Theorem IS_SOME___VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___SUBSTATE_RIGHT:
  !st1 st2 e.
(IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e) /\
 VAR_RES_STACK_IS_SUBSTATE st1 st2 /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_const:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_var:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_op:
  !f eL vs.
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_binop:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_binop_const:
  !binop e n vs.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_expression:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_binexpression:
  !f emp p e1 e2 vs.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_equal:
  !f e1 e2 vs.
  ((VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e1) /\
  (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e2)) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_unequal:
  !f e1 e2 vs.
  ((VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e1) /\
  (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e2)) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_weak_equal:
  !e1 e2 vs.
  ((VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e1) /\
  (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e2)) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_weak_unequal:
  !e1 e2 vs.
  ((VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e1) /\
  (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e2)) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_expression:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_binexpression:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_unequal:
  !f e1 e2.
  (IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1)) /\
  (IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2)) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_equal:
  !f e1 e2.
  (IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1)) /\
  (IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2)) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_weak_unequal:
  !e1 e2.
  (IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1)) /\
  (IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2)) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_weak_equal:
  !e1 e2.
  (IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1)) /\
  (IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2)) ==>
...
Theorem asl_star___VAR_RES_IS_STACK_IMPRECISE:
...
Theorem asl_star___var_res_prop_stack_true:
  !f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem asl_star___var_res_prop_stack_true___STACK_IMPRECISE:
  !f. IS_SEPARATION_COMBINATOR f ==>
(!P. VAR_RES_IS_STACK_IMPRECISE P ==>
...
Theorem asl_star___var_res_prop_stack_true___STACK_IMPRECISE___COMM:
  !f. IS_SEPARATION_COMBINATOR f ==>
(!P. VAR_RES_IS_STACK_IMPRECISE P ==>
...
Theorem asl_star___var_res_prop_stack_true___IDEM:
  !f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem asl_star___var_res_prop_stack_true___IDEM_2:
  !f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem asl_star___var_res_prop_stack_true___IDEM_3:
  !f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem asl_star___swap_var_res_prop_stack_true:
...
Theorem var_res_bigstar_REWRITE:
  (!f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_bigstar_list_REWRITE:
  (!f. IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_bigstar_list_APPEND:
...
Theorem var_res_bigstar_list_SNOC:
  !f p pL. IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_bigstar_list_REVERSE:
...
Theorem var_res_bigstar_list___var_res_prop_stack_true:
  !f pL. IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_bigstar___var_res_prop_stack_true:
  !f pL. IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_bigstar___var_res_prop_stack_true___asl_star_ELIM:
  !f pL. IS_SEPARATION_COMBINATOR f ==>
...
Theorem asl_bigstar_list___VAR_RES_IS_STACK_IMPRECISE:
...
Theorem var_res_bigstar_list___VAR_RES_IS_STACK_IMPRECISE:
  !f P1 PL. IS_SEPARATION_COMBINATOR f /\ (EVERY VAR_RES_IS_STACK_IMPRECISE (P1::PL)) ==>
...
Theorem var_res_bigstar___VAR_RES_IS_STACK_IMPRECISE:
...
Theorem asl_and___weak_binexpression:
  !f e1 e2 P p.
  IS_SEPARATION_COMBINATOR f /\
  IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1) /\
  IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2) /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___VAR_CONST_EVAL:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___var_res_exp_op:
  !vs f el.
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___var_res_exp_binop:
  !f vs e1 e2.
VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e1 /\
VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e2 ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___var_res_exp_binop_const:
  !f vs e n.
VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___IS_SOME_IMPL:
...
Theorem IS_SOME___VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___VAR_CONST_EVAL:
...
Theorem IS_SOME___VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_op:
  !f el.
EVERY (\e. IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e)) el ==>
...
Theorem IS_SOME___VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_binop:
  !f e1 e2.
IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1) /\
IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2) ==>
...
Theorem IS_SOME___VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_binop_const:
  !f e n.
IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e) ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_exp_is_defined:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_exp_is_defined:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_exp_prop:
  !e P vs.
(VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs e /\
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_exp_prop:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_exp_full_prop:
  !eL P vs.
EVERY (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET vs) eL ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_exp_full_prop:
...
Theorem var_res_prop_input_distinct___REWRITE:
...
Theorem var_res_prop_input_ap_distinct_ELIM:
...
Theorem var_res_prop___PROP___REWRITE_2:
  !f wpb rpb sfb.
    var_res_prop___PROP f (wpb,rpb) sfb =
       (\s.
          (!v. BAG_IN v wpb ==> var_res_sl___has_write_permission v (FST s)) /\
...
Theorem var_res_prop___PROP___REWRITE:
  !f wpb rpb sfb.
    IS_SEPARATION_COMBINATOR f ==>
    (var_res_prop___PROP f (wpb,rpb) sfb =
       (\s.
...
(* Simple rewrites *)
Theorem var_res_prop_internal___COND___EXPAND:
  !f wpb rpb sfb d.
  (var_res_prop_internal___COND f (wpb,rpb) d sfb =
...
Theorem var_res_prop_internal___EQ:
  (var_res_prop_internal f (wpb, rpb) (wp,rp) d sfb P =
   var_res_prop_internal f (wpb', rpb') (wp',rp') d' sfb' P') =
...
Theorem var_res_prop_internal___EXISTS:
...
Theorem var_res_prop_internal___VARS_TO_BAGS:
...
Theorem var_res_prop_internal___VARS_TO_BAGS___END:
...
Theorem var_res_prop_internal___PROP_TO_BAG:
...
Theorem var_res_prop_internal___PROP_TO_BAG___END:
...
Theorem var_res_prop___COND_VAR_INSERT:
  !f wpb rpb sfb v.
  (var_res_prop___COND f (wpb, rpb) sfb /\
...
Theorem var_res_prop___COND_INSERT:
...
Theorem var_res_prop___COND_UNION:
  !f wpb rpb sfb1 sfb2.
...
Theorem var_res_prop___IMPLIES_VAR_DISTINCT:
  !f wpb rpb sfb.
...
Theorem var_res_prop___PROP_EMPTY:
...
Theorem var_res_prop___PROP___VARS:
  !s f wpb rpb sfb.
...
Theorem var_res_prop___PROP_INSERT:
  !f wpb rpb sf sfb.
  (var_res_prop___COND f (wpb, rpb) (BAG_INSERT sf sfb)) ==>
...
Theorem var_res_prop___PROP_UNION:
  !f wpb rpb sfb1 sfb2.
var_res_prop___COND f (wpb,rpb) (BAG_UNION sfb1 sfb2) ==>
...
Theorem var_res_prop___PROP___asl_false:
...
Theorem var_res_prop___var_res_exp_is_defined:
  !f e wpb rpb sfb.
...
Theorem var_res_exp_is_cond_defined___var_res_prop:
  !f e wpb rpb sfb vs.
  ((VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e = SOME vs) /\
...
Theorem COND_PROP___STRONG_IMP___asl_cond_star___var_res_prop:
...
Theorem asl_star___var_res_prop___PROP:
...
Theorem asl_star___var_res_prop___PROP___SIMPLE:
  !f wpb rpb sfb sf.
         var_res_prop___COND f (wpb,rpb) sfb /\
...
Theorem COND_PROP___STRONG_EQUIV___WEAK_COND_REWRITE:
  !f wpb rpb sfb sfb'.
...
Theorem COND_PROP___EQUIV___WEAK_COND_REWRITE:
  !f wpb rpb sfb sfb'.
(BAG_ALL_DISTINCT (BAG_UNION wpb rpb) ==> (sfb = sfb')) ==>
...
Theorem var_res_prop___PROP___var_res_bool_proposition:
  !f c wpb rpb sfb.
  var_res_prop___COND f (wpb,rpb) sfb ==>
  ((var_res_prop___PROP f (wpb,rpb)
...
Theorem var_res_prop___var_res_prop_stack_true:
  !f wpb rpb sfb.
...
Theorem COND_PROP___STRONG_EQUIV___var_res_prop_stack_true:
  !f wpb rpb sfb.
...
Theorem COND_PROP___EQUIV___var_res_prop_stack_true:
  !f wpb rpb sfb.
  COND_PROP___EQUIV
     (var_res_prop f (wpb,rpb) (BAG_INSERT (var_res_prop_stack_true f) sfb))
     (var_res_prop f (wpb,rpb) sfb)
...
Theorem var_res_prop___PROP___asl_star:
  !f wpb rpb sfb P1 P2.
  IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_prop___PROP___asl_bigstar:
  !f wpb rpb sfb1 sfb2.
  IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_prop___PROP___var_res_bigstar:
  !f wpb rpb sfb1 sfb2.
  IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_prop___PROP___var_res_prop_stack_true:
  !f wpb rpb sfb.
  IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_prop___asl_star:
  !f f' wpb rpb sfb P1 P2.
  (IS_VAR_RES_COMBINATOR f /\ (GET_VAR_RES_COMBINATOR f = f') /\
   (VAR_RES_IS_STACK_IMPRECISE___USED_VARS (SET_OF_BAG (BAG_UNION wpb rpb)) P1) /\
   (VAR_RES_IS_STACK_IMPRECISE___USED_VARS (SET_OF_BAG (BAG_UNION wpb rpb)) P2)) ==>
...
Theorem var_res_prop___PROP___asl_exists:
  !f wpb rpb sfb P.
  IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_prop___asl_exists:
  !f wpb rpb sfb P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_binexpression_cond:
  !f p e1 e2 vs P1 P2.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_binexpression_cond:
  !f p e1 e2 P1 P2.
(VAR_RES_IS_STACK_IMPRECISE P1 /\ VAR_RES_IS_STACK_IMPRECISE P2 /\
 IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1) /\
 IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2)) ==>
...
Theorem var_res_prop_binexpression_cond___COMM:
  !f p e1 e2 P1 P2.
...
Theorem var_res_prop_binexpression_cond___asl_false___false:
  !f p e1 e2 P.
...
Theorem var_res_prop_binexpression_cond___asl_false___true:
  !f p e1 e2 P.
  (IS_SEPARATION_COMBINATOR f /\ VAR_RES_IS_STACK_IMPRECISE P /\
   IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1) /\
   IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2)) ==>
...
Theorem VAR_RES_HOARE_TRIPLE_REWRITE:
  VAR_RES_HOARE_TRIPLE xenv penv P prog Q =
...
Theorem VAR_RES_COND_HOARE_TRIPLE_REWRITE:
  !f P prog Q.
  VAR_RES_COND_HOARE_TRIPLE f P prog Q =
...
Theorem VAR_RES_COND_HOARE_TRIPLE_INTRO:
...
Theorem VAR_RES_COND_HOARE_TRIPLE___COND_PROP_IMP:
  !f P1 P2 prog Q.
...
Theorem VAR_RES_COND_HOARE_TRIPLE___COND_PROP_STRONG_IMP:
  !f P1 P2 prog Q.
...
Theorem VAR_RES_COND_HOARE_TRIPLE___COND_PROP_EQUIV:
  !f P1 P2 prog Q.
...
Theorem VAR_RES_COND_HOARE_TRIPLE___COND_PROP_STRONG_EQUIV:
  !f P1 P2 prog Q.
...
Theorem VAR_RES_COND_HOARE_TRIPLE___COND_EXISTS:
  !f P prog Q.
...
Theorem VAR_RES_COND_HOARE_TRIPLE___PROGRAM_ABSTRACTION:
  !f P prog1 prog2 Q.
  (IS_SEPARATION_COMBINATOR f ==>
   (VAR_RES_PROGRAM_IS_ABSTRACTION f prog1 prog2 /\
...
Theorem VAR_RES_COND_HOARE_TRIPLE___PROGRAM_ABSTRACTION_EVAL:
  !f P prog1 prog2 Q.
  VAR_RES_PROGRAM_IS_ABSTRACTION f prog1 prog2 ==>
  VAR_RES_COND_HOARE_TRIPLE f P prog2 Q ==>
  VAR_RES_COND_HOARE_TRIPLE f P prog1 Q
...
Theorem VAR_RES_COND_HOARE_TRIPLE___PROGRAM_ABSTRACTION_first:
...
Theorem VAR_RES_COND_HOARE_TRIPLE___PROGRAM_ABSTRACTION_first_block:
...
Theorem VAR_RES_COND_HOARE_TRIPLE___PROGRAM_ABSTRACTION_first_block_simple:
...
Theorem ASL_IS_LOCAL_ACTION___var_res_best_local_action:
...
Theorem ASL_IS_LOCAL_ACTION___var_res_cond_best_local_action:
  !f P Q. IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_prog_best_local_action_REWRITE:
...
Theorem var_res_prog_cond_best_local_action_REWRITE:
  var_res_prog_cond_best_local_action pre post =
  asl_prog_prim_command (asl_pc_shallow_command
...
Theorem var_res_prog_cond_best_local_action___STRONG_EQUIV___pre_post:
  !pre post pre' post'.
...
Theorem var_res_prog_cond_best_local_action___STRONG_IMP___pre_post:
  !f pre post pre' post'.
...
Theorem ASL_IS_LOCAL_ACTION___var_res_quant_best_local_action:
  !f P Q. IS_SEPARATION_COMBINATOR f ==>
...
Theorem ASL_IS_LOCAL_ACTION___var_res_cond_quant_best_local_action:
  !f P Q. IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_prog_quant_best_local_action_REWRITE:
  var_res_prog_quant_best_local_action qP qQ =
  asl_prog_prim_command (asl_pc_shallow_command
...
Theorem var_res_prog_cond_quant_best_local_action_REWRITE:
  var_res_prog_cond_quant_best_local_action qP qQ =
  asl_prog_prim_command (asl_pc_shallow_command
...
Theorem var_res_prog_cond_best_local_action_INTRO:
...
Theorem var_res_prog_cond_best_local_action_INTRO_star:
...
Theorem var_res_prog_cond_quant_best_local_action_INTRO:
  !f f' wp wp' rp rp' d d' P P'.
  ALL_DISTINCT d /\ ALL_DISTINCT d' ==>
...
Theorem var_res_prog_cond_quant_best_local_action___STRONG_EQUIV___pre_post:
  !pre post pre' post'.
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_quant_best_local_action:
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_best_local_action:
  !xenv penv P prog Q.
  IS_VAR_RES_COMBINATOR (FST xenv) ==>
...
Theorem VAR_RES_HOARE_TRIPLE___comment___ELIM_preserve_names:
...
Theorem var_res_state_varlist_update_REWRITE:
...
Theorem var_res_state_varlist_update_THM:
...
Theorem var_res_exp_varlist_update_THM:
...
Theorem var_res_prop_varlist_update_THM:
...
Theorem var_res_prop_varlist_update_SING:
...
Theorem var_res_exp_varlist_update___const_EVAL:
...
Theorem var_res_exp_varlist_update___var_EVAL:
  !v1 v2 c vL.
...
Theorem var_res_exp_varlist_update___var_res_exp_op_EVAL:
  !vL f eL.
...
Theorem var_res_exp_varlist_update___var_res_exp_binop_EVAL:
  !vL f e1 e2.
...
Theorem var_res_exp_varlist_update___var_res_exp_binop_const_EVAL:
  !f vL e n.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_var_update___INSERT:
  !vc vs P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_varlist_update___INSERT:
  !vcL vs P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_var_update:
  !vc vs P.
...
Theorem VAR_RES_IS_STACK_IMPRECISE___USED_VARS___var_res_prop_varlist_update:
  !vcL vs P.
(VAR_RES_IS_STACK_IMPRECISE___USED_VARS vs P ==>
 VAR_RES_IS_STACK_IMPRECISE___USED_VARS vs (var_res_prop_varlist_update vcL P))
Proof
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_var_update:
...
Theorem VAR_RES_IS_STACK_IMPRECISE___var_res_prop_varlist_update:
  !vc P. (VAR_RES_IS_STACK_IMPRECISE P ==>
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_var_update:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS___var_res_exp_varlist_update:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___var_res_exp_var_update:
...
Theorem VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET___var_res_exp_varlist_update:
...
Theorem var_res_prop_var_update___asl_star:
...
Theorem var_res_prop_varlist_update___bool_cond:
  !c vL p1 p2.
...
Theorem var_res_prop_varlist_update___asl_star:
  !f vL p1 p2.
(VAR_RES_IS_STACK_IMPRECISE p1 /\ VAR_RES_IS_STACK_IMPRECISE p2) ==>
...
Theorem var_res_prop_var_update___var_res_prop_expression:
  !f vc emp p el.
...
Theorem var_res_prop_var_update___var_res_prop_binexpression:
  !f vc emp p e1 e2.
...
Theorem var_res_prop_varlist_update___var_res_prop_expression:
  !f vcL emp p el.
...
Theorem var_res_prop_varlist_update___var_res_prop_binexpression:
  !f vcL emp p e1 e2.
...
Theorem var_res_prop_var_update___equal_unequal:
...
Theorem var_res_prop_varlist_update___equal_unequal:
...
Theorem var_res_prop_var_update___var_res_exp_is_defined:
  !f vc e.
...
Theorem var_res_prop_varlist_update___var_res_exp_is_defined:
  !f vcL e.
...
Theorem var_res_prop_var_update___var_res_exp_prop:
  !vc e P.
...
Theorem var_res_prop_varlist_update___var_res_exp_prop:
  !vcL e P.
...
Theorem var_res_prop_var_update___var_res_exp_full_prop:
  !vc eL P.
...
Theorem var_res_prop_varlist_update___var_res_exp_full_prop:
  !vcL eL P.
...
Theorem var_res_prop_var_update___BOOL:
...
Theorem var_res_prop_varlist_update___BOOL:
...
Theorem var_res_prop_varlist_update___asl_trivial_cond:
  !vL c p.
...
Theorem var_res_prop_var_update___var_res_prop_binexpression_cond:
  !p f vc e1 e2 P1 P2.
...
Theorem var_res_prop_varlist_update___var_res_prop_binexpression_cond:
  !p f vcL e1 e2 P1 P2.
...
Theorem var_res_prop_varlist_update_IDEMPOT:
...
Theorem var_res_prop_varlist_update_IDEMPOT_o:
...
Theorem var_res_prop_varlist_update___asl_bigstar_list:
  !f vcL pL.
...
Theorem var_res_prop_varlist_update___var_res_bigstar_list:
  !f vcL pL.
...
Theorem var_res_prop_varlist_update___var_res_map:
  !f vcL P l.
...
Theorem var_res_prop_varlist_update___var_res_bigstar:
...
Theorem var_res_prop___var_eq_const_BAG_THM:
...
Theorem var_res_prop___PROP___var_res_prop_var_list_update___EQ_PRED_LIST:
...
Theorem var_res_prop___equal_const:
  !f wpb rpb vcL sfb.
  COND_PROP___STRONG_IMP
...
Theorem var_res_prop___equal_const___equal_var:
...
Theorem var_res_prop___CONST_INTRO:
  !e f wpb rpb sfb.
(VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET (SET_OF_BAG (BAG_UNION wpb rpb)) e) ==>
(COND_PROP___EQUIV
 (var_res_prop f (wpb,rpb) sfb)
...
Theorem VAR_RES_INFERENCE___EXISTS_PRE:
  !xenv penv P prog Q.
...
Theorem VAR_RES_COND_INFERENCE___STRONG_COND_EXISTS_PRE:
  !f P prog Q.
(!x. VAR_RES_COND_HOARE_TRIPLE f (P x) prog Q) ==>
...
Theorem VAR_RES_COND_INFERENCE___STRONG_COND_EXISTS_POST:
  !f P prog Q.
...
Theorem VAR_RES_COND_INFERENCE___asl_exists_pre:
...
Theorem VAR_RES_COND_INFERENCE___asl_star_pre:
...
Theorem VAR_RES_COND_INFERENCE___var_res_prop_stack_true:
...
Theorem VAR_RES_COND_INFERENCE___false_precond:
  !f wpb rpb sfb prog post.
VAR_RES_COND_HOARE_TRIPLE f
   (var_res_prop f (wpb,rpb)
...
Theorem VAR_RES_COND_INFERENCE___var_res_bool_proposition:
...
Theorem asl_trivial_cond___asl_star_var_res_bool_proposition:
  (!f c p.
     (IS_SEPARATION_COMBINATOR f /\ VAR_RES_IS_STACK_IMPRECISE p) ==>
...
Theorem asl_trivial_cond___var_res_bool_proposition:
...
Theorem asl_trivial_cond___var_res_stack_true:
...
Theorem VAR_RES_COND_INFERENCE___asl_trivial_cond:
...
Theorem VAR_RES_COND_INFERENCE___EQ_CASE_SPLIT:
...
Theorem VAR_RES_COND_INFERENCE___CONST_INTRO:
...
Theorem VAR_RES_COND_INFERENCE___TRIVIAL_CONST_INTRO:
  !c f wpb rpb sfb prog post.
(VAR_RES_COND_HOARE_TRIPLE f (var_res_prop f (wpb,rpb) sfb) prog post =
 VAR_RES_COND_HOARE_TRIPLE f
        (var_res_prop f (wpb,rpb)
...
Theorem var_res_prop___UNEQUAL_INTRO:
  !f c1 c2 wpb rpb sfb.
(~(c1 = c2)) ==>
 (var_res_prop f (wpb,rpb) sfb =
...
Theorem VAR_RES_COND_INFERENCE___prog_block:
  !f P prog L Q.
...
Theorem VAR_RES_COND_INFERENCE___prog_block2:
  !f P prog1 prog2 L Q.
...
Theorem VAR_RES_COND_INFERENCE___prog_block3:
  !f P p1 pL pL2 Q.
...
Theorem VAR_RES_COND_INFERENCE___prog_block4:
  !f P pL pL2 Q.
...
Theorem VAR_RES_INFERENCE___prog_parallel:
...
Theorem VAR_RES_INFERENCE___prog_forall:
  !xenv penv P Q body.
...
Theorem VAR_RES_COND_INFERENCE___prog_forall:
  !f P Q body.
...
Theorem VAR_RES_INFERENCE___prog_seq:
...
Theorem VAR_RES_COND_INFERENCE___prog_seq:
  !f P Q R p1 p2.
  (FST P /\ FST R ==> FST Q) /\
...
Theorem VAR_RES_INFERENCE___STRENGTHEN:
...
Theorem VAR_RES_INFERENCE___STRENGTHEN_PERMS:
...
Theorem VAR_RES_COND_INFERENCE___STRENGTHEN_PERMS:
...
Theorem VAR_RES_INFERENCE___FRAME:
...
Theorem VAR_RES_COND_INFERENCE___FRAME:
...
Theorem VAR_RES_COND_INFERENCE___CONST_INTRO_READ:
...
Theorem VAR_RES_FRAME_SPLIT___sfb_restP_OK___REWRITE:
  VAR_RES_FRAME_SPLIT___sfb_restP_OK f (wpb,rpb) sfb_restP =
(?sfb. sfb_restP sfb /\ (var_res_prop___COND f (wpb,rpb) sfb)) /\
(!sfbS. (!sfb. sfb IN sfbS ==>
            ((var_res_prop___COND f (wpb,rpb) sfb) /\ (sfb_restP sfb))) ==>
...
Theorem VAR_RES_FRAME_SPLIT___sfb_restP_OK___asl_exists_IMP:
  VAR_RES_FRAME_SPLIT___sfb_restP_OK f (wpb,rpb) sfb_restP ==>
...
Theorem var_res_prop___COND___var_set_extend:
...
Theorem var_res_prop___COND___BAG_DIFF_REMOVE:
  !f wpb rpb wpb' rpb' sfb.
   (BAG_ALL_DISTINCT (BAG_UNION wpb rpb) /\
...
Theorem VAR_RES_FRAME_SPLIT_EXPAND:
...
Theorem VAR_RES_FRAME_SPLIT_NORMALISE:
  VAR_RES_FRAME_SPLIT f rfc (wpb,rpb) wpb' sfb_context sfb_split sfb_imp sfb_restP =
...
Theorem VAR_RES_COND_HOARE_TRIPLE___SOLVE_WEAK_IMP:
...
Theorem VAR_RES_FRAME_SPLIT___sfb_restP_OK___PURE_PROPOSITION:
...
Theorem COND_PROP___WEAK_IMP___var_res_prop___SOLVE:
...
Theorem VAR_RES_COND_HOARE_TRIPLE___SOLVE:
...
Theorem VAR_RES_COND_INFERENCE___prog_diverge:
  !f P progL Q.
...
Theorem VAR_RES_COND_INFERENCE___first_command_REWRITE:
...
Theorem VAR_RES_COND_INFERENCE___first_command_PRECOND_SEM:
  !f p1 p1' P progL Q.
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_quant_best_local_action:
  !f P qP qQ progL Q.
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_cond_quant_best_local_action:
  !f P qP qQ progL Q.
...
Theorem asl_exists___var_res_prop___UNION_PROP_REWRITE:
  !f wpb rpb sfb sfb'.
  IS_SEPARATION_COMBINATOR f ==>
...
Theorem asl_exists___var_res_prop___PROP_REWRITE:
  !f wpb rpb sfb.
  IS_SEPARATION_COMBINATOR f ==>
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_cond_best_local_action___EXISTS_VAR_CHANGE:
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_cond_best_local_action___VAR_CHANGE:
  !rfc f wpb rpb sfb wpb' wpb'' rpb' sfb' sfb'' progL Q.
   ((SET_OF_BAG wpb') SUBSET (SET_OF_BAG wpb)) /\
   ((SET_OF_BAG rpb') SUBSET (SET_OF_BAG (BAG_UNION wpb rpb))) ==>
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_cond_best_local_action___EXISTS:
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_cond_best_local_action:
  !rfc f wpb rpb sfb wpb' rpb' sfb' sfb'' progL Q.
   ((SET_OF_BAG wpb') SUBSET (SET_OF_BAG wpb)) /\
   ((SET_OF_BAG rpb') SUBSET (SET_OF_BAG (BAG_UNION wpb rpb))) ==>
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___IMP_REWRITE:
  VAR_RES_FRAME_SPLIT___REWRITE_OK f (wpb,rpb)
     sfb_context  sfb_split  sfb_imp
     sfb_context' sfb_split' sfb_imp' =
  (VAR_RES_FRAME_SPLIT___IMP_OK f (wpb,rpb)
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___REWRITE:
  VAR_RES_FRAME_SPLIT___REWRITE_OK f (wpb,rpb)
     sfb_context  sfb_split  sfb_imp
     sfb_context' sfb_split' sfb_imp' =
  !sfb_rest s.
...
Theorem VAR_RES_FRAME_SPLIT___IMP_OK___REWRITE:
  VAR_RES_FRAME_SPLIT___IMP_OK f (wpb,rpb)
     sfb_context' sfb_split' sfb_imp'
     sfb_context  sfb_split  sfb_imp  =
  !sfb_rest s.
...
Theorem VAR_RES_FRAME_SPLIT___IMP_OK___THM:
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___THM:
  !f strong_rest wpb rpb wpb' sfb_context sfb_split sfb_imp
   sfb_context' sfb_split' sfb_imp' sfb_restP.
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___SYM:
  VAR_RES_FRAME_SPLIT___REWRITE_OK f (wpb,rpb)
     sfb_context  sfb_split  sfb_imp
     sfb_context' sfb_split' sfb_imp' =
  VAR_RES_FRAME_SPLIT___REWRITE_OK f (wpb,rpb)
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___EQ_REWRITE:
  VAR_RES_FRAME_SPLIT___REWRITE_OK f (wpb,rpb)
     sfb_context  sfb_split  sfb_imp
     sfb_context' sfb_split' sfb_imp' =
...
Theorem VAR_RES_FRAME_SPLIT___IMP_OK___asl_star:
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___var_res_bool_proposition:
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___asl_star:
  !P1 P2 f wpb rpb sfb_context sfb_split sfb_imp
   sfb_context' sfb_split' sfb_imp'.
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___exists_imp:
...
Theorem VAR_RES_FRAME_SPLIT___IMP_OK___asl_exists:
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___FRAME:
...
Theorem VAR_RES_FRAME_SPLIT___FRAME:
...
Theorem VAR_RES_FRAME_SPLIT___ELIM_CONTEXT:
...
Theorem VAR_RES_PROP_IS_EQUIV_FALSE___REWRITE:
  !f wpb rpb sfb c.
...
Theorem VAR_RES_PROP_IS_EQUIV_FALSE___comment_REWRITE:
  !c1 c2 f wpb rpb sfb.
...
Theorem VAR_RES_PROP_IS_EQUIV_FALSE___INTRO:
...
Theorem VAR_RES_PROP_IS_EQUIV_FALSE___INTRO_IMP:
...
Theorem VAR_RES_PROP_IS_EQUIV_FALSE___FRAME_SPLIT_DEF:
  !f wpb rpb sfb c.
  VAR_RES_PROP_IS_EQUIV_FALSE c f (wpb,rpb) sfb =
...
Theorem VAR_RES_PROP_IS_EQUIV_FALSE___FRAME_SPLIT_DEF2:
  !f wpb rpb sfb c.
  VAR_RES_PROP_IS_EQUIV_FALSE c f (wpb,rpb) sfb =
...
Theorem VAR_RES_FRAME_SPLIT___SOLVE___bool_prop:
...
Theorem VAR_RES_FRAME_SPLIT___SOLVE___bool_prop___MP:
...
Theorem VAR_RES_FRAME_SPLIT___SOLVE_WEAK___bool_prop:
  !b rfc f wpb rpb wpb' sfb_context sfb_split sfb_restP.
(BAG_EVERY (VAR_RES_IS_STACK_IMPRECISE___USED_VARS (SET_OF_BAG
           (BAG_DIFF (BAG_UNION wpb rpb) wpb'))) sfb_split) ==>
 (b /\ (b ==> (sfb_restP sfb_split)))  ==>
...
Theorem VAR_RES_FRAME_SPLIT___SOLVE_WEAK___bool_prop___MP:
  !b. b ==> !rfc f wpb rpb wpb' sfb_context sfb_split sfb_restP.
(BAG_EVERY (VAR_RES_IS_STACK_IMPRECISE___USED_VARS (SET_OF_BAG
           (BAG_DIFF (BAG_UNION wpb rpb) wpb'))) sfb_split) ==>
 (sfb_restP sfb_split)  ==>
...
Theorem VAR_RES_PROP_IS_EQUIV_FALSE___FRAME_SPLIT_IMP:
...
Theorem VAR_RES_FRAME_SPLIT___PURE_PROPOSITION_INTRO:
...
Theorem VAR_RES_FRAME_SPLIT___PURE_PROPOSITION___TO_CONTEXT:
  !f wpb rpb wpb' sfb_context sfb_split sfb_imp sfb_restP sr sf.
VAR_RES_IS_PURE_PROPOSITION f sf ==>
((VAR_RES_FRAME_SPLIT f sr (wpb,rpb) wpb' sfb_context (BAG_INSERT sf sfb_split)
   sfb_imp sfb_restP) =
...
Theorem VAR_RES_FRAME_SPLIT___PURE_PROPOSITION___CONTEXT_FRAME:
  !f wpb rpb wpb' sfb_context sfb_split sfb_imp sfb_restP sr sf.
VAR_RES_IS_PURE_PROPOSITION f sf ==>
...
Theorem VAR_RES_FRAME_SPLIT___COND_PROP_IMP___split:
...
Theorem VAR_RES_FRAME_SPLIT___equal_const___context:
...
Theorem VAR_RES_FRAME_SPLIT___equal_const___context_SING:
...
Theorem VAR_RES_FRAME_SPLIT___equal_const:
  !vcL f wpb rpb wpb' sfb_context sfb_split sfb_imp sfb_restP sr.
...
Theorem VAR_RES_FRAME_SPLIT___equal_const_SING:
  !v c f wpb rpb wpb' sfb_context sfb_split sfb_imp sfb_restP sr.
((VAR_RES_FRAME_SPLIT f sr (wpb,rpb) wpb'
   (BAG_INSERT
      (var_res_prop_equal f (var_res_exp_var v) (var_res_exp_const c))
...
Theorem VAR_RES_FRAME_SPLIT___WEAK_COND_REWRITE:
...
Theorem VAR_RES_FRAME_SPLIT___COND_PROP_STRONG_IMP:
...
Theorem VAR_RES_FRAME_SPLIT___COND_PROP_STRONG_EQUIV:
  !f wpb rpb wpb' sfb_context  sfb_split sfb_imp
                sfb_context' sfb_split' sfb_imp' sfb_restP sr.
...
Theorem VAR_RES_FRAME_SPLIT___asl_star___context:
...
Theorem VAR_RES_FRAME_SPLIT___asl_star___imp:
  !f f' P1 P2 wpb rpb wpb' sfb_context  sfb_split sfb_imp sfb_restP sr.
...
Theorem VAR_RES_FRAME_SPLIT___asl_star___split:
  !f f' P1 P2 wpb rpb wpb' sfb_context  sfb_split sfb_imp sfb_restP sr.
...
Theorem VAR_RES_FRAME_SPLIT___COND_PROP___STRONG_EXISTS___imp:
...
Theorem VAR_RES_FRAME_SPLIT___asl_exists___imp:
...
Theorem VAR_RES_FRAME_SPLIT___COND_PROP___STRONG_IMP_EXISTS___split:
...
Theorem VAR_RES_FRAME_SPLIT___COND_PROP___EQ_EXISTS___split:
  !f wpb rpb wpb' sfb_context sfb_split sfb_split' sfb_imp sfb_restP sr.
...
Theorem VAR_RES_FRAME_SPLIT___asl_exists___split:
  !f P wpb rpb wpb' sfb_context  sfb_split sfb_imp sfb_restP sr.
...
Theorem VAR_RES_FRAME_SPLIT___CONST_INTRO:
...
Theorem VAR_RES_FRAME_SPLIT___COND_PROP___STRONG_EXISTS___context:
...
Theorem VAR_RES_FRAME_SPLIT___asl_exists___context:
  !f P wpb rpb wpb' sfb_context  sfb_split sfb_imp sfb_restP sr.
...
Theorem VAR_RES_FRAME_SPLIT___REWRITE_OK___stack_true:
...
Theorem VAR_RES_FRAME_SPLIT___stack_true:
  (!f wpb rpb wpb' sfb_context  sfb_split  sfb_imp sfb_restP sr.
((VAR_RES_FRAME_SPLIT f sr (wpb,rpb) wpb'
...
Theorem VAR_RES_FRAME_SPLIT___SOLVE:
...
Theorem VAR_RES_FRAME_SPLIT___SOLVE_WEAK:
  !rfc f wpb rpb wpb' sfb_context sfb_split sfb_restP.
(BAG_EVERY (VAR_RES_IS_STACK_IMPRECISE___USED_VARS (SET_OF_BAG
           (BAG_DIFF (BAG_UNION wpb rpb) wpb'))) sfb_split) ==>
(sfb_restP sfb_split ==>
...
Theorem VAR_RES_FRAME_SPLIT___asl_false___context:
...
Theorem VAR_RES_FRAME_SPLIT___asl_false___split:
  !f strong_rest wpb rpb wpb' sfb_context sfb_split sfb_imp sfb_restP.
  VAR_RES_FRAME_SPLIT f strong_rest (wpb,rpb) wpb' sfb_context
...
Theorem VAR_RES_FRAME_SPLIT___bool_proposition___context:
...
Theorem VAR_RES_FRAME_SPLIT___bool_proposition___split:
  !f wpb rpb wpb' sfb_context  sfb_split  sfb_imp sfb_restP c sr.
...
Theorem VAR_RES_FRAME_SPLIT___bool_proposition___imp:
...
Theorem VAR_RES_FRAME_SPLIT___trivial_cond___context:
...
Theorem VAR_RES_FRAME_SPLIT___trivial_cond___split:
  !f wpb rpb wpb' sfb_context  sfb_split  sfb_imp sfb_restP c P sr.
...
Theorem VAR_RES_FRAME_SPLIT___trivial_cond___imp:
  !f wpb rpb wpb' sfb_context  sfb_split  sfb_imp sfb_restP c P sr.
...
Theorem VAR_RES_FRAME_SPLIT___JUST_COND___GUESS:
  ((c /\
VAR_RES_FRAME_SPLIT f strong_rest (wpb,rpb) wpb' sfb_context
       sfb_split {||} sfb_restP) ==>
...
Theorem VAR_RES_PROP_IS_EQUIV_FALSE___ELIM:
...
Theorem GUESS_RULES___VAR_RES_FRAME_SPLIT_1:
...
Theorem GUESS_RULES___VAR_RES_FRAME_SPLIT_2:
  !i c f wpb rpb wpb' sfb_context sfb_split sfb_imp sfb_restP sr.
...
Theorem var_res_implies_unequal_SYM:
  !f b e1 e2.
  var_res_implies_unequal f b e1 e2 =
...
Theorem var_res_implies_unequal___SUB_BAG:
  !f sfb1 sfb2 e1 e2.
  (SUB_BAG sfb1 sfb2 /\
...
Theorem var_res_implies_unequal___asl_exists:
...
Theorem var_res_implies_unequal___trivial_context:
  !f b c1 c2. ~(c1 = c2) ==>
...
Theorem var_res_implies_unequal___trivial_unequal:
  !f b e1 e2.
...
Theorem var_res_prop_implies_REWRITE:
  !f wpb rpb sfb sfb'.
   var_res_prop_implies f (wpb,rpb) sfb sfb' =
   (var_res_prop f (wpb,rpb) sfb =
    var_res_prop f (wpb,rpb) (BAG_UNION sfb sfb'))
...
Theorem var_res_prop_implies_eq___SUB_BAG:
...
Theorem var_res_prop_implies___SUB_BAG:
...
Theorem var_res_prop_implies___UNION:
...
Theorem var_res_implies_unequal___var_res_prop___PROP:
...
Theorem var_res_implies_unequal___prop_implies:
  !f e1 e2 wpb rpb sfb.
 (var_res_implies_unequal f sfb e1 e2) ==>
 ((VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS_SUBSET
...
Theorem VAR_RES_COND_INFERENCE___prop_implies:
...
Theorem VAR_RES_COND_INFERENCE___prop_implies_eq:
  !f wpb rpb sfb sfb' prog post.
...
Theorem VAR_RES_FRAME_SPLIT___var_res_prop_implies_eq___split:
...
Theorem VAR_RES_FRAME_SPLIT___var_res_prop_implies_eq___imp:
...
Theorem VAR_RES_FRAME_SPLIT___var_res_prop_implies___split:
...
Theorem VAR_RES_FRAME_SPLIT___var_res_prop_implies___imp:
...
Theorem var_res_new_var_init_action___best_local_action_THM:
  !f v e vs.
   IS_SEPARATION_COMBINATOR f /\
   (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e = SOME vs) ==>
...
Theorem ASL_IS_LOCAL_ACTION___var_res_new_var_init_action:
  !f e v.
IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e) ==>
...
Theorem var_res_dispose_var_action___best_local_action_THM:
  !f v.
   IS_SEPARATION_COMBINATOR f ==>
...
Theorem ASL_IS_LOCAL_ACTION___var_res_dispose_var_action:
...
Theorem VAR_RES_PROGRAM_IS_ABSTRACTION___var_res_prog_call_by_value_arg:
  !f c body.
IS_SEPARATION_COMBINATOR f ==>
(VAR_RES_PROGRAM_IS_ABSTRACTION f
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_prog_call_by_value_arg___CONG:
...
Theorem VAR_RES_PROGRAM_IS_ABSTRACTION___var_res_prog_local_var:
  !f body.
IS_SEPARATION_COMBINATOR f ==>
(VAR_RES_PROGRAM_IS_ABSTRACTION f
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_prog_local_var___CONG:
  !xenv penv body body'.
(!v. ASL_PROGRAM_IS_ABSTRACTION xenv penv (body v) (body' v)) ==>
ASL_PROGRAM_IS_ABSTRACTION xenv penv
       (var_res_prog_local_var body)
...
Theorem VAR_RES_COND_INFERENCE___prog_seq_skip_INTRO:
  !f P prog Q.
  VAR_RES_COND_HOARE_TRIPLE f P prog Q =
...
Theorem VAR_RES_COND_INFERENCE___prog_block_INTRO:
  !f P prog Q.
  VAR_RES_COND_HOARE_TRIPLE f P prog Q =
...
Theorem VAR_RES_COND_INFERENCE___prog_seq_skip_ELIM:
  !f P prog Q.
...
Theorem VAR_RES_COND_INFERENCE___prog_block_skip_ELIM:
  !f P progL Q.
...
Theorem VAR_RES_COND_INFERENCE___prog_seq_diverge:
  !f P prog Q.
...
Theorem VAR_RES_COND_INFERENCE___prog_block_diverge:
  !f P progL Q.
  VAR_RES_COND_HOARE_TRIPLE f P (asl_prog_block (asl_prog_diverge::progL)) Q
Proof
SIMP_TAC std_ss [VAR_RES_COND_INFERENCE___prog_block,
...
Theorem VAR_RES_COND_INFERENCE___prog_local_var:
...
Theorem VAR_RES_COND_INFERENCE___prog_call_by_value_arg:
...
Theorem ASL_IS_LOCAL_ACTION___var_res_assign_action:
  !f e v.
IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e) ==>
...
Theorem VAR_RES_PROGRAM_IS_ABSTRACTION___var_res_prog_assign:
  !f v c e vs.
   IS_SEPARATION_COMBINATOR f /\
   (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e = SOME vs) ==>
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_assign:
...
Theorem var_res_prog_procedure_call_THM:
...
Theorem var_res_prog_parallel_procedure_call_THM:
  var_res_prog_parallel_procedure_call name1 (ref1, expL1:('a, 'b,'c) var_res_expression list)
name2 (ref2, expL2:('a, 'b,'c) var_res_expression list) =
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_prog_eval_expressions:
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_prog_procedure_call:
...
Theorem VAR_RES_STACK___IS_EQUAL_UPTO_VALUES___VAR_RES_STACK_COMBINE:
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_prog_parallel_procedure_call:
...
Theorem VAR_RES_COND_INFERENCE___eval_expressions___NIL:
  !f P prog progL Q.
(VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___eval_expressions___ONE:
...
Theorem VAR_RES_COND_INFERENCE___eval_expressions___LIST:
...
Theorem VAR_RES_COND_INFERENCE___eval_expressions:
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___asl_prog_cond_critical_section___lock_decls_env:
...
Theorem var_res_lock_invariant___prop_input:
  IS_SEPARATION_COMBINATOR f ==>
...
Theorem var_res_lock_invariant___var_res_prop:
...
Theorem var_res_prog_aquire_release_lock_input___REWRITE:
  !f c wp P.
 IS_SEPARATION_COMBINATOR f ==>
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___asl_prog_cond_critical_section___lock_decls_env___INTERNAL:
...
Theorem var_res_prog_aquire_lock___INTRO:
  !f c wpb wp sfb.
     (SET_OF_BAG wpb = wp) ==>
     ((var_res_prog_aquire_lock_internal f c wp
         (var_res_prop f (wpb, EMPTY_BAG) sfb)) =
...
Theorem var_res_prog_release_lock___INTRO:
  !f wpb wp sfb.
     (SET_OF_BAG wpb = wp) ==>
     ((var_res_prog_release_lock_internal f wp
         (var_res_prop f (wpb, EMPTY_BAG) sfb)) =
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_prog_aquire_lock:
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_aquire_lock:
...
Theorem ASL_PROGRAM_IS_ABSTRACTION___var_res_prog_release_lock:
  !f lenv penv wpb sfb.
IS_SEPARATION_COMBINATOR f ==>
ASL_PROGRAM_IS_ABSTRACTION (VAR_RES_COMBINATOR f, lenv) penv
     (var_res_prog_release_lock f wpb sfb)
...
Theorem VAR_RES_COND_INFERENCE___var_res_prog_release_lock:
...
Theorem VAR_RES_COND_INFERENCE___prog_choice:
  !f P p1 p2 prog Q.
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___prog_cond:
...
Theorem VAR_RES_COND_INFERENCE___prog_cond_block:
...
Theorem VAR_RES_INFERENCE___prog_kleene_star:
  !xenv penv P prog.
...
Theorem VAR_RES_COND_INFERENCE___prog_while_GENERAL:
  !f P Inv c pL prog Q.
(FST P ==> (!x. FST (Inv x))) ==>
...
Theorem VAR_RES_COND_INFERENCE___prog_while:
...
Theorem VAR_RES_COND_INFERENCE___block_spec_GENERAL:
...
Theorem VAR_RES_COND_INFERENCE___block_spec:
...
Theorem VAR_RES_COND_INFERENCE___loop_spec_GENERAL:
...
Theorem VAR_RES_COND_INFERENCE___loop_spec:
...
Theorem VAR_RES_COND_INFERENCE___while_unroll:
  !f c p prog P Q.
...
Theorem VAR_RES_COND_INFERENCE___while_unroll___invariant:
  !i f c p prog P Q.
...
Theorem VAR_RES_COND_INFERENCE___while_unroll___loop_spec:
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_true:
  !f P progL Q.
VAR_RES_COND_HOARE_TRIPLE f P (asl_prog_block progL) Q ==>
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_false:
  !f P progL Q.
T ==>
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_neg_false:
  !f P progL Q.
VAR_RES_COND_HOARE_TRIPLE f P (asl_prog_block progL) Q ==>
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_neg_true:
  !f P progL Q. T ==>
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_and:
  !f P1 P2 P progL Q.
VAR_RES_COND_HOARE_TRIPLE f P
   (asl_prog_block (
         (asl_prog_assume P1)::
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_or:
  !f P1 P2 P progL Q.
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_neg_neg:
  !f p P progL Q.
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_neg_and:
  !f P1 P2 P progL Q.
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_neg_or:
  !f P1 P2 P progL Q.
VAR_RES_COND_HOARE_TRIPLE f P
...
Theorem ASL_IS_INTUITIONISTIC___weak_expression:
  !f p el.
IS_SEPARATION_COMBINATOR f /\
EVERY (\e. IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e)) el ==>
...
Theorem ASL_IS_INTUITIONISTIC___weak_binexpression:
  !f p e1 e2.
IS_SEPARATION_COMBINATOR f /\
IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e1) /\
IS_SOME (VAR_RES_IS_STACK_IMPRECISE_EXPRESSION___USED_VARS e2) ==>
...
Theorem ASL_INTUITIONISTIC_NEGATION___weak_prop_expression:
  !el f s p.
    (IS_SEPARATION_COMBINATOR f /\
...
Theorem ASL_INTUITIONISTIC_NEGATION___weak_prop_binexpression:
  !e1 e2 f s p.
(IS_SEPARATION_COMBINATOR f /\
...
Theorem var_res_pred_bin___ALTERNATIVE_DEF:
  var_res_pred_bin p e1 e2 =
...
Theorem asl_predicate_IS_DECIDED___var_res_pred:
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_pred:
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_pred_bin:
...
Theorem VAR_RES_COND_INFERENCE___prog_assert_pred:
...
Theorem VAR_RES_COND_INFERENCE___comment_assert:
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_neg_pred:
  !f wpb rpb sfb p el progL Q.
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_neg_pred_bin:
  !f wpb rpb sfb p e1 e2 progL Q.
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_pred_equiv:
...
Theorem VAR_RES_COND_INFERENCE___prog_assume_and___NO_EQUIV_COUNTER_EXAMPLE:
  (IS_SEPARATION_COMBINATOR f ==>
...
Theorem asl_prog_IS_RESOURCE_AND_PROCCALL_FREE___var_res_bla:
...
Theorem asl_prog_IS_RESOURCE_AND_PROCCALL_FREE___VAR_RES_SIMPLE_REWRITES:
...
Theorem asl_prog_IS_RESOURCE_AND_PROCCALL_FREE___var_res_prog_new_var:
...
Theorem asl_prog_IS_RESOURCE_AND_PROCCALL_FREE___var_res_prog_call_by_value_arg:
  !body c.
...
Theorem asl_prog_IS_RESOURCE_AND_PROCCALL_FREE___var_res_prog_local_var:
  !body.
  ((!v. asl_prog_IS_RESOURCE_AND_PROCCALL_FREE (body v)) ==>
...
Theorem asl_prog_IS_RESOURCE_AND_PROCCALL_FREE___var_res_prog_eval_expressions:
  !body expL.
