...
sig
  ...
  val smallfoot_input_file_term : term
  ...
  val dest_SMALLFOOT_INPUT_FILE : term -> term
  val dest_SMALLFOOT_SING_PROCEDURE_SPEC : term -> term * term * term * term * term * term * term
  ...
  val is_SMALLFOOT_INPUT_FILE : term -> bool
