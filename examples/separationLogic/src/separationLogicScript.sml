...
``!f. IS_SEPARATION_COMBINATOR f ==>
      ...
      (!P. asl_bigstar_list f [] = asl_emp f) /\
...
val asl_rec_pred_num___WEAKEN_NUM = store_thm ("asl_rec_pred_num___WEAKEN_NUM",
``(IS_SEPARATION_COMBINATOR f /\
(n <= m)) ==>
...
``!P. COND_PROP___EQUIV (COND_PROP___EXISTS x. cond_prop_false) cond_prop_false``,
