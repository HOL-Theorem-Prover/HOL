...
EVAL ``state_array_to_lane_words
  (string_to_state_array (GENLIST (λi. i MOD 5 = 0) 1600))``

[0x1084210842108421, 0x1084210842108421, 0x1084210842108421, 0x1084210842108421, 0x1084210842108421, 0x2108421084210842, 0x2108421084210842, 0x2108421084210842, 0x2108421084210842, 0x2108421084210842, 0x4210842108421084, 0x4210842108421084, 0x4210842108421084, 0x4210842108421084, 0x4210842108421084, 0x8421084210842108, 0x8421084210842108, 0x8421084210842108, 0x8421084210842108, 0x8421084210842108, 0x842108421084210, 0x842108421084210, 0x842108421084210, 0x842108421084210, 0x842108421084210]

val () = wordsLib.add_words_compset true cs
val () = computeLib.add_thms
  [bools_to_word_def, state_array_to_lane_words_def] cs

val rho_test_thm = CBV_CONV cs ``state_array_to_lane_words (
  spt_to_state_array (rho_spt (fromList (GENLIST (λi. i MOD 5 = 0) 1600))))``

val pi_test_thm = CBV_CONV cs ``state_array_to_lane_words (
  spt_to_state_array (pi_spt (fromList (GENLIST (λi. i MOD 5 = 0) 1600))))``

val theta_test_thm = CBV_CONV cs ``state_array_to_lane_words (
  spt_to_state_array (theta_spt (fromList (GENLIST (λi. i MOD 5 = 0) 1600))))``

val chi_test_thm = CBV_CONV cs ``state_array_to_lane_words (
  spt_to_state_array (chi_spt (fromList (GENLIST (λi. i MOD 5 = 0) 1600))))``

val iota_test_thm = CBV_CONV cs ``state_array_to_lane_words (
  spt_to_state_array (iota_spt (fromList (GENLIST (λi. i MOD 5 = 0) 1600)) 7))``
