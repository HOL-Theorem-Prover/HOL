...
Definition ROR4_def:  ROR4(x:word8, n) = x >> n && x << (4 - n)
End
Definition ROL4_def:  ROL4(x:word8, n) = x << n && x >> (4 - n)
End
...
Definition toLarge_def:  toLarge (a3:word8,a2:word8,a1:word8,a0:word8) =
   a3 @@ a2 @@ a1 @@ a0
End

Definition fromLarge_def:  fromLarge (a:word32) =
...
Definition MDSMul_def:  MDSMul(m0,m1,m2,m3) =
...
Definition RSMul_def:  RSMul(m0,m1,m2,m3,m4,m5,m6,m7) =
...
Definition q0_def:  q0 = qq t00 t01 t02 t03
End
Definition q1_def:  q1 = qq t10 t11 t12 t13
End
...
Definition bwd_def:   bwd(b,k,s) = de_rnd 16 b k s
End
