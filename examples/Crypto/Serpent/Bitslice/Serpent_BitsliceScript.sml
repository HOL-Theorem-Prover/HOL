...
open HolKernel Parse boolLib bossLib 
     ...
     word32Theory metisLib pairTheory arithmeticTheory
...
"transform_THM",
`!v. 
	inv_transform (transform v) = v`,

SIMP_TAC std_ss [FORALL_PROD,transform_def,inv_transform_def,
                 LET_THM,word32Theory.ROR_ADD,ror_32_lem,
		 WORD_EOR_ID2,WORD_EOR_REDUCTION]);
...
SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,keying_def] THEN  
RW_TAC std_ss [] THENL [
