open HolKernel Parse boolLib bossLib bitsTheory
     markerTheory metisLib pairTheory arithmeticTheory 
     word32Theory word32Lib metisLib
     Serpent_Bitslice_UtilityTheory ;

val _ = new_theory "Serpent_Bitslice_SBox";

(*RNDxxx is the SBox in xxx round,
invRNDxxx is the invSBox in xxx round*)
...
val WORD_BITWISE_EQ_PROVE_TAC
    =SIMP_TAC std_ss [word32Theory.ONE_COMP_EVAL, word32Theory.AND_EVAL,
                      word32Theory.OR_EVAL, word32Theory.EOR_EVAL] THEN
     SIMP_TAC std_ss [word32Theory.n2w_11,GSYM word32Theory.EQUIV_def] THEN
     RW_TAC bool_ss [word32Theory.EOR_def, word32Theory.AND_def, word32Theory.OR_def,
                     word32Theory.ONE_COMP_BITWISE_THM, GSYM word32Theory.BITWISE_THM2,
		     BITWISE_THM] THEN
     tautLib.TAUT_TAC;
			  
		
val RND00_THM=Q.store_thm(
"RND00_THM",
`!v. 
	InvRND00 (RND00 v) = v`,

SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,RND00_def,
                 InvRND00_def,LET_THM] THEN
RW_TAC std_ss [] THENL [ 
...
val RND01_THM=Q.store_thm(
"RND01_THM",
`!v. 
	InvRND01 (RND01 v) = v`,

SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,RND01_def,
                 InvRND01_def,LET_THM] THEN
RW_TAC std_ss [] THENL [ 
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
...
val RND02_THM=Q.store_thm(
"RND02_THM",
`!v. 
	InvRND02 (RND02 v) = v`,

SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,RND02_def,
                 InvRND02_def,LET_THM] THEN
RW_TAC std_ss [] THENL [ 
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
...
val RND03_THM=Q.store_thm(
"RND03_THM",
`!v. 
	InvRND03 (RND03 v) = v`,

SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,RND03_def,
                 InvRND03_def,LET_THM] THEN
RW_TAC std_ss [] THENL [ 
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
...
val RND04_THM=Q.store_thm(
"RND04_THM",
`!v. 
	InvRND04 (RND04 v) = v`,

SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,RND04_def,
                 InvRND04_def,LET_THM] THEN
RW_TAC std_ss [] THENL [ 
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
...
val RND05_THM=Q.store_thm(
"RND05_THM",
`!v. 
	InvRND05 (RND05 v) = v`,

SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,RND05_def,
                 InvRND05_def,LET_THM] THEN
RW_TAC std_ss [] THENL [ 
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
...
val RND06_THM=Q.store_thm(
"RND06_THM",
`!v. 
	InvRND06 (RND06 v) = v`,

SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,RND06_def,
                 InvRND06_def,LET_THM] THEN
RW_TAC std_ss [] THENL [ 
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
...
val RND07_THM=Q.store_thm(
"RND07_THM",
`!v. 
	InvRND07 (RND07 v) = v`,

SIMP_TAC std_ss [FORALL_PROD,word32Theory.FORALL_WORD,RND07_def,
                 InvRND07_def,LET_THM] THEN
RW_TAC std_ss [] THENL [ 
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
	WORD_BITWISE_EQ_PROVE_TAC,
...
val RND27_THM=Q.store_thm (
"RND27_THM",
`!v. 
	InvRND27 (RND27 v)= v`,
METIS_TAC [RND27_def,InvRND27_def,RND03_THM]);	
   		  
val RND28_THM=Q.store_thm (
"RND28_THM",
`!v. 
	InvRND28 (RND28 v)= v`,
