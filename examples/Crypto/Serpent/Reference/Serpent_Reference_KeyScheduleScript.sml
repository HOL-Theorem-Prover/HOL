open HolKernel Parse boolLib bossLib listTheory rich_listTheory bitsTheory
     ...
     word4Theory word32Theory word256Theory word4Lib word32Lib word256Lib 
...
val PHI_def=Define `PHI=(n2w:num->word32) 0x9e3779b9`;
...
(*the only property of key shecduling 
which matters for the functional correctness of Serpent
is the length of the generated key*)	    
