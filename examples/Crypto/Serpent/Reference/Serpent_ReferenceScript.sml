...
open HolKernel Parse boolLib bossLib 
 listTheory arithmeticTheory metisLib
     word128Theory word128Lib
...
Induct_on `r` THENL [
	...
	Cases_on `r` THEN Cases_on `revKeyHat` THENL [
		...
		RW_TAC list_ss [enRound_def,deRound_def,invSBlock_sBlock_cancel,
		                invLT_LT_cancel,GSYM word128Theory.WORD_EOR_ASSOC,
				word128Theory.WORD_EOR_INV,word128Theory.WORD_EOR_ID,
				LET_THM,R_def] THEN
		Cases_on `t'` THENL [
			FULL_SIMP_TAC list_ss [],
			RW_TAC list_ss [enRound_def,deRound_def,
			                invSBlock_sBlock_cancel,
			                invLT_LT_cancel,
					GSYM word128Theory.WORD_EOR_ASSOC,
					word128Theory.WORD_EOR_INV,
					word128Theory.WORD_EOR_ID,LET_THM,R_def]],
		FULL_SIMP_TAC list_ss [], 
		`SUC (31 - SUC (SUC n))=31-SUC n` by RW_TAC arith_ss [] THEN
		FULL_SIMP_TAC list_ss [enRound_def,deRound_def,
		                       invSBlock_sBlock_cancel,
		                       invLT_LT_cancel,
				       GSYM word128Theory.WORD_EOR_ASSOC,
				       word128Theory.WORD_EOR_INV,
...
RW_TAC list_ss [doAllDeRound_def,doAllEnRound_def,deRound0_def,
                enRound31_def,LET_THM,GSYM word128Theory.WORD_EOR_ASSOC,
		word128Theory.WORD_EOR_INV,word128Theory.WORD_EOR_ID,
		invSBlock_sBlock_cancel] THEN
`LENGTH [v_30; v_29; v_28; v_27; v_26; v_25; v_24; v_23; v_22; v_21; v_20; v_19; 
         v_18; v_17; v_16; v_15; v_14; v_13; v_12; v_11; v_10; v_9; v_8; v_7; v_6;
	 v_5; v_4; v_3; v_2; v_1; v_0]
 =30+1` 
...
RW_TAC list_ss [doAllDeRound_def,deRound_def,doAllEnRound_def,
                enRound_def,enRound31_def,deRound0_def,invFP_FP_cancel,
		invIP_IP_cancel,invSBlock_sBlock_cancel,invLT_LT_cancel,
		GSYM word128Theory.WORD_EOR_ASSOC,word128Theory.WORD_EOR_INV,
		word128Theory.WORD_EOR_ID,LET_THM,R_def]);
