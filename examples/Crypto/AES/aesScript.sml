...
val (RoundTuple_def,_) = Defn.tprove
 (Hol_defn 
   "RoundTuple"
...
val (InvRoundTuple_def,_) = Defn.tprove
 (Hol_defn 
   "InvRoundTuple"
...
val Round_def = Define `Round n k s = Round(n,k,s)`;
val InvRound_def = Define `InvRound n k s = InvRound(n,k,s)`;
