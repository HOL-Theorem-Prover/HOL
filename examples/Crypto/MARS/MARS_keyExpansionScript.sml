...
Definition l8b_def:   l8b x = x && 0xffw : word32
End
Definition l9b_def:   l9b x = x && 0x1ffw : word32
End
...
Definition Init_T_def:   Init_T(key_list) =
