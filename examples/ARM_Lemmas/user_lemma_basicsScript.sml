...
val reflex_priv_mode_constraints_v2a_thm = store_thm("reflex_priv_mode_constraints_v2_thm",
...
(*
e(RW_TAC (srw_ss()) [strict_unt_def, priv_mode_constraints_v2a_def, priv_mode_constraints_v1_def, ARM_MODE_def, ARM_READ_CPSR_def, LET_DEF] THEN FULL_SIMP_TAC (srw_ss()) [vector_table_address_def, get_base_vector_table_def, get_pc_value_def, LET_DEF]);
*)
