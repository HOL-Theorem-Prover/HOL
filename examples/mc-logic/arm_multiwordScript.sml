...
val arm_amm_imp = save_thm("arm_amm_imp",let
  ...
  val th0 = (*  ldr  z,[iz],#4   *) FST_PROG2 (SIMP_RULE (bool_ss++armINST_ss) [EVAL ``(w2w (4w :word12) :word32)``] (Q.INST [`c_flag`|->`AL`,`opt`|->`<|Pre := F; Up := T; Wb := T|>`,`a`|->`z`,`b`|->`iz`,`imm`|->`4w`,`x`|->`x1`,`y`|->`y1`,`z`|->`z1` ] arm_LDR_NONALIGNED))
  val th1 = (FST_PROG2 (SIMP_RULE (bool_ss++armINST_ss) [EVAL ``(w2w (4w :word12) :word32)``] (Q.INST [`c_flag`|->`AL`,`opt`|->`<|Pre := F; Up := T; Wb := T|>`,`a`|->`x`,`b`|->`ix`,`imm`|->`4w`,`x`|->`x2`,`y`|->`y2`,`z`|->`z2` ] arm_LDR_NONALIGNED)))
  val th2 = (FST_PROG2 (SIMP_RULE (bool_ss++armINST_ss) [EVAL ``(w2w (4w :word12) :word32)``] (Q.INST [`c_flag`|->`AL`,`opt`|->`<|Pre := F; Up := T; Wb := T|>`,`a`|->`y`,`b`|->`iy`,`imm`|->`4w`,`x`|->`x3`,`y`|->`y3`,`z`|->`z3` ] arm_LDR_NONALIGNED)))
  val th3 = (FST_PROG2 (SIMP_RULE (bool_ss++armINST_ss) [] (Q.INST [`c_flag`|->`AL`,`s_flag`|->`F`,`c'`|->`v`,`c`|->`z`,`a`|->`x`,`b`|->`p`,`x`|->`x4`,`y`|->`y4`,`z`|->`z4`,`z'`|->`z'4` ] arm_UMLAL4)))
  val th4 = (FST_PROG2 (SIMP_RULE (bool_ss++armINST_ss) [EVAL ``(w2w (0w :word8) :word32)``] (Q.INST [`c_flag`|->`AL`,`s_flag`|->`F`,`a`|->`x`,`a_mode`|->`Imm 0w`,`x`|->`x5` ] arm_MOV1)))
  val th = (*  ldr  x,[ix],#4   *) MOVE_COMPOSE th0 th1 `x1*x2*x3*x4` `(x4)*(x1*x2*x3)` `x1*x2*x3*x4` `(x4)*(x1*x2*x3)`
  val th = (*  ldr  y,[iy],#4   *) MOVE_COMPOSE th th2 `x1*x2*x3*x4*x5*x6*x7` `(x4)*(x1*x2*x3*x5*x6*x7)` `x1*x2*x3*x4` `(x4)*(x1*x2*x3)`
  val th = (*  umlal v,z,x,p    *) MOVE_COMPOSE th th3 `x1*x2*x3*x4*x5*x6*x7*x8*x9*x10` `(x4*x5*x8)*(x1*x2*x3*x6*x7*x9*x10)` `x1*x2*x3*x4*x5` `(x5*x1*x3)*(x2*x4)`
  val th = (*  mov  x,#0        *) MOVE_COMPOSE th th4 `x1*x2*x3*x4*x5*x6*x7*x8*x9*x10*x11*x12` `(x1*x5)*(x2*x3*x4*x6*x7*x8*x9*x10*x11*x12)` `x1*x2` `(x1*x2)*(emp)`
