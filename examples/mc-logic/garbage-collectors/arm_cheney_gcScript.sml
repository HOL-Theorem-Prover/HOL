...
val (th,def4) = decompile_arm "arm_cheney_loop" `
  E1530004 (* CHENEY:cmp r3,r4 *)
  0A00001D (* beq EXIT *)
  insert: arm_cheney_step
  EAFFFFDF (* b CHENEY *)`;

val (th,def5) = decompile_arm "arm_move_roots" `
...
val ref_cheney_move_roots = prove(
  ...
  \\ Q.PAT_ASSUM `!j m xs r12. bbb`
    (STRIP_ASSUME_TAC o UNDISCH_ALL o RW [GSYM AND_IMP_INTRO] o
     Q.SPECL [`j1`,`m1`,`ref_addr a y1`,`r71`,`r81`,`(r12 =+ ref_addr a y1) xs1`,`r12+4w`,`ys'`,`j2`,`m2`])
