...
val finish_rws2 =
  [TO_WRITE_READ6,READ_TO_READ6,REG_WRITE_WRITE,REGISTER_RANGES,REG_WRITE_READ,
   REG_READ_WRITE,REG_WRITE_COMMUTE_PC,CONJUNCT1 exception_BIJ,CPSR_WRITE_READ,
   SIMP_interrupt2exception,SIMP_interrupt2exception2,
   SIMP_interrupt2exception3,
