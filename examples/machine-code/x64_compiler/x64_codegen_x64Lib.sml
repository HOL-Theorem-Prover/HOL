structure x64_codegen_x64Lib :> x64_codegen_x64Lib =
struct

open HolKernel boolLib bossLib Parse;
open helperLib x64_codegen_inputLib;
open x64_encodeLib;
...
val x64_assign2assembly = let
  ...
  fun mov_name ACCESS_WORD = "mov QWORD"
    | mov_name ACCESS_BYTE = "mov BYTE"
  fun mem_rhs ACCESS_WORD (ASSIGN_X_REG t) = r t
    | mem_rhs ACCESS_BYTE (ASSIGN_X_REG t) = r t ^ "b"
