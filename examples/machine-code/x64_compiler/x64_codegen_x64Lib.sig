signature x64_codegen_x64Lib =
sig

  include Abbrev

  val x64_assign2assembly      : x64_codegen_inputLib.assign_type -> string list
  val x64_guard2assembly       : x64_codegen_inputLib.guard_type -> string list * (string * string)
