...
Datatype: heap_address = H_ADDR of num | H_DATA of 'a
End
...
val move_thm = store_thm("move_thm",
  ...
  THEN1
   (Q.LIST_EXISTS_TAC [`h`,`f`] \\ ASM_SIMP_TAC std_ss []
    \\ Q.PAT_X_ASSUM `move xx = fg` MP_TAC \\ ASM_SIMP_TAC (srw_ss()) [move_def]
  ...
  \\ Q.PAT_X_ASSUM `ref_mem (h,f) m` (fn th => FULL_SIMP_TAC std_ss [RW[ref_mem_def]th])
