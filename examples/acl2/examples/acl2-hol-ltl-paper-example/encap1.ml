...
mknum "1" "1" "0" "1")) (mkpair (mkpair (mksym "ACL2" "H2") (mknum "2" "1" 
"0" "1")) (mksym "COMMON-LISP" "NIL"))) (mkpair (mkpair (mksym "ACL2" 
"DEFTHM") (mkpair (mksym "ACL2" "H1-PROP") (mkpair (mkpair (mksym "ACL2" 
"IMPLIES") (mkpair (mkpair (mksym "COMMON-LISP" "INTEGERP") (mkpair (mksym 
"ACL2" "X") (mksym "COMMON-LISP" "NIL"))) (mkpair (mkpair (mksym 
"COMMON-LISP" "INTEGERP") (mkpair (mkpair (mksym "ACL2" "H1") (mkpair (mksym 
"ACL2" "X") (mksym "COMMON-LISP" "NIL"))) (mksym "COMMON-LISP" "NIL"))) (
...
mknum "1" "1" "0" "1")) (mkpair (mkpair (mksym "ACL2" "H4") (mknum "2" "1" 
"0" "1")) (mksym "COMMON-LISP" "NIL"))) (mkpair (mkpair (mksym "ACL2" 
"DEFTHM") (mkpair (mksym "ACL2" "H3-PROP") (mkpair (mkpair (mksym "ACL2" 
"IMPLIES") (mkpair (mkpair (mksym "COMMON-LISP" "INTEGERP") (mkpair (mksym 
"ACL2" "X") (mksym "COMMON-LISP" "NIL"))) (mkpair (mkpair (mksym 
"COMMON-LISP" "INTEGERP") (mkpair (mkpair (mksym "ACL2" "H3") (mkpair (mksym 
"ACL2" "X") (mksym "COMMON-LISP" "NIL"))) (mksym "COMMON-LISP" "NIL"))) (
mksym "COMMON-LISP" "NIL")))) (mksym "COMMON-LISP" "NIL")))) (mkpair (mkpair (
mksym "COMMON-LISP" "DEFUN") (mkpair (mksym "ACL2" "H5") (mkpair (mkpair (
mksym "ACL2" "X") (mksym "COMMON-LISP" "NIL")) (mkpair (mkpair (mksym "ACL2" 
"H3") (mkpair (mksym "ACL2" "X") (mksym "COMMON-LISP" "NIL"))) (mksym 
"COMMON-LISP" "NIL"))))) (mkpair (mkpair (mksym "ACL2" "DEFTHM") (mkpair (
mksym "ACL2" "H4-H5-PROP") (mkpair (mkpair (mksym "ACL2" "IMPLIES") (mkpair (
mkpair (mksym "COMMON-LISP" "INTEGERP") (mkpair (mksym "ACL2" "Y") (mksym 
