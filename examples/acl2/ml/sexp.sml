...
name is as follows.(see definition of create_hol_name below).
 ...
 5. Record any names generated by step 1-3 above in acl2_names.
...
fun create_hol_name acl2_name =
 if acl2_name = acl2_name_to_hol_name acl2_name
  ...
  let val (pkg_name,sym_name) = split_acl2_name acl2_name
      ...
      val res = assoc1 hol_sym_name (!acl2_names)
  in
   case res
   of SOME(_,acl2_name')
      => if acl2_name = acl2_name'
          then hol_sym_name
           ...
           let val hol_pkg_name = acl2_name_to_hol_name pkg_name
               val long_hol_name = (hol_pkg_name ^ "_" ^ hol_sym_name)
               val res' = assoc1 long_hol_name (!acl2_names)
           in
            case res'
            of SOME(_,acl2_name'')
               => if acl2_name = acl2_name''
