...
open bossLib pairTheory pred_setTheory pred_setLib stringLib
     ...
     DerivedBddRules Binarymap PairRules pairTools setLemmasTheory muSyntax
     muSyntaxTheory muTheory boolSyntax Drule Tactical Conv Rewrite Tactic
     boolTheory listSyntax stringTheory stringBinTree boolSimps pureSimps
     listSimps numLib reachTheory bddTools envTheory lazyTools
