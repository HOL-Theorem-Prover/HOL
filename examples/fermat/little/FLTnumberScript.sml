...
*)
val row_prime_not_in_residue_image = store_thm(
  "row_prime_not_in_residue_image",
  ``!p a n. prime p /\ a IN (residue p) /\ n <= p ==>
            (row p a)(n) NOTIN IMAGE (row p a) (residue n)``,
  rw[row_def] >>
...
(* Proof:
   ...
   (2) 0 < x /\ x < p /\ 0 < y /\ y < p /\ (a * x) MOD p = (a * y) MOD p ==> x = y
       ...
       Thus x = y
*)
val residue_prime_row_inj = store_thm(
  "residue_prime_row_inj",
...
*)
val residue_prime_row_surj = store_thm(
  "residue_prime_row_surj",
...
*)
val residue_prime_row_bij = store_thm(
  "residue_prime_row_bij",
...
*)
val residue_prime_row_image = store_thm(
  "residue_prime_row_image",
