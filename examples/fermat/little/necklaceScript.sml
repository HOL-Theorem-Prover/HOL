...
val necklace_element = store_thm(
  "necklace_element",
...
val show_necklace_def = Define`
    (show_necklace 0 a = {[]}) /\ (* by necklace_0 *)
    (show_necklace (SUC n) a =
       IMAGE (\(c,ls). c::ls) (count a CROSS show_necklace n a)) (* by necklace_suc *)
`;
...
*)
val show_necklace_eqn = store_thm(
  "show_necklace_eqn[compute]",
...
val monocoloured_element = store_thm(
  "monocoloured_element",
  ``!n a ls. ls IN monocoloured n a <=>
            (ls IN necklace n a /\ (ls <> [] ==> SING (set ls)))``,
...
val monocoloured_subset = store_thm(
  "monocoloured_subset",
...
*)
val monocoloured_finite = store_thm(
  "monocoloured_finite",
...
*)
val monocoloured_empty = store_thm(
  "monocoloured_empty",
...
*)
val monocoloured_mono = store_thm(
  "monocoloured_mono",
...
*)
val monocoloured_suc = store_thm(
  "monocoloured_suc",
  ``!n a. 0 < n ==> (monocoloured (SUC n) a = IMAGE (\ls. HD ls :: ls) (monocoloured n a))``,
...
*)
val monocoloured_0_card = store_thm(
  "monocoloured_0_card",
...
*)
val monocoloured_card = store_thm(
  "monocoloured_card",
...
*)
val monocoloured_eqn = store_thm(
  "monocoloured_eqn[compute]",
...
(* Proof:
   ...
   If n <> 0, then 0 < n.
      ...
      = a                          by CARD_COUNT
*)
val monocoloured_card_eqn = store_thm(
  "monocoloured_card_eqn",
...
(* Proof:
   ...
   <=> ls IN (necklace n a) /\ ls <> [] /\ ~SING (set ls)    by logical equivalence
     ...
     = t /\ (p /\ ~q)
*)
val multicoloured_element = store_thm(
  "multicoloured_element",
...
*)
val multicoloured_subset = store_thm(
  "multicoloured_subset",
...
*)
val multicoloured_finite = store_thm(
  "multicoloured_finite",
...
(* Proof:
   ...
   If n <> 0, then 0 < n.
     ...
     = {}                                      by EMPTY_DIFF
*)
val multicoloured_n_0 = store_thm(
  "multicoloured_n_0",
  ``!n. multicoloured n 0 = {}``,
  rpt strip_tac >>
  Cases_on `n = 0` >-
...
(* Proof:
   ...
   = {}                                      by DIFF_EQ_EMPTY
*)
val multicoloured_n_1 = store_thm(
  "multicoloured_n_1",
  ``!n. multicoloured n 1 = {}``,
...
*)
val multicoloured_card = store_thm(
  "multicoloured_card",
...
*)
val multicoloured_card_eqn = store_thm(
  "multicoloured_card_eqn",
...
*)
val multicoloured_not_monocoloured_iff = store_thm(
  "multicoloured_not_monocoloured_iff",
  ``!n a ls. ls IN necklace n a ==>
            (ls IN multicoloured n a <=> ~(ls IN monocoloured n a))``,
  simp[multicoloured_def]);
...
(* Theorem: ls IN necklace n a ==>
            (ls IN multicoloured n a \/ ls IN monocoloured n a) *)
(* Proof: by multicoloured_def. *)
val multicoloured_or_monocoloured = store_thm(
  "multicoloured_or_monocoloured",
  ``!n a ls. ls IN necklace n a ==>
            (ls IN multicoloured n a \/ ls IN monocoloured n a)``,
  simp[multicoloured_def]);
