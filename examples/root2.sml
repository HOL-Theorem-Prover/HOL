...
app load ["transcTheory"];   open arithmeticTheory BasicProvers;
...
val EXP_2 = Q.prove
(`!n:num. n**2 = n*n`,
 RW_TAC arith_ss [CONV_RULE numLib.SUC_TO_NUMERAL_DEFN_CONV EXP,
                  MULT_CLAUSES]);

val EXP2_LEM = Q.prove
(`!x y:num. ((2*x)**2 = 2*(y**2)) = (2*(x**2) = y**2)`,
 RW_TAC arith_ss [EXP_2,GSYM MULT_ASSOC, EQ_MULT_LCANCEL]
 THEN PROVE_TAC [MULT_ASSOC,MULT_COMM]);
