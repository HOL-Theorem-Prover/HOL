...
Theorem algn_subtyping_swap1_eqn:
...
Theorem wfctxt_APPEND_DISJOINT:
...
(* lemma 28.4.1.1 *)
Theorem algn_subtyping_permutation:
    !n G t1 t2. algn_subtyping n G t1 t2 ==>
                !D. PERM D G /\ wfctxt D ==>
...
(* lemma 28.4.1.2 *)
Theorem algn_subtyping_weakening:
    !n G t1 t2. algn_subtyping n G t1 t2 ==>
...
Theorem algn_subtyping_Top_left:
...
Theorem algn_subtyping_foralltyleft_inversion:
