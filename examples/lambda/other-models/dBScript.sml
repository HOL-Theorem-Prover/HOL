...
Theorem dDEG_dOK:  !t. dOK t = (dDEG t = 0)
Proof
...
Theorem EQ_dVAR_dSUB:
  !u x. [x |-> u] (dVAR x) = u
Proof
RW_TAC arith_ss [dSUB, Inst, Abst]
QED

Theorem NEQ_dVAR_dSUB:
...
Theorem dLGH_NOT_ZERO:
 !t. ~(dLGH t = 0)
Proof
Induct THEN RW_TAC arith_ss [dLGH]
QED

Theorem dLGH_dAPP_LESS_1:
