...
Theorem PRIME_EXPONENT_EXISTS0:
...
Theorem PRIME_EXPONENT_DIVIDES:
     !n p k.
...
Theorem PRIME_EXPONENT_PRIME_MULT:
     !a p q.
       0 < a /\ prime p /\ prime q ==>
       (exponent p (q * a) =
...
Theorem PRIME_EXPONENT_1_UNIQUE:
...
Theorem FACTOR_PRIME_POWER_SANDWICH:
     !p n r s.
