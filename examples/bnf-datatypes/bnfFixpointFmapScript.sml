...
(* ----------------------------------------------------------------------
    ...
    nested under a finite map's range and under a list, inside a pair —
    and everything after this point is character-for-character the same
    text, which is the point of the exercise.
   ---------------------------------------------------------------------- *)

val Fty = “:(num |-> 'a) + num # ('b1 # 'a) list”
