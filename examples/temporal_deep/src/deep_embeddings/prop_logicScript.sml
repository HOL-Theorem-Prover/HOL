  ...
  REPEAT STRIP_TAC THEN EQ_TAC THEN REPEAT STRIP_TAC THENL [
    Cases_on `h IN s` THEN ASM_REWRITE_TAC [] THENL [
      Cases_on `MEM h l` THENL [
        ...
        REPEAT STRIP_TAC THEN (
          SIMP_ALL_TAC std_ss [IN_POWER_SET_SUBSET_EQUIV, SUBSET_DEF, IN_INSERT, IN_DELETE, IN_LIST_TO_SET, EXTENSION, IN_INTER] THEN
          METIS_TAC[]
        )
      ],
    ...
    SIMP_ALL_TAC std_ss [IN_POWER_SET_SUBSET_EQUIV, SUBSET_DEF, IN_INSERT, IN_DELETE, IN_LIST_TO_SET, EXTENSION, IN_INTER,
    UNION_SING] THEN
    METIS_TAC[],
