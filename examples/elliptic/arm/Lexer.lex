...
rule Token = parse
  ...
  | M U L cond              { MULT3 (cond3 lexbuf, false) }
  | M U L cond S            { MULT3 (cond3 lexbuf, true) }
  | M L A cond              { MULT4 (cond3 lexbuf, false, false, true, false) }
  | M L A cond S            { MULT4 (cond3 lexbuf, false, false, true, true) }
  | U M U L L cond          { MULT4 (cond3 lexbuf, true, false, false, false) }
  | U M U L L cond S        { MULT4 (cond3 lexbuf, true, false, false, true) }
  | U M L A L cond          { MULT4 (cond3 lexbuf, true, false, true, false) }
  | U M L A L cond S        { MULT4 (cond3 lexbuf, true, false, true, true) }
  | S M U L L cond          { MULT4 (cond3 lexbuf, true, true, false, false) }
  | S M U L L cond S        { MULT4 (cond3 lexbuf, true, true, false, true) }
  | S M L A L cond          { MULT4 (cond3 lexbuf, true, true, true, false) }
  | S M L A L cond S        { MULT4 (cond3 lexbuf, true, true, true, true) }
