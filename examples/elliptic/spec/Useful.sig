...
val set_benchmark_seconds : int -> unit

val check_benchmark_time : unit -> unit

(* ------------------------------------------------------------------------- *)
(* Tracing                                                                   *)
(* ------------------------------------------------------------------------- *)

val trace_print : (string -> unit) ref
...
val delete_nth : int -> 'a list -> 'a list  (* Subscript *)
...
val lex_option_order : 'a ordering -> 'a option ordering  (* NONE last *)

(* ------------------------------------------------------------------------- *)
(* Sorting and searching                                                     *)
(* ------------------------------------------------------------------------- *)

val minimum : 'a ordering -> 'a list -> 'a * 'a list

val maximum : 'a ordering -> 'a list -> 'a * 'a list
...
val pluralize : {singular : string, plural : string} -> int -> string
...
val toString : 'a pp -> 'a -> string  (* Uses LINE_LENGTH *)

val varToString : 'a pp -> string -> 'a -> string  (* for tracing *)
