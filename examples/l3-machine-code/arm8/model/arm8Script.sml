(* arm8Script.sml - generated by L<3> - Tue Aug 12 12:23:52 2014 *)
...
val _ = Construct
  [("MBReqTypes",
    [("MBReqTypes_Reads",[]),("MBReqTypes_Writes",[]),
     ("MBReqTypes_All",[])])]
;
val _ = Construct
  [("AccType",
...
val _ = Construct
  [("instruction",
    [("Address",[PTy(bTy,PTy(F64,FTy 5))]),("Branch",[CTy"Branch"]),
     ...
     ("MemoryBarrier",
      [PTy(CTy"MemBarrierOp",PTy(CTy"MBReqDomain",CTy"MBReqTypes"))]),
     ("Reserved",[]),("System",[CTy"System"]),("Unallocated",[])])]
;
val _ = Construct
  [("exception",
...
val dfn'MemoryBarrier_def = Def
  ("dfn'MemoryBarrier",
   TP[Var("op",CTy"MemBarrierOp"),Var("domain",CTy"MBReqDomain"),
      Var("types",CTy"MBReqTypes")],
   Close
     (qVar"state",
      Apply
        (Call
         ...
         [(Const("Reserved",CTy"instruction"),
          ...
          (Call
             ("Address",CTy"instruction",
              Var("v79",PTy(bTy,PTy(F64,FTy 5)))),
           Apply
             (Call
                ("dfn'Address",ATy(qTy,PTy(uTy,qTy)),
                 Var("v79",PTy(bTy,PTy(F64,FTy 5)))),qVar"state")),
          (Call("ClearExclusive",CTy"instruction",Var("v80",F4)),
           Apply
             (Call
                ("dfn'ClearExclusive",ATy(qTy,PTy(uTy,qTy)),Var("v80",F4)),
              qVar"state")),
          (Call("Hint",CTy"instruction",Var("v81",CTy"SystemHintOp")),
           Apply
             (Call
                ("dfn'Hint",ATy(qTy,PTy(uTy,qTy)),
                 Var("v81",CTy"SystemHintOp")),qVar"state")),
          (Call
             ("MemoryBarrier",CTy"instruction",
              Var("v82",
                  PTy(CTy"MemBarrierOp",
                      PTy(CTy"MBReqDomain",CTy"MBReqTypes")))),
           Apply
             (Call
              ...
              [(Call
               ...
               (Call
                  ("CountLeading@32",CTy"Data",
                   Var("v29",PTy(F32,PTy(bTy,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
               ...
               (Call
                  ("CountLeading@64",CTy"Data",
                   Var("v30",PTy(F64,PTy(bTy,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
                     ("dfn'CountLeading",ATy(qTy,PTy(uTy,qTy)),
                      Var("v30",PTy(F64,PTy(bTy,PTy(FTy 5,FTy 5))))),
               ...
               (Call
                  ("Division@32",CTy"Data",
                   Var("v31",PTy(F32,PTy(bTy,PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                Apply
                  (Call
               ...
               (Call
                  ("Division@64",CTy"Data",
                   Var("v32",PTy(F64,PTy(bTy,PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                Apply
                  (Call
                     ("dfn'Division",ATy(qTy,PTy(uTy,qTy)),
                      Var("v32",
               ...
               (Call
                  ("MultiplyHigh",CTy"Data",
                   Var("v44",PTy(bTy,PTy(FTy 5,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
               ...
               (Call
                  ("Reverse@32",CTy"Data",
                   Var("v45",PTy(F32,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
               ...
               (Call
                  ("Reverse@64",CTy"Data",
                   Var("v46",PTy(F64,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
                     ("dfn'Reverse",ATy(qTy,PTy(uTy,qTy)),
                      Var("v46",PTy(F64,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                      ...
                      Var("v48",
                          PTy(F64,
                              PTy(CTy"ShiftType",
                                  PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                   qVar"state"))])),
          (Call("Debug",CTy"instruction",Var("v49",CTy"Debug")),
           CS(Var("v49",CTy"Debug"),
              [(Const("DebugRestore",CTy"Debug"),
                Apply
                  (Const("dfn'DebugRestore",ATy(qTy,PTy(uTy,qTy))),
                   qVar"state")),
               (Call("Breakpoint",CTy"Debug",Var("v50",F16)),
                Apply
                  (Call
                     ("dfn'Breakpoint",ATy(qTy,PTy(uTy,qTy)),
                      Var("v50",F16)),qVar"state")),
               (Call("DebugSwitch",CTy"Debug",Var("v51",FTy 2)),
                Apply
                  (Call
                     ("dfn'DebugSwitch",ATy(qTy,PTy(uTy,qTy)),
                      Var("v51",FTy 2)),qVar"state")),
               (Call("Halt",CTy"Debug",Var("v52",F16)),
                Apply
                  (Call("dfn'Halt",ATy(qTy,PTy(uTy,qTy)),Var("v52",F16)),
                   qVar"state"))])),
          (Call("LoadStore",CTy"instruction",Var("v53",CTy"LoadStore")),
           CS(Var("v53",CTy"LoadStore"),
              [(Call
                                      ...
                                      PTy(bTy,
                                          PTy(FTy 5,
                                              PTy(CTy"ExtendType",
                                                  PTy(nTy,PTy(FTy 5,FTy 5)))))))))),
                   qVar"state"))])),
          (Call("System",CTy"instruction",Var("v72",CTy"System")),
           CS(Var("v72",CTy"System"),
              [(Const("ExceptionReturn",CTy"System"),
                Apply
                  (Const("dfn'ExceptionReturn",ATy(qTy,PTy(uTy,qTy))),
                   qVar"state")),
               (Call("HypervisorCall",CTy"System",Var("v73",F16)),
                Apply
                  (Call
                     ("dfn'HypervisorCall",ATy(qTy,PTy(uTy,qTy)),
                      Var("v73",F16)),qVar"state")),
               (Call
                  ("MoveImmediateProcState",CTy"System",
                   Var("v74",PTy(CTy"PSTATEField",F4))),
                Apply
                  (Call
                     ("dfn'MoveImmediateProcState",ATy(qTy,PTy(uTy,qTy)),
                      Var("v74",PTy(CTy"PSTATEField",F4))),qVar"state")),
               (Call
                ...
                Apply
                  (Call
                   ...
                   qVar"state")),
               (Call("SecureMonitorCall",CTy"System",Var("v76",F16)),
                Apply
                  (Call
                     ("dfn'SecureMonitorCall",ATy(qTy,PTy(uTy,qTy)),
                      Var("v76",F16)),qVar"state")),
               (Call("SupervisorCall",CTy"System",Var("v77",F16)),
                Apply
                  (Call
                     ("dfn'SupervisorCall",ATy(qTy,PTy(uTy,qTy)),
                      Var("v77",F16)),qVar"state")),
               (Call
...
val LoadStoreImmediate_def = Def
  ("LoadStoreImmediate",
   TP[Var("size",FTy 2),Var("opc",FTy 2),Var("acctype",CTy"AccType"),
      bVar"wback",bVar"postindex",Var("offset",F64),Var("Rn",FTy 5),
      Var("Rt",FTy 5)],
       ...
       ITB([(Bop(And,bVar"b'28",
             ...
             Call
               ("LoadStoreImmediate",CTy"instruction",
                TP[Mop(Cast(FTy 2),LL[bVar"b'31",bVar"b'30"]),
                   ...
                   EQ(Mop(Cast F1,LL[bVar"b'11"]),LW(0,1)),
                   Mop(SE F64,
                       Mop(Cast(FTy 9),
                           LL[bVar"b'20",bVar"b'19",bVar"b'18",bVar"b'17",
                              bVar"b'16",bVar"b'15",bVar"b'14",bVar"b'13",
               ...
               ("LoadStoreImmediate",CTy"instruction",
                TP[Mop(Cast(FTy 2),LL[bVar"b'31",bVar"b'30"]),
                   ...
                   ITE(EQ(Mop(Cast F1,LL[bVar"b'11"]),LW(1,1)),
                       ...
                       LC("AccType_NORMAL",CTy"AccType")),LF,LF,
                   Mop(SE F64,
                       Mop(Cast(FTy 9),
                           LL[bVar"b'20",bVar"b'19",bVar"b'18",bVar"b'17",
                              bVar"b'16",bVar"b'15",bVar"b'14",bVar"b'13",
                             ...
                             Bop(And,Mop(Not,bVar"b'25"),
                                 Bop(And,Mop(Not,bVar"b'24"),
                                     Bop(And,bVar"b'21",
                                         Bop(And,bVar"b'11",
                                             Mop(Not,bVar"b'10"))))))))),
             Let(Var("option",FTy 3),
                 Mop(Cast(FTy 3),LL[bVar"b'15",bVar"b'14",bVar"b'13"]),
                 Let(Var("opc",FTy 2),
                     Mop(Cast(FTy 2),LL[bVar"b'23",bVar"b'22"]),
                     Let(Var("size",FTy 2),
                         Mop(Cast(FTy 2),LL[bVar"b'31",bVar"b'30"]),
                         ITE(Mop(Not,Bop(Bit,Var("option",FTy 3),LN 1)),
                             Const("Unallocated",CTy"instruction"),
                             Let(TP[Var("memop",CTy"MemOp"),
                                    bVar"regsize_word",bVar"signed"],
                                 ITB([(Mop(Not,
                                           Bop(Bit,Var("opc",FTy 2),LN 1)),
                                       TP[ITE(Bop(Bit,Var("opc",FTy 2),
                                                  LN 0),
                                              LC("MemOp_LOAD",CTy"MemOp"),
                                              LC("MemOp_STORE",CTy"MemOp")),
                                          Mop(Not,
                                          ...
                                          LF]),
                                      (EQ(Var("size",FTy 2),LW(3,2)),
                                       TP[LC("MemOp_PREFETCH",CTy"MemOp"),
                                          LX bTy,LX bTy])],
                                    ...
                                    TP[Var("size",FTy 2),
                                       ...
                                       Call
                                         ("DecodeRegExtend",
                                          CTy"ExtendType",
                                          Var("option",FTy 3)),
                                       ITE(EQ(Mop(Cast F1,LL[bVar"b'12"]),
                                              LW(1,1)),
                                           Mop(Cast nTy,Var("size",FTy 2)),
                                           LN 0),
                                       Mop(Cast(FTy 5),
            ...
            (Bop(And,bVar"b'31",
             ...
             Let(Var("CRm",F4),
                 ...
                 Let(Var("domain",CTy"MBReqDomain"),
                     Mop(Cast(CTy"MBReqDomain"),
                         EX(Var("CRm",F4),LN 3,LN 2,FTy 2)),
                     Let(TP[Var("domain",CTy"MBReqDomain"),
                            Var("types",CTy"MBReqTypes")],
                         CS(EX(Var("CRm",F4),LN 1,LN 0,FTy 2),
                            [(LW(0,2),
                              TP[LC("MBReqDomain_FullSystem",
                                    CTy"MBReqDomain"),
                                 LC("MBReqTypes_All",CTy"MBReqTypes")]),
                             (LW(1,2),
                              TP[Var("domain",CTy"MBReqDomain"),
                                 LC("MBReqTypes_Reads",CTy"MBReqTypes")]),
                             (LW(2,2),
                              TP[Var("domain",CTy"MBReqDomain"),
                                 LC("MBReqTypes_Writes",CTy"MBReqTypes")]),
                             (LW(3,2),
                              TP[Var("domain",CTy"MBReqDomain"),
                                 LC("MBReqTypes_All",CTy"MBReqTypes")])]),
                         Call
