(* arm8Script.sml - generated by L<3> - Thu Nov 06 16:00:59 2014 *)
...
;
val _ = Construct [("imm32_64",[("Imm32",[F32]),("Imm64",[F64])])]
;
val _ = Construct
  [("exception",
...
val e_data_def = Def
  ("e_data",
   TP[Var("imm_enc",ATy(CTy"imm32_64",OTy(PTy(F1,PTy(FTy 6,FTy 6))))),
      Var("i",CTy"Data")],
   CS(Var("i",CTy"Data"),
      [(Call
          ("AddSubShiftedRegister@32",CTy"Data",
       ...
       (Call
        ...
        CS(TP[Apply
                (Var("imm_enc",
                     ATy(CTy"imm32_64",OTy(PTy(F1,PTy(FTy 6,FTy 6))))),
                 Call("Imm32",CTy"imm32_64",Var("imm",F32))),
              Call
                ("EncodeLogicalOp",OTy(FTy 2),
                 TP[Var("opc",CTy"LogicalOp"),bVar"s"])],
       ...
       (Call
        ...
        CS(TP[Apply
                (Var("imm_enc",
                     ATy(CTy"imm32_64",OTy(PTy(F1,PTy(FTy 6,FTy 6))))),
                 Call("Imm64",CTy"imm32_64",Var("imm",F64))),
              Call
                ("EncodeLogicalOp",OTy(FTy 2),
                 TP[Var("opc",CTy"LogicalOp"),bVar"s"])],
           [(TP[Mop(Some,
