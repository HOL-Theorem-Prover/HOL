(* arm8Script.sml - generated by L3 - Wed May 18 13:34:12 2016 *)
...
val dfn'ConditionalSelect_def = Def
  ("dfn'ConditionalSelect",
   ...
   Close
     (qVar"state",
      Let(Var("s0",PTy(BTy"N",qTy)),TP[LX(BTy"N"),qVar"state"],
          Let(Var("s",PTy(BTy"N",qTy)),
              ITE(Apply
                    (Call("ConditionHolds",ATy(qTy,bTy),Var("cond",F4)),
                     qVar"state"),
                  TP[Apply
                       (Call("X",ATy(qTy,BTy"N"),Var("n",FTy 5)),
                        qVar"state"),Mop(Snd,Var("s0",PTy(BTy"N",qTy)))],
                  Let(Var("s",PTy(BTy"N",qTy)),
                      TP[Apply
