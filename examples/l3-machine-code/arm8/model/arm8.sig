...
val SP:Nat.nat-> unit -> BitsN.nbit
...
val e_data:
  ((imm32_64 -> ((BitsN.nbit * (BitsN.nbit * BitsN.nbit)) option)) * Data) ->
  MachineCode
...
val Encode:
  ((imm32_64 -> ((BitsN.nbit * (BitsN.nbit * BitsN.nbit)) option)) *
...
val CheckDecode: string -> (string option)
