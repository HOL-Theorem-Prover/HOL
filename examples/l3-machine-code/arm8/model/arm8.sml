(* arm8 - generated by L3 - Fri Oct 16 13:04:09 2015 *)
...
fun reg'SCTLRType x =
  case x of
     {A = A, E0E = E0E, EE = EE, SA = SA, SA0 = SA0,
      ...
      BitsN.concat
        [BitsN.bits(5,0) sctlrtype'rst,BitsN.fromBit EE,BitsN.fromBit E0E,
         BitsN.bits(24,6) sctlrtype'rst,BitsN.fromBit SA0,
         BitsN.fromBit SA,BitsN.bits(25,25) sctlrtype'rst,BitsN.fromBit A,
