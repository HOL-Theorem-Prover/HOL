(* arm8 - generated by L<3> - Tue Nov 18 15:32:41 2014 *)
...
fun e_data (imm_enc,i) =
  case i of
   ...
   | AddSubImmediate''32(sf,(opc,(s,(imm,(rn,rd))))) =>
      (if (BitsN.&&(imm,BitsN.B(0xFFF,32))) = (BitsN.B(0x0,32))
         then if (BitsN.&&(imm,BitsN.~(BitsN.B(0xFFFFFF,32)))) =
                 (BitsN.B(0x0,32))
                then ARM8
                       (BitsN.concat
       ...
       else if (BitsN.&&(imm,BitsN.~(BitsN.B(0xFFF,32)))) =
          (BitsN.B(0x0,32))
         then ARM8
                (BitsN.concat
                   [e_sf 32 sf,BitsN.fromBit opc,BitsN.fromBit s,
   ...
   | AddSubImmediate''64(sf,(opc,(s,(imm,(rn,rd))))) =>
      (if (BitsN.&&(imm,BitsN.B(0xFFF,64))) = (BitsN.B(0x0,64))
         then if (BitsN.&&(imm,BitsN.~(BitsN.B(0xFFFFFF,64)))) =
                 (BitsN.B(0x0,64))
                then ARM8
                       (BitsN.concat
       ...
       else if (BitsN.&&(imm,BitsN.~(BitsN.B(0xFFF,64)))) =
          (BitsN.B(0x0,64))
         then ARM8
                (BitsN.concat
                   [e_sf 64 sf,BitsN.fromBit opc,BitsN.fromBit s,
  ...
  in
    if wback
      ...
      then BadCode("LoadStoreImmediate")
        ...
        (offset = (LSL 64 (BitsN.zeroExtend 64 imm12,BitsN.toNat sz)))) andalso
       (acctype = AccType_NORMAL)
...
fun e_load_store i =
  case i of
   ...
   | LoadStoreAcquire''8
      ...
      in
        if (sizeok andalso (Set.mem(memop,[MemOp_LOAD,MemOp_STORE]))) andalso
              ...
              (String.concat
               ...
               String.concat
                 [s_regz(wide,rt),", [",s_regp(true,rn),", ",
                  s_regz
                    (Set.mem
                       (extend_type,[ExtendType_UXTX,ExtendType_SXTX]),rm),
