(* arm8 - generated by L3 - Wed Jul 15 11:01:45 2015 *)
    ...
    then data
         ...
         val data =
           if Bitstring.bit(data,i)
             then (Bitstring.bits(Nat.-(List.length data,1),i) data)
                    @
                    (Bitstring.??
...
fun Poly32Mod2 (data,poly) =
  BitsN.fromBitstring
    (Bitstring.bits(31,0)
       (Poly32Mod2_loop
        (Nat.-(List.length data,1),(data,BitsN.toBitstring poly))),32);
...
fun e_LoadStoreImmediate
  ...
  let
    ...
    val imm12 = BitsN.bits(11,0) (LSR 64 (offset,BitsN.toNat sz))
    val opc =
  ...
  case i of
   ...
   | LoadStorePair''32
      ...
      let
        ...
        val scale = Nat.+(2,BitsN.toNat sf)
        val imm7 = BitsN.bits(6,0) (LSR 64 (offset,scale))
      in
