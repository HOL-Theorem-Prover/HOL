(* arm8 - generated by L<3> - Fri Oct 10 16:45:06 2014 *)
...
datatype imm32_64 = Imm32 of BitsN.nbit | Imm64 of BitsN.nbit
...
fun rec'TCR_EL1 x =
  {TBI0 = BitsN.bit(x,37), TBI1 = BitsN.bit(x,38),
   tcr_el1'rst = BitsN.@@(BitsN.bits(x,36,0),BitsN.bits(x,63,39))};
  ...
  case x of
     {TBI0 = TBI0, TBI1 = TBI1, tcr_el1'rst = tcr_el1'rst} =>
      BitsN.modify
        (fn (i,_) =>
           if i = 63
             then BitsN.bit(tcr_el1'rst,24)
           else if i = 62
             then BitsN.bit(tcr_el1'rst,23)
           else if i = 61
             then BitsN.bit(tcr_el1'rst,22)
           else if i = 60
             then BitsN.bit(tcr_el1'rst,21)
           else if i = 59
             then BitsN.bit(tcr_el1'rst,20)
           else if i = 58
             then BitsN.bit(tcr_el1'rst,19)
           else if i = 57
             then BitsN.bit(tcr_el1'rst,18)
           else if i = 56
             then BitsN.bit(tcr_el1'rst,17)
           else if i = 55
             then BitsN.bit(tcr_el1'rst,16)
           else if i = 54
             then BitsN.bit(tcr_el1'rst,15)
           else if i = 53
             then BitsN.bit(tcr_el1'rst,14)
           else if i = 52
             then BitsN.bit(tcr_el1'rst,13)
           else if i = 51
             then BitsN.bit(tcr_el1'rst,12)
           else if i = 50
             then BitsN.bit(tcr_el1'rst,11)
           else if i = 49
             then BitsN.bit(tcr_el1'rst,10)
           else if i = 48
             then BitsN.bit(tcr_el1'rst,9)
           else if i = 47
             then BitsN.bit(tcr_el1'rst,8)
           else if i = 46
             then BitsN.bit(tcr_el1'rst,7)
           else if i = 45
             then BitsN.bit(tcr_el1'rst,6)
           else if i = 44
             then BitsN.bit(tcr_el1'rst,5)
           else if i = 43
             then BitsN.bit(tcr_el1'rst,4)
           else if i = 42
             then BitsN.bit(tcr_el1'rst,3)
           else if i = 41
             then BitsN.bit(tcr_el1'rst,2)
           else if i = 40
             then BitsN.bit(tcr_el1'rst,1)
           else if i = 39
             then BitsN.bit(tcr_el1'rst,0)
           else if i = 38
             then TBI1
           else if i = 37
             then TBI0
           else if i = 36
             then BitsN.bit(tcr_el1'rst,61)
           else if i = 35
             then BitsN.bit(tcr_el1'rst,60)
           else if i = 34
             then BitsN.bit(tcr_el1'rst,59)
           else if i = 33
             then BitsN.bit(tcr_el1'rst,58)
           else if i = 32
             then BitsN.bit(tcr_el1'rst,57)
           else if i = 31
             then BitsN.bit(tcr_el1'rst,56)
           else if i = 30
             then BitsN.bit(tcr_el1'rst,55)
           else if i = 29
             then BitsN.bit(tcr_el1'rst,54)
           else if i = 28
             then BitsN.bit(tcr_el1'rst,53)
           else if i = 27
             then BitsN.bit(tcr_el1'rst,52)
           else if i = 26
             then BitsN.bit(tcr_el1'rst,51)
           else if i = 25
             then BitsN.bit(tcr_el1'rst,50)
           else if i = 24
             then BitsN.bit(tcr_el1'rst,49)
           else if i = 23
             then BitsN.bit(tcr_el1'rst,48)
           else if i = 22
             then BitsN.bit(tcr_el1'rst,47)
           else if i = 21
             then BitsN.bit(tcr_el1'rst,46)
           else if i = 20
             then BitsN.bit(tcr_el1'rst,45)
           else if i = 19
             then BitsN.bit(tcr_el1'rst,44)
           else if i = 18
             then BitsN.bit(tcr_el1'rst,43)
           else if i = 17
             then BitsN.bit(tcr_el1'rst,42)
           else if i = 16
             then BitsN.bit(tcr_el1'rst,41)
           else if i = 15
             then BitsN.bit(tcr_el1'rst,40)
           else if i = 14
             then BitsN.bit(tcr_el1'rst,39)
           else if i = 13
             then BitsN.bit(tcr_el1'rst,38)
           else if i = 12
             then BitsN.bit(tcr_el1'rst,37)
           else if i = 11
             then BitsN.bit(tcr_el1'rst,36)
           else if i = 10
             then BitsN.bit(tcr_el1'rst,35)
           else if i = 9
             then BitsN.bit(tcr_el1'rst,34)
           else if i = 8
             then BitsN.bit(tcr_el1'rst,33)
           else if i = 7
             then BitsN.bit(tcr_el1'rst,32)
           else if i = 6
             then BitsN.bit(tcr_el1'rst,31)
           else if i = 5
             then BitsN.bit(tcr_el1'rst,30)
           else if i = 4
             then BitsN.bit(tcr_el1'rst,29)
           else if i = 3
             then BitsN.bit(tcr_el1'rst,28)
           else if i = 2
             then BitsN.bit(tcr_el1'rst,27)
           else if i = 1
             then BitsN.bit(tcr_el1'rst,26)
           else BitsN.bit(tcr_el1'rst,25),BitsN.B(0x0,64));
...
fun rec'TCR_EL2_EL3 x =
  {TBI = BitsN.bit(x,20),
   tcr_el2_el3'rst = BitsN.@@(BitsN.bits(x,19,0),BitsN.bits(x,31,21))};
  ...
  case x of
     {TBI = TBI, tcr_el2_el3'rst = tcr_el2_el3'rst} =>
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(tcr_el2_el3'rst,10)
           else if i = 30
             then BitsN.bit(tcr_el2_el3'rst,9)
           else if i = 29
             then BitsN.bit(tcr_el2_el3'rst,8)
           else if i = 28
             then BitsN.bit(tcr_el2_el3'rst,7)
           else if i = 27
             then BitsN.bit(tcr_el2_el3'rst,6)
           else if i = 26
             then BitsN.bit(tcr_el2_el3'rst,5)
           else if i = 25
             then BitsN.bit(tcr_el2_el3'rst,4)
           else if i = 24
             then BitsN.bit(tcr_el2_el3'rst,3)
           else if i = 23
             then BitsN.bit(tcr_el2_el3'rst,2)
           else if i = 22
             then BitsN.bit(tcr_el2_el3'rst,1)
           else if i = 21
             then BitsN.bit(tcr_el2_el3'rst,0)
           else if i = 20
             then TBI
           else if i = 19
             then BitsN.bit(tcr_el2_el3'rst,30)
           else if i = 18
             then BitsN.bit(tcr_el2_el3'rst,29)
           else if i = 17
             then BitsN.bit(tcr_el2_el3'rst,28)
           else if i = 16
             then BitsN.bit(tcr_el2_el3'rst,27)
           else if i = 15
             then BitsN.bit(tcr_el2_el3'rst,26)
           else if i = 14
             then BitsN.bit(tcr_el2_el3'rst,25)
           else if i = 13
             then BitsN.bit(tcr_el2_el3'rst,24)
           else if i = 12
             then BitsN.bit(tcr_el2_el3'rst,23)
           else if i = 11
             then BitsN.bit(tcr_el2_el3'rst,22)
           else if i = 10
             then BitsN.bit(tcr_el2_el3'rst,21)
           else if i = 9
             then BitsN.bit(tcr_el2_el3'rst,20)
           else if i = 8
             then BitsN.bit(tcr_el2_el3'rst,19)
           else if i = 7
             then BitsN.bit(tcr_el2_el3'rst,18)
           else if i = 6
             then BitsN.bit(tcr_el2_el3'rst,17)
           else if i = 5
             then BitsN.bit(tcr_el2_el3'rst,16)
           else if i = 4
             then BitsN.bit(tcr_el2_el3'rst,15)
           else if i = 3
             then BitsN.bit(tcr_el2_el3'rst,14)
           else if i = 2
             then BitsN.bit(tcr_el2_el3'rst,13)
           else if i = 1
             then BitsN.bit(tcr_el2_el3'rst,12)
           else BitsN.bit(tcr_el2_el3'rst,11),BitsN.B(0x0,32));
...
fun rec'SCTLRType x =
  {A = BitsN.bit(x,1), E0E = BitsN.bit(x,24), EE = BitsN.bit(x,25),
   ...
   sctlrtype'rst =
     BitsN.concat
       [BitsN.bits(x,0,0),BitsN.bits(x,2,2),BitsN.bits(x,23,5),
        BitsN.bits(x,31,26)]};
  ...
  case x of
     {A = A, E0E = E0E, EE = EE, SA = SA, SA0 = SA0,
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(sctlrtype'rst,5)
           else if i = 30
             then BitsN.bit(sctlrtype'rst,4)
           else if i = 29
             then BitsN.bit(sctlrtype'rst,3)
           else if i = 28
             then BitsN.bit(sctlrtype'rst,2)
           else if i = 27
             then BitsN.bit(sctlrtype'rst,1)
           else if i = 26
             then BitsN.bit(sctlrtype'rst,0)
           else if i = 25
             then EE
           else if i = 24
             then E0E
           else if i = 23
             then BitsN.bit(sctlrtype'rst,24)
           else if i = 22
             then BitsN.bit(sctlrtype'rst,23)
           else if i = 21
             then BitsN.bit(sctlrtype'rst,22)
           else if i = 20
             then BitsN.bit(sctlrtype'rst,21)
           else if i = 19
             then BitsN.bit(sctlrtype'rst,20)
           else if i = 18
             then BitsN.bit(sctlrtype'rst,19)
           else if i = 17
             then BitsN.bit(sctlrtype'rst,18)
           else if i = 16
             then BitsN.bit(sctlrtype'rst,17)
           else if i = 15
             then BitsN.bit(sctlrtype'rst,16)
           else if i = 14
             then BitsN.bit(sctlrtype'rst,15)
           else if i = 13
             then BitsN.bit(sctlrtype'rst,14)
           else if i = 12
             then BitsN.bit(sctlrtype'rst,13)
           else if i = 11
             then BitsN.bit(sctlrtype'rst,12)
           else if i = 10
             then BitsN.bit(sctlrtype'rst,11)
           else if i = 9
             then BitsN.bit(sctlrtype'rst,10)
           else if i = 8
             then BitsN.bit(sctlrtype'rst,9)
           else if i = 7
             then BitsN.bit(sctlrtype'rst,8)
           else if i = 6
             then BitsN.bit(sctlrtype'rst,7)
           else if i = 5
             then BitsN.bit(sctlrtype'rst,6)
           else if i = 4
             then SA0
           else if i = 3
             then SA
           else if i = 2
             then BitsN.bit(sctlrtype'rst,25)
           else if i = 1 then A else BitsN.bit(sctlrtype'rst,26),
         BitsN.B(0x0,32));
...
fun SP N () =
  let
    val sp =
      if not((#SPS) (!PSTATE))
        then (!SP_EL0)
      else case (#EL) (!PSTATE) of
              BitsN.B(0x0,2) => (!SP_EL0)
            | BitsN.B(0x1,2) => (!SP_EL1)
            | BitsN.B(0x2,2) => (!SP_EL2)
            | BitsN.B(0x3,2) => (!SP_EL3)
  ...
  in
    if not((#SPS) (!PSTATE))
      then SP_EL0 := v
            ...
            BitsN.B(0x0,2) => SP_EL0 := v
          | BitsN.B(0x1,2) => SP_EL1 := v
          | BitsN.B(0x2,2) => SP_EL2 := v
          | BitsN.B(0x3,2) => SP_EL3 := v
          | _ => raise General.Bind
  end;

fun TranslationRegime () =
  if not(((#EL) (!PSTATE)) = (BitsN.B(0x0,2)))
    then (#EL) (!PSTATE)
  else BitsN.B(0x1,2);
...
fun SCTLR () =
  ...
  in
    case regime of
       BitsN.B(0x1,2) => (!SCTLR_EL1)
     | BitsN.B(0x2,2) => (!SCTLR_EL2)
     | BitsN.B(0x3,2) => (!SCTLR_EL3)
     | BitsN.B(0x0,2) =>
          {A = false, E0E = false, EE = false, SA = false, SA0 = false,
...
fun BranchTo (target0,branch_type) =
  ...
  in
    ...
    ; case (#EL) (!PSTATE) of
         BitsN.B(0x0,2) =>
            ( if (BitsN.bit((!target),55)) andalso ((#TBI1) (!TCR_EL1))
                then target :=
                     (BitsN.bitFieldInsert
                        ((!target),BitsN.B(0xFF,8),63,56))
              else ()
            ; if (not(BitsN.bit((!target),55))) andalso
                 ((#TBI0) (!TCR_EL1))
                then target :=
                     (BitsN.bitFieldInsert((!target),BitsN.B(0x0,8),63,56))
              else ()
            )
       | BitsN.B(0x1,2) =>
            ( if (BitsN.bit((!target),55)) andalso ((#TBI1) (!TCR_EL1))
...
fun CheckAlignment (address,(size,(acctype,iswrite))) =
  ...
  in
    if (not aligned) andalso
       (((acctype = AccType_ATOMIC) orelse (acctype = AccType_ORDERED)) orelse
        ((#A)(SCTLR ())))
      then raise ALIGNMENT_FAULT
    else aligned
  end;
       ...
       fn i =>
         ...
         in
           ...
           (Map.update
              ((!MEM),BitsN.toNat x,
               BitsN.fromBitstring
                 (Bitstring.bits(value,Nat.+(Nat.*(8,i),7),Nat.*(8,i)),8)))
         end)
  end;
  ...
  let
    val result =
      case BitsN.bits(cond,3,1) of
       ...
       | BitsN.B(0x2,3) => N
       | BitsN.B(0x3,3) => V
       | BitsN.B(0x4,3) => C andalso (not Z)
       | BitsN.B(0x5,3) => N = V
       | BitsN.B(0x6,3) => (N = V) andalso (not Z)
       | BitsN.B(0x7,3) => true
       | _ => raise General.Bind
  in
...
fun ConditionHolds cond =
  ConditionTest
    (cond,
     ((#N) (!PSTATE),((#Z) (!PSTATE),((#C) (!PSTATE),(#V) (!PSTATE)))));
...
fun Replicate N l =
  BitsN.fromBitstring
    (Bitstring.replicate
       (l,Nat.div(BitsN.size(BitsN.B(0x0,N)),List.length l)),N);
...
fun CountLeadingSignBits N w =
  Nat.-
    (CountLeadingZeroBits N
       (BitsN.??
          (BitsN.>>+(w,1),BitsN.&&(w,BitsN.~(BitsN.#>>(BitsN.B(0x1,N),1))))),
     1);
    ...
    then data
         ...
         val data =
           if Bitstring.bit(data,i)
             then (Bitstring.bits(data,Nat.-(List.length data,1),i))
                    @
                    (Bitstring.??
                     (Bitstring.bits(data,Nat.-(i,1),0),
...
fun Poly32Mod2 (data,poly) =
  BitsN.fromBitstring
    (Bitstring.bits
       (Poly32Mod2_loop
          (Nat.-(List.length data,1),(data,BitsN.toBitstring poly)),31,0),
     32);
...
fun LSL N (x,shift) = BitsN.<<(x,shift);

fun LSR N (x,shift) = BitsN.>>+(x,shift);

fun ASR N (x,shift) = BitsN.>>(x,shift);

fun ROR N (x,shift) = BitsN.#>>(x,shift);

fun DecodeShift sh = (Cast.natToShiftType o BitsN.toNat) sh;

fun ShiftValue N (value,(ty,amount)) =
  case ty of
     ShiftType_LSL => LSL N (value,amount)
   | ShiftType_LSR => LSR N (value,amount)
   | ShiftType_ASR => ASR N (value,amount)
   | ShiftType_ROR => ROR N (value,amount);
...
fun Extend N (l,unsigned) =
  if unsigned orelse (not(List.hd l))
    then BitsN.fromBitstring(l,N)
         ...
         (L3.padLeft(true,(BitsN.size(BitsN.B(0x0,N)),l)),N);
...
fun ExtendValue N (value,(ty,sh)) =
  let
    ...
    val len = Nat.min(len,Nat.-(BitsN.size(BitsN.B(0x0,N)),sh))
  in
    Extend N
      (Bitstring.<<(Bitstring.bits(value,Nat.-(len,1),0),sh),unsigned)
  end;
         ...
         in
           if immediate andalso (S = levels)
             then NONE
                  ...
                  val d = Bitstring.bits(diff,Nat.-(len,1),0)
                  val welem =
...
fun dfn'Address (page,(imm,d)) =
  ...
  in
    ( if page
        then base := (BitsN.bitFieldInsert((!base),BitsN.B(0x0,12),11,0))
      else ()
...
fun dfn'AddSubCarry N (sf,(sub_op,(setflags,(m,(n,d))))) =
  let
    ...
    val (result,nzcv) =
      AddWithCarry N (operand1,(operand2,(#C) (!PSTATE)))
  in
...
fun dfn'LogicalImmediate N (sf,(opc,(setflags,(imm,(n,d))))) =
  ...
  in
    ( SetTheFlags
        (setflags,
         (BitsN.msb result,(result = (BitsN.B(0x0,N)),(false,false))))
    ; if (d = (BitsN.B(0x1F,5))) andalso (not setflags)
        then write'SP N result
      else write'X N (result,d)
    )
  ...
  let
    ...
    val result =
      ShiftReg N
        (n,
         (shift_type,
          Nat.mod(BitsN.toNat operand2,BitsN.size(BitsN.B(0x0,N)))))
  in
    write'X N (result,d)
  end;
  ...
  in
    ...
    in
      ( let
          val h = Nat.+(pos,15)
        in
          result := (BitsN.bitFieldInsert((!result),imm,h,pos))
        end
      ; let
          val result =
...
fun dfn'BitfieldMove N
  ...
  let
    val dst = if inzero then BitsN.B(0x0,N) else X N d
    val src = X N n
    val bot =
      BitsN.||(BitsN.&&(dst,BitsN.~ wmask),BitsN.&&(ROR N (src,R),wmask))
    val top =
      if extend
    ...
    in
      ( if ConditionHolds cond
          then result := operand1
             ...
             ; if else_inc
                 then result := (BitsN.+((!result),BitsN.B(0x1,N)))
               else ()
             )
      ; write'X N ((!result),d)
      )
...
fun dfn'MultiplyHigh (signed,(m,(n,d))) =
  ...
  in
    write'X 64 (BitsN.bits(result,127,64),d)
  end;

fun dfn'Reverse N (sf,(op',(n,d))) =
  if (BitsN.size(BitsN.B(0x0,N))) = 32
    then let
           val v = X 32 n
           val result =
             case op' of
              ...
              | RevOp_REV16 =>
                   BitsN.concat
                     [BitsN.bits(v,23,16),BitsN.bits(v,31,24),
                      BitsN.bits(v,7,0),BitsN.bits(v,15,8)]
              | RevOp_REV32 =>
                   BitsN.concat
                     [BitsN.bits(v,7,0),BitsN.bits(v,15,8),
                      BitsN.bits(v,23,16),BitsN.bits(v,31,24)]
         ...
         val result =
           case op' of
            ...
            | RevOp_REV16 =>
                 BitsN.concat
                   [BitsN.bits(v,55,48),BitsN.bits(v,63,56),
                    BitsN.bits(v,39,32),BitsN.bits(v,47,40),
                    BitsN.bits(v,23,16),BitsN.bits(v,31,24),
                    BitsN.bits(v,7,0),BitsN.bits(v,15,8)]
            | RevOp_REV32 =>
                 BitsN.concat
  ...
  let
    ...
    val tempacc =
      (List.rev(BitsN.toBitstring acc))
        @
        (Zeros(BitsN.size(BitsN.B(0x0,N))))
    ...
    in
      ( case memop of
           MemOp_STORE =>
              let
                val data =
                  if rt_unknown then BitsN.fromNat(0,N) else X N t
                val x =
                  (address,(Nat.div(BitsN.size(BitsN.B(0x0,N)),8),acctype))
              in
                write'Mem N (data,x)
              end
         | MemOp_LOAD =>
              let
                val data =
                  Mem N
                    (address,
                     (Nat.div(BitsN.size(BitsN.B(0x0,N)),8),acctype))
              in
                if regsize_word
...
fun dfn'LoadStorePair N
  ...
  let
    val dbytes = Nat.div(BitsN.size(BitsN.B(0x0,N)),8)
  in
        ...
        ( case memop of
           ...
           | MemOp_LOAD =>
                ...
                in
                  if signed
                    then ( write'X 64
                             (ExtendWord (64,64) (data1,signed),t)
                         ; write'X 64
                             (ExtendWord (64,64) (data2,signed),t2)
                         )
        ...
        case memop of
                  ...
                  then if ExclusiveMonitorPass(address,dbytes)
                         then ( let
                              ...
                              ; let
                                ...
                                in
                                  write'X 32
                                    (BitsN.fromNat(BitsN.toNat status,32),
                                     s)
                                end
                              )
         ...
         | MemOp_LOAD =>
              ...
              ; let
                ...
                in
                  if (BitsN.size(BitsN.B(0x0,N))) = 64
      ...
      in
        case memop of
           MemOp_STORE =>
              let
                val data =
                  if rt_unknown
                    then BitsN.fromNat(0,N)
                  else if (BitsN.size(BitsN.B(0x0,N))) = 64
                    then if BigEndian ()
                           then BitsN.fromNat
         ...
         | MemOp_LOAD =>
              ...
              ; if rt_unknown
                  then if (BitsN.size(BitsN.B(0x0,N))) = 64
                  ...
                  then let
                       ...
                       in
                         if BigEndian ()
                           then ( write'X 32 (BitsN.bits(data,63,32),t)
                                ; write'X 32 (BitsN.bits(data,31,0),t2)
                                )
                         else ( write'X 32 (BitsN.bits(data,31,0),t)
                              ; write'X 32 (BitsN.bits(data,63,32),t2)
                              )
                       end
                     ...
                     ; write'X 64
                         (Mem 64
                            (BitsN.+(address,BitsN.B(0x8,64)),(8,acctype)),
                          t2)
                     )
              )
         | _ => ()
       ...
       MemOp_LOAD =>
          let
            val data =
              Mem N
                (address,
                 (Nat.div(BitsN.size(BitsN.B(0x0,N)),8),AccType_NORMAL))
          in
  ...
  case v0 of
   ...
   | Data v14 =>
      (case v14 of
        ...
        | AddSubShiftedRegister''32 v21 =>
           dfn'AddSubShiftedRegister 32 v21
        | AddSubShiftedRegister''64 v22 =>
           dfn'AddSubShiftedRegister 64 v22
   ...
   | LoadStore v55 =>
      (case v55 of
        ...
        | LoadStoreAcquirePair''128 v62 =>
           dfn'LoadStoreAcquirePair 128 v62
...
fun DecodeLogicalOp opc =
  case opc of
     BitsN.B(0x0,2) => (LogicalOp_AND,false)
   | BitsN.B(0x1,2) => (LogicalOp_ORR,false)
   | BitsN.B(0x2,2) => (LogicalOp_EOR,false)
   | BitsN.B(0x3,2) => (LogicalOp_AND,true)
   | _ => raise General.Bind;
...
fun LoadStoreRegister
  ...
  in
    case size of
       BitsN.B(0x0,2) => LoadStore(LoadStoreRegister''8(BitsN.B(0x0,8),a))
     | BitsN.B(0x1,2) =>
...
fun LoadStoreImmediate
  ...
  in
    if (((memop = MemOp_LOAD) andalso wback) andalso (Rn = Rt)) andalso
      ...
      then case (L3.K(BitsN.B(0x0,2))) ("LoadImmediate unpredictable") of
            ...
            | BitsN.B(0x2,2) => Unallocated
            | BitsN.B(0x3,2) => NoOperation
            | _ => raise General.Bind
    else if (((memop = MemOp_STORE) andalso wback) andalso (Rn = Rt)) andalso
       (not(Rn = (BitsN.B(0x1F,5))))
...
fun LoadStorePair
  ...
  let
    ...
    val rt_unknown = false
  in
    if (((memop = MemOp_LOAD) andalso wback) andalso
      ...
      then case (L3.K(BitsN.B(0x0,2))) ("LoadPair unpredictable") of
            ...
            | BitsN.B(0x3,2) => NoOperation
            | _ => raise General.Bind
    else if (((memop = MemOp_STORE) andalso wback) andalso
        ((Rn = Rt) orelse (Rn = Rt2))) andalso
       (not(Rn = (BitsN.B(0x1F,5))))
...
fun LoadStoreAcquire
  ...
  let
    val (rt_unknown,(rn_unknown,ast)) =
      if ((memop = MemOp_LOAD) andalso pair) andalso (Rt = Rt2)
        then case (L3.K(BitsN.B(0x0,2))) ("LoadAcquire unpredictable") of
                BitsN.B(0x0,2) => (true,(false,NONE))
              | BitsN.B(0x1,2) => (false,(false,Option.SOME Unallocated))
      ...
      if (((memop = MemOp_STORE) andalso excl) andalso (Rs = Rt)) orelse
        ...
        then case (L3.K(BitsN.B(0x0,2)))
               ("StoreAcquire Rs = Rt unpredictable") of
                BitsN.B(0x0,2) => (true,(rn_unknown,ast))
              | BitsN.B(0x1,2) => (rt_unknown,(rn_unknown,ast))
              | BitsN.B(0x2,2) =>
    ...
    val (rt_unknown,(rn_unknown,ast)) =
      if (((memop = MemOp_STORE) andalso excl) andalso (Rs = Rn)) andalso
         (not(Rn = (BitsN.B(0x1F,5))))
        then case (L3.K(BitsN.B(0x0,2)))
               ("StoreAcquire Rs = Rn unpredictable") of
                BitsN.B(0x0,2) => (rt_unknown,(true,ast))
              | BitsN.B(0x1,2) => (rt_unknown,(rn_unknown,ast))
              | BitsN.B(0x2,2) =>
                   (rt_unknown,(rn_unknown,Option.SOME Unallocated))
              | BitsN.B(0x3,2) =>
...
fun Decode w =
  case boolify'32 w of
      ...
      let
        ...
        val opcode =
          case BitsN.fromBitstring([opc'1,opc'0],2) of
             BitsN.B(0x0,2) => MoveWideOp_N
           | BitsN.B(0x2,2) => MoveWideOp_Z
           | BitsN.B(0x3,2) => MoveWideOp_K
           | BitsN.B(0x1,2) => MoveWideOp_K
           | _ => raise General.Bind
      in
        if (BitsN.fromBitstring([sf'0],1)) = (BitsN.B(0x1,1))
          then Data
                 (MoveWide''64(BitsN.B(0x1,64),(opcode,(hw,(imm16,Rd)))))
   ...
   | (false,
      ...
      in
        if ((N = (BitsN.B(0x1,1))) orelse (BitsN.bit(immr,5))) orelse
           (BitsN.bit(imms,5))
          then Reserved
        else let
               val (inzero,extend) =
                 case BitsN.fromBitstring([opc'1,opc'0],2) of
                    BitsN.B(0x0,2) => (true,true)
                  | BitsN.B(0x1,2) => (false,false)
                  | BitsN.B(0x2,2) => (true,false)
                  | _ => (false,false)
             in
            ...
            (BitsN.@@
               (BitsN.fromBitstring
                  ([imm19'18,imm19'17,imm19'16,imm19'15,imm19'14,imm19'13,
                    ...
                    imm19'6,imm19'5,imm19'4,imm19'3,imm19'2,imm19'1,
                    imm19'0],19),BitsN.B(0x0,2)))
      in
        if (BitsN.fromBitstring([sf'0],1)) = (BitsN.B(0x1,1))
          then Branch
                 (CompareAndBranch''64
        ...
        (MoveSystemRegister
           ((not o L3.equal (BitsN.zero (1)))
            ...
            (BitsN.+
               (BitsN.B(0x2,3),
                BitsN.fromNat
                  (BitsN.toNat(BitsN.fromBitstring([o0'0],1)),3)),
...
fun e_sf N sf = BitsN.fromBit((BitsN.size(BitsN.B(0x0,N))) = 64);
...
fun e_data (imm_enc,i) =
  case i of
   ...
   | AddSubImmediate''32(sf,(opc,(s,(imm,(rn,rd))))) =>
      (if (BitsN.bits(imm,11,0)) = (BitsN.B(0x0,12))
         then if (BitsN.bits(imm,31,24)) = (BitsN.B(0x0,8))
                then ARM8
                       (BitsN.concat
                          [e_sf 32 sf,BitsN.fromBit opc,BitsN.fromBit s,
                           BitsN.B(0x45,7),BitsN.bits(imm,23,12),rn,rd])
              else BadCode("AddSubImmediate")
       else if (BitsN.bits(imm,31,12)) = (BitsN.B(0x0,20))
         then ARM8
                (BitsN.concat
                   [e_sf 32 sf,BitsN.fromBit opc,BitsN.fromBit s,
                    BitsN.B(0x44,7),BitsN.bits(imm,11,0),rn,rd])
       else BadCode("AddSubImmediate"))
   ...
   | LogicalImmediate''32(_,(opc,(s,(imm,(rn,rd))))) =>
      (case (imm_enc (Imm32 imm),EncodeLogicalOp(opc,s)) of
   ...
   | LogicalImmediate''64(_,(opc,(s,(imm,(rn,rd))))) =>
      (case (imm_enc (Imm64 imm),EncodeLogicalOp(opc,s)) of
           ...
           Option.SOME opc =>
            ...
            in
              if ((immr = (BitsN.toNat r)) andalso
                 ...
                 ((DecodeBitMasks 32
                     (BitsN.fromNat(BitsN.toNat sz,1),(s,(r,false)))) =
                  (Option.SOME(wmask,tmask)))
                then ARM8
   ...
   | ConditionalCompareImmediate''32
      ...
      in
        if imm = (BitsN.fromNat(BitsN.toNat imm5,32))
          then ARM8
                 (BitsN.concat
                    [e_sf 32 sf,BitsN.fromBit opc,BitsN.B(0x1D2,9),imm5,
                     cd,BitsN.B(0x2,2),rn,BitsN.B(0x0,1),BitsN.fromBit n,
   ...
   | ConditionalCompareImmediate''64
      ...
      in
        if imm = (BitsN.fromNat(BitsN.toNat imm5,64))
          then ARM8
                 (BitsN.concat
                    [e_sf 64 sf,BitsN.fromBit opc,BitsN.B(0x1D2,9),imm5,
                     cd,BitsN.B(0x2,2),rn,BitsN.B(0x0,1),BitsN.fromBit n,
                     BitsN.fromBit z,BitsN.fromBit c,BitsN.fromBit v])
        else BadCode("ConditionalCompareImmediate")
      end
   ...
   | Division''64(_,(o1,(rm,(rn,rd)))) =>
      ARM8
        (BitsN.concat
           [BitsN.B(0x4D6,11),rm,BitsN.B(0x1,5),BitsN.fromBit(not o1),rn,
            rd])
   ...
   | Reverse''32(_,(opc,(rn,rd))) =>
      (if opc = RevOp_REV64
         then BadCode("Reverse32")
              ...
              (BitsN.concat
                 [BitsN.B(0x5AC00,20),
                  BitsN.fromNat(Cast.RevOpToNat opc,2),rn,rd]))
...
fun e_branch i =
  case i of
     BranchConditional(imm,cd) =>
      let
        val imm19 = BitsN.bits(imm,20,2)
      in
        if imm = (BitsN.signExtend 64 (BitsN.@@(imm19,BitsN.B(0x0,2))))
          then ARM8(BitsN.concat[BitsN.B(0x54,8),imm19,BitsN.B(0x0,1),cd])
        else BadCode("BranchConditional")
      end
   | BranchImmediate(imm,btype) =>
      let
        val imm26 = BitsN.bits(imm,27,2)
      in
        if (imm = (BitsN.signExtend 64 (BitsN.@@(imm26,BitsN.B(0x0,2))))) andalso
           (L3.mem(btype,[BranchType_CALL,BranchType_JMP]))
          then ARM8
                 (BitsN.concat
                    [BitsN.fromBit(btype = BranchType_CALL),
                     BitsN.B(0x5,5),imm26])
      ...
      in
        if opc = (BitsN.B(0x3,2))
          then BadCode("BranchRegister")
               ...
               (BitsN.concat
                  [BitsN.B(0x1AC,9),opc,BitsN.B(0x7C0,11),rn,
                   BitsN.B(0x0,5)])
      end
   | CompareAndBranch''32(_,(iszero,(offset,rt))) =>
      let
        val imm19 = BitsN.bits(offset,20,2)
      in
   ...
   | TestBitAndBranch''32(_,(bit_pos,(bit_val,(offset,rt)))) =>
      let
        val imm14 = BitsN.bits(offset,15,2)
      in
        if (offset =
            (BitsN.signExtend 64 (BitsN.@@(imm14,BitsN.B(0x0,2))))) andalso
           (not(BitsN.bit(bit_pos,5)))
          then ARM8
                 (BitsN.concat
                    [BitsN.B(0x1B,7),BitsN.fromBit bit_val,
                     BitsN.bits(bit_pos,4,0),imm14,rt])
...
fun e_LoadStoreImmediate
  ...
  let
    val imm9 = BitsN.bits(offset,8,0)
    val opc =
  ...
  in
    if wback
      ...
      then let
             val imm12 = BitsN.bits(LSR 64 (offset,BitsN.toNat sz),11,0)
           in
             if (offset =
                 (LSL 64 (BitsN.zeroExtend 64 imm12,BitsN.toNat sz))) andalso
                (acctype = AccType_NORMAL)
  ...
  case i of
   ...
   | LoadLiteral''32(_,(memop,(signed,(offset,rt)))) =>
      ...
      in
        if (Option.isSome opc) andalso
           (offset =
            (BitsN.signExtend 64 (BitsN.@@(imm19,BitsN.B(0x0,2)))))
          then ARM8
   ...
   | LoadStorePair''32
      ...
      let
        ...
        val scale = Nat.+(2,BitsN.toNat sf)
        val imm7 = BitsN.bits(LSR 64 (offset,scale),6,0)
      in
        if ((((sf = (BitsN.B(0x1,1))) = ((BitsN.size size) = 64)) andalso
             (L3.mem(memop,[MemOp_LOAD,MemOp_STORE]))) andalso
            (L3.mem(acctype,[AccType_STREAM,AccType_NORMAL]))) andalso
           (offset = (LSL 64 (BitsN.signExtend 64 imm7,scale)))
          then ARM8
                 (BitsN.concat
   ...
   | LoadStoreAcquire''8
       (size,
        (memop,(acctype,(excl,(rn_unknown,(rt_unknown,(rs,(rn,rt)))))))) =>
      let
        val sizeok =
      ...
      in
        if (sizeok andalso (L3.mem(memop,[MemOp_LOAD,MemOp_STORE]))) andalso
           (L3.mem(acctype,[AccType_ORDERED,AccType_ATOMIC]))
          then ARM8
                 (BitsN.concat
   ...
   | LoadStoreAcquirePair''64
       (size,
        (memop,(acctype,(rn_unknown,(rt_unknown,(rs,(rn,(rt,rt2)))))))) =>
      let
        val sizeok =
          size =
...
fun Encode (imm_enc,i) =
  case i of
     Address(page,(imm,rd)) =>
      (if page
         then let
                val immlo = BitsN.bits(imm,13,12)
                val immhi = BitsN.bits(imm,32,14)
              in
                if (BitsN.signExtend 64
                      (BitsN.concat[immhi,immlo,BitsN.B(0x0,12)])) = imm
                  then ARM8
                         (BitsN.concat
                            [BitsN.B(0x1,1),immlo,BitsN.B(0x10,5),immhi,rd])
                else BadCode("Address")
              end
       else let
              val immlo = BitsN.bits(imm,1,0)
              val immhi = BitsN.bits(imm,20,2)
            in
  ...
  case p_encode_immediate N s of
     Option.SOME(true,v) =>
      Option.SOME
        (if (BitsN.neg v) = v
           then (true,v)
         else (BitsN.<(BitsN.B(0x0,N),v),BitsN.neg v))
   | x => x;

fun p_pos_immediate N s =
  case p_encode_immediate N s of
     Option.SOME(true,v) => Option.SOME(BitsN.<=(BitsN.B(0x0,N),v),v)
   | x => x;
...
fun p_extend2 (size,(wide,s)) =
  let
    val r =
      case String.explode(stripSpaces s) of
       ...
       | #"l" :: (#"s" :: (#"l" :: t)) =>
          (if wide
             then p_extend_amount
                    (ExtendType_UXTX,(false,String.implode t))
           else NONE)
       | #"s" :: (#"x" :: (#"t" :: (#"w" :: t))) =>
          (if wide
             then NONE
  ...
  in
    case r of
       Option.SOME(_,v) => (if L3.mem(v,[0,size]) then r else NONE)
     | NONE => NONE
  end;
                 ...
                 (case p_register(false,r2) of
                     Option.SOME(true,xn) =>
                      (case (t,wb) of
                          ([],_) =>
                           ("",
                            Option.SOME(xn,(BitsN.B(0x0,64),(wb,false))))
                        | ([a],false) =>
...
fun p_exclusive_address l =
  case p_address l of
     ("",Option.SOME(xn,(BitsN.B(0x0,64),(false,false)))) =>
      Option.SOME xn
   | _ => NONE;
...
fun p_ldr_literal
  ...
  if ((((size = 2) andalso allow_unsigned_offset) andalso
       (memop = MemOp_LOAD)) andalso ((not signed) orelse wide)) andalso
     ((List.length l) = 1)
    then let
           val a = List.hd l
         in
           case p_label a of
            ...
            | NONE =>
                 (case p_offset 21 a of
                   ...
                   | Option.SOME _ =>
                      FAIL("offset too large: ldr (literal)")
                   ...
                   case p_address r of
                      ("",Option.SOME(xn,(offset,(wb,postindex)))) =>
                       ...
                       in
                         if unsigned_offset andalso
                           ...
                           then FAIL("unsigned offset required: ldr, str")
                    ...
                    | (err,_) =>
                       (if acctype = AccType_NORMAL
                          then let
                                 val sz =
                                   if ((size = 2) andalso wide) andalso
                                      (not signed)
                                     then 3
                                   else size
                               in
                    ...
                    Option.SOME xn =>
                     let
                       val a =
                         (memop,
                          (acctype,
                           (excl,(false,(false,(BitsN.B(0x1F,5),(xn,rt)))))))
                     in
                       OK(LoadStore
                            (case size of
                                0 => LoadStoreAcquire''8(BitsN.B(0x0,8),a)
                              | 1 =>
     ...
     t1 :: (t2 :: r) =>
      (case p_register2z[t1,t2] of
          Option.SOME(wide,(rt1,rt2)) =>
           (case p_address r of
               ("",Option.SOME(xn,(offset,(wb,postindex)))) =>
                (if ((acctype = AccType_STREAM) andalso (wb orelse signed)) orelse
                   ...
                   then FAIL("syntax error: ldp, stp, ...")
                      ...
                      in
                        OK(LoadStore
                             (if wide andalso (not signed)
                                then LoadStorePair''64(BitsN.B(0x1,64),a)
                  ...
                  OK(LoadStore
                       (if wide
                          then LoadStoreAcquirePair''128
                                 (BitsN.B(0x3,128),a)
                        else LoadStoreAcquirePair''64(BitsN.B(0x2,64),a)))
                end
...
fun p_b_bl (branch_type,l) =
  case l of
     [a] =>
      (case p_label a of
          Option.SOME v =>
           PENDING(v,Branch(BranchImmediate(BitsN.B(0x0,64),branch_type)))
        | NONE =>
             ...
             case p_label a of
              ...
              | NONE =>
                   (case p_offset 16 a of
                     ...
                     | Option.SOME _ =>
                        FAIL("offset too large: tbz, tbnz")
...
fun p_extend_register
  ...
  case (p_register2(setflags,(false,[d,n])),p_register(true,m)) of
   ...
   | (Option.SOME(wide,(rd,rn)),NONE) =>
      (if is_lsl andalso (L3.mem(amount,[0,12]))
...
fun p_madd_msub (sub_op,l) =
  case p_register4(true,(true,(true,(true,l)))) of
     Option.SOME(true,(xd,(xn,(xm,xa)))) =>
      OK(Data
           (MultiplyAddSub''64(BitsN.B(0x1,64),(sub_op,(xm,(xa,(xn,xd)))))))
     ...
     [d,n,m,a] =>
      (case (p_register2z[d,a],p_register2z[n,m]) of
          (Option.SOME(true,(xd,xa)),Option.SOME(false,(wn,wm))) =>
           OK(Data(MultiplyAddSubLong(sub_op,(signed,(wm,(xa,(wn,xd)))))))
     ...
     [i] =>
      (case p_immediate 7 i of
          Option.SOME(true,imm7) =>
           OK(Hint
                (case imm7 of
                    BitsN.B(0x0,7) => SystemHintOp_NOP
                  | BitsN.B(0x1,7) => SystemHintOp_YIELD
                  | BitsN.B(0x2,7) => SystemHintOp_WFE
                  | BitsN.B(0x3,7) => SystemHintOp_WFI
                  | BitsN.B(0x4,7) => SystemHintOp_SEV
                  | BitsN.B(0x5,7) => SystemHintOp_SEVL
                  | _ => SystemHintOp_NOP))
...
fun convert_immediate (wide,imm) =
  if wide
    then if (BitsN.bits(imm,63,16)) = (BitsN.B(0x0,48))
           then [("#0x") ^ (BitsN.toHexString(BitsN.bits(imm,15,0))),
                 "lsl #0"]
         else if (BitsN.&&(imm,BitsN.B(0xFFFFFFFF0000FFFF,64))) =
            (BitsN.B(0x0,64))
           then [("#0x") ^ (BitsN.toHexString(BitsN.bits(imm,31,16))),
                 "lsl #16"]
         else if (BitsN.&&(imm,BitsN.B(0xFFFF0000FFFFFFFF,64))) =
            (BitsN.B(0x0,64))
           then [("#0x") ^ (BitsN.toHexString(BitsN.bits(imm,47,32))),
                 "lsl #32"]
         else if (BitsN.bits(imm,47,0)) = (BitsN.B(0x0,48))
           then [("#0x") ^ (BitsN.toHexString(BitsN.bits(imm,63,48))),
                 "lsl #48"]
         else []
  else if (BitsN.bits(imm,63,32)) = (BitsN.B(0x0,32))
    then if (BitsN.bits(imm,31,16)) = (BitsN.B(0x0,16))
           then [("#0x") ^ (BitsN.toHexString(BitsN.bits(imm,15,0))),
                 "lsl #0"]
         else if (BitsN.bits(imm,15,0)) = (BitsN.B(0x0,16))
           then [("#0x") ^ (BitsN.toHexString(BitsN.bits(imm,31,16))),
                 "lsl #16"]
         else []
  else [];
      ...
      in
        if n = ("")
          then FAIL("syntax error: mov")
             ...
             in
               if (L3.mem(d,s)) orelse (L3.mem(n,s))
                 then if i
                        then p_and_etc orr
     ...
     [d,n,a,b] =>
      (case (p_unbounded_immediate a,p_unbounded_immediate b) of
        ...
        | (Option.SOME lsb,Option.SOME width) =>
           ...
           in
             [d,n,("#") ^ (Int.toString(Int.mod(Int.~(Nat.toInt lsb),m))),
  ...
  case p_tokens s of
     v'0 :: v'1 =>
      (case (String.explode v'0,v'1) of
        ...
        | ([#"c",#"r",#"c",#"3",#"2",#"b"],l) => p_crc32b_etc(0,(false,l))
        | ([#"c",#"r",#"c",#"3",#"2",#"h"],l) => p_crc32b_etc(1,(false,l))
        | ([#"c",#"r",#"c",#"3",#"2",#"w"],l) => p_crc32b_etc(2,(false,l))
...
fun EncodeARM (imm_enc,s) =
  case instructionFromString s of
     OK ast =>
      (case Encode(imm_enc,ast) of
          ARM8 w =>
...
fun CheckDecode s =
  L3.snd
    (EncodeARM
       (L3.K(Option.SOME(BitsN.B(0x0,1),(BitsN.B(0x0,6),BitsN.B(0x0,6)))),
        s));
...
fun s_shifted_imm N imm =
  ...
  in
    if (not(top = (BitsN.B(0x0,N)))) andalso
       ((BitsN.bits(imm,11,0)) = (BitsN.B(0x0,12)))
  ...
  case ast of
        ...
        ((if sub_op then "sub" else "add")
         ...
         String.concat
           [if setflags then s_regz(wide,d) else s_regp(wide,d),", ",
            ...
            s_regz
              (wide andalso
               (L3.mem(extend_type,[ExtendType_UXTX,ExtendType_SXTX])),m),
   ...
   | LogicalShiftedRegister''32
      ...
      let
        val wide = (BitsN.size sf) = 64
      in
        if (((opc = LogicalOp_ORR) andalso (n = (BitsN.B(0x1F,5)))) andalso
            (shift_type = ShiftType_LSL)) andalso (imm = 0)
          then (if invert then "mvn" else "mov",
                (s_reg2z(wide,(d,m))) ^ (s_shift_amount(shift_type,imm)))
        else if (((opc = LogicalOp_AND) andalso (not invert)) andalso
            setflags) andalso (d = (BitsN.B(0x1F,5)))
          then ("tst",
                (s_reg2z(wide,(n,m))) ^ (s_shift_amount(shift_type,imm)))
        else ((if invert
                 then s_invert_logical_op opc
               else s_logical_op opc)
                ^
                (if setflags then "s" else ""),
                ...
                (s_regz(wide,d))
                  ...
                  (if wide
                   then s_imm 64
                        ...
                        (BitsN.~
                           (BitsN.<<(BitsN.fromNat(BitsN.toNat imm,32),sh)))))
   ...
   | BitfieldMove''32(sf,(inzero,(extend,(wmask,(tmask,(r,(s,(n,d)))))))) =>
      ...
      in
        case (inzero,extend) of
         ...
         | (true,false) =>
              if (wide andalso (s = 63)) orelse
                 ((not wide) andalso (s = 31))
                then ("lsr",dn ^ (s_immn r))
              else if (Nat.+(s,1)) = r
                then ("lsl",
                      dn ^ (s_immn(Nat.-(if wide then 63 else 31,s))))
   ...
   | ConditionalSelect''32(sf,(else_inv,(else_inc,(cd,(m,(n,d)))))) =>
      ...
      in
        case (else_inv,else_inc) of
         ...
         | (false,true) =>
              if ((n = m) andalso (not(n = (BitsN.B(0x1F,5))))) andalso
                 (not((BitsN.bits(cd,3,1)) = (BitsN.B(0x7,3))))
                then ("cinc",
                      String.concat
                        [s_reg2z(wide,(d,n)),", ",invert_cond(s_cond cd)])
              else if ((n = m) andalso (n = (BitsN.B(0x1F,5)))) andalso
                 (not((BitsN.bits(cd,3,1)) = (BitsN.B(0x7,3))))
                then ("cset",
                      String.concat
   ...
   | MultiplyAddSub''32(sf,(sub_op,(m,(a,(n,d))))) =>
      ...
      in
        ...
        else (if sub_op then "msub" else "madd",
              s_reg4z(wide,(d,(n,(m,a)))))
      end
            ...
            in
              (String.concat
               ...
               String.concat
                 [s_regz(wide,rt),", [",s_regp(true,rn),", ",
                  s_regz
                    (L3.mem(extend_type,[ExtendType_UXTX,ExtendType_SXTX]),
                     rm),
      ...
      in
        (String.concat
           [if memop = MemOp_LOAD
              then ("ld")
                     ^
                     (if acctype = AccType_ORDERED then "a" else "")
