(* m0Script.sml - generated by L<3> - Tue Nov 26 11:30:12 2013 *)
      ...
      ITE(Bop(And,
          ...
          Apply
            (Call
               ("BranchTo",ATy(qTy,PTy(uTy,qTy)),
                CC[EX(Var("address",F32),LN 31,LN 1,FTy 31),LW(0,1)]),
             ITE(Bop(Bit,Var("address",F32),LN 0),
                 Mop(Snd,
                     Apply
                       (Call
                          ("Raise",ATy(qTy,PTy(uTy,qTy)),
                     ...
                     ("dfn'Register",ATy(qTy,PTy(uTy,qTy)),
                      Var("v10",
                          PTy(F4,
                              PTy(bTy,
                                  PTy(F4,
                                      PTy(F4,PTy(F4,PTy(CTy"SRType",nTy)))))))),
                   qVar"state")),
               (Call
                               ...
                               Call
                                 ("Branch",CTy"instruction",
                                  Call
                                    ("BranchTarget",CTy"Branch",
                                     Mop(SE F32,
                                         CC[Mop(Cast F1,LL[bVar"b'26"]),
                                            Mop(Cast F1,LL[bVar"b'11"]),
                                            Mop(Cast F1,LL[bVar"b'13"]),
                                            Mop(Cast(FTy 6),
                                                LL[bVar"b'21",bVar"b'20",
                                                   bVar"b'19",bVar"b'18",
                                                   bVar"b'17",bVar"b'16"]),
                                            Mop(Cast(FTy 11),
                                                LL[bVar"b'10",bVar"b'9",
                                       ...
                                       CC[Var("S",F1),
                                          ...
                                          Mop(Cast(FTy 11),
                                              LL[bVar"b'10",bVar"b'9",
                                                 ...
                                                 bVar"b'2",bVar"b'1",
                                                 bVar"b'0"]),LW(0,1)]),
                                   ITE(EQ(Mop(Cast F1,LL[bVar"b'14"]),
                                          LW(1,1)),
                                       Call
                                         ("Branch",CTy"instruction",
                                          Call
                                            ("BranchLinkImmediate",
                                             CTy"Branch",Var("imm32",F32))),
                                       Call
                                         ("Branch",CTy"instruction",
                                          Call
                                            ("BranchTarget",CTy"Branch",
