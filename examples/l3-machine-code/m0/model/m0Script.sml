(* m0Script.sml - generated by L<3> - Fri Nov 08 14:05:34 2013 *)
             ...
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),bVar"N"),(EQ(nVar"i",LN 30),bVar"Z"),
                  ...
                  (EQ(nVar"i",LN 23),Bop(Bit,Var("psr'rst",FTy 21),LN 20)),
                  (EQ(nVar"i",LN 22),Bop(Bit,Var("psr'rst",FTy 21),LN 19)),
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("psr'rst",FTy 21),LN 18)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("psr'rst",FTy 21),LN 17)),
                  (EQ(nVar"i",LN 19),Bop(Bit,Var("psr'rst",FTy 21),LN 16)),
                  (EQ(nVar"i",LN 18),Bop(Bit,Var("psr'rst",FTy 21),LN 15)),
                  (EQ(nVar"i",LN 17),Bop(Bit,Var("psr'rst",FTy 21),LN 14)),
                  (EQ(nVar"i",LN 16),Bop(Bit,Var("psr'rst",FTy 21),LN 13)),
                  (EQ(nVar"i",LN 15),Bop(Bit,Var("psr'rst",FTy 21),LN 12)),
                  (EQ(nVar"i",LN 14),Bop(Bit,Var("psr'rst",FTy 21),LN 11)),
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("psr'rst",FTy 21),LN 10)),
        ...
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 2),bVar"control'rst"),
             ...
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("VECTKEY",F16),LN 15)),
                  ...
                  (EQ(nVar"i",LN 9),Bop(Bit,Var("aircr'rst",FTy 13),LN 6)),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("aircr'rst",FTy 13),LN 5)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("aircr'rst",FTy 13),LN 4)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("aircr'rst",FTy 13),LN 3)),
                  (EQ(nVar"i",LN 5),Bop(Bit,Var("aircr'rst",FTy 13),LN 2)),
                  (EQ(nVar"i",LN 4),Bop(Bit,Var("aircr'rst",FTy 13),LN 1)),
                  (EQ(nVar"i",LN 3),Bop(Bit,Var("aircr'rst",FTy 13),LN 0)),
        ...
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("ccr'rst",FTy 30),LN 21)),
                  (EQ(nVar"i",LN 30),Bop(Bit,Var("ccr'rst",FTy 30),LN 20)),
                  (EQ(nVar"i",LN 29),Bop(Bit,Var("ccr'rst",FTy 30),LN 19)),
                  (EQ(nVar"i",LN 28),Bop(Bit,Var("ccr'rst",FTy 30),LN 18)),
                  (EQ(nVar"i",LN 27),Bop(Bit,Var("ccr'rst",FTy 30),LN 17)),
                  (EQ(nVar"i",LN 26),Bop(Bit,Var("ccr'rst",FTy 30),LN 16)),
                  (EQ(nVar"i",LN 25),Bop(Bit,Var("ccr'rst",FTy 30),LN 15)),
                  (EQ(nVar"i",LN 24),Bop(Bit,Var("ccr'rst",FTy 30),LN 14)),
                  (EQ(nVar"i",LN 23),Bop(Bit,Var("ccr'rst",FTy 30),LN 13)),
                  (EQ(nVar"i",LN 22),Bop(Bit,Var("ccr'rst",FTy 30),LN 12)),
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("ccr'rst",FTy 30),LN 11)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("ccr'rst",FTy 30),LN 10)),
             ...
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("PRI_11",FTy 2),LN 1)),
                  ...
                  (EQ(nVar"i",LN 9),Bop(Bit,Var("shpr2'rst",FTy 30),LN 9)),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("shpr2'rst",FTy 30),LN 8)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("shpr2'rst",FTy 30),LN 7)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("shpr2'rst",FTy 30),LN 6)),
                  (EQ(nVar"i",LN 5),Bop(Bit,Var("shpr2'rst",FTy 30),LN 5)),
                  (EQ(nVar"i",LN 4),Bop(Bit,Var("shpr2'rst",FTy 30),LN 4)),
                  (EQ(nVar"i",LN 3),Bop(Bit,Var("shpr2'rst",FTy 30),LN 3)),
                  (EQ(nVar"i",LN 2),Bop(Bit,Var("shpr2'rst",FTy 30),LN 2)),
                  (EQ(nVar"i",LN 1),Bop(Bit,Var("shpr2'rst",FTy 30),LN 1))],
             ...
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("PRI_15",FTy 2),LN 1)),
                  ...
                  (EQ(nVar"i",LN 3),Bop(Bit,Var("shpr3'rst",FTy 28),LN 9)),
                  (EQ(nVar"i",LN 2),Bop(Bit,Var("shpr3'rst",FTy 28),LN 8)),
                  (EQ(nVar"i",LN 1),Bop(Bit,Var("shpr3'rst",FTy 28),LN 7))],
             ...
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("PRI_N3",FTy 2),LN 1)),
                  ...
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("ipr'rst",FTy 24),LN 11)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("ipr'rst",FTy 24),LN 10)),
                  ...
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("ipr'rst",FTy 24),LN 17)),
                  (EQ(nVar"i",LN 12),Bop(Bit,Var("ipr'rst",FTy 24),LN 16)),
                  (EQ(nVar"i",LN 11),Bop(Bit,Var("ipr'rst",FTy 24),LN 15)),
                  (EQ(nVar"i",LN 10),Bop(Bit,Var("ipr'rst",FTy 24),LN 14)),
