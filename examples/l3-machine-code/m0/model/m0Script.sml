(* m0Script.sml - generated by L<3> - Fri Aug 09 15:30:26 2013 *)
                        ...
                        Rupd
                          ("PRIMASK",
                           TP[qVar"s",
                              Rupd
                                ("PM",
                                 TP[Dest("PRIMASK",CTy"PRIMASK",qVar"s"),
                                    LF])]),
                        Let
                          (qVar"s",
                           Rupd
                        ...
                        Let
                          (TP[Var("v",F32),qVar"s"],
                           Apply
                             (Call
                                ("MemA",ATy(qTy,PTy(F32,qTy)),
                                 TP[Bop(Add,Var("frameptr",F32),LW(8,32)),
                                    LN 4]),
                              Let
                                (TP[Var("v",F32),qVar"s"],
                                 Apply
   ...
   Close
     (qVar"state",
      TP[TP[Bop(Lsl,Var("x",BTy"N"),nVar"shift"),
            Bop
              (Bit,
               CC[Mop(Cast vTy,Var("x",BTy"N")),Bop(Rep,LV"0",nVar"shift")],
               Mop(Size,LY(0,"N")))],
         ITE
           (EQ(nVar"shift",LN 0),
            Mop
       ...
       (LW(3,2),
        ITE
          (EQ(Var("imm5",FTy 5),LW(0,5)),
           ...
           TP[LC("SRType_ROR",CTy"SRType"),Mop(Cast nTy,Var("imm5",FTy 5))]))]))
;
                  ...
                  Apply
                    (Call
                       ("DataProcessingPC",ATy(qTy,PTy(uTy,qTy)),
                        TP[Var("opc",F4),Var("n",F4),Var("shifted",F32),
                           bVar"v"]),qVar"s"),
                  Apply
                    (Call
                       ("DataProcessing",ATy(qTy,PTy(uTy,qTy)),
...
val dfn'TestCompareRegister_def = Def
  ("dfn'TestCompareRegister",
   TP[Var("opc",FTy 2),Var("n",F4),Var("m",F4),Var("shift_t",CTy"SRType"),
      nVar"shift_n"],
   Close
     (qVar"state",
      Apply
     ...
     (qVar"state",
      Let
        (Var("mc",CTy"MachineCode"),
         ...
         Let
           (TP[bVar"b'15",bVar"b'14",bVar"b'13",bVar"b'12",bVar"b'11",
                                 ...
                                 Call
                                   ("ArithLogicImmediate",CTy"Data",
                                    TP[LW(4,4),LF,
                                       Mop
                                         (Cast F4,
                                          EX(Var("h",F16),LN 10,LN 8,
                                             FTy 3)),
                                       ITE
                                         (EQ(EX(Var("h",F16),LN 11,LN 11,
                                                F1),LW(1,1)),LW(13,4),
                                          LW(15,4)),
                                       Mop
                                         (Cast F32,
                           ...
                           TP[Call
                                ("Data",CTy"instruction",
                                 Call
                                   ("ArithLogicImmediate",CTy"Data",
                                    TP[ITE
                                         (EQ(EX(Var("h",F16),LN 7,LN 7,F1),
                                             LW(1,1)),LW(2,4),LW(4,4)),LF,
                                       LW(13,4),LW(13,4),
                                       Mop
                                         (Cast F32,
                                          CC[EX(Var("h",F16),LN 6,LN 0,
                                                FTy 7),LW(0,2)])])),
                              qVar"state"]),
                          (Bop
                             (And,Mop(Not,bVar"b'14"),
                           ...
                           TP[Call
                                ("Media",CTy"instruction",
                                 Call
                                   ("ExtendHalfword",CTy"Media",
                                    TP[EQ(EX(Var("h",F16),LN 7,LN 7,F1),
                                          LW(1,1)),
                                       Mop
                                         (Cast F4,
                           ...
                           Let
                             (Var("Rm",FTy 3),
                              ...
                              Let
                                (Var("Rd",FTy 3),
                                 EX(Var("h",F16),LN 2,LN 0,FTy 3),
                                 TP[CS(EX(Var("h",F16),LN 7,LN 6,FTy 2),
                                       [(LW(0,2),
                                         Call
                                           ("Media",CTy"instruction",
                                            Call
                                 ...
                                 (Var("m",CTy"offset"),
                                  Call
                                    ("immediate_form",CTy"offset",
                                     Mop
                                       (Cast F32,
                                        CC[EX(Var("h",F16),LN 10,LN 6,
                                              FTy 5),LW(0,1)])),
                                  ITE
                                    (EQ(EX(Var("h",F16),LN 11,LN 11,F1),
                                        LW(1,1)),
                                     Call
                                       ("Load",CTy"instruction",
                                        Call
                           ...
                           (Var("Rn",FTy 3),
                            ...
                            TP[Let
                                 (Var("m",CTy"offset"),
                                  ...
                                  CS(EX(Var("h",F16),LN 11,LN 9,FTy 3),
                                     [(LW(0,3),
                                       Call
                                         ("Store",CTy"instruction",
                                          Call
                         ...
                         (TP[Var("shift_t",CTy"SRType"),nVar"shift_n"],
                          Call
                            ("DecodeImmShift",PTy(CTy"SRType",nTy),
                             TP[EX(Var("h",F16),LN 12,LN 11,FTy 2),
                                EX(Var("h",F16),LN 10,LN 6,FTy 5)]),
                          Call
                            ("Data",CTy"instruction",
                             Call
     ...
     (qVar"state",
      Let
        (Var("mc",CTy"MachineCode"),
         ...
         Let
           (TP[TP[bVar"b'31",bVar"b'30",bVar"b'29",bVar"b'28",bVar"b'27",
                   ...
                   (Bop
                    ...
                    Let
                      (Var("option",F4),
                       ...
                       TP[CS(EX(Mop(Snd,Var("h",PTy(F16,F16))),LN 7,LN 4,
                                F4),
                             [(LW(4,4),
                               Call
                                 ("Hint",CTy"instruction",
                   ...
                   (Bop
                    ...
                    TP[Call
                         ("Undefined",CTy"instruction",
                          Mop
                            (Cast F32,
                             CC[EX(Mop(Fst,Var("h",PTy(F16,F16))),LN 3,
                                   LN 0,F4),
                                EX(Mop(Snd,Var("h",PTy(F16,F16))),LN 11,
                            ...
                            (Fst,
                             Apply
                               (Call
                                  ("ConditionPassed",
                                   ATy(qTy,PTy(bTy,qTy)),
                                   EX(Mop(Fst,Var("h",PTy(F16,F16))),LN 9,
                                      LN 6,F4)),qVar"state")),
                          Call
                            ("Branch",CTy"instruction",
                             Call
                               ("BranchTarget",CTy"Branch",
                                Mop
                                  (SE F32,
                                   CC[EX(Mop(Fst,Var("h",PTy(F16,F16))),
                                         LN 10,LN 10,F1),
                                      EX(Mop(Snd,Var("h",PTy(F16,F16))),
                                         LN 11,LN 11,F1),
                                      EX(Mop(Snd,Var("h",PTy(F16,F16))),
                                         LN 13,LN 13,F1),
                                      EX(Mop(Fst,Var("h",PTy(F16,F16))),
                                         LN 5,LN 0,FTy 6),
                                      EX(Mop(Snd,Var("h",PTy(F16,F16))),
                               ...
                               (SE F32,
                                CC[Var("S",F1),
                                   ...
                                   EX(Mop(Snd,Var("h",PTy(F16,F16))),
                                      LN 10,LN 0,FTy 11),LW(0,1)]),
                             ITE
                               (EQ(EX(Mop(Snd,Var("h",PTy(F16,F16))),
