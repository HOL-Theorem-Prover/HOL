(* m0Script.sml - generated by L3 - Wed Apr 27 15:59:59 2016 *)
              ...
              ITE(Bop(And,
                  ...
                  Let(TP[Var("v",F32),Var("s",PTy(F32,PTy(F1,qTy)))],
                      CS(TP[Apply
                            ...
                            Mop(Fst,Mop(Snd,Var("s",PTy(F32,PTy(F1,qTy))))),
                            Mop(Snd,Mop(Snd,Var("s",PTy(F32,PTy(F1,qTy)))))],
...
val dfn'BranchLinkImmediate_def = Def
  ("dfn'BranchLinkImmediate",Var("imm32",F32),
   Close
     (qVar"state",
      Let(Var("v",F32),Apply(Const("PC",ATy(qTy,F32)),qVar"state"),
          Let(qVar"s",
              Apply
                (Call
                   ("BranchWritePC",ATy(qTy,qTy),
                    Bop(Add,
                        Apply
                          (Const("PC",ATy(qTy,F32)),
                           Apply
                             (Call
                                ("write'LR",ATy(qTy,qTy),
                                 CC[EX(Var("v",F32),LN 31,LN 1,FTy 31),
                                    LW(1,1)]),qVar"state")),
                        Var("imm32",F32))),
                 Apply
                   (Call
                      ("write'LR",ATy(qTy,qTy),
                       CC[EX(Var("v",F32),LN 31,LN 1,FTy 31),LW(1,1)]),
                    qVar"state")),
              Rupd
                ("count",
   ...
   Close
     (qVar"state",
      Let(Var("v",F32),
          ...
          Let(nVar"v0",
              Apply
                (Call("BitCount",ATy(qTy,nTy),Var("registers",FTy 9)),
                 qVar"state"),
              Let(Var("s",PTy(F32,qTy)),
                  Mop(Snd,
                      Apply
   ...
   Close
     (qVar"state",
      Let(Var("v",F32),
          ...
          Let(nVar"v0",
              Apply
                (Call("BitCount",ATy(qTy,nTy),Var("registers",F8)),
                 qVar"state"),
              Let(Var("s",PTy(F32,qTy)),
                  Mop(Snd,
                      Apply
