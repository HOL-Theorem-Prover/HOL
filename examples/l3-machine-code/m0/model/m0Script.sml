(* m0Script.sml - generated by L<3> - Mon Jul 08 14:02:44 2013 *)

open HolKernel boolLib bossLib Import

val () = Import.start "m0"

val _ = Record("PRIMASK",[("'rst",FTy 31),("PM",bTy)])
;

val _ = Record
  ("PSR",
   [("'rst",FTy 21),("C",bTy),("ExceptionNumber",FTy 6),("N",bTy),
    ("T",bTy),("V",bTy),("Z",bTy)])
;

val _ = Record("CONTROL",[("'rst",bTy),("SPSEL",bTy),("nPRIV",bTy)])
;

val _ = Record
  ("AIRCR",
   [("'rst",FTy 13),("ENDIANNESS",bTy),("SYSRESETREQ",bTy),
    ("VECTCLRACTIVE",bTy),("VECTKEY",F16)])
;

val _ = Record
  ("CCR",[("'rst",FTy 30),("STKALIGN",bTy),("UNALIGN_TRP",bTy)])
;

val _ = Record("SHPR2",[("'rst",FTy 30),("PRI_11",FTy 2)])
;

val _ = Record
  ("SHPR3",[("'rst",FTy 28),("PRI_14",FTy 2),("PRI_15",FTy 2)])
;

val _ = Record
  ("IPR",
   [("'rst",FTy 24),("PRI_N0",FTy 2),("PRI_N1",FTy 2),("PRI_N2",FTy 2),
    ("PRI_N3",FTy 2)])
;
...
val _ = Construct
  [("Data",
    [("ArithLogicImmediate",[PTy(F4,PTy(bTy,PTy(F4,PTy(F4,F32))))]),
     ...
     ("Register",
      [PTy(F4,PTy(bTy,PTy(F4,PTy(F4,PTy(F4,PTy(CTy"SRType",nTy))))))]),
     ("ShiftImmediate",
      [PTy(bTy,PTy(bTy,PTy(F4,PTy(F4,PTy(CTy"SRType",nTy)))))]),
     ("ShiftRegister",[PTy(F4,PTy(F4,PTy(CTy"SRType",F4)))]),
     ("TestCompareRegister",
      [PTy(FTy 2,PTy(F4,PTy(F4,PTy(CTy"SRType",nTy))))])])]
;
...
val reg'PRIMASK_def = Def
  ("reg'PRIMASK",Var("x",CTy"PRIMASK"),
   CS
     (Var("x",CTy"PRIMASK"),
      [(Rec(CTy"PRIMASK",[Var("'rst",FTy 31),bVar"PM"]),
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("'rst",FTy 31),LN 30)),
                  (EQ(nVar"i",LN 30),Bop(Bit,Var("'rst",FTy 31),LN 29)),
                  (EQ(nVar"i",LN 29),Bop(Bit,Var("'rst",FTy 31),LN 28)),
                  (EQ(nVar"i",LN 28),Bop(Bit,Var("'rst",FTy 31),LN 27)),
                  (EQ(nVar"i",LN 27),Bop(Bit,Var("'rst",FTy 31),LN 26)),
                  (EQ(nVar"i",LN 26),Bop(Bit,Var("'rst",FTy 31),LN 25)),
                  (EQ(nVar"i",LN 25),Bop(Bit,Var("'rst",FTy 31),LN 24)),
                  (EQ(nVar"i",LN 24),Bop(Bit,Var("'rst",FTy 31),LN 23)),
                  (EQ(nVar"i",LN 23),Bop(Bit,Var("'rst",FTy 31),LN 22)),
                  (EQ(nVar"i",LN 22),Bop(Bit,Var("'rst",FTy 31),LN 21)),
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("'rst",FTy 31),LN 20)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("'rst",FTy 31),LN 19)),
                  (EQ(nVar"i",LN 19),Bop(Bit,Var("'rst",FTy 31),LN 18)),
                  (EQ(nVar"i",LN 18),Bop(Bit,Var("'rst",FTy 31),LN 17)),
                  (EQ(nVar"i",LN 17),Bop(Bit,Var("'rst",FTy 31),LN 16)),
                  (EQ(nVar"i",LN 16),Bop(Bit,Var("'rst",FTy 31),LN 15)),
                  (EQ(nVar"i",LN 15),Bop(Bit,Var("'rst",FTy 31),LN 14)),
                  (EQ(nVar"i",LN 14),Bop(Bit,Var("'rst",FTy 31),LN 13)),
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("'rst",FTy 31),LN 12)),
                  (EQ(nVar"i",LN 12),Bop(Bit,Var("'rst",FTy 31),LN 11)),
                  (EQ(nVar"i",LN 11),Bop(Bit,Var("'rst",FTy 31),LN 10)),
                  (EQ(nVar"i",LN 10),Bop(Bit,Var("'rst",FTy 31),LN 9)),
                  (EQ(nVar"i",LN 9),Bop(Bit,Var("'rst",FTy 31),LN 8)),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("'rst",FTy 31),LN 7)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("'rst",FTy 31),LN 6)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("'rst",FTy 31),LN 5)),
                  (EQ(nVar"i",LN 5),Bop(Bit,Var("'rst",FTy 31),LN 4)),
                  (EQ(nVar"i",LN 4),Bop(Bit,Var("'rst",FTy 31),LN 3)),
                  (EQ(nVar"i",LN 3),Bop(Bit,Var("'rst",FTy 31),LN 2)),
                  (EQ(nVar"i",LN 2),Bop(Bit,Var("'rst",FTy 31),LN 1)),
                  (EQ(nVar"i",LN 1),Bop(Bit,Var("'rst",FTy 31),LN 0))],
                 bVar"PM")),LW(0,32)))]))
;
...
val rec'PRIMASK_def = Def
  ("rec'PRIMASK",Var("x",F32),
   Rec
     (CTy"PRIMASK",
      [EX(Var("x",F32),LN 31,LN 1,FTy 31),Bop(Bit,Var("x",F32),LN 0)]))
;
  ...
  ("reg'PSR",Var("x",CTy"PSR"),
   CS
     (Var("x",CTy"PSR"),
      [(Rec
          (CTy"PSR",
           [Var("'rst",FTy 21),bVar"C",Var("ExceptionNumber",FTy 6),
            bVar"N",bVar"T",bVar"V",bVar"Z"]),
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),bVar"N"),(EQ(nVar"i",LN 30),bVar"Z"),
                  (EQ(nVar"i",LN 29),bVar"C"),(EQ(nVar"i",LN 28),bVar"V"),
                  (EQ(nVar"i",LN 27),Bop(Bit,Var("'rst",FTy 21),LN 2)),
                  (EQ(nVar"i",LN 26),Bop(Bit,Var("'rst",FTy 21),LN 1)),
                  (EQ(nVar"i",LN 25),Bop(Bit,Var("'rst",FTy 21),LN 0)),
                  (EQ(nVar"i",LN 24),bVar"T"),
                  (EQ(nVar"i",LN 23),Bop(Bit,Var("'rst",FTy 21),LN 20)),
                  (EQ(nVar"i",LN 22),Bop(Bit,Var("'rst",FTy 21),LN 19)),
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("'rst",FTy 21),LN 18)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("'rst",FTy 21),LN 17)),
                  (EQ(nVar"i",LN 19),Bop(Bit,Var("'rst",FTy 21),LN 16)),
                  (EQ(nVar"i",LN 18),Bop(Bit,Var("'rst",FTy 21),LN 15)),
                  (EQ(nVar"i",LN 17),Bop(Bit,Var("'rst",FTy 21),LN 14)),
                  (EQ(nVar"i",LN 16),Bop(Bit,Var("'rst",FTy 21),LN 13)),
                  (EQ(nVar"i",LN 15),Bop(Bit,Var("'rst",FTy 21),LN 12)),
                  (EQ(nVar"i",LN 14),Bop(Bit,Var("'rst",FTy 21),LN 11)),
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("'rst",FTy 21),LN 10)),
                  (EQ(nVar"i",LN 12),Bop(Bit,Var("'rst",FTy 21),LN 9)),
                  (EQ(nVar"i",LN 11),Bop(Bit,Var("'rst",FTy 21),LN 8)),
                  (EQ(nVar"i",LN 10),Bop(Bit,Var("'rst",FTy 21),LN 7)),
                  (EQ(nVar"i",LN 9),Bop(Bit,Var("'rst",FTy 21),LN 6)),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("'rst",FTy 21),LN 5)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("'rst",FTy 21),LN 4)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("'rst",FTy 21),LN 3)),
                  (EQ(nVar"i",LN 5),
   ...
   Rec
     (CTy"PSR",
      [CC[EX(Var("x",F32),LN 23,LN 6,FTy 18),
          EX(Var("x",F32),LN 27,LN 25,FTy 3)],Bop(Bit,Var("x",F32),LN 29),
       EX(Var("x",F32),LN 5,LN 0,FTy 6),Bop(Bit,Var("x",F32),LN 31),
       Bop(Bit,Var("x",F32),LN 24),Bop(Bit,Var("x",F32),LN 28),
...
val rec'CONTROL_def = Def
  ("rec'CONTROL",Var("x",FTy 3),
   Rec
     (CTy"CONTROL",
      [Bop(Bit,Var("x",FTy 3),LN 2),Bop(Bit,Var("x",FTy 3),LN 1),
...
val reg'CONTROL_def = Def
  ("reg'CONTROL",Var("x",CTy"CONTROL"),
   CS
     (Var("x",CTy"CONTROL"),
      [(Rec(CTy"CONTROL",[bVar"'rst",bVar"SPSEL",bVar"nPRIV"]),
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 2),bVar"'rst"),
  ...
  ("reg'AIRCR",Var("x",CTy"AIRCR"),
   CS
     (Var("x",CTy"AIRCR"),
      [(Rec
          (CTy"AIRCR",
           [Var("'rst",FTy 13),bVar"ENDIANNESS",bVar"SYSRESETREQ",
            bVar"VECTCLRACTIVE",Var("VECTKEY",F16)]),
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("VECTKEY",F16),LN 15)),
                  ...
                  (EQ(nVar"i",LN 14),Bop(Bit,Var("'rst",FTy 13),LN 11)),
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("'rst",FTy 13),LN 10)),
                  (EQ(nVar"i",LN 12),Bop(Bit,Var("'rst",FTy 13),LN 9)),
                  (EQ(nVar"i",LN 11),Bop(Bit,Var("'rst",FTy 13),LN 8)),
                  (EQ(nVar"i",LN 10),Bop(Bit,Var("'rst",FTy 13),LN 7)),
                  (EQ(nVar"i",LN 9),Bop(Bit,Var("'rst",FTy 13),LN 6)),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("'rst",FTy 13),LN 5)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("'rst",FTy 13),LN 4)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("'rst",FTy 13),LN 3)),
                  (EQ(nVar"i",LN 5),Bop(Bit,Var("'rst",FTy 13),LN 2)),
                  (EQ(nVar"i",LN 4),Bop(Bit,Var("'rst",FTy 13),LN 1)),
                  (EQ(nVar"i",LN 3),Bop(Bit,Var("'rst",FTy 13),LN 0)),
                  (EQ(nVar"i",LN 2),bVar"SYSRESETREQ"),
                  (EQ(nVar"i",LN 1),bVar"VECTCLRACTIVE")],
                 Bop(Bit,Var("'rst",FTy 13),LN 12))),LW(0,32)))]))
;
...
val rec'AIRCR_def = Def
  ("rec'AIRCR",Var("x",F32),
   Rec
     (CTy"AIRCR",
      [CC[EX(Var("x",F32),LN 0,LN 0,F1),EX(Var("x",F32),LN 14,LN 3,FTy 12)],
   ...
   Rec
     (CTy"CCR",
      [CC[EX(Var("x",F32),LN 2,LN 0,FTy 3),
          ...
          EX(Var("x",F32),LN 31,LN 10,FTy 22)],Bop(Bit,Var("x",F32),LN 9),
       Bop(Bit,Var("x",F32),LN 3)]))
;
...
val reg'CCR_def = Def
  ("reg'CCR",Var("x",CTy"CCR"),
   CS
     (Var("x",CTy"CCR"),
      [(Rec
          (CTy"CCR",[Var("'rst",FTy 30),bVar"STKALIGN",bVar"UNALIGN_TRP"]),
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("'rst",FTy 30),LN 21)),
                  (EQ(nVar"i",LN 30),Bop(Bit,Var("'rst",FTy 30),LN 20)),
                  (EQ(nVar"i",LN 29),Bop(Bit,Var("'rst",FTy 30),LN 19)),
                  (EQ(nVar"i",LN 28),Bop(Bit,Var("'rst",FTy 30),LN 18)),
                  (EQ(nVar"i",LN 27),Bop(Bit,Var("'rst",FTy 30),LN 17)),
                  (EQ(nVar"i",LN 26),Bop(Bit,Var("'rst",FTy 30),LN 16)),
                  (EQ(nVar"i",LN 25),Bop(Bit,Var("'rst",FTy 30),LN 15)),
                  (EQ(nVar"i",LN 24),Bop(Bit,Var("'rst",FTy 30),LN 14)),
                  (EQ(nVar"i",LN 23),Bop(Bit,Var("'rst",FTy 30),LN 13)),
                  (EQ(nVar"i",LN 22),Bop(Bit,Var("'rst",FTy 30),LN 12)),
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("'rst",FTy 30),LN 11)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("'rst",FTy 30),LN 10)),
                  (EQ(nVar"i",LN 19),Bop(Bit,Var("'rst",FTy 30),LN 9)),
                  (EQ(nVar"i",LN 18),Bop(Bit,Var("'rst",FTy 30),LN 8)),
                  (EQ(nVar"i",LN 17),Bop(Bit,Var("'rst",FTy 30),LN 7)),
                  (EQ(nVar"i",LN 16),Bop(Bit,Var("'rst",FTy 30),LN 6)),
                  (EQ(nVar"i",LN 15),Bop(Bit,Var("'rst",FTy 30),LN 5)),
                  (EQ(nVar"i",LN 14),Bop(Bit,Var("'rst",FTy 30),LN 4)),
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("'rst",FTy 30),LN 3)),
                  (EQ(nVar"i",LN 12),Bop(Bit,Var("'rst",FTy 30),LN 2)),
                  (EQ(nVar"i",LN 11),Bop(Bit,Var("'rst",FTy 30),LN 1)),
                  (EQ(nVar"i",LN 10),Bop(Bit,Var("'rst",FTy 30),LN 0)),
                  (EQ(nVar"i",LN 9),bVar"STKALIGN"),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("'rst",FTy 30),LN 26)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("'rst",FTy 30),LN 25)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("'rst",FTy 30),LN 24)),
                  (EQ(nVar"i",LN 5),Bop(Bit,Var("'rst",FTy 30),LN 23)),
                  (EQ(nVar"i",LN 4),Bop(Bit,Var("'rst",FTy 30),LN 22)),
                  (EQ(nVar"i",LN 3),bVar"UNALIGN_TRP"),
                  (EQ(nVar"i",LN 2),Bop(Bit,Var("'rst",FTy 30),LN 29)),
                  (EQ(nVar"i",LN 1),Bop(Bit,Var("'rst",FTy 30),LN 28))],
                 Bop(Bit,Var("'rst",FTy 30),LN 27))),LW(0,32)))]))
;
...
val reg'SHPR2_def = Def
  ("reg'SHPR2",Var("x",CTy"SHPR2"),
   CS
     (Var("x",CTy"SHPR2"),
      [(Rec(CTy"SHPR2",[Var("'rst",FTy 30),Var("PRI_11",FTy 2)]),
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("PRI_11",FTy 2),LN 1)),
                  (EQ(nVar"i",LN 30),Bop(Bit,Var("PRI_11",FTy 2),LN 0)),
                  (EQ(nVar"i",LN 29),Bop(Bit,Var("'rst",FTy 30),LN 29)),
                  (EQ(nVar"i",LN 28),Bop(Bit,Var("'rst",FTy 30),LN 28)),
                  (EQ(nVar"i",LN 27),Bop(Bit,Var("'rst",FTy 30),LN 27)),
                  (EQ(nVar"i",LN 26),Bop(Bit,Var("'rst",FTy 30),LN 26)),
                  (EQ(nVar"i",LN 25),Bop(Bit,Var("'rst",FTy 30),LN 25)),
                  (EQ(nVar"i",LN 24),Bop(Bit,Var("'rst",FTy 30),LN 24)),
                  (EQ(nVar"i",LN 23),Bop(Bit,Var("'rst",FTy 30),LN 23)),
                  (EQ(nVar"i",LN 22),Bop(Bit,Var("'rst",FTy 30),LN 22)),
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("'rst",FTy 30),LN 21)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("'rst",FTy 30),LN 20)),
                  (EQ(nVar"i",LN 19),Bop(Bit,Var("'rst",FTy 30),LN 19)),
                  (EQ(nVar"i",LN 18),Bop(Bit,Var("'rst",FTy 30),LN 18)),
                  (EQ(nVar"i",LN 17),Bop(Bit,Var("'rst",FTy 30),LN 17)),
                  (EQ(nVar"i",LN 16),Bop(Bit,Var("'rst",FTy 30),LN 16)),
                  (EQ(nVar"i",LN 15),Bop(Bit,Var("'rst",FTy 30),LN 15)),
                  (EQ(nVar"i",LN 14),Bop(Bit,Var("'rst",FTy 30),LN 14)),
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("'rst",FTy 30),LN 13)),
                  (EQ(nVar"i",LN 12),Bop(Bit,Var("'rst",FTy 30),LN 12)),
                  (EQ(nVar"i",LN 11),Bop(Bit,Var("'rst",FTy 30),LN 11)),
                  (EQ(nVar"i",LN 10),Bop(Bit,Var("'rst",FTy 30),LN 10)),
                  (EQ(nVar"i",LN 9),Bop(Bit,Var("'rst",FTy 30),LN 9)),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("'rst",FTy 30),LN 8)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("'rst",FTy 30),LN 7)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("'rst",FTy 30),LN 6)),
                  (EQ(nVar"i",LN 5),Bop(Bit,Var("'rst",FTy 30),LN 5)),
                  (EQ(nVar"i",LN 4),Bop(Bit,Var("'rst",FTy 30),LN 4)),
                  (EQ(nVar"i",LN 3),Bop(Bit,Var("'rst",FTy 30),LN 3)),
                  (EQ(nVar"i",LN 2),Bop(Bit,Var("'rst",FTy 30),LN 2)),
                  (EQ(nVar"i",LN 1),Bop(Bit,Var("'rst",FTy 30),LN 1))],
                 Bop(Bit,Var("'rst",FTy 30),LN 0))),LW(0,32)))]))
;
  ...
  ("reg'SHPR3",Var("x",CTy"SHPR3"),
   CS
     (Var("x",CTy"SHPR3"),
      [(Rec
          (CTy"SHPR3",
           [Var("'rst",FTy 28),Var("PRI_14",FTy 2),Var("PRI_15",FTy 2)]),
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("PRI_15",FTy 2),LN 1)),
                  (EQ(nVar"i",LN 30),Bop(Bit,Var("PRI_15",FTy 2),LN 0)),
                  (EQ(nVar"i",LN 29),Bop(Bit,Var("'rst",FTy 28),LN 5)),
                  (EQ(nVar"i",LN 28),Bop(Bit,Var("'rst",FTy 28),LN 4)),
                  (EQ(nVar"i",LN 27),Bop(Bit,Var("'rst",FTy 28),LN 3)),
                  (EQ(nVar"i",LN 26),Bop(Bit,Var("'rst",FTy 28),LN 2)),
                  (EQ(nVar"i",LN 25),Bop(Bit,Var("'rst",FTy 28),LN 1)),
                  (EQ(nVar"i",LN 24),Bop(Bit,Var("'rst",FTy 28),LN 0)),
                  (EQ(nVar"i",LN 23),Bop(Bit,Var("PRI_14",FTy 2),LN 1)),
                  (EQ(nVar"i",LN 22),Bop(Bit,Var("PRI_14",FTy 2),LN 0)),
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("'rst",FTy 28),LN 27)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("'rst",FTy 28),LN 26)),
                  (EQ(nVar"i",LN 19),Bop(Bit,Var("'rst",FTy 28),LN 25)),
                  (EQ(nVar"i",LN 18),Bop(Bit,Var("'rst",FTy 28),LN 24)),
                  (EQ(nVar"i",LN 17),Bop(Bit,Var("'rst",FTy 28),LN 23)),
                  (EQ(nVar"i",LN 16),Bop(Bit,Var("'rst",FTy 28),LN 22)),
                  (EQ(nVar"i",LN 15),Bop(Bit,Var("'rst",FTy 28),LN 21)),
                  (EQ(nVar"i",LN 14),Bop(Bit,Var("'rst",FTy 28),LN 20)),
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("'rst",FTy 28),LN 19)),
                  (EQ(nVar"i",LN 12),Bop(Bit,Var("'rst",FTy 28),LN 18)),
                  (EQ(nVar"i",LN 11),Bop(Bit,Var("'rst",FTy 28),LN 17)),
                  (EQ(nVar"i",LN 10),Bop(Bit,Var("'rst",FTy 28),LN 16)),
                  (EQ(nVar"i",LN 9),Bop(Bit,Var("'rst",FTy 28),LN 15)),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("'rst",FTy 28),LN 14)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("'rst",FTy 28),LN 13)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("'rst",FTy 28),LN 12)),
                  (EQ(nVar"i",LN 5),Bop(Bit,Var("'rst",FTy 28),LN 11)),
                  (EQ(nVar"i",LN 4),Bop(Bit,Var("'rst",FTy 28),LN 10)),
                  (EQ(nVar"i",LN 3),Bop(Bit,Var("'rst",FTy 28),LN 9)),
                  (EQ(nVar"i",LN 2),Bop(Bit,Var("'rst",FTy 28),LN 8)),
                  (EQ(nVar"i",LN 1),Bop(Bit,Var("'rst",FTy 28),LN 7))],
                 Bop(Bit,Var("'rst",FTy 28),LN 6))),LW(0,32)))]))
;
  ...
  ("reg'IPR",Var("x",CTy"IPR"),
   CS
     (Var("x",CTy"IPR"),
      [(Rec
          (CTy"IPR",
           [Var("'rst",FTy 24),Var("PRI_N0",FTy 2),Var("PRI_N1",FTy 2),
            Var("PRI_N2",FTy 2),Var("PRI_N3",FTy 2)]),
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 31),Bop(Bit,Var("PRI_N3",FTy 2),LN 1)),
                  (EQ(nVar"i",LN 30),Bop(Bit,Var("PRI_N3",FTy 2),LN 0)),
                  (EQ(nVar"i",LN 29),Bop(Bit,Var("'rst",FTy 24),LN 5)),
                  (EQ(nVar"i",LN 28),Bop(Bit,Var("'rst",FTy 24),LN 4)),
                  (EQ(nVar"i",LN 27),Bop(Bit,Var("'rst",FTy 24),LN 3)),
                  (EQ(nVar"i",LN 26),Bop(Bit,Var("'rst",FTy 24),LN 2)),
                  (EQ(nVar"i",LN 25),Bop(Bit,Var("'rst",FTy 24),LN 1)),
                  (EQ(nVar"i",LN 24),Bop(Bit,Var("'rst",FTy 24),LN 0)),
                  (EQ(nVar"i",LN 23),Bop(Bit,Var("PRI_N2",FTy 2),LN 1)),
                  (EQ(nVar"i",LN 22),Bop(Bit,Var("PRI_N2",FTy 2),LN 0)),
                  (EQ(nVar"i",LN 21),Bop(Bit,Var("'rst",FTy 24),LN 11)),
                  (EQ(nVar"i",LN 20),Bop(Bit,Var("'rst",FTy 24),LN 10)),
                  (EQ(nVar"i",LN 19),Bop(Bit,Var("'rst",FTy 24),LN 9)),
                  (EQ(nVar"i",LN 18),Bop(Bit,Var("'rst",FTy 24),LN 8)),
                  (EQ(nVar"i",LN 17),Bop(Bit,Var("'rst",FTy 24),LN 7)),
                  (EQ(nVar"i",LN 16),Bop(Bit,Var("'rst",FTy 24),LN 6)),
                  (EQ(nVar"i",LN 15),Bop(Bit,Var("PRI_N1",FTy 2),LN 1)),
                  (EQ(nVar"i",LN 14),Bop(Bit,Var("PRI_N1",FTy 2),LN 0)),
                  (EQ(nVar"i",LN 13),Bop(Bit,Var("'rst",FTy 24),LN 17)),
                  (EQ(nVar"i",LN 12),Bop(Bit,Var("'rst",FTy 24),LN 16)),
                  (EQ(nVar"i",LN 11),Bop(Bit,Var("'rst",FTy 24),LN 15)),
                  (EQ(nVar"i",LN 10),Bop(Bit,Var("'rst",FTy 24),LN 14)),
                  (EQ(nVar"i",LN 9),Bop(Bit,Var("'rst",FTy 24),LN 13)),
                  (EQ(nVar"i",LN 8),Bop(Bit,Var("'rst",FTy 24),LN 12)),
                  (EQ(nVar"i",LN 7),Bop(Bit,Var("PRI_N0",FTy 2),LN 1)),
                  (EQ(nVar"i",LN 6),Bop(Bit,Var("PRI_N0",FTy 2),LN 0)),
                  (EQ(nVar"i",LN 5),Bop(Bit,Var("'rst",FTy 24),LN 23)),
                  (EQ(nVar"i",LN 4),Bop(Bit,Var("'rst",FTy 24),LN 22)),
                  (EQ(nVar"i",LN 3),Bop(Bit,Var("'rst",FTy 24),LN 21)),
                  (EQ(nVar"i",LN 2),Bop(Bit,Var("'rst",FTy 24),LN 20)),
                  (EQ(nVar"i",LN 1),Bop(Bit,Var("'rst",FTy 24),LN 19))],
                 Bop(Bit,Var("'rst",FTy 24),LN 18))),LW(0,32)))]))
;
   ...
   Close
     (qVar"state",
      Let
        (TP[bVar"v",qVar"s"],
         CS
           (EX(Var("cond",F4),LN 3,LN 1,FTy 3),
            [(LW(0,3),
              TP
             ...
             (LW(2,3),
              TP
                [Dest("N",bTy,Dest("PSR",CTy"PSR",qVar"state")),
                 qVar"state"]),
             (LW(3,3),
              TP
             ...
             (LW(4,3),
              TP
                [Bop
                   (And,Dest("C",bTy,Dest("PSR",CTy"PSR",qVar"state")),
                    Mop
                      (Not,Dest("Z",bTy,Dest("PSR",CTy"PSR",qVar"state")))),
                 qVar"state"]),
             (LW(5,3),
              TP
                [EQ
     ...
     (qVar"state",
      TP
        [Bop
           (Or,
            EQ
              (Dest("CurrentMode",CTy"Mode",qVar"state"),
  ...
  ("LookUpSP",AVar uTy,
   Close
     (qVar"state",
      TP
        [ITE
           (Dest("SPSEL",bTy,Dest("CONTROL",CTy"CONTROL",qVar"state")),
...
val SP_def = Def
  ("SP",qVar"state",
   TP
     [Mop(Fst,Apply(Call("R",ATy(qTy,PTy(F32,qTy)),LW(13,4)),qVar"state")),
      qVar"state"])
;
...
val LR_def = Def
  ("LR",qVar"state",
   TP
     [Mop(Fst,Apply(Call("R",ATy(qTy,PTy(F32,qTy)),LW(14,4)),qVar"state")),
      qVar"state"])
;
...
val PC_def = Def
  ("PC",qVar"state",
   TP
     [Mop(Fst,Apply(Call("R",ATy(qTy,PTy(F32,qTy)),LW(15,4)),qVar"state")),
      qVar"state"])
;
                       ...
                       TP
                         [qVar"s",
                          Fupd
                            (Dest("MEM",ATy(F32,F8),qVar"s"),
                             Bop(Add,Var("address",F32),LW(2,32)),
                             Mop(Cast F8,EX(vVar"value",LN 23,LN 16,vTy)))]),
                    TP
                      [LU,
                       Rupd
                         ("MEM",
      ...
      CS
        (nVar"n",
         [(LN 1,TP[EX(vVar"value",LN 7,LN 0,vTy),qVar"state"]),
          (LN 2,
           TP
             [CC[EX(vVar"value",LN 7,LN 0,vTy),
...
val MemA_def = Def
  ("MemA",TP[Var("address",F32),nVar"size"],
   Close
     (qVar"state",
      ITE
        (Mop(Not,Call("Aligned",bTy,TP[Var("address",F32),nVar"size"])),
         TP
           [LX(BTy"N"),
            Mop
              (Snd,
         ...
         Let
           (TP[vVar"v",qVar"s"],
            ...
            Let
              (TP[vVar"v",qVar"s"],
               ITE
                 (Dest("ENDIANNESS",bTy,Dest("AIRCR",CTy"AIRCR",qVar"s")),
                  Apply
                    (Call
         ...
         Apply
           (Call
              ("Raise",ATy(qTy,PTy(uTy,qTy)),
               Const("HardFault",CTy"ARM_Exception")),qVar"state"),
         Let
           (TP[Var("v",PTy(vTy,PTy(F32,nTy))),qVar"s"],
            Let
              (TP[vVar"v",qVar"s"],
               ITE
                 (Dest
                  ...
                  Apply
                    (Call
                       ("BigEndianReverse",ATy(qTy,PTy(vTy,qTy)),
                        TP[Mop(Cast vTy,Var("value",BTy"N")),nVar"size"]),
                     qVar"state"),
...
val TakeReset_def = Def
  ("TakeReset",AVar uTy,
   Close
     (qVar"state",
      Let
        (Var("v",F32),Dest("VTOR",F32,qVar"state"),
         Let
           (TP[Var("v0",F32),qVar"s"],
            Apply
                       ...
                       (Call("write'LR",ATy(qTy,PTy(uTy,qTy)),LX F32),
                        Mop
                          (Snd,
                           Apply
                             (Call
                                ("write'SP_process",ATy(qTy,PTy(uTy,qTy)),
                                 CC[LX(FTy 30),LW(0,2)]),
                              Mop
                                (Snd,
                                 Apply
                           ...
                           TP
                             [qVar"s",
                              Rupd
                                ("PM",
                                 TP
                                   [Dest("PRIMASK",CTy"PRIMASK",qVar"s"),
                                    LF])]),
                        Let
                          (qVar"s",
                           Rupd
...
val ExceptionPriority_def = Def
  ("ExceptionPriority",nVar"n",
   Close
     (qVar"state",
      ITB
        ([(EQ(nVar"n",LN 2),TP[Mop(Neg,LI 2),qVar"state"]),
          ...
          (Bop(Ge,nVar"n",LN 16),
           Let
             (Var("v",CTy"IPR"),
              ...
              TP
                [CS
                   (Mop(Cast(FTy 2),Bop(Mod,nVar"n",LN 4)),
                    [(LW(0,2),
...
val ExecutionPriority_def = Def
  ("ExecutionPriority",AVar uTy,
   Close
     (qVar"state",
      Let
        (TP[iVar"r",Var("s1",PTy(iTy,qTy))],
         Let
           (TP[iVar"r",Var("s1",PTy(iTy,PTy(iTy,qTy)))],
            Let
                 ...
                 (Var("s",PTy(iTy,PTy(iTy,qTy))),
                  ...
                  TP
                    [Mop
                       (Min,
                        TP
                          [Mop(Fst,Var("s",PTy(iTy,PTy(iTy,qTy)))),
                           Mop
                             (Fst,Mop(Snd,Var("s",PTy(iTy,PTy(iTy,qTy)))))]),
                     Var("s",PTy(iTy,PTy(iTy,qTy)))])),
...
val ReturnAddress_def = Def
  ("ReturnAddress",AVar uTy,
   Close
     (qVar"state",
      TP
        [Mop(Fst,Apply(Const("PC",ATy(qTy,PTy(F32,qTy))),qVar"state")),
         qVar"state"]))
;
   ...
   Close
     (qVar"state",
      TP
        [LU,
         Let
           (Var("s",PTy(F32,PTy(F1,qTy))),TP[LX F32,LX F1,qVar"state"],
            Let
              (Var("s",PTy(F32,PTy(F1,qTy))),
               ITE
                 (Bop
                  ...
                  Let
                    (TP[Var("v",F32),Var("s",PTy(F32,PTy(F1,qTy)))],
                     CS
                       (Let
               ...
               Let
                 (Var("s",PTy(F32,PTy(F1,qTy))),
                  Let
                    (TP[Var("v0",F32),Var("s0",PTy(F32,PTy(F1,qTy)))],
                     CS
                       (Let
                          (TP[Var("v",F32),qVar"s3"],
                           TP
                        ...
                        [(TP[Var("v",F32),Var("s3",PTy(F1,qTy))],
                          TP
                            [Var("v",F32),
                             ...
                             Var("s3",PTy(F1,qTy))])]),
                     TP
                       [Mop(Fst,Var("s0",PTy(F32,PTy(F1,qTy)))),
                     ...
                     Let
                       (TP[Var("v0",F32),Var("s0",PTy(F32,PTy(F1,qTy)))],
                        ...
                        TP
                          [Mop(Fst,Var("s0",PTy(F32,PTy(F1,qTy)))),
                           Mop
                             (Fst,Mop(Snd,Var("s0",PTy(F32,PTy(F1,qTy))))),
                           Mop
                             (Snd,
                              Apply
                                (Call
                                 ...
                                 Mop
                                   (Snd,
                                    Mop
                                      (Snd,Var("s0",PTy(F32,PTy(F1,qTy)))))))]),
                     Let
                       (Var("s",PTy(F32,PTy(F1,qTy))),
                        Let
                          (TP
                             [Var("v0",F32),Var("s0",PTy(F32,PTy(F1,qTy)))],
                           CS
                             (Let
                                (TP[Var("v",F32),qVar"s3"],
                                 TP
         ...
         Apply
           (Call
              ("MemA",ATy(qTy,PTy(F32,qTy)),
               TP
                 [Bop
                    (Add,Dest("VTOR",F32,qVar"state"),
                     Bop
                       (Mul,LW(4,32),
                        Mop(Cast F32,Var("ExceptionNumber",FTy 6)))),LN 4]),
            Mop
              (Snd,
               Apply
                 (Call
...
val ExceptionEntry_def = Def
  ("ExceptionEntry",AVar uTy,
   Close
     (qVar"state",
      CS
        (Dest("pending",OTy(CTy"ARM_Exception"),qVar"state"),
      ...
      Let
        (TP[Var("v",F32),qVar"s"],
         Apply
           (Call
              ("MemA",ATy(qTy,PTy(F32,qTy)),
               TP[Bop(Add,Var("frameptr",F32),LW(20,32)),LN 4]),
            Let
              (TP[Var("v",F32),qVar"s"],
               Apply
                 (Call
                    ("MemA",ATy(qTy,PTy(F32,qTy)),
                     TP[Bop(Add,Var("frameptr",F32),LW(16,32)),LN 4]),
                  Let
                    (TP[Var("v",F32),qVar"s"],
                     Apply
                       (Call
                          ...
                          (TP[Var("v",F32),qVar"s"],
                           Apply
                             (Call
                                ("MemA",ATy(qTy,PTy(F32,qTy)),
                                 TP
                                   [Bop(Add,Var("frameptr",F32),LW(8,32)),
                                    LN 4]),
                              Let
                                (TP[Var("v",F32),qVar"s"],
                                 Apply
         ...
         Let
           (TP[Var("v",F32),qVar"s"],
            Apply
              (Call
                 ("MemA",ATy(qTy,PTy(F32,qTy)),
                  TP[Bop(Add,Var("frameptr",F32),LW(24,32)),LN 4]),
               Mop
                 (Snd,
                  Apply
                    (Call("write'LR",ATy(qTy,PTy(uTy,qTy)),Var("v",F32)),
                     qVar"s"))),
            Let
              (TP[Var("v",F32),qVar"s"],
               Apply
                 (Call
                    ("MemA",ATy(qTy,PTy(F32,qTy)),
                     TP[Bop(Add,Var("frameptr",F32),LW(28,32)),LN 4]),
                  Mop
                    (Snd,
                     Apply
                       (Call
                          ("write'PC",ATy(qTy,PTy(uTy,qTy)),Var("v",F32)),
                        qVar"s"))),
               Let
                 (Var("spmask",F32),
                  Mop(Cast F32,CC[EX(Var("v",F32),LN 9,LN 9,F1),LW(0,2)]),
                  Let
                    (qVar"s",
                     Let
                       (TP[bVar"b'3",bVar"b'2",bVar"b'1",bVar"b'0"],
                        BL(4,EX(Var("EXC_RETURN",FTy 28),LN 3,LN 0,F4)),
                        ITE
                          (Bop(And,Mop(Not,bVar"b'1"),bVar"b'0"),
                           ITB
                             ([(Mop(Not,bVar"b'2"),
                              ...
                              qVar"s"),qVar"s")),
                     Let
                       (Var("v0",CTy"PSR"),Dest("PSR",CTy"PSR",qVar"s"),
                        Let
                          (qVar"s",
                           Rupd
                             ("PSR",
        ...
        (qVar"s",
         ...
         Let
           (qVar"s",
            ...
            Let
              (Var("v",FTy 6),
               Dest("ExceptionNumber",FTy 6,Dest("PSR",CTy"PSR",qVar"s")),
               Let
                 (TP[nVar"v0",qVar"s"],
                  Apply
                    (Call
                       ("ExceptionActiveBitCount",ATy(qTy,PTy(nTy,qTy)),
                        LU),qVar"s"),
                  ITE
                    (Mop
                       (Not,
                        Apply
                          (Dest("ExceptionActive",ATy(FTy 6,bTy),qVar"s"),
                           Var("v",FTy 6))),
                     Apply
                       (Call
                          ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                     ...
                     TP
                       [LU,
                        Let
                          (Var("s",PTy(F32,qTy)),
                           CS
                             (EX(Var("EXC_RETURN",FTy 28),LN 3,LN 0,F4),
                              [(LW(1,4),
                                ITE
                                  (EQ(nVar"v0",LN 1),
                                   TP
...
val HighestSetBit_def = Def
  ("HighestSetBit",Var("w",BTy"N"),
   ITE
     (EQ(Var("w",BTy"N"),LY(0,"N")),Mop(Neg,LI 1),
...
val CountLeadingZeroBits_def = Def
  ("CountLeadingZeroBits",Var("w",BTy"N"),
   Mop
     (Cast nTy,
      Bop
        (Sub,Bop(Sub,Mop(Cast iTy,Mop(Size,LY(0,"N"))),LI 1),
            ...
            Mop
              (Snd,
               Apply
                 (For
                    (TP
                       [LN 0,Bop(Sub,Mop(Size,LY(0,"N")),LN 1),
                        Close
                          (nVar"i",
                           Close
                             (Var("state",PTy(nTy,qTy)),
...
val SignExtendFrom_def = Def
  ("SignExtendFrom",TP[Var("w",BTy"N"),nVar"p"],
   Let
     (nVar"s",Bop(Sub,Mop(Size,LY(0,"N")),nVar"p"),
...
val Extend_def = Def
  ("Extend",TP[bVar"unsigned",Var("w",BTy"M")],
   ITE
     (bVar"unsigned",Mop(Cast(BTy"N"),Var("w",BTy"M")),
            ...
            Bop
              (Bit,
               CC[Mop(Cast vTy,Var("x",BTy"N")),
                  Bop(Rep,LL[LF],nVar"shift")],Mop(Size,LY(0,"N")))],
         ITE
           (EQ(nVar"shift",LN 0),
            Mop
              (Snd,
               Apply
                 (Call
                    ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                     Call("ASSERT",CTy"exception",LS"LSL_C")),qVar"state")),
            qVar"state")]))
;
...
val LSL_def = Def
  ("LSL",TP[Var("x",BTy"N"),nVar"shift"],
   Close
     (qVar"state",
      ITE
        (EQ(nVar"shift",LN 0),TP[Var("x",BTy"N"),qVar"state"],
         Let
           (TP[Var("v",PTy(BTy"N",bTy)),qVar"s"],
            Apply
              (Call
      ...
      TP
        [TP
           [Bop(Lsr,Var("x",BTy"N"),nVar"shift"),
            Bop
              (And,Bop(Le,nVar"shift",Mop(Size,LY(0,"N"))),
            ...
            Mop
              (Snd,
               Apply
                 (Call
                    ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                     Call("ASSERT",CTy"exception",LS"LSR_C")),qVar"state")),
            qVar"state")]))
;
            ...
            Mop
              (Snd,
               Apply
                 (Call
                    ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                     Call("ASSERT",CTy"exception",LS"ASR_C")),qVar"state")),
            qVar"state")]))
;
  ...
  ("ROR_C",TP[Var("x",BTy"N"),nVar"shift"],
   Close
     (qVar"state",
      TP
        [Let
           (Var("result",BTy"N"),Bop(Ror,Var("x",BTy"N"),nVar"shift"),
            ...
            Mop
              (Snd,
               Apply
                 (Call
                    ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                     Call("ASSERT",CTy"exception",LS"ROR_C")),qVar"state")),
            qVar"state")]))
;
   ...
   CS
     (Var("typ",FTy 2),
      [(LW(0,2),
       ...
       (LW(1,2),
        TP
          [LC("SRType_LSR",CTy"SRType"),
           ITE
             (EQ(Var("imm5",FTy 5),LW(0,5)),LN 32,
       ...
       (LW(3,2),
        ITE
          (EQ(Var("imm5",FTy 5),LW(0,5)),
           TP[LC("SRType_RRX",CTy"SRType"),LN 1],
           TP
             [LC("SRType_ROR",CTy"SRType"),Mop(Cast nTy,Var("imm5",FTy 5))]))]))
;
...
val Shift_C_def = Def
  ("Shift_C",
   TP
     [Var("value",BTy"N"),Var("typ",CTy"SRType"),nVar"amount",
      bVar"carry_in"],
   Close
     (qVar"state",
      ITE
   ...
   Let
     (nVar"unsigned_sum",
      Bop
        (Add,
         Bop
           (Add,Mop(Cast nTy,Var("x",BTy"N")),
            Mop(Cast nTy,Var("y",BTy"N"))),Mop(Cast nTy,bVar"carry_in")),
      Let
        (Var("result",BTy"N"),Mop(Cast(BTy"N"),nVar"unsigned_sum"),
         TP
           [Var("result",BTy"N"),
            Mop
              (Not,
            ...
            Mop
              (Not,
               EQ
                 (Mop(Cast iTy,Var("result",BTy"N")),
                  Bop
                    (Add,
                     Bop
                       (Add,Mop(Cast iTy,Var("x",BTy"N")),
...
val ArithmeticOpcode_def = Def
  ("ArithmeticOpcode",Var("opc",F4),
   Bop
     (And,Bop(Or,Bop(Bit,Var("opc",F4),LN 2),Bop(Bit,Var("opc",F4),LN 1)),
      Mop
        (Not,
                     ...
                     Bop
                       (Add,
                        Mop
                          (Fst,
                           Apply
                             (Const("PC",ATy(qTy,PTy(F32,qTy))),qVar"s")),
                        Var("imm32",F32))),qVar"s")),
            TP
              [LU,
               Rupd
                 ("count",
                                ...
                                (Sub,
                                 Mop
                                   (Fst,
                                    Apply
                                      (Const("PC",ATy(qTy,PTy(F32,qTy))),
                                       qVar"state")),LW(2,32)),LN 31,LN 1,
                              FTy 31),LW(1,1)]),qVar"state")))),
         TP
           [LU,
            Rupd
              ("count",
...
val DataProcessing_def = Def
  ("DataProcessing",
   TP
     [Var("opc",F4),bVar"setflags",Var("d",F4),Var("n",F4),
      Var("imm32",F32),bVar"C"],
   Close
     (qVar"state",
      Let
        (TP[Var("result",F32),bVar"carry",bVar"overflow"],
         Call
           ("DataProcessingALU",PTy(F32,PTy(bTy,bTy)),
            TP
              [Var("opc",F4),
               ITB
                 ([(Bop
                      (Or,EQ(Var("opc",F4),LW(13,4)),
                       EQ(Var("opc",F4),LW(15,4))),LW(0,32)),
                   (Bop
                      (And,
                       Bop
                         (And,Bop(In,Var("opc",F4),SL[LW(4,4),LW(2,4)]),
                          EQ(Var("n",F4),LW(15,4))),
         ...
         Let
           (qVar"s",
            ITE
              (Mop(Not,EQ(EX(Var("opc",F4),LN 3,LN 2,FTy 2),LW(2,2))),
               Mop
                 (Snd,
                  Apply
                    (Call
           ...
           (qVar"s",
            Mop
              (Snd,
               Apply
                 (Call
                    ("ALUWritePC",ATy(qTy,PTy(uTy,qTy)),Var("result",F32)),
                  qVar"state")),
            TP
              [LU,
               Rupd
      ...
      Apply
        (Call
           ("DataProcessing",ATy(qTy,PTy(uTy,qTy)),
            TP
              [LW(13,4),LT,Var("d",F4),LW(15,4),Var("imm32",F32),
               Dest("C",bTy,Dest("PSR",CTy"PSR",qVar"state"))]),
         qVar"state")))
;
     ...
     (qVar"state",
      Apply
        (Call
           ("DataProcessing",ATy(qTy,PTy(uTy,qTy)),
            TP
              [LW(10,4),LT,LX F4,Var("n",F4),Var("imm32",F32),
               Dest("C",bTy,Dest("PSR",CTy"PSR",qVar"state"))]),
         qVar"state")))
;
...
val doRegister_def = Def
  ("doRegister",
   TP
     [Var("opc",F4),bVar"setflags",Var("d",F4),Var("n",F4),Var("m",F4),
      Var("shift_t",CTy"SRType"),nVar"shift_n"],
   Close
     (qVar"state",
      Let
        (TP[Var("v",PTy(F32,bTy)),qVar"s"],
         Apply
           (Call
            ...
            qVar"state"),
         Let
           (TP[Var("shifted",F32),bVar"carry"],Var("v",PTy(F32,bTy)),
            Let
              (bVar"v",
               ITE
                 (Call("ArithmeticOpcode",bTy,Var("opc",F4)),
                  Dest("C",bTy,Dest("PSR",CTy"PSR",qVar"s")),bVar"carry"),
               ITE
                 (EQ(Var("d",F4),LW(15,4)),
                  Apply
                    (Call
                       ("DataProcessingPC",ATy(qTy,PTy(uTy,qTy)),
                        TP
                          [Var("opc",F4),Var("n",F4),Var("shifted",F32),
                           bVar"v"]),qVar"s"),
                  Apply
                    (Call
                       ("DataProcessing",ATy(qTy,PTy(uTy,qTy)),
                        TP
                          [Var("opc",F4),bVar"setflags",Var("d",F4),
...
val dfn'TestCompareRegister_def = Def
  ("dfn'TestCompareRegister",
   TP
     [Var("opc",FTy 2),Var("n",F4),Var("m",F4),Var("shift_t",CTy"SRType"),
      nVar"shift_n"],
   Close
     (qVar"state",
      Apply
        (Call
           ("doRegister",ATy(qTy,PTy(uTy,qTy)),
            TP
              [CC[LW(2,2),Var("opc",FTy 2)],LT,LW(0,4),Var("n",F4),
               Var("m",F4),Var("shift_t",CTy"SRType"),nVar"shift_n"]),
         qVar"state")))
;
...
val dfn'ShiftImmediate_def = Def
  ("dfn'ShiftImmediate",
   TP
     [bVar"negate",bVar"setflags",Var("d",F4),Var("m",F4),
      Var("shift_t",CTy"SRType"),nVar"shift_n"],
   Close
     (qVar"state",
      ITE
        (bVar"negate",
         Apply
           (Call
              ("doRegister",ATy(qTy,PTy(uTy,qTy)),
               TP
                 [LW(15,4),bVar"setflags",Var("d",F4),LW(15,4),
                  Var("m",F4),Var("shift_t",CTy"SRType"),nVar"shift_n"]),
            qVar"state"),
         Apply
           (Call
              ("doRegister",ATy(qTy,PTy(uTy,qTy)),
               TP
                 [LW(13,4),bVar"setflags",Var("d",F4),LX F4,Var("m",F4),
           ...
           (TP[Var("shifted",F32),bVar"carry"],Var("v",PTy(F32,bTy)),
            Apply
              (Call
                 ("DataProcessing",ATy(qTy,PTy(uTy,qTy)),
                  TP
                    [LW(13,4),LT,Var("d",F4),LX F4,Var("shifted",F32),
                     bVar"carry"]),qVar"s")))))
;
                  ...
                  TP
                    [LU,
                     Rupd
                       ("count",
                        TP
                          [qVar"s",Bop(Add,Dest("count",nTy,qVar"s"),LN 1)])]))))))
;
     ...
     (qVar"state",
      Let
        (Var("v",F32),
         Mop
           (Fst,
            Apply(Call("R",ATy(qTy,PTy(F32,qTy)),Var("m",F4)),qVar"state")),
         Let
           (qVar"s",
            Mop
              (Snd,
                   ...
                   ("Shift",ATy(qTy,PTy(F32,qTy)),
                    TP
                      [Mop
                       ...
                       LN 0,Dest("C",bTy,Dest("PSR",CTy"PSR",qVar"state"))]),
                 qVar"state")),
     ...
     (qVar"state",
      Let
        (Var("v",F32),
         Mop
           (Fst,
            Apply(Call("R",ATy(qTy,PTy(F32,qTy)),Var("n",F4)),qVar"state")),
         Let
           (nVar"v0",
            Mop
              (Fst,
                                            ...
                                            [LU,
                                             Bop
                                               (Add,
                                                ...
                                                LW(4,32)),
                                             Mop
                                               (Snd,Var("s",PTy(F32,qTy)))]),
                                       TP[LU,Var("state",PTy(F32,qTy))])))]),
                        TP[Var("v",F32),qVar"state"])),
                  Let
                    (Var("s",PTy(F32,qTy)),
                     ITE
                       (Bop(Bit,Var("registers",FTy 9),LN 8),
                        Let
                          (Var("s",PTy(F32,qTy)),
                           Let
                             (TP[Var("v",F32),Var("s",PTy(F32,qTy))],
                              CS
                                (Apply
                                   (Call
                                      ("MemA",ATy(qTy,PTy(F32,qTy)),
           ...
           (nVar"v0",
            Mop
              (Fst,
               Apply
                 (Call
                    ("BitCount",ATy(qTy,PTy(nTy,qTy)),Var("registers",F8)),
                  qVar"state")),
            TP
              [LU,
               Let
               ...
               Apply
                 (Call
                    ("BitCount",ATy(qTy,PTy(nTy,qTy)),
                     Var("registers",FTy 9)),qVar"state")),
            Let
              (Var("length",F32),Bop(Mul,LW(4,32),Mop(Cast F32,nVar"v0")),
               TP
                 [LU,
                  Let
                    (Var("s",PTy(F32,qTy)),
                     ...
                     TP
                       [qVar"state",
                        Rupd
                          ("PM",
                           TP
                             [Dest("PRIMASK",CTy"PRIMASK",qVar"state"),
                              bVar"im"])]),qVar"state"))),
         TP
           [LU,
            Rupd
            ...
            Mop
              (Snd,
               Apply
                 (Call("IncPC",ATy(qTy,PTy(uTy,qTy)),LU),
                  CS
                    (EX(Var("SYSm",F8),LN 7,LN 3,FTy 5),
                     [(LW(0,5),
                       Let
                         (qVar"s",
                          ITE
                            (Bop(Bit,Var("SYSm",F8),LN 0),
                             Mop
                               (Snd,
                                Apply
                                  (Call
                            ...
                            (qVar"s",
                             ITE
                               (Bop(Bit,Var("SYSm",F8),LN 1),
                                ...
                                qVar"s"),
                             ITE
                               (Mop(Not,Bop(Bit,Var("SYSm",F8),LN 2)),
                                Mop
                                  (Snd,
                                   Apply
                                     (Call
                      ...
                      (LW(1,5),
                       CS
                         (EX(Var("SYSm",F8),LN 2,LN 0,FTy 3),
                          [(LW(0,3),
                            Mop
                              (Snd,
                               Apply
   ...
   Close
     (qVar"state",
      Let
        (qVar"s",
         Mop
           (Snd,Apply(Call("IncPC",ATy(qTy,PTy(uTy,qTy)),LU),qVar"state")),
         TP
           [LU,
            Rupd
              ("count",
                     ...
                     ("v10",
                      PTy
                        (F4,
                         PTy
                           (bTy,
                            PTy(F4,PTy(F4,PTy(F4,PTy(CTy"SRType",nTy)))))))),
                Apply
                  (Call
                         ...
                         PTy
                           (F4,
                            PTy
                              (bTy,
                               PTy
                                 (F4,PTy(F4,PTy(F4,PTy(CTy"SRType",nTy)))))))),
                   qVar"state")),
               (Call
...
val DecodeHint_def = Def
  ("DecodeHint",Var("op",F8),
   CS
     (Var("op",F8),
      [(LW(1,8),Call("Hint",CTy"instruction",Call("Yield",CTy"Hint",LU))),
       (LW(2,8),
        Call("Hint",CTy"instruction",Call("WaitForEvent",CTy"Hint",LU))),
       (LW(3,8),
        Call
          ("Hint",CTy"instruction",Call("WaitForInterrupt",CTy"Hint",LU))),
       (LW(4,8),
        Call("Hint",CTy"instruction",Call("SendEvent",CTy"Hint",LU))),
       (AVar F8,Call("NoOperation",CTy"instruction",LU))]))
;
              ...
              ([(bVar"b'15",
                 ITB
                   ([(bVar"b'13",
                      ITB
                        ([(Bop
                             (And,Mop(Not,bVar"b'14"),Mop(Not,bVar"b'12")),
                           TP
                             [Call
                                    ...
                                    TP
                                      [LW(4,4),LF,
                                       Mop
                                         (Cast F4,
                                          EX
                                            (Var("h",F16),LN 10,LN 8,
                                             FTy 3)),
                                       ITE
                                         (EQ
                                            (EX
                                               (Var("h",F16),LN 11,LN 11,
                                                F1),LW(1,1)),LW(13,4),
                                          LW(15,4)),
                                       Mop
                                         (Cast F32,
                                          CC[EX(Var("h",F16),LN 7,LN 0,F8),
                                             LW(0,2)])])),qVar"state"]),
                          (Bop
                             (And,Mop(Not,bVar"b'14"),
                              Bop
                                (And,bVar"b'12",
                                 Bop
                                   (And,Mop(Not,bVar"b'11"),
                                    Bop
                                 ...
                                 Call
                                   ("ArithLogicImmediate",CTy"Data",
                                    TP
                                      [ITE
                                         (EQ
                                            (EX(Var("h",F16),LN 7,LN 7,F1),
                                             LW(1,1)),LW(2,4),LW(4,4)),LF,
                                       LW(13,4),LW(13,4),
                                       Mop
                                         (Cast F32,
                                          CC[EX
                                   ...
                                   ("ExtendHalfword",CTy"Media",
                                    TP
                                      [EQ
                                       ...
                                       Mop
                                         (Cast F4,
                                          EX(Var("h",F16),LN 2,LN 0,FTy 3)),
                                       Mop
                                         (Cast F4,
                                          EX(Var("h",F16),LN 5,LN 3,FTy 3))])),
                              qVar"state"]),
                          (Bop
                             (And,Mop(Not,bVar"b'14"),
                              Bop
                             ...
                             (And,Mop(Not,bVar"b'14"),
                              Bop
                                (And,bVar"b'12",
                                 Bop
                                   (And,Mop(Not,bVar"b'11"),
                                    Bop(And,bVar"b'10",Mop(Not,bVar"b'9"))))),
                           Let
                             (Var("registers",FTy 9),
                              EX(Var("h",F16),LN 8,LN 0,FTy 9),
                              TP
                                [Call
                           ...
                           TP
                             [Call
                                ("System",CTy"instruction",
                                 Call
                                   ("ChangeProcessorState",CTy"System",
                                    Mop
                                      (Cast bTy,
                                       EX(Var("h",F16),LN 4,LN 4,F1)))),
                              qVar"state"]),
                          (Bop
                             (And,Mop(Not,bVar"b'14"),
                              Bop
                             ...
                             (Var("Rm",FTy 3),
                              ...
                              Let
                                (Var("Rd",FTy 3),
                                 ...
                                 TP
                                   [CS
                                      (EX(Var("h",F16),LN 7,LN 6,FTy 2),
                                       [(LW(0,2),
                                         Call
                                           ("Media",CTy"instruction",
                                            Call
                                              ("ByteReverse",CTy"Media",
                                               TP
                                                 [Mop
                                                    (Cast F4,
                                                     Var("Rd",FTy 3)),
                                                           ...
                                                           (And,
                                                            ...
                                                            Mop
                                                              (Not,
                                                               bVar"b'0")))))))))),
                                 Call
                                   ("DecodeHint",CTy"instruction",
                                    Mop
                                      (Cast F8,
                                       EX(Var("h",F16),LN 7,LN 4,F4)))),
                                (Bop
                                   (And,bVar"b'14",
                                    Bop
                                      (And,Mop(Not,bVar"b'12"),
                                       Mop(Not,bVar"b'11"))),
                                 Call
                                  ...
                                  Call
                                    ("immediate_form",CTy"offset",
                                     Mop
                                       (Cast F32,
                                        CC[EX
                                             (Var("h",F16),LN 10,LN 6,
                                              FTy 5),LW(0,1)])),
                                  ITE
                                    (EQ
                                       (EX(Var("h",F16),LN 11,LN 11,F1),
                                        LW(1,1)),
                                     Call
                                       ("Load",CTy"instruction",
                                        Call
                     ...
                     (Bop
                        (And,bVar"b'14",
                         Bop(And,Mop(Not,bVar"b'12"),Mop(Not,bVar"b'11"))),
                      Let
                        (Var("registers",F8),
                         EX(Var("h",F16),LN 7,LN 0,F8),
                         TP
                     ...
                     (Bop
                      ...
                      Let
                        (Var("Rn",FTy 3),
                         ...
                         Let
                           (Var("registers",FTy 9),
                            Mop(Cast(FTy 9),EX(Var("h",F16),LN 7,LN 0,F8)),
                            TP
                              [Call
                                 ("Load",CTy"instruction",
                                  Call
                    ...
                    TP
                      [ITB
                         ([(Bop
                            ...
                            Call
                              ("Undefined",CTy"instruction",
                               Mop(Cast F32,EX(Var("h",F16),LN 7,LN 0,F8)))),
                           (Bop
                              (And,bVar"b'14",
                               Bop
                                 (And,bVar"b'12",
                                    ...
                                    ("BranchTarget",CTy"Branch",
                                     Mop
                                       (SE F32,
                                        CC[EX(Var("h",F16),LN 7,LN 0,F8),
                                           LW(0,1)]))),
                               Call("NoOperation",CTy"instruction",LU)))],
                          Call("Undefined",CTy"instruction",LW(0,32))),
                       qVar"state"])),
                (bVar"b'14",
                 ITB
                   ([(Bop
                        (And,Mop(Not,bVar"b'13"),
                         Bop
                           (And,Mop(Not,bVar"b'12"),
                            Bop
                              (And,Mop(Not,bVar"b'11"),
                               Mop(Not,bVar"b'10")))),
                      Let
                        (Var("opc",F4),EX(Var("h",F16),LN 9,LN 6,F4),
                         Let
                           (Var("Ry",FTy 3),
                            EX(Var("h",F16),LN 2,LN 0,FTy 3),
                            Let
                                 ...
                                 (And,bVar"b'10",
                                  Bop
                                    (And,Mop(Not,bVar"b'9"),
                                     Mop(Not,bVar"b'8")))))),
                      Let
                        (Var("Rm",F4),EX(Var("h",F16),LN 6,LN 3,F4),
                         Let
                           (Var("d",F4),
                            CC[EX(Var("h",F16),LN 7,LN 7,F1),
                               EX(Var("h",F16),LN 2,LN 0,FTy 3)],
                            TP
                              [Call
                                 ("Data",CTy"instruction",
                           ...
                           (And,Mop(Not,bVar"b'12"),
                            Bop
                              (And,Mop(Not,bVar"b'11"),
                               Bop
                                 (And,bVar"b'10",
                                  Bop(And,Mop(Not,bVar"b'9"),bVar"b'8"))))),
                      Let
                        (Var("Rm",F4),EX(Var("h",F16),LN 6,LN 3,F4),
                         Let
                           (Var("n",F4),
                           ...
                           (And,Mop(Not,bVar"b'12"),
                            Bop
                              (And,Mop(Not,bVar"b'11"),
                               Bop
                                 (And,bVar"b'10",
                                  Bop(And,bVar"b'9",Mop(Not,bVar"b'8")))))),
                      TP
                        [Call
                           ("Data",CTy"instruction",
                            Call
                              ...
                              (And,Mop(Not,bVar"b'11"),
                               Bop
                                 (And,bVar"b'10",
                                  Bop
                                    (And,bVar"b'9",
                                     Bop(And,bVar"b'8",Mop(Not,bVar"b'7"))))))),
                      TP
                        [Call
                           ("Branch",CTy"instruction",
                            Call
                              ("BranchExchange",CTy"Branch",
                               EX(Var("h",F16),LN 6,LN 3,F4))),qVar"state"]),
                     (Bop
                        (And,Mop(Not,bVar"b'13"),
                         Bop
                           (And,Mop(Not,bVar"b'12"),
                      ...
                      TP
                        [Call
                           ("Branch",CTy"instruction",
                            Call
                              ("BranchLinkExchangeRegister",CTy"Branch",
                               EX(Var("h",F16),LN 6,LN 3,F4))),qVar"state"]),
                     (Bop
                        (And,Mop(Not,bVar"b'13"),
                         Bop(And,Mop(Not,bVar"b'12"),bVar"b'11")),
                                 ...
                                 (Var("m",CTy"offset"),
                                  Call
                                    ("register_form",CTy"offset",
                                     Mop
                                       (Cast F4,
                                        EX(Var("h",F16),LN 8,LN 6,FTy 3))),
                                  CS
                                    (EX(Var("h",F16),LN 11,LN 9,FTy 3),
                                     [(LW(0,3),
                                       Call
                                         ("Store",CTy"instruction",
                                          Call
               ...
               TP
                 [ITB
                    ([(Bop
                      ...
                      (Mop(Not,bVar"b'13"),
                       Let
                         (TP[Var("shift_t",CTy"SRType"),nVar"shift_n"],
                          Call
                            ("DecodeImmShift",PTy(CTy"SRType",nTy),
                             TP
                               [EX(Var("h",F16),LN 12,LN 11,FTy 2),
                                EX(Var("h",F16),LN 10,LN 6,FTy 5)]),
                          Call
                            ("Data",CTy"instruction",
                             Call
                             ...
                             TP
                               [Mop
                                  (Cast F4,
                                   EX(Var("h",F16),LN 10,LN 8,FTy 3)),
                                Mop
                                  (Cast F32,EX(Var("h",F16),LN 7,LN 0,F8))]))),
                      (Bop
                         (And,bVar"b'13",
                          Bop(And,Mop(Not,bVar"b'12"),bVar"b'11")),
                       Call
                      ...
                      (Bop(And,bVar"b'13",bVar"b'12"),
                       Let
                         (Var("d",F4),
                          Mop(Cast F4,EX(Var("h",F16),LN 10,LN 8,FTy 3)),
                          Call
                            ("Data",CTy"instruction",
                             Call
                               ("ArithLogicImmediate",CTy"Data",
      ...
      Let
        (Var("mc",CTy"MachineCode"),
         ...
         Let
           (TP
              [TP
                 [bVar"b'31",bVar"b'30",bVar"b'29",bVar"b'28",bVar"b'27",
               ...
               bVar"b'6",bVar"b'5",bVar"b'4",bVar"b'3",bVar"b'2",
               bVar"b'1",bVar"b'0"],
            TP
              [BL(16,Mop(Fst,Var("h",PTy(F16,F16)))),
               ...
               ITB
                 ([(Bop
                          ...
                          Bop
                            (And,bVar"b'24",
                             Bop
                               (And,bVar"b'23",
                                Bop
                                  (And,Mop(Not,bVar"b'22"),
                                   Bop
                                     (And,Mop(Not,bVar"b'21"),
                                      Bop
                                        (And,Mop(Not,bVar"b'14"),
                                         Mop(Not,bVar"b'12")))))))),
                    Let
                      (Var("Rn",F4),
                       EX(Mop(Fst,Var("h",PTy(F16,F16))),LN 3,LN 0,F4),
                       Let
                         (Var("SYSm",F8),
                          EX(Mop(Snd,Var("h",PTy(F16,F16))),LN 7,LN 0,F8),
                          TP
                            [Call
                               ("System",CTy"instruction",
                                Call
                                  ...
                                  (Or,
                                   ...
                                   Mop
                                     (Not,
                                      Bop
                                        (In,Var("SYSm",F8),
                                         SL[LW(0,8),LW(1,8),LW(2,8),
                                            LW(3,8),LW(5,8),LW(6,8),
                                            LW(7,8),LW(8,8),LW(9,8),
                                            LW(16,8),LW(17,8),LW(18,8),
                                            LW(19,8),LW(20,8)]))),
                                Mop
                                  (Snd,
                                   Apply
                   ...
                   (Bop
                    ...
                    Let
                      (Var("option",F4),
                       EX(Mop(Snd,Var("h",PTy(F16,F16))),LN 3,LN 0,F4),
                       TP
                         [CS
                            (EX
                               (Mop(Snd,Var("h",PTy(F16,F16))),LN 7,LN 4,
                                F4),
                             [(LW(4,4),
                               Call
                                 ("Hint",CTy"instruction",
                   ...
                   (Bop
                    ...
                    Let
                      (Var("SYSm",F8),
                       ...
                       Let
                         (Var("Rd",F4),
                          EX(Mop(Snd,Var("h",PTy(F16,F16))),LN 11,LN 8,F4),
                          TP
                            [Call
                               ("System",CTy"instruction",
                                Call
                      ...
                      [Call
                         ("Undefined",CTy"instruction",
                          Mop
                            (Cast F32,
                             CC[EX
                                  (Mop(Fst,Var("h",PTy(F16,F16))),LN 3,
                                   LN 0,F4),
                                EX
                                  (Mop(Snd,Var("h",PTy(F16,F16))),LN 11,
                                   LN 0,FTy 12)])),qVar"state"]),
                   (Bop(And,Mop(Not,bVar"b'14"),Mop(Not,bVar"b'12")),
                    TP
                      [ITE
                         (Mop
                             ...
                             Apply
                               (Call
                                  ("ConditionPassed",
                                   ATy(qTy,PTy(bTy,qTy)),
                                   EX
                                     (Mop(Fst,Var("h",PTy(F16,F16))),LN 9,
                                      LN 6,F4)),qVar"state")),
                          Call
                            ("Branch",CTy"instruction",
                             Call
                               ("BranchTarget",CTy"Branch",
                                Mop
                                  (SE F32,
                                   CC[EX
                                        (Mop(Fst,Var("h",PTy(F16,F16))),
                                         LN 10,LN 10,F1),
                                      EX
                                        (Mop(Snd,Var("h",PTy(F16,F16))),
                                         LN 11,LN 11,F1),
                                      EX
                                        (Mop(Snd,Var("h",PTy(F16,F16))),
                                         LN 13,LN 13,F1),
                                      ...
                                      EX
                                        (Mop(Snd,Var("h",PTy(F16,F16))),
                                         LN 10,LN 0,FTy 11),LW(0,1)]))),
                          Call("NoOperation",CTy"instruction",LU)),
                       qVar"state"]),
                   (bVar"b'12",
                    Let
                      (Var("S",F1),
                       EX(Mop(Fst,Var("h",PTy(F16,F16))),LN 10,LN 10,F1),
                       TP
                         [Let
                            (Var("imm32",F32),
                             Mop
                  ...
                  TP
                    [Call("Undefined",CTy"instruction",LW(0,32)),
                     qVar"state"]),
               TP[Call("Undefined",CTy"instruction",LW(0,32)),qVar"state"])))))
;
...
val Next_def = Def
  ("Next",qVar"state",
   Let
     (TP[Var("v",CTy"MachineCode"),qVar"s"],
      Apply(Const("Fetch",ATy(qTy,PTy(CTy"MachineCode",qTy))),qVar"state"),
      Let
        (TP[Var("v",CTy"instruction"),qVar"s"],
         Apply
           (Call
