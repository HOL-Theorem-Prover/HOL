(* m0 - generated by L<3> - Wed Feb 19 15:29:09 2014 *)
...
fun rec'PRIMASK x =
  {PM = BitsN.bit(x,0), primask'rst = BitsN.bits(x,31,1)};
  ...
  case x of
     {PM = PM, primask'rst = primask'rst} =>
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(primask'rst,30)
           else if i = 30
             then BitsN.bit(primask'rst,29)
           else if i = 29
             then BitsN.bit(primask'rst,28)
           else if i = 28
             then BitsN.bit(primask'rst,27)
           else if i = 27
             then BitsN.bit(primask'rst,26)
           else if i = 26
             then BitsN.bit(primask'rst,25)
           else if i = 25
             then BitsN.bit(primask'rst,24)
           else if i = 24
             then BitsN.bit(primask'rst,23)
           else if i = 23
             then BitsN.bit(primask'rst,22)
           else if i = 22
             then BitsN.bit(primask'rst,21)
           else if i = 21
             then BitsN.bit(primask'rst,20)
           else if i = 20
             then BitsN.bit(primask'rst,19)
           else if i = 19
             then BitsN.bit(primask'rst,18)
           else if i = 18
             then BitsN.bit(primask'rst,17)
           else if i = 17
             then BitsN.bit(primask'rst,16)
           else if i = 16
             then BitsN.bit(primask'rst,15)
           else if i = 15
             then BitsN.bit(primask'rst,14)
           else if i = 14
             then BitsN.bit(primask'rst,13)
           else if i = 13
             then BitsN.bit(primask'rst,12)
           else if i = 12
             then BitsN.bit(primask'rst,11)
           else if i = 11
             then BitsN.bit(primask'rst,10)
           else if i = 10
             then BitsN.bit(primask'rst,9)
           else if i = 9
             then BitsN.bit(primask'rst,8)
           else if i = 8
             then BitsN.bit(primask'rst,7)
           else if i = 7
             then BitsN.bit(primask'rst,6)
           else if i = 6
             then BitsN.bit(primask'rst,5)
           else if i = 5
             then BitsN.bit(primask'rst,4)
           else if i = 4
             then BitsN.bit(primask'rst,3)
           else if i = 3
             then BitsN.bit(primask'rst,2)
           else if i = 2
             then BitsN.bit(primask'rst,1)
           else if i = 1 then BitsN.bit(primask'rst,0) else PM,
         BitsN.B(0x0,32));
...
fun rec'PSR x =
  {C = BitsN.bit(x,29), ExceptionNumber = BitsN.bits(x,5,0),
   N = BitsN.bit(x,31), T = BitsN.bit(x,24), V = BitsN.bit(x,28),
   Z = BitsN.bit(x,30),
   psr'rst = BitsN.@@(BitsN.bits(x,23,6),BitsN.bits(x,27,25))};
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             ...
             then BitsN.bit(psr'rst,20)
           else if i = 22
             then BitsN.bit(psr'rst,19)
           else if i = 21
             then BitsN.bit(psr'rst,18)
           else if i = 20
             then BitsN.bit(psr'rst,17)
           else if i = 19
             then BitsN.bit(psr'rst,16)
           else if i = 18
             then BitsN.bit(psr'rst,15)
           else if i = 17
             then BitsN.bit(psr'rst,14)
           else if i = 16
             then BitsN.bit(psr'rst,13)
           else if i = 15
             then BitsN.bit(psr'rst,12)
           else if i = 14
             then BitsN.bit(psr'rst,11)
           else if i = 13
             then BitsN.bit(psr'rst,10)
           else if i = 12
             then BitsN.bit(psr'rst,9)
           else if i = 11
             then BitsN.bit(psr'rst,8)
           else if i = 10
             then BitsN.bit(psr'rst,7)
           else if i = 9
             then BitsN.bit(psr'rst,6)
           else if i = 8
             then BitsN.bit(psr'rst,5)
           else if i = 7
             then BitsN.bit(psr'rst,4)
           else if i = 6
             then BitsN.bit(psr'rst,3)
           else if i = 5
             then BitsN.bit(ExceptionNumber,5)
           else if i = 4
             then BitsN.bit(ExceptionNumber,4)
           else if i = 3
             then BitsN.bit(ExceptionNumber,3)
           else if i = 2
             then BitsN.bit(ExceptionNumber,2)
           else if i = 1
             then BitsN.bit(ExceptionNumber,1)
           else BitsN.bit(ExceptionNumber,0),BitsN.B(0x0,32));
...
fun reg'CONTROL x =
  case x of
     {SPSEL = SPSEL, control'rst = control'rst, nPRIV = nPRIV} =>
      BitsN.modify
        (fn (i,_) =>
           if i = 2 then control'rst else if i = 1 then SPSEL else nPRIV,
         BitsN.B(0x0,3));
...
fun rec'AIRCR x =
  {ENDIANNESS = BitsN.bit(x,15), SYSRESETREQ = BitsN.bit(x,2),
   VECTCLRACTIVE = BitsN.bit(x,1), VECTKEY = BitsN.bits(x,31,16),
   aircr'rst = BitsN.@@(BitsN.bits(x,0,0),BitsN.bits(x,14,3))};
  ...
  case x of
     {ENDIANNESS = ENDIANNESS, SYSRESETREQ = SYSRESETREQ,
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(VECTKEY,15)
           else if i = 30
             then BitsN.bit(VECTKEY,14)
           else if i = 29
             then BitsN.bit(VECTKEY,13)
           else if i = 28
             then BitsN.bit(VECTKEY,12)
           else if i = 27
             then BitsN.bit(VECTKEY,11)
           else if i = 26
             then BitsN.bit(VECTKEY,10)
           else if i = 25
             then BitsN.bit(VECTKEY,9)
           else if i = 24
             then BitsN.bit(VECTKEY,8)
           else if i = 23
             then BitsN.bit(VECTKEY,7)
           else if i = 22
             then BitsN.bit(VECTKEY,6)
           else if i = 21
             then BitsN.bit(VECTKEY,5)
           else if i = 20
             then BitsN.bit(VECTKEY,4)
           else if i = 19
             then BitsN.bit(VECTKEY,3)
           else if i = 18
             then BitsN.bit(VECTKEY,2)
           else if i = 17
             then BitsN.bit(VECTKEY,1)
           else if i = 16
             then BitsN.bit(VECTKEY,0)
           else if i = 15
             then ENDIANNESS
           else if i = 14
             then BitsN.bit(aircr'rst,11)
           else if i = 13
             then BitsN.bit(aircr'rst,10)
           else if i = 12
             then BitsN.bit(aircr'rst,9)
           else if i = 11
             then BitsN.bit(aircr'rst,8)
           else if i = 10
             then BitsN.bit(aircr'rst,7)
           else if i = 9
             then BitsN.bit(aircr'rst,6)
           else if i = 8
             then BitsN.bit(aircr'rst,5)
           else if i = 7
             then BitsN.bit(aircr'rst,4)
           else if i = 6
             then BitsN.bit(aircr'rst,3)
           else if i = 5
             then BitsN.bit(aircr'rst,2)
           else if i = 4
             then BitsN.bit(aircr'rst,1)
           else if i = 3
             then BitsN.bit(aircr'rst,0)
           else if i = 2
             then SYSRESETREQ
           else if i = 1 then VECTCLRACTIVE else BitsN.bit(aircr'rst,12),
         BitsN.B(0x0,32));
...
fun rec'CCR x =
  {STKALIGN = BitsN.bit(x,9), UNALIGN_TRP = BitsN.bit(x,3),
   ccr'rst =
     BitsN.concat[BitsN.bits(x,2,0),BitsN.bits(x,8,4),BitsN.bits(x,31,10)]};
  ...
  case x of
     {STKALIGN = STKALIGN, UNALIGN_TRP = UNALIGN_TRP, ccr'rst = ccr'rst} =>
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(ccr'rst,21)
           else if i = 30
             then BitsN.bit(ccr'rst,20)
           else if i = 29
             then BitsN.bit(ccr'rst,19)
           else if i = 28
             then BitsN.bit(ccr'rst,18)
           else if i = 27
             then BitsN.bit(ccr'rst,17)
           else if i = 26
             then BitsN.bit(ccr'rst,16)
           else if i = 25
             then BitsN.bit(ccr'rst,15)
           else if i = 24
             then BitsN.bit(ccr'rst,14)
           else if i = 23
             then BitsN.bit(ccr'rst,13)
           else if i = 22
             then BitsN.bit(ccr'rst,12)
           else if i = 21
             then BitsN.bit(ccr'rst,11)
           else if i = 20
             then BitsN.bit(ccr'rst,10)
           else if i = 19
             then BitsN.bit(ccr'rst,9)
           else if i = 18
             then BitsN.bit(ccr'rst,8)
           else if i = 17
             then BitsN.bit(ccr'rst,7)
           else if i = 16
             then BitsN.bit(ccr'rst,6)
           else if i = 15
             then BitsN.bit(ccr'rst,5)
           else if i = 14
             then BitsN.bit(ccr'rst,4)
           else if i = 13
             then BitsN.bit(ccr'rst,3)
           else if i = 12
             then BitsN.bit(ccr'rst,2)
           else if i = 11
             then BitsN.bit(ccr'rst,1)
           else if i = 10
             then BitsN.bit(ccr'rst,0)
           else if i = 9
             then STKALIGN
           else if i = 8
             then BitsN.bit(ccr'rst,26)
           else if i = 7
             then BitsN.bit(ccr'rst,25)
           else if i = 6
             then BitsN.bit(ccr'rst,24)
           else if i = 5
             then BitsN.bit(ccr'rst,23)
           else if i = 4
             then BitsN.bit(ccr'rst,22)
           else if i = 3
             then UNALIGN_TRP
           else if i = 2
             then BitsN.bit(ccr'rst,29)
           else if i = 1
             then BitsN.bit(ccr'rst,28)
           else BitsN.bit(ccr'rst,27),BitsN.B(0x0,32));
...
fun rec'SHPR2 x =
  {PRI_11 = BitsN.bits(x,31,30), shpr2'rst = BitsN.bits(x,29,0)};
  ...
  case x of
     {PRI_11 = PRI_11, shpr2'rst = shpr2'rst} =>
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(PRI_11,1)
           else if i = 30
             then BitsN.bit(PRI_11,0)
           else if i = 29
             then BitsN.bit(shpr2'rst,29)
           else if i = 28
             then BitsN.bit(shpr2'rst,28)
           else if i = 27
             then BitsN.bit(shpr2'rst,27)
           else if i = 26
             then BitsN.bit(shpr2'rst,26)
           else if i = 25
             then BitsN.bit(shpr2'rst,25)
           else if i = 24
             then BitsN.bit(shpr2'rst,24)
           else if i = 23
             then BitsN.bit(shpr2'rst,23)
           else if i = 22
             then BitsN.bit(shpr2'rst,22)
           else if i = 21
             then BitsN.bit(shpr2'rst,21)
           else if i = 20
             then BitsN.bit(shpr2'rst,20)
           else if i = 19
             then BitsN.bit(shpr2'rst,19)
           else if i = 18
             then BitsN.bit(shpr2'rst,18)
           else if i = 17
             then BitsN.bit(shpr2'rst,17)
           else if i = 16
             then BitsN.bit(shpr2'rst,16)
           else if i = 15
             then BitsN.bit(shpr2'rst,15)
           else if i = 14
             then BitsN.bit(shpr2'rst,14)
           else if i = 13
             then BitsN.bit(shpr2'rst,13)
           else if i = 12
             then BitsN.bit(shpr2'rst,12)
           else if i = 11
             then BitsN.bit(shpr2'rst,11)
           else if i = 10
             then BitsN.bit(shpr2'rst,10)
           else if i = 9
             then BitsN.bit(shpr2'rst,9)
           else if i = 8
             then BitsN.bit(shpr2'rst,8)
           else if i = 7
             then BitsN.bit(shpr2'rst,7)
           else if i = 6
             then BitsN.bit(shpr2'rst,6)
           else if i = 5
             then BitsN.bit(shpr2'rst,5)
           else if i = 4
             then BitsN.bit(shpr2'rst,4)
           else if i = 3
             then BitsN.bit(shpr2'rst,3)
           else if i = 2
             then BitsN.bit(shpr2'rst,2)
           else if i = 1
             then BitsN.bit(shpr2'rst,1)
           else BitsN.bit(shpr2'rst,0),BitsN.B(0x0,32));
...
fun rec'SHPR3 x =
  {PRI_14 = BitsN.bits(x,23,22), PRI_15 = BitsN.bits(x,31,30),
   shpr3'rst = BitsN.@@(BitsN.bits(x,21,0),BitsN.bits(x,29,24))};
  ...
  case x of
     {PRI_14 = PRI_14, PRI_15 = PRI_15, shpr3'rst = shpr3'rst} =>
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(PRI_15,1)
           else if i = 30
             then BitsN.bit(PRI_15,0)
           else if i = 29
             then BitsN.bit(shpr3'rst,5)
           else if i = 28
             then BitsN.bit(shpr3'rst,4)
           else if i = 27
             then BitsN.bit(shpr3'rst,3)
           else if i = 26
             then BitsN.bit(shpr3'rst,2)
           else if i = 25
             then BitsN.bit(shpr3'rst,1)
           else if i = 24
             then BitsN.bit(shpr3'rst,0)
           else if i = 23
             then BitsN.bit(PRI_14,1)
           else if i = 22
             then BitsN.bit(PRI_14,0)
           else if i = 21
             then BitsN.bit(shpr3'rst,27)
           else if i = 20
             then BitsN.bit(shpr3'rst,26)
           else if i = 19
             then BitsN.bit(shpr3'rst,25)
           else if i = 18
             then BitsN.bit(shpr3'rst,24)
           else if i = 17
             then BitsN.bit(shpr3'rst,23)
           else if i = 16
             then BitsN.bit(shpr3'rst,22)
           else if i = 15
             then BitsN.bit(shpr3'rst,21)
           else if i = 14
             then BitsN.bit(shpr3'rst,20)
           else if i = 13
             then BitsN.bit(shpr3'rst,19)
           else if i = 12
             then BitsN.bit(shpr3'rst,18)
           else if i = 11
             then BitsN.bit(shpr3'rst,17)
           else if i = 10
             then BitsN.bit(shpr3'rst,16)
           else if i = 9
             then BitsN.bit(shpr3'rst,15)
           else if i = 8
             then BitsN.bit(shpr3'rst,14)
           else if i = 7
             then BitsN.bit(shpr3'rst,13)
           else if i = 6
             then BitsN.bit(shpr3'rst,12)
           else if i = 5
             then BitsN.bit(shpr3'rst,11)
           else if i = 4
             then BitsN.bit(shpr3'rst,10)
           else if i = 3
             then BitsN.bit(shpr3'rst,9)
           else if i = 2
             then BitsN.bit(shpr3'rst,8)
           else if i = 1
             then BitsN.bit(shpr3'rst,7)
           else BitsN.bit(shpr3'rst,6),BitsN.B(0x0,32));
...
fun rec'IPR x =
  {PRI_N0 = BitsN.bits(x,7,6), PRI_N1 = BitsN.bits(x,15,14),
   PRI_N2 = BitsN.bits(x,23,22), PRI_N3 = BitsN.bits(x,31,30),
   ipr'rst =
     BitsN.concat
       [BitsN.bits(x,5,0),BitsN.bits(x,13,8),BitsN.bits(x,21,16),
        BitsN.bits(x,29,24)]};
  ...
  case x of
     {PRI_N0 = PRI_N0, PRI_N1 = PRI_N1, PRI_N2 = PRI_N2, PRI_N3 = PRI_N3,
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(PRI_N3,1)
           else if i = 30
             then BitsN.bit(PRI_N3,0)
           else if i = 29
             then BitsN.bit(ipr'rst,5)
           else if i = 28
             then BitsN.bit(ipr'rst,4)
           else if i = 27
             then BitsN.bit(ipr'rst,3)
           else if i = 26
             then BitsN.bit(ipr'rst,2)
           else if i = 25
             then BitsN.bit(ipr'rst,1)
           else if i = 24
             then BitsN.bit(ipr'rst,0)
           else if i = 23
             then BitsN.bit(PRI_N2,1)
           else if i = 22
             then BitsN.bit(PRI_N2,0)
           else if i = 21
             then BitsN.bit(ipr'rst,11)
           else if i = 20
             then BitsN.bit(ipr'rst,10)
           else if i = 19
             then BitsN.bit(ipr'rst,9)
           else if i = 18
             then BitsN.bit(ipr'rst,8)
           else if i = 17
             then BitsN.bit(ipr'rst,7)
           else if i = 16
             then BitsN.bit(ipr'rst,6)
           else if i = 15
             then BitsN.bit(PRI_N1,1)
           else if i = 14
             then BitsN.bit(PRI_N1,0)
           else if i = 13
             then BitsN.bit(ipr'rst,17)
           else if i = 12
             then BitsN.bit(ipr'rst,16)
           else if i = 11
             then BitsN.bit(ipr'rst,15)
           else if i = 10
             then BitsN.bit(ipr'rst,14)
           else if i = 9
             then BitsN.bit(ipr'rst,13)
           else if i = 8
             then BitsN.bit(ipr'rst,12)
           else if i = 7
             then BitsN.bit(PRI_N0,1)
           else if i = 6
             then BitsN.bit(PRI_N0,0)
           else if i = 5
             then BitsN.bit(ipr'rst,23)
           else if i = 4
             then BitsN.bit(ipr'rst,22)
           else if i = 3
             then BitsN.bit(ipr'rst,21)
           else if i = 2
             then BitsN.bit(ipr'rst,20)
           else if i = 1
             then BitsN.bit(ipr'rst,19)
           else BitsN.bit(ipr'rst,18),BitsN.B(0x0,32));
  ...
  let
    val result =
      case BitsN.bits(cond,3,1) of
       ...
       | BitsN.B(0x2,3) => (#N) (!PSR)
       | BitsN.B(0x3,3) => (#V) (!PSR)
       | BitsN.B(0x4,3) => ((#C) (!PSR)) andalso (not((#Z) (!PSR)))
       | BitsN.B(0x5,3) => ((#N) (!PSR)) = ((#V) (!PSR))
       | BitsN.B(0x6,3) =>
            (((#N) (!PSR)) = ((#V) (!PSR))) andalso (not((#Z) (!PSR)))
       | BitsN.B(0x7,3) => true
...
fun CurrentModeIsPrivileged () =
  ((!CurrentMode) = Mode_Handler) orelse (not((#nPRIV) (!CONTROL)));

fun LookUpSP () =
  if (#SPSEL) (!CONTROL) then RName_SP_process else RName_SP_main;
         ...
         in
           ...
           (Map.update
              ((!REG),Cast.RNameToNat x,
               BitsN.@@(BitsN.bits(value,31,2),BitsN.B(0x0,2))))
         end
  else let
...
fun ExceptionPriority n =
  if n = 2
    ...
    then BitsN.toInt((#PRI_11) (!SHPR2))
  else if n = 14
    then BitsN.toInt((#PRI_14) (!SHPR3))
  else if n = 15
    then BitsN.toInt((#PRI_15) (!SHPR3))
  else if Nat.>=(n,16)
    then let
           val r =
             Map.lookup
         ...
         in
           case BitsN.fromNat(Nat.mod(n,4),2) of
              BitsN.B(0x0,2) => BitsN.toInt((#PRI_N0) r)
            | BitsN.B(0x1,2) => BitsN.toInt((#PRI_N1) r)
            | BitsN.B(0x2,2) => BitsN.toInt((#PRI_N2) r)
            | BitsN.B(0x3,2) => BitsN.toInt((#PRI_N3) r)
            | _ => raise General.Bind
         end
  else 4;
...
fun ExecutionPriority () =
  ...
  in
    ...
    in
      ...
      ; if (#PM) (!PRIMASK) then boostedpri := 0 else ()
      ; Int.min((!boostedpri),(!highestpri))
      )
    end
  end;
...
fun PushStack () =
  ...
  in
    ...
    in
      ( if ((#SPSEL) (!CONTROL)) andalso ((!CurrentMode) = Mode_Thread)
          then ( frameptralign := (BitsN.bits(SP_process (),2,2))
               ; write'SP_process
                   (BitsN.&&
        ...
        else ( frameptralign := (BitsN.bits(SP_main (),2,2))
             ; write'SP_process
                 (BitsN.&&
      ...
      ; let
        ...
        in
          write'MemA 32
            (BitsN.concat
               [BitsN.bits(reg'PSR (!PSR),31,10),(!frameptralign),
                BitsN.bits(reg'PSR (!PSR),8,0)],x)
        end
      ; if (!CurrentMode) = Mode_Handler
          then write'LR(BitsN.B(0xFFFFFFF1,32))
        else if not((#SPSEL) (!CONTROL))
...
fun PopStack (frameptr,EXC_RETURN) =
  ...
  ; let
      ...
      val spmask =
        BitsN.zeroExtend 32 (BitsN.@@(BitsN.bits(psr,9,9),BitsN.B(0x0,2)))
    in
      ( case boolify'4(BitsN.bits(EXC_RETURN,3,0)) of
           (_,(false,(false,true))) =>
            write'SP_main
      ...
      ; let
        ...
        in
          PSR :=
          (write'reg'PSR
             ((!PSR),BitsN.bitFieldInsert(w,BitsN.bits(psr,31,27),31,27)))
        end
      ; let
          val w = reg'PSR (!PSR)
        in
          ...
          (write'reg'PSR
             ((!PSR),
              BitsN.bitFieldInsert
                (w,BitsN.fromBit(BitsN.bit(psr,24)),24,24)))
        end
      ; let
          val w = reg'PSR (!PSR)
        in
          PSR :=
          (write'reg'PSR
             ((!PSR),BitsN.bitFieldInsert(w,BitsN.bits(psr,5,0),5,0)))
        end
      )
    end
  );
...
fun IsOnes N w = w = (BitsN.neg(BitsN.B(0x1,N)));
...
fun ExceptionReturn EXC_RETURN =
  ...
  ; if not(IsOnes 24 (BitsN.bits(EXC_RETURN,27,4)))
      then raise UNPREDICTABLE ("ExceptionReturn")
    else ()
  ; let
      val ReturningExceptionNumber = (#ExceptionNumber) (!PSR)
    ...
    in
      if not(Map.lookup
        ...
        then raise UNPREDICTABLE ("ExceptionReturn")
             ...
             val frameptr = ref (BitsN.B(0x0,32))
           in
             ( case BitsN.bits(EXC_RETURN,3,0) of
                  BitsN.B(0x1,4) =>
                ...
                | BitsN.B(0xD,4) =>
                     if not(NestedActivation = 1)
                       then raise UNPREDICTABLE ("ExceptionReturn")
                          ...
                          ; CurrentMode := Mode_Thread
                          ; CONTROL :=
                            (CONTROL_SPSEL_rupd((!CONTROL),true))
                          )
                | _ => raise UNPREDICTABLE ("ExceptionReturn")
             ; DeActivate ReturningExceptionNumber
             ; PopStack((!frameptr),EXC_RETURN)
             ; if (!CurrentMode) = Mode_Handler
                 then if ((#ExceptionNumber) (!PSR)) = (BitsN.B(0x0,6))
                        then raise UNPREDICTABLE ("ExceptionReturn")
                      else ()
               else if not(((#ExceptionNumber) (!PSR)) = (BitsN.B(0x0,6)))
                 then raise UNPREDICTABLE ("ExceptionReturn")
               else ()
             )
           end
...
fun BXWritePC address =
  if ((!CurrentMode) = Mode_Handler) andalso
     ((BitsN.bits(address,31,28)) = (BitsN.B(0xF,4)))
    then ExceptionReturn(BitsN.bits(address,27,0))
...
fun dfn'BranchLinkImmediate imm32 =
  ...
  in
    ( write'LR(BitsN.@@(BitsN.bits(next_instr_addr,31,1),BitsN.B(0x1,1)))
...
fun dfn'Move (d,imm32) =
  DataProcessing
    (BitsN.B(0xD,4),(true,(d,(BitsN.B(0xF,4),(imm32,(#C) (!PSR))))));

fun dfn'CompareImmediate (n,imm32) =
  DataProcessing
    (BitsN.B(0xA,4),(true,(BitsN.B(0x0,4),(n,(imm32,(#C) (!PSR))))));

fun dfn'ArithLogicImmediate (opc,(setflags,(d,(n,imm32)))) =
  DataProcessing(opc,(setflags,(d,(n,(imm32,(#C) (!PSR))))));

fun doRegister (opc,(setflags,(d,(n,(m,(shift_t,shift_n)))))) =
  let
    val (shifted,carry) = Shift_C 32 (R m,(shift_t,(shift_n,(#C) (!PSR))))
    val carry = if ArithmeticOpcode opc then (#C) (!PSR) else carry
  in
    if d = (BitsN.B(0xF,4))
...
fun dfn'ShiftRegister (d,(n,(shift_t,m))) =
  let
    val shift_n = BitsN.toNat(BitsN.bits(R m,7,0))
    val (shifted,carry) = Shift_C 32 (R n,(shift_t,(shift_n,(#C) (!PSR))))
  in
    DataProcessing
...
fun dfn'ExtendByte (unsigned,(d,m)) =
  ( write'R(Extend (8,32) (unsigned,BitsN.bits(R m,7,0)),d)
  ; IncPC ()
  ; count := (Nat.+((!count),1))
  );

fun dfn'ExtendHalfword (unsigned,(d,m)) =
  ( write'R(Extend (16,32) (unsigned,BitsN.bits(R m,15,0)),d)
  ; IncPC ()
  ; count := (Nat.+((!count),1))
  );
...
fun dfn'LoadWord (t,(n,m)) =
  let
    val offset =
      case m of
         register_form m => Shift 32 (R m,(SRType_LSL,(0,(#C) (!PSR))))
...
fun dfn'StoreByte (t,(n,m)) =
  let
    ...
    val address = BitsN.+(R n,offset)
  in
    ( let val x = (address,1) in write'MemU 8 (BitsN.bits(R t,7,0),x) end
    ; IncPC ()
    ; count := (Nat.+((!count),2))
    )
  end;
          ...
          ( if BitsN.bit(SYSm,0)
              then let
                   ...
                   in
                     write'R
                       (BitsN.bitFieldInsert
                          (w,BitsN.bits(reg'PSR (!PSR),8,0),8,0),d)
                   end
            else ()
          ; if BitsN.bit(SYSm,1)
              then let
                   ...
                   in
                     write'R
                       (BitsN.bitFieldInsert(w,BitsN.fromBit false,24,24),
                        d)
                   end
            else ()
          ; if not(BitsN.bit(SYSm,2))
              then let
                   ...
                   in
                     write'R
                       (BitsN.bitFieldInsert
                          (w,BitsN.bits(reg'PSR (!PSR),31,27),31,27),d)
                   end
            else ()
          )
     | BitsN.B(0x1,5) =>
          (case BitsN.bits(SYSm,2,0) of
              BitsN.B(0x0,3) => write'R(SP_main (),d)
            | BitsN.B(0x1,3) => write'R(SP_process (),d)
            | _ => ())
     | BitsN.B(0x2,5) =>
          (case BitsN.bits(SYSm,2,0) of
              BitsN.B(0x0,3) =>
                 ...
                 in
                   write'R
                     (BitsN.bitFieldInsert
                        (w,BitsN.fromBit((#PM) (!PRIMASK)),0,0),d)
                 end
            | BitsN.B(0x4,3) =>
                 let
                   val w = R d
                 in
                   write'R
                     (BitsN.bitFieldInsert
                        (w,BitsN.bits(reg'CONTROL (!CONTROL),1,0),1,0),d)
                 end
            | _ => ())
     | _ => ()
  ; IncPC ()
              ...
              then let
                   ...
                   in
                     ...
                     (write'reg'PSR
                        ((!PSR),
                         BitsN.bitFieldInsert
                           (w,BitsN.bits(Rn,31,27),31,27)))
                   end
            else ()
       | BitsN.B(0x1,5) =>
            if CurrentModeIsPrivileged ()
              then case BitsN.bits(SYSm,2,0) of
                      BitsN.B(0x0,3) =>
                         write'SP_main
                           (BitsN.@@(BitsN.bits(Rn,31,2),BitsN.B(0x0,2)))
                    | BitsN.B(0x1,3) =>
                         write'SP_process
                           (BitsN.@@(BitsN.bits(Rn,31,2),BitsN.B(0x0,2)))
                    | _ => ()
    ...
    case boolify'16 h of
          ...
          case opc of
           ...
           | BitsN.B(0x8,4) =>
                let
                  ...
                  val m = BitsN.fromNat(BitsN.toNat Rx,4)
                in
                  Data(TestCompareRegister(BitsN.bits(opc,1,0),(n,m)))
                end
           | BitsN.B(0xA,4) =>
                let
                  val n = BitsN.fromNat(BitsN.toNat Ry,4)
          ...
          val registers =
            BitsN.fromBitstring
              ([registers'8,registers'7,registers'6,registers'5,
                registers'4,registers'3,registers'2,registers'1,
                registers'0],9)
        in
        ...
        (false,
         (true,
          (true,
           (false,
            (true,
             (true,(false,(false,(true,(true,(im'0,(_,(_,(_,_))))))))))))))) =>
        System
     ...
     | (true,
        ...
        (case BitsN.fromBitstring([op'3,op'2,op'1,op'0],4) of
            BitsN.B(0x1,4) => Hint(Yield ())
          | BitsN.B(0x2,4) => Hint(WaitForEvent ())
          | BitsN.B(0x3,4) => Hint(WaitForInterrupt ())
          | BitsN.B(0x4,4) => Hint(SendEvent ())
          | _ => NoOperation ())
     | (true,
        (true,
         (false,
  ...
  in
    case (boolify'16(L3.fst h),boolify'16(L3.snd h)) of
     ...
     | ((true,
        ...
        in
          case BitsN.fromBitstring([op'3,op'2,op'1,op'0],4) of
             BitsN.B(0x4,4) => Hint(DataSynchronizationBarrier option)
     ...
     | ((true,
         (true,
          (true,
           (true,
            (false,
             (false,(true,(true,(true,(true,(true,(_,(_,(_,(_,_))))))))))))))),
        (true,
         (false,
          (_,
           (false,
  ...
  case ast of
     BranchTarget imm32 =>
      (if L3.mem(c,[BitsN.B(0xE,4),BitsN.B(0xF,4)])
         ...
         then Thumb16
                (BitsN.concat[BitsN.B(0xD,4),c,BitsN.bits(imm32,8,1)])
...
fun e_data ast =
  case ast of
     Move(d,imm32) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x4,5),BitsN.bits(d,2,0),BitsN.bits(imm32,7,0)])
   | ArithLogicImmediate(opc,(setflags,(d,(n,imm32)))) =>
      (if (((L3.mem(opc,[BitsN.B(0x4,4),BitsN.B(0x2,4)])) andalso
            (BitsN.<=+(imm32,BitsN.B(0x7,32)))) andalso setflags) andalso
         ...
         then let
             ...
             (d = n)) andalso (BitsN.<=+(imm32,BitsN.B(0xFF,32)))) andalso
         ...
         then let
            ...
            (imm32 = (BitsN.B(0x0,32)))) andalso setflags) andalso
          (not((BitsN.bit(d,3)) orelse (BitsN.bit(n,3))))
         then let
                val Rd = BitsN.bits(d,2,0)
                val Rn = BitsN.bits(n,2,0)
   ...
   | Register(opc,(setflags,(d,(n,m)))) =>
      (if ((L3.mem(opc,[BitsN.B(0x2,4),BitsN.B(0x4,4)])) andalso setflags) andalso
          (not(((BitsN.bit(d,3)) orelse (BitsN.bit(n,3))) orelse
               (BitsN.bit(m,3))))
         then let
                val Rn = BitsN.bits(n,2,0)
                val Rd = BitsN.bits(d,2,0)
            ...
            setflags) andalso (d = n)) andalso
          (not((BitsN.bit(d,3)) orelse (BitsN.bit(m,3))))
         then let
                val Rdn = BitsN.bits(d,2,0)
                val Rm = BitsN.bits(m,2,0)
              in
   ...
   | TestCompareRegister(opc,(n,m)) =>
      (if not(((opc = (BitsN.B(0x1,2))) orelse (BitsN.bit(n,3))) orelse
              (BitsN.bit(m,3)))
         then let
                val Rn = BitsN.bits(n,2,0)
                val Rm = BitsN.bits(m,2,0)
   ...
   | CompareImmediate(n,imm32) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x5,5),BitsN.bits(n,2,0),BitsN.bits(imm32,7,0)])
   | ShiftImmediate(negate,(setflags,(d,(m,(shift_t,shift_n))))) =>
      (if (((negate andalso (shift_t = SRType_LSL)) andalso (shift_n = 0)) andalso
           setflags) andalso
...
fun e_media ast =
  case ast of
   ...
   | ByteReverse(d,m) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x2E8,10),BitsN.bits(m,2,0),BitsN.bits(d,2,0)])
   | ByteReversePackedHalfword(d,m) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x2E9,10),BitsN.bits(m,2,0),BitsN.bits(d,2,0)])
   | ByteReverseSignedHalfword(d,m) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x2EB,10),BitsN.bits(m,2,0),BitsN.bits(d,2,0)]);

fun e_hint (ast,e) =
  case ast of
     Breakpoint imm32 =>
      Thumb16(BitsN.@@(BitsN.B(0xBE,8),BitsN.bits(imm32,7,0)))
...
fun e_system ast =
  case ast of
   ...
   | SupervisorCall imm32 =>
      Thumb16(BitsN.@@(BitsN.B(0xDF,8),BitsN.bits(imm32,7,0)));
  ...
  case ast of
     LoadWord(t,(n,immediate_form imm32)) =>
      (if n = (BitsN.B(0xD,4))
         then Thumb16
                (BitsN.concat
                   [BitsN.B(0x13,5),BitsN.bits(t,2,0),
                    BitsN.bits(imm32,9,2)])
       else Thumb16
              (BitsN.concat
                 [BitsN.B(0xD,5),BitsN.bits(imm32,6,2),BitsN.bits(n,2,0),
                  BitsN.bits(t,2,0)]))
   | LoadWord(t,(n,register_form m)) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x2C,7),BitsN.bits(m,2,0),BitsN.bits(n,2,0),
            BitsN.bits(t,2,0)])
   | LoadLiteral(t,imm32) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x9,5),BitsN.bits(t,2,0),BitsN.bits(imm32,9,2)])
   | LoadByte(unsigned,(t,(n,immediate_form imm32))) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0xF,5),BitsN.bits(imm32,4,0),BitsN.bits(n,2,0),
            BitsN.bits(t,2,0)])
  ...
  case ast of
     StoreWord(t,(n,immediate_form imm32)) =>
      (if n = (BitsN.B(0xD,4))
         then Thumb16
                (BitsN.concat
                   [BitsN.B(0x12,5),BitsN.bits(t,2,0),
                    BitsN.bits(imm32,9,2)])
       else Thumb16
              (BitsN.concat
                 [BitsN.B(0xC,5),BitsN.bits(imm32,6,2),BitsN.bits(n,2,0),
                  BitsN.bits(t,2,0)]))
   | StoreWord(t,(n,register_form m)) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x28,7),BitsN.bits(m,2,0),BitsN.bits(n,2,0),
            BitsN.bits(t,2,0)])
   | StoreByte(t,(n,immediate_form imm32)) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0xE,5),BitsN.bits(imm32,4,0),BitsN.bits(n,2,0),
            BitsN.bits(t,2,0)])
   | StoreByte(t,(n,register_form m)) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x2A,7),BitsN.bits(m,2,0),BitsN.bits(n,2,0),
            BitsN.bits(t,2,0)])
   | StoreHalf(t,(n,immediate_form imm32)) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x10,5),BitsN.bits(imm32,5,1),BitsN.bits(n,2,0),
            BitsN.bits(t,2,0)])
   | StoreHalf(t,(n,register_form m)) =>
      Thumb16
        (BitsN.concat
           [BitsN.B(0x29,7),BitsN.bits(m,2,0),BitsN.bits(n,2,0),
            BitsN.bits(t,2,0)])
   | Push registers => Thumb16(BitsN.@@(BitsN.B(0x5A,7),registers))
   | StoreMultiple(n,registers) =>
      Thumb16(BitsN.concat[BitsN.B(0x18,5),BitsN.bits(n,2,0),registers]);
...
fun SetPassCondition c =
  case c of
     BitsN.B(0x0,4) => PSR := (PSR_Z_rupd((!PSR),true))
   | BitsN.B(0x1,4) => PSR := (PSR_Z_rupd((!PSR),false))
   | BitsN.B(0x2,4) => PSR := (PSR_C_rupd((!PSR),true))
   | BitsN.B(0x3,4) => PSR := (PSR_C_rupd((!PSR),false))
   | BitsN.B(0x4,4) => PSR := (PSR_N_rupd((!PSR),true))
   | BitsN.B(0x5,4) => PSR := (PSR_N_rupd((!PSR),false))
   | BitsN.B(0x6,4) => PSR := (PSR_V_rupd((!PSR),true))
   | BitsN.B(0x7,4) => PSR := (PSR_V_rupd((!PSR),false))
   | BitsN.B(0x8,4) =>
        ( PSR := (PSR_C_rupd((!PSR),true))
        ; PSR := (PSR_Z_rupd((!PSR),false))
        )
   | BitsN.B(0x9,4) => PSR := (PSR_C_rupd((!PSR),false))
   | BitsN.B(0xA,4) =>
...
fun p_encode_signed_offset N x =
  case p_signed_number x of
     Option.SOME(sub,n) =>
      let
        val i = Int.-(if sub then Int.~(Nat.toInt n) else Nat.toInt n,4)
     ...
     #"+" :: (#"#" :: t) =>
      (case p_encode_signed_immediate N (false,String.implode t) of
          Option.SOME(false,(true,n)) =>
           Option.SOME
             (BitsN.<=+(BitsN.B(0x4,N),n),BitsN.-(n,BitsN.B(0x4,N)))
...
fun p_suffix s =
  case L3.uncurry String.fields (fn c => c = #".",s) of
     [cond,s] =>
      (case (p_cond cond,L3.mem(s,["w","n"])) of
...
fun p_al_suffix s =
  case p_suffix s of
     Option.SOME(BitsN.B(0xE,4),c) => Option.SOME(BitsN.B(0xE,4),c)
   | _ => NONE;
           ...
           (case p_register x of
             ...
             | NONE =>
                  (case (opc,p_immediate 32 x) of
                      (BitsN.B(0x2,2),Option.SOME(true,imm32)) =>
                       OK(c,Data(CompareImmediate(rn,imm32)))
                    | (BitsN.B(0x2,2),Option.SOME _) =>
  ...
  case (p_al_suffix c,l) of
   ...
   | (Option.SOME c,[r1,r2,sh]) =>
      (case (negate,(setflags,(p_register2[r1,r2],p_shift_imm_or_reg sh))) of
        ...
        | (false,(true,(Option.SOME _,(err,(_,_))))) => FAIL err
        | _ => FAIL("syntax error"))
   | _ => FAIL("syntax error");
        ...
        | NONE =>
             (case p_label a of
                 Option.SOME label =>
                  PENDING
                    (label,
                     (c,Branch(BranchLinkImmediate(BitsN.B(0x0,32)))))
               | NONE => FAIL("syntax error")))
   | _ => FAIL("syntax error");
...
fun pick_ldr_str (opc,(rt,(rn,offset))) =
  ...
  in
    case opc of
       0 =>
          (case (rn,offset) of
              (BitsN.B(0xF,4),immediate_form imm32) =>
                        ...
                        Load
                          (LoadMultiple
                             (true,
                              (BitsN.B(0xD,4),
                               BitsN.@@
                                 (BitsN.bits(w,15,15),BitsN.bits(w,7,0))))))
              else FAIL("bad register list")
       else if (BitsN.&&(w,BitsN.B(0xBF00,16))) = (BitsN.B(0x0,16))
         then OK(c,
                 Store
                   (Push(BitsN.@@(BitsN.bits(w,14,14),BitsN.bits(w,7,0)))))
       else FAIL("bad register list"))
      ...
      in
        case (p_register r,(p_registers t,L3.mem(wb,["","!"]))) of
           (Option.SOME rn,(Option.SOME w,true)) =>
            (if (BitsN.bits(w,15,8)) = (BitsN.B(0x0,8))
               then let
                      val wback = wb = ("!")
                    in
                      if load
...
fun s_special_reg SYSm =
  case SYSm of
   ...
   | BitsN.B(0x8,8) => "msp"
   | BitsN.B(0x9,8) => "psp"
   | BitsN.B(0x10,8) => "primask"
   | BitsN.B(0x14,8) => "control"
  ...
  case ast of
   ...
   | LoadMultiple(true,(BitsN.B(0xD,4),registers)) =>
      ("pop",
       s_registers 16
         (BitsN.concat
            [BitsN.bits(registers,8,8),BitsN.B(0x0,7),
             BitsN.bits(registers,7,0)]))
   | LoadMultiple(wback,(n,registers)) =>
      ("ldm",
       String.concat
  ...
  case ast of
   ...
   | Push registers =>
      ("push",
       s_registers 15
         (BitsN.concat
            [BitsN.bits(registers,8,8),BitsN.B(0x0,6),
             BitsN.bits(registers,7,0)]))
   | StoreMultiple(n,registers) =>
