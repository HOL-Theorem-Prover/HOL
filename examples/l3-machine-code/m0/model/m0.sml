(* m0 - generated by L3 - Fri Oct 16 12:58:24 2015 *)
     ...
     {C = C, ExceptionNumber = ExceptionNumber, N = N, T = T, V = V,
      ...
      BitsN.concat
        [BitsN.fromBit N,BitsN.fromBit Z,BitsN.fromBit C,BitsN.fromBit V,
         BitsN.bits(2,0) psr'rst,BitsN.fromBit T,BitsN.bits(20,3) psr'rst,
         ExceptionNumber];
...
fun reg'CONTROL x =
  case x of
     {SPSEL = SPSEL, control'rst = control'rst, nPRIV = nPRIV} =>
      BitsN.concat
        [BitsN.fromBit control'rst,BitsN.fromBit SPSEL,BitsN.fromBit nPRIV];
     ...
     {PRI_N0 = PRI_N0, PRI_N1 = PRI_N1, PRI_N2 = PRI_N2, PRI_N3 = PRI_N3,
      ...
      BitsN.concat
        [PRI_N3,BitsN.bits(5,0) ipr'rst,PRI_N2,BitsN.bits(11,6) ipr'rst,
         PRI_N1,BitsN.bits(17,12) ipr'rst,PRI_N0,BitsN.bits(23,18) ipr'rst];
