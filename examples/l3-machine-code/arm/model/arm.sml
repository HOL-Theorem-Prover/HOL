(* arm - generated by L3 - Fri Feb 17 11:04:18 2017 *)
  ...
  let
    ...
    val result =
      case BitsN.bits(3,1) cond of
         BitsN.B(0x0,3) => #Z((!CPSR) : PSR)
       | BitsN.B(0x1,3) => #C((!CPSR) : PSR)
       | BitsN.B(0x2,3) => #N((!CPSR) : PSR)
       | BitsN.B(0x3,3) => #V((!CPSR) : PSR)
       | BitsN.B(0x4,3) =>
         (#C((!CPSR) : PSR)) andalso (not(#Z((!CPSR) : PSR)))
       | BitsN.B(0x5,3) => (#N((!CPSR) : PSR)) = (#V((!CPSR) : PSR))
       | BitsN.B(0x6,3) =>
