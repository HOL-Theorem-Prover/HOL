(* arm - generated by L3 - Mon Feb 15 14:35:25 2016 *)
        ...
        then ( if privileged
             ...
             ; if privileged andalso
                  (((not nmfi) orelse (not(BitsN.bit(value,6)))) andalso
                   ((IsSecure ()) orelse
                    (((#FW)((#SCR) (!CP15))) orelse (HaveVirtExt ()))))
                 then let
                        val w = reg'PSR (!CPSR)
                      in
                        CPSR :=
...
fun Rmode (n,mode) =
  ...
  in
    ...
    ; if notSecure andalso
         ((mode = (BitsN.B(0x11,5))) andalso ((#RFR)((#NSACR) (!CP15))))
        then raise UNPREDICTABLE ("Rmode")
      else ()
...
fun HighestSetBit N w =
  if w = (BitsN.B(0x0,N)) then IntInf.~ 1 else BitsN.toInt(BitsN.log2 w);

fun CountLeadingZeroBits N w =
  Nat.fromInt
    (IntInf.-
       (IntInf.-(Nat.toInt(BitsN.size(BitsN.B(0x0,N))),1),
        HighestSetBit N w));
...
fun TakeDataAbortException () =
  let
    ...
    val route_to_monitor =
      (HaveSecurityExt ()) andalso
      (((#EA)((#SCR) (!CP15))) andalso (IsExternalAbort ()))
    val take_to_hyp =
      (HaveVirtExt ()) andalso
      ((HaveSecurityExt ()) andalso
       (((#NS)((#SCR) (!CP15))) andalso
...
fun TakePhysicalIRQException () =
  let
    ...
    val route_to_hyp =
      ((HaveVirtExt ()) andalso
       ((HaveSecurityExt ()) andalso
        ((not((#IRQ)((#SCR) (!CP15)))) andalso
         (((#IMO)((#HCR) (!CP15))) andalso (not(IsSecure ())))))) orelse
      (((#M) (!CPSR)) = (BitsN.B(0x1A,5)))
  in
    if route_to_monitor
      then ( if ((#M) (!CPSR)) = (BitsN.B(0x16,5))
...
fun TakePhysicalFIQException () =
  let
    ...
    val route_to_hyp =
      ((HaveVirtExt ()) andalso
       ((HaveSecurityExt ()) andalso
        ((not((#FIQ)((#SCR) (!CP15)))) andalso
         (((#FMO)((#HCR) (!CP15))) andalso (not(IsSecure ())))))) orelse
      (((#M) (!CPSR)) = (BitsN.B(0x1A,5)))
  in
    if route_to_monitor
      then ( if ((#M) (!CPSR)) = (BitsN.B(0x16,5))
