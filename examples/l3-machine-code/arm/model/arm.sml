(* arm - generated by L3 - Thu Jul 21 13:36:01 2016 *)
...
fun dfn'vmov_double (to_arm_registers,(t,(t2,m))) =
  ( if to_arm_registers
      then ( write'R(BitsN.bits(31,0) (D m),t)
         ...
         ; let
             val x = BitsN.+(m,BitsN.B(0x1,5))
             val w = D x
           in
             write'D(BitsN.bitFieldInsert(63,32) (w,R t2),x)
           end
         )
  ; IncPC ()
  );
...
fun Run v0 =
  case v0 of
   ...
   | Divide v150 => dfn'Divide v150
   | IfThen v151 => dfn'IfThen v151
   | Swap v152 => dfn'Swap v152
   | Undefined v153 => dfn'Undefined v153
   | Branch v1 =>
     (case v1 of
   ...
   | VFP v125 =>
     (case v125 of
       ...
       | vldr v135 => dfn'vldr v135
       | vmla_vmls v136 => dfn'vmla_vmls v136
       | vmov v137 => dfn'vmov v137
       | vmov_double v138 => dfn'vmov_double v138
       | vmov_imm v139 => dfn'vmov_imm v139
       | vmov_single v140 => dfn'vmov_single v140
       | vmov_two_singles v141 => dfn'vmov_two_singles v141
       | vmrs v142 => dfn'vmrs v142
       | vmsr v143 => dfn'vmsr v143
       | vmul v144 => dfn'vmul v144
       | vneg v145 => dfn'vneg v145
       | vneg_mul v146 => dfn'vneg_mul v146
       | vsqrt v147 => dfn'vsqrt v147
       | vstr v148 => dfn'vstr v148
       | vsub v149 => dfn'vsub v149);
     ...
     in
       (not((!VFPExtension) = NoVFP),
        VFP(case BitsN.fromBitstring([op1'1,op1'0],2) of
             ...
             | BitsN.B(0x1,2) => vneg_mul(dp_operation,(typ,(d,(n,m))))
             | BitsN.B(0x2,2) =>
               if op2 = (BitsN.B(0x1,1))
