(* arm - generated by L<3> - Wed May 07 16:36:10 2014 *)
...
fun HaveDSPSupport () =
  not(L3.mem((!Architecture),[ARMv4,ARMv4T,ARMv5T]));

fun HaveThumb2 () = L3.mem((!Architecture),[ARMv6T2,ARMv7_A,ARMv7_R]);

fun HaveThumbEE () =
  ((!Architecture) = ARMv7_A) orelse
  (((!Architecture) = ARMv7_R) andalso
   (L3.mem(Extension_ThumbEE,(!Extensions))));

fun HaveMPExt () =
  (Nat.>=(ArchVersion (),7)) andalso
  (L3.mem(Extension_Multiprocessing,(!Extensions)));

fun HaveSecurityExt () =
  (L3.mem((!Architecture),[ARMv6K,ARMv7_A])) andalso
  (L3.mem(Extension_Security,(!Extensions)));

fun HaveVirtExt () =
  (Nat.>=(ArchVersion (),7)) andalso
  (L3.mem(Extension_Virtualization,(!Extensions)));

fun rec'PSR x =
  {A = BitsN.bit(x,8), C = BitsN.bit(x,29), E = BitsN.bit(x,9),
   F = BitsN.bit(x,6), GE = BitsN.bits(x,19,16), I = BitsN.bit(x,7),
   IT = BitsN.@@(BitsN.bits(x,15,10),BitsN.bits(x,26,25)),
   J = BitsN.bit(x,24), M = BitsN.bits(x,4,0), N = BitsN.bit(x,31),
   Q = BitsN.bit(x,27), T = BitsN.bit(x,5), V = BitsN.bit(x,28),
   Z = BitsN.bit(x,30), psr'rst = BitsN.bits(x,23,20)};
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             ...
             then BitsN.bit(psr'rst,3)
           else if i = 22
             then BitsN.bit(psr'rst,2)
           else if i = 21
             then BitsN.bit(psr'rst,1)
           else if i = 20
             then BitsN.bit(psr'rst,0)
           else if i = 19
             then BitsN.bit(GE,3)
           else if i = 18
             then BitsN.bit(GE,2)
             ...
             then BitsN.bit(M,2)
           else if i = 1 then BitsN.bit(M,1) else BitsN.bit(M,0),
         BitsN.B(0x0,32));
...
fun rec'SCTLR x =
  {A = BitsN.bit(x,1), B = BitsN.bit(x,7), BR = BitsN.bit(x,17),
   ...
   sctlr'rst =
     BitsN.concat
       [BitsN.bits(x,6,3),BitsN.bits(x,9,8),BitsN.bits(x,16,15),
        BitsN.bits(x,18,18),BitsN.bits(x,20,20),BitsN.bits(x,23,23),
        BitsN.bits(x,26,26),BitsN.bits(x,29,28)]};
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             ...
             then BitsN.bit(sctlr'rst,1)
           else if i = 28
             then BitsN.bit(sctlr'rst,0)
           else if i = 27
             then NMFI
           else if i = 26
             then BitsN.bit(sctlr'rst,2)
           else if i = 25
             then EE
           else if i = 24
             then VE
           else if i = 23
             then BitsN.bit(sctlr'rst,3)
           else if i = 22
             then U
           else if i = 21
             then FI
           else if i = 20
             then BitsN.bit(sctlr'rst,4)
           else if i = 19
             then DZ
           else if i = 18
             then BitsN.bit(sctlr'rst,5)
           else if i = 17
             then BR
           else if i = 16
             then BitsN.bit(sctlr'rst,7)
           else if i = 15
             then BitsN.bit(sctlr'rst,6)
           else if i = 14
             then RR
           else if i = 13
             then V
             ...
             then BitsN.bit(sctlr'rst,9)
           else if i = 8
             then BitsN.bit(sctlr'rst,8)
           else if i = 7
             then B
           else if i = 6
             then BitsN.bit(sctlr'rst,13)
           else if i = 5
             then BitsN.bit(sctlr'rst,12)
           else if i = 4
             then BitsN.bit(sctlr'rst,11)
           else if i = 3
             then BitsN.bit(sctlr'rst,10)
           else if i = 2 then C else if i = 1 then A else M,
         BitsN.B(0x0,32));
...
fun rec'HSCTLR x =
  {A = BitsN.bit(x,1), C = BitsN.bit(x,2), CP15BEN = BitsN.bit(x,5),
   ...
   hsctlr'rst =
     BitsN.concat
       [BitsN.bits(x,4,3),BitsN.bits(x,11,6),BitsN.bits(x,18,13),
        BitsN.bits(x,20,20),BitsN.bits(x,24,22),BitsN.bits(x,29,26),
        BitsN.bits(x,31,31)]};
  ...
  case x of
     {A = A, C = C, CP15BEN = CP15BEN, EE = EE, FI = FI, I = I, M = M,
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(hsctlr'rst,0)
           else if i = 30
             then TE
           else if i = 29
             then BitsN.bit(hsctlr'rst,4)
           else if i = 28
             then BitsN.bit(hsctlr'rst,3)
           else if i = 27
             then BitsN.bit(hsctlr'rst,2)
           else if i = 26
             then BitsN.bit(hsctlr'rst,1)
           else if i = 25
             then EE
           else if i = 24
             then BitsN.bit(hsctlr'rst,7)
           else if i = 23
             then BitsN.bit(hsctlr'rst,6)
           else if i = 22
             then BitsN.bit(hsctlr'rst,5)
           else if i = 21
             then FI
           else if i = 20
             then BitsN.bit(hsctlr'rst,8)
           else if i = 19
             then WXN
           else if i = 18
             then BitsN.bit(hsctlr'rst,14)
           else if i = 17
             then BitsN.bit(hsctlr'rst,13)
           else if i = 16
             then BitsN.bit(hsctlr'rst,12)
           else if i = 15
             then BitsN.bit(hsctlr'rst,11)
           else if i = 14
             then BitsN.bit(hsctlr'rst,10)
           else if i = 13
             then BitsN.bit(hsctlr'rst,9)
           else if i = 12
             then I
           else if i = 11
             then BitsN.bit(hsctlr'rst,20)
           else if i = 10
             then BitsN.bit(hsctlr'rst,19)
           else if i = 9
             then BitsN.bit(hsctlr'rst,18)
           else if i = 8
             then BitsN.bit(hsctlr'rst,17)
           else if i = 7
             then BitsN.bit(hsctlr'rst,16)
           else if i = 6
             then BitsN.bit(hsctlr'rst,15)
           else if i = 5
             then CP15BEN
           else if i = 4
             then BitsN.bit(hsctlr'rst,22)
           else if i = 3
             then BitsN.bit(hsctlr'rst,21)
           else if i = 2 then C else if i = 1 then A else M,
         BitsN.B(0x0,32));
...
fun rec'HSR x =
  {EC = BitsN.bits(x,31,26), IL = BitsN.bit(x,25),
   ISS = BitsN.bits(x,24,0)};
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             ...
             then BitsN.bit(ISS,24)
           else if i = 23
             then BitsN.bit(ISS,23)
           else if i = 22
             then BitsN.bit(ISS,22)
           else if i = 21
             then BitsN.bit(ISS,21)
           else if i = 20
             then BitsN.bit(ISS,20)
           else if i = 19
             then BitsN.bit(ISS,19)
           else if i = 18
             then BitsN.bit(ISS,18)
           else if i = 17
             then BitsN.bit(ISS,17)
           else if i = 16
             then BitsN.bit(ISS,16)
           else if i = 15
             then BitsN.bit(ISS,15)
           else if i = 14
             then BitsN.bit(ISS,14)
           else if i = 13
             then BitsN.bit(ISS,13)
           else if i = 12
             then BitsN.bit(ISS,12)
           else if i = 11
             then BitsN.bit(ISS,11)
           else if i = 10
             then BitsN.bit(ISS,10)
           else if i = 9
             then BitsN.bit(ISS,9)
           else if i = 8
             then BitsN.bit(ISS,8)
           else if i = 7
             then BitsN.bit(ISS,7)
           else if i = 6
             then BitsN.bit(ISS,6)
           else if i = 5
             then BitsN.bit(ISS,5)
           else if i = 4
             then BitsN.bit(ISS,4)
           else if i = 3
             then BitsN.bit(ISS,3)
           else if i = 2
             then BitsN.bit(ISS,2)
           else if i = 1 then BitsN.bit(ISS,1) else BitsN.bit(ISS,0),
         BitsN.B(0x0,32));
...
fun rec'SCR x =
  {AW = BitsN.bit(x,5), EA = BitsN.bit(x,3), FIQ = BitsN.bit(x,2),
   ...
   nET = BitsN.bit(x,6), scr'rst = BitsN.bits(x,31,10)};
  ...
  case x of
     {AW = AW, EA = EA, FIQ = FIQ, FW = FW, HCE = HCE, IRQ = IRQ, NS = NS,
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(scr'rst,21)
           else if i = 30
             then BitsN.bit(scr'rst,20)
           else if i = 29
             then BitsN.bit(scr'rst,19)
           else if i = 28
             then BitsN.bit(scr'rst,18)
           else if i = 27
             then BitsN.bit(scr'rst,17)
           else if i = 26
             then BitsN.bit(scr'rst,16)
           else if i = 25
             then BitsN.bit(scr'rst,15)
           else if i = 24
             then BitsN.bit(scr'rst,14)
           else if i = 23
             then BitsN.bit(scr'rst,13)
           else if i = 22
             then BitsN.bit(scr'rst,12)
           else if i = 21
             then BitsN.bit(scr'rst,11)
           else if i = 20
             then BitsN.bit(scr'rst,10)
           else if i = 19
             then BitsN.bit(scr'rst,9)
           else if i = 18
             then BitsN.bit(scr'rst,8)
           else if i = 17
             then BitsN.bit(scr'rst,7)
           else if i = 16
             then BitsN.bit(scr'rst,6)
           else if i = 15
             then BitsN.bit(scr'rst,5)
           else if i = 14
             then BitsN.bit(scr'rst,4)
           else if i = 13
             then BitsN.bit(scr'rst,3)
           else if i = 12
             then BitsN.bit(scr'rst,2)
           else if i = 11
             then BitsN.bit(scr'rst,1)
           else if i = 10
             then BitsN.bit(scr'rst,0)
           else if i = 9
             then SIF
           else if i = 8
             then HCE
             ...
             then EA
           else if i = 2 then FIQ else if i = 1 then IRQ else NS,
         BitsN.B(0x0,32));
...
fun rec'NSACR x =
  {NSASEDIS = BitsN.bit(x,15), NSD32DIS = BitsN.bit(x,14),
   ...
   cp = BitsN.bits(x,13,0),
   nsacr'rst = BitsN.@@(BitsN.bits(x,18,16),BitsN.bits(x,31,21))};
  ...
  case x of
     {NSASEDIS = NSASEDIS, NSD32DIS = NSD32DIS, NSTRCDIS = NSTRCDIS,
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(nsacr'rst,10)
           else if i = 30
             then BitsN.bit(nsacr'rst,9)
           else if i = 29
             then BitsN.bit(nsacr'rst,8)
           else if i = 28
             then BitsN.bit(nsacr'rst,7)
           else if i = 27
             then BitsN.bit(nsacr'rst,6)
           else if i = 26
             then BitsN.bit(nsacr'rst,5)
           else if i = 25
             then BitsN.bit(nsacr'rst,4)
           else if i = 24
             then BitsN.bit(nsacr'rst,3)
           else if i = 23
             then BitsN.bit(nsacr'rst,2)
           else if i = 22
             then BitsN.bit(nsacr'rst,1)
           else if i = 21
             then BitsN.bit(nsacr'rst,0)
           else if i = 20
             then NSTRCDIS
           else if i = 19
             then RFR
           else if i = 18
             then BitsN.bit(nsacr'rst,13)
           else if i = 17
             then BitsN.bit(nsacr'rst,12)
           else if i = 16
             then BitsN.bit(nsacr'rst,11)
           else if i = 15
             then NSASEDIS
           else if i = 14
             then NSD32DIS
           else if i = 13
             then BitsN.bit(cp,13)
           else if i = 12
             then BitsN.bit(cp,12)
           else if i = 11
             then BitsN.bit(cp,11)
           else if i = 10
             then BitsN.bit(cp,10)
           else if i = 9
             then BitsN.bit(cp,9)
           else if i = 8
             then BitsN.bit(cp,8)
             ...
             then BitsN.bit(cp,2)
           else if i = 1 then BitsN.bit(cp,1) else BitsN.bit(cp,0),
         BitsN.B(0x0,32));
...
fun rec'HCR x =
  {AMO = BitsN.bit(x,5), BSU = BitsN.bits(x,11,10), DC = BitsN.bit(x,12),
   ...
   VM = BitsN.bit(x,0), hcr'rst = BitsN.bits(x,31,28)};
  ...
  case x of
     {AMO = AMO, BSU = BSU, DC = DC, FB = FB, FMO = FMO, IMO = IMO,
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             then BitsN.bit(hcr'rst,3)
           else if i = 30
             then BitsN.bit(hcr'rst,2)
           else if i = 29
             then BitsN.bit(hcr'rst,1)
           else if i = 28
             then BitsN.bit(hcr'rst,0)
           else if i = 27
             then TGE
           else if i = 26
             then TVM
             ...
             then BitsN.bit(TID,3)
           else if i = 17
             then BitsN.bit(TID,2)
           else if i = 16
             then BitsN.bit(TID,1)
           else if i = 15
             then BitsN.bit(TID,0)
           else if i = 14
             then TWE
           else if i = 13
             then TWI
             ...
             then BitsN.bit(BSU,1)
           else if i = 10
             then BitsN.bit(BSU,0)
           else if i = 9
             then FB
           else if i = 8
             then VA
             ...
             then FMO
           else if i = 2 then PTW else if i = 1 then SWIO else VM,
         BitsN.B(0x0,32));
...
fun IsSecure () =
  ((not(HaveSecurityExt ())) orelse (not((#NS)((#SCR) (!CP15))))) orelse
  (((#M) (!CPSR)) = (BitsN.B(0x16,5)));

fun UnalignedSupport () =
  let
    val v = ArchVersion ()
  in
    (Nat.>=(v,7)) orelse ((v = 6) andalso ((#U)((#SCTLR) (!CP15))))
  end;

fun BadMode mode =
  case mode of
     BitsN.B(0x10,5) => false
   | BitsN.B(0x11,5) => false
   | BitsN.B(0x12,5) => false
   | BitsN.B(0x13,5) => false
   | BitsN.B(0x16,5) => not(HaveSecurityExt ())
   | BitsN.B(0x17,5) => false
   | BitsN.B(0x1A,5) => not(HaveVirtExt ())
   | BitsN.B(0x1B,5) => false
   | BitsN.B(0x1F,5) => false
   | _ => true;

fun CurrentModeIsNotUser () =
  ( if BadMode((#M) (!CPSR))
      then raise UNPREDICTABLE
             (("BadMode: ") ^ (BitsN.toHexString((#M) (!CPSR))))
    else ()
  ; not(((#M) (!CPSR)) = (BitsN.B(0x10,5)))
  );
...
fun CurrentModeIsUserOrSystem () =
  ...
  ; L3.mem((#M) (!CPSR),[BitsN.B(0x10,5),BitsN.B(0x1F,5)])
  );
...
fun CurrentModeIsHyp () =
  ...
  ; ((#M) (!CPSR)) = (BitsN.B(0x1A,5))
  );

fun IntegerZeroDivideTrappingEnabled () = (#DZ)((#SCTLR) (!CP15));

fun ISETSTATE () =
  BitsN.@@(BitsN.fromBit((#J) (!CPSR)),BitsN.fromBit((#T) (!CPSR)));
...
fun CurrentInstrSet () =
  case ISETSTATE () of
     BitsN.B(0x0,2) => InstrSet_ARM
   | BitsN.B(0x1,2) => InstrSet_Thumb
   | BitsN.B(0x2,2) => InstrSet_Jazelle
   | BitsN.B(0x3,2) => InstrSet_ThumbEE
...
fun ITSTATE () = if HaveThumb2 () then (#IT) (!CPSR) else BitsN.B(0x0,8);

fun write'ITSTATE value = CPSR := (PSR_IT_rupd((!CPSR),value));

fun ITAdvance () =
  if (HaveThumb2 ()) andalso (not((!Encoding) = Encoding_ARM))
    then if (BitsN.bits(ITSTATE (),2,0)) = (BitsN.B(0x0,3))
              ...
              in
                write'ITSTATE
                  (BitsN.bitFieldInsert
                     (w,BitsN.<<(BitsN.bits(ITSTATE (),4,0),1),4,0))
              end
  else ();

fun InITBlock () = not((BitsN.bits(ITSTATE (),3,0)) = (BitsN.B(0x0,4)));

fun LastInITBlock () = (BitsN.bits(ITSTATE (),3,0)) = (BitsN.B(0x8,4));

fun ThumbCondition () =
  if (ITSTATE ()) = (BitsN.B(0x0,8))
    then BitsN.B(0xE,4)
  else if not((BitsN.bits((#IT) (!CPSR),3,0)) = (BitsN.B(0x0,4)))
    then BitsN.bits((#IT) (!CPSR),7,4)
  else raise UNPREDICTABLE ("ThumbCondition");

fun BigEndian () = (#E) (!CPSR);
...
fun ConditionPassed () =
  let
    ...
    val result =
      case BitsN.bits(cond,3,1) of
         BitsN.B(0x0,3) => (#Z) (!CPSR)
       | BitsN.B(0x1,3) => (#C) (!CPSR)
       | BitsN.B(0x2,3) => (#N) (!CPSR)
       | BitsN.B(0x3,3) => (#V) (!CPSR)
       | BitsN.B(0x4,3) => ((#C) (!CPSR)) andalso (not((#Z) (!CPSR)))
       | BitsN.B(0x5,3) => ((#N) (!CPSR)) = ((#V) (!CPSR))
       | BitsN.B(0x6,3) =>
            (((#N) (!CPSR)) = ((#V) (!CPSR))) andalso (not((#Z) (!CPSR)))
       | BitsN.B(0x7,3) => true
       | _ => raise General.Bind
  in
...
fun SPSR () =
  if BadMode((#M) (!CPSR))
    then raise UNPREDICTABLE
           (("SPSR: BadMode: ") ^ (BitsN.toHexString((#M) (!CPSR))))
  else case (#M) (!CPSR) of
          BitsN.B(0x11,5) => (!SPSR_fiq)
        | BitsN.B(0x12,5) => (!SPSR_irq)
        | BitsN.B(0x13,5) => (!SPSR_svc)
        | BitsN.B(0x16,5) => (!SPSR_mon)
        | BitsN.B(0x17,5) => (!SPSR_abt)
        | BitsN.B(0x1A,5) => (!SPSR_hyp)
        | BitsN.B(0x1B,5) => (!SPSR_und)
...
fun write'SPSR value =
  if BadMode((#M) (!CPSR))
    then raise UNPREDICTABLE
          ...
          BitsN.B(0x11,5) => SPSR_fiq := value
        | BitsN.B(0x12,5) => SPSR_irq := value
        | BitsN.B(0x13,5) => SPSR_svc := value
        | BitsN.B(0x16,5) => SPSR_mon := value
        | BitsN.B(0x17,5) => SPSR_abt := value
        | BitsN.B(0x1A,5) => SPSR_hyp := value
        | BitsN.B(0x1B,5) => SPSR_und := value
        | _ => raise UNPREDICTABLE ("SPSR");

fun CPSRWriteByInstr (value,(bytemask,is_excpt_return)) =
  let
    val privileged = CurrentModeIsNotUser ()
    val nmfi = (#NMFI)((#SCTLR) (!CP15))
  in
    ( if BitsN.bit(bytemask,3)
        then ( let
               ...
               in
                 ...
                 (write'reg'PSR
                    ((!CPSR),
                     BitsN.bitFieldInsert(w,BitsN.bits(value,31,27),31,27)))
               end
             ; if is_excpt_return
                 then let
                        val w = reg'PSR (!CPSR)
                      in
                        ...
                        (write'reg'PSR
                           ((!CPSR),
                            BitsN.bitFieldInsert
                              (w,BitsN.bits(value,26,24),26,24)))
                      end
               else ()
             )
      else ()
    ; if BitsN.bit(bytemask,2)
        then let
             ...
             in
               ...
               (write'reg'PSR
                  ((!CPSR),
                   BitsN.bitFieldInsert(w,BitsN.bits(value,19,16),19,16)))
             end
      else ()
                 ...
                 then let
                      ...
                      in
                        ...
                        (write'reg'PSR
                           ((!CPSR),
                            BitsN.bitFieldInsert
                              (w,BitsN.bits(value,15,10),15,10)))
                      end
               else ()
             ; let
                 val w = reg'PSR (!CPSR)
               in
                 ...
                 (write'reg'PSR
                    ((!CPSR),
                     BitsN.bitFieldInsert
                       (w,BitsN.fromBit(BitsN.bit(value,9)),9,9)))
               end
             ; if privileged andalso
                  ((IsSecure ()) orelse ((#AW)((#SCR) (!CP15))))
                 then let
                        val w = reg'PSR (!CPSR)
                      in
                        CPSR :=
                        (write'reg'PSR
                           ((!CPSR),
                            BitsN.bitFieldInsert
                              (w,BitsN.fromBit(BitsN.bit(value,8)),8,8)))
                      end
               else ()
             )
      else ()
                 ...
                 then let
                      ...
                      in
                        ...
                        (write'reg'PSR
                           ((!CPSR),
                            BitsN.bitFieldInsert
                              (w,BitsN.fromBit(BitsN.bit(value,7)),7,7)))
                      end
               else ()
             ; if (privileged andalso
                   ((not nmfi) orelse (not(BitsN.bit(value,6))))) andalso
                  (((IsSecure ()) orelse ((#FW)((#SCR) (!CP15)))) orelse
                   (HaveVirtExt ()))
                 then let
                        val w = reg'PSR (!CPSR)
                      in
                        ...
                        (write'reg'PSR
                           ((!CPSR),
                            BitsN.bitFieldInsert
                              (w,BitsN.fromBit(BitsN.bit(value,6)),6,6)))
                      end
               else ()
             ; if is_excpt_return
                 then let
                      ...
                      in
                        ...
                        (write'reg'PSR
                           ((!CPSR),
                            BitsN.bitFieldInsert
                              (w,BitsN.fromBit(BitsN.bit(value,5)),5,5)))
                      end
               else ()
             ; if privileged
                 then if BadMode(BitsN.bits(value,4,0))
                        then raise UNPREDICTABLE
                               (("CPSRWriteByInstr: BadMode: ")
                                  ^
                                  (BitsN.toHexString
                                   (BitsN.bits(value,4,0))))
                           ...
                           ; if ((not(IsSecure ())) andalso
                                 (not(((#M) (!CPSR)) = (BitsN.B(0x1A,5))))) andalso
                                ((BitsN.bits(value,4,0)) =
                                 (BitsN.B(0x1A,5)))
                               then raise UNPREDICTABLE
                                      ("CPSRWriteByInstr")
                             else ()
                           ; if ((((#M) (!CPSR)) = (BitsN.B(0x1A,5))) andalso
                                 (not((BitsN.bits(value,4,0)) =
  ...
  ; if BitsN.bit(bytemask,3)
      then let
           ...
           in
             write'SPSR
               (write'reg'PSR
                  (x,BitsN.bitFieldInsert(w,BitsN.bits(value,31,24),31,24)))
           end
    else ()
  ; if BitsN.bit(bytemask,2)
      then let
           ...
           in
             write'SPSR
               (write'reg'PSR
                  (x,BitsN.bitFieldInsert(w,BitsN.bits(value,19,16),19,16)))
           end
    else ()
  ; if BitsN.bit(bytemask,1)
      then let
           ...
           in
             write'SPSR
               (write'reg'PSR
                  (x,BitsN.bitFieldInsert(w,BitsN.bits(value,15,8),15,8)))
           end
    else ()
  ; if BitsN.bit(bytemask,0)
      then ( let
             ...
             in
               write'SPSR
                 (write'reg'PSR
                    (x,BitsN.bitFieldInsert(w,BitsN.bits(value,7,5),7,5)))
             end
           ; if BadMode(BitsN.bits(value,4,0))
               then raise UNPREDICTABLE
                      (("SPSRWriteByInstr: BadMode: ")
                         ^
                         (BitsN.toHexString(BitsN.bits(value,4,0))))
             else let
                    val x = SPSR ()
                    val w = reg'PSR x
                  in
...
fun LookUpRName (n,mode) =
  case n of
     BitsN.B(0x0,4) => RName_0usr
   | BitsN.B(0x1,4) => RName_1usr
   | BitsN.B(0x2,4) => RName_2usr
   | BitsN.B(0x3,4) => RName_3usr
   | BitsN.B(0x4,4) => RName_4usr
   | BitsN.B(0x5,4) => RName_5usr
   | BitsN.B(0x6,4) => RName_6usr
   | BitsN.B(0x7,4) => RName_7usr
   | BitsN.B(0x8,4) => RfiqBankSelect(mode,(RName_8usr,RName_8fiq))
   | BitsN.B(0x9,4) => RfiqBankSelect(mode,(RName_9usr,RName_9fiq))
   | BitsN.B(0xA,4) => RfiqBankSelect(mode,(RName_10usr,RName_10fiq))
   | BitsN.B(0xB,4) => RfiqBankSelect(mode,(RName_11usr,RName_11fiq))
   | BitsN.B(0xC,4) => RfiqBankSelect(mode,(RName_12usr,RName_12fiq))
   | BitsN.B(0xD,4) =>
        RBankSelect
          (mode,
           (RName_SPusr,
   ...
   | BitsN.B(0xF,4) => raise ASSERT ("LookUpRName: n >= 0 and n <= 14")
   | _ => raise General.Bind;
...
fun Rmode (n,mode) =
  ...
  in
    ...
    ; if (notSecure andalso (mode = (BitsN.B(0x11,5)))) andalso
         ((#RFR)((#NSACR) (!CP15)))
        then raise UNPREDICTABLE ("Rmode")
      else ()
...
fun write'Rmode (value,(n,mode)) =
  ...
  in
    ...
    ; if ((n = (BitsN.B(0xD,4))) andalso
          (not((BitsN.bits(value,1,0)) = (BitsN.B(0x0,2))))) andalso
...
fun write'R (value,n) =
  let val x = (n,(#M) (!CPSR)) in write'Rmode(value,x) end;
...
fun BranchWritePC address =
  if (CurrentInstrSet ()) = InstrSet_ARM
    then ( if (Nat.<(ArchVersion (),6)) andalso
              (not((BitsN.bits(address,1,0)) = (BitsN.B(0x0,2))))
             then raise UNPREDICTABLE ("BranchWritePC")
           else ()
         ; BranchTo(BitsN.@@(BitsN.bits(address,31,2),BitsN.B(0x0,2)))
         )
  else BranchTo(BitsN.@@(BitsN.bits(address,31,1),BitsN.B(0x0,1)));

fun BXWritePC address =
  if (CurrentInstrSet ()) = InstrSet_ThumbEE
    then if BitsN.bit(address,0)
           then BranchTo
                  (BitsN.@@(BitsN.bits(address,31,1),BitsN.B(0x0,1)))
         else raise UNPREDICTABLE ("BXWritePC")
  else if BitsN.bit(address,0)
    then ( SelectInstrSet InstrSet_Thumb
         ; BranchTo(BitsN.@@(BitsN.bits(address,31,1),BitsN.B(0x0,1)))
         )
...
fun mem (address,size) =
  case size of
     1 => Bitstring.bits(mem1(BitsN.+(address,BitsN.B(0x0,32))),7,0)
   | 2 =>
        Bitstring.bits
          ((mem1(BitsN.+(address,BitsN.B(0x1,32))))
             @
             (mem1(BitsN.+(address,BitsN.B(0x0,32)))),15,0)
   | 4 =>
        Bitstring.bits
          (List.concat
             [mem1(BitsN.+(address,BitsN.B(0x3,32))),
              ...
              mem1(BitsN.+(address,BitsN.B(0x1,32))),
              mem1(BitsN.+(address,BitsN.B(0x0,32)))],31,0)
   | 8 =>
        Bitstring.bits
          (List.concat
             [mem1(BitsN.+(address,BitsN.B(0x7,32))),
              ...
              mem1(BitsN.+(address,BitsN.B(0x2,32))),
              mem1(BitsN.+(address,BitsN.B(0x1,32))),
              mem1(BitsN.+(address,BitsN.B(0x0,32)))],63,0)
  ...
  case size of
     1 =>
        ...
        in
          ...
          (Map.update
             ((!MEM),BitsN.toNat x,
              BitsN.fromBitstring(Bitstring.bits(value,7,0),8)))
        end
   | 2 =>
        ( let
            val x = BitsN.+(address,BitsN.B(0x0,32))
        ...
        ; let
          ...
          in
            ...
            (Map.update
               ((!MEM),BitsN.toNat x,
                BitsN.fromBitstring(Bitstring.bits(value,15,8),8)))
          end
        )
   | 4 =>
        ( let
        ...
        ; let
          ...
          in
            ...
            (Map.update
               ((!MEM),BitsN.toNat x,
                BitsN.fromBitstring(Bitstring.bits(value,23,16),8)))
          end
        ; let
          ...
          in
            ...
            (Map.update
               ((!MEM),BitsN.toNat x,
                BitsN.fromBitstring(Bitstring.bits(value,31,24),8)))
          end
        )
   | 8 =>
        ( let
        ...
        ; let
          ...
          in
            ...
            (Map.update
               ((!MEM),BitsN.toNat x,
                BitsN.fromBitstring(Bitstring.bits(value,39,32),8)))
          end
        ; let
          ...
          in
            ...
            (Map.update
               ((!MEM),BitsN.toNat x,
                BitsN.fromBitstring(Bitstring.bits(value,47,40),8)))
          end
        ; let
          ...
          in
            ...
            (Map.update
               ((!MEM),BitsN.toNat x,
                BitsN.fromBitstring(Bitstring.bits(value,55,48),8)))
          end
        ; let
          ...
          in
            ...
            (Map.update
               ((!MEM),BitsN.toNat x,
                BitsN.fromBitstring(Bitstring.bits(value,63,56),8)))
          end
        )
   | _ => raise ASSERT ("mem: size in {1, 2, 4, 8}");
...
fun BigEndianReverse (value,n) =
  case n of
     1 => Bitstring.bits(value,7,0)
   | 2 => (Bitstring.bits(value,7,0)) @ (Bitstring.bits(value,15,8))
   | 4 =>
        List.concat
          [Bitstring.bits(value,7,0),Bitstring.bits(value,15,8),
           Bitstring.bits(value,23,16),Bitstring.bits(value,31,24)]
   | 8 =>
        List.concat
          [Bitstring.bits(value,7,0),Bitstring.bits(value,15,8),
           Bitstring.bits(value,23,16),Bitstring.bits(value,31,24),
           Bitstring.bits(value,39,32),Bitstring.bits(value,47,40),
           Bitstring.bits(value,55,48),Bitstring.bits(value,63,56)]
...
fun MemA_with_priv N (address,(size,privileged)) =
  ...
  in
    ( if Aligned 32 (address,size)
        then VA := address
      else if ((#A)((#SCTLR) (!CP15))) orelse ((#U)((#SCTLR) (!CP15)))
              ...
              fn i =>
                ...
                in
                  write'MemA_with_priv 8
                    (BitsN.fromBitstring
                       (Bitstring.bits(v,Nat.+(Nat.*(8,i),7),Nat.*(8,i)),8),
                     x)
                end)
         end
  end;
  ...
  in
    ( if (CurrentInstrSet ()) = InstrSet_ThumbEE
        then if n = (BitsN.B(0xF,4))
               ...
               then ( write'LR
                        (BitsN.@@(BitsN.bits(PC (),31,1),BitsN.B(0x1,1)))
                    ; write'ITSTATE(BitsN.B(0x0,8))
                    ; BranchWritePC
                        (BitsN.-((#TEEHBR) (!CP14),BitsN.B(0x4,32)))
...
fun HighestSetBit N w =
  if w = (BitsN.B(0x0,N)) then Int.~ 1 else BitsN.toInt(BitsN.log2 w);

fun CountLeadingZeroBits N w =
  Nat.fromInt
    (Int.-
       (Int.-(Nat.toInt(BitsN.size(BitsN.B(0x0,N))),1),HighestSetBit N w));
...
fun BitCount N w =
  ...
  in
    ( L3.for
        (0,Nat.-(BitsN.size(BitsN.B(0x0,N)),1),
         fn i =>
...
fun SignExtendFrom N (w,p) =
  let
    val s = Nat.-(BitsN.size(BitsN.B(0x0,N)),p)
  in
    BitsN.>>(BitsN.<<(w,s),s)
  end;
...
fun SignedSatQ M (i,N) =
  ( if Nat.<(BitsN.size(BitsN.B(0x0,M)),N)
      then raise ASSERT ("SignedSatQ: M < N")
    else ()
  ; let
      val max = Nat.toInt(Nat.-(Nat.pow(2,Nat.-(N,1)),1))
    in
      if Int.>(i,max)
        then (BitsN.fromInt(max,M),true)
      else if Int.<(i,Int.~ max)
        then (BitsN.neg(BitsN.fromInt(max,M)),true)
...
fun LSL_C N (x,shift) =
  ...
  ; let
    ...
    in
      (BitsN.<<(x,shift),
       Bitstring.bit(extended_x,BitsN.size(BitsN.B(0x0,N))))
    end
  );
...
fun LSR_C N (x,shift) =
  ...
  ; (BitsN.>>+(x,shift),
     (Nat.<=(shift,BitsN.size(BitsN.B(0x0,N)))) andalso
...
fun ASR_C N (x,shift) =
  ...
  ; (BitsN.>>(x,shift),
     BitsN.bit(x,Nat.-(Nat.min(BitsN.size(BitsN.B(0x0,N)),shift),1)))
  );
    ...
    val result =
      BitsN.fromBitstring
        ((Bitstring.fromBool carry_in)
           @
           (Bitstring.bits
            (BitsN.toBitstring x,Nat.-(BitsN.size(BitsN.B(0x0,N)),1),1)),N)
  in
...
fun DecodeImmShift (typ,imm5) =
  case typ of
     BitsN.B(0x0,2) => (SRType_LSL,BitsN.toNat imm5)
   | BitsN.B(0x1,2) =>
        (SRType_LSR,
         if imm5 = (BitsN.B(0x0,5)) then 32 else BitsN.toNat imm5)
   | BitsN.B(0x2,2) =>
        (SRType_ASR,
         if imm5 = (BitsN.B(0x0,5)) then 32 else BitsN.toNat imm5)
   | BitsN.B(0x3,2) =>
...
fun DecodeRegShift typ =
  case typ of
     BitsN.B(0x0,2) => SRType_LSL
   | BitsN.B(0x1,2) => SRType_LSR
   | BitsN.B(0x2,2) => SRType_ASR
   | BitsN.B(0x3,2) => SRType_ROR
   | _ => raise General.Bind;
...
fun ARMExpandImm_C (imm12,carry_in) =
  let
    val unroatated_value = BitsN.zeroExtend 32 (BitsN.bits(imm12,7,0))
  in
    Shift_C 32
      (unroatated_value,
       (SRType_ROR,(Nat.*(2,BitsN.toNat(BitsN.bits(imm12,11,8))),carry_in)))
  end;

fun ARMExpandImm imm12 = L3.fst(ARMExpandImm_C(imm12,(#C) (!CPSR)));

fun ThumbExpandImm_C (imm12,carry_in) =
  if (BitsN.bits(imm12,11,10)) = (BitsN.B(0x0,2))
    then let
           val imm32 =
             case BitsN.bits(imm12,9,8) of
                BitsN.B(0x0,2) =>
                   BitsN.zeroExtend 32 (BitsN.bits(imm12,7,0))
              | BitsN.B(0x1,2) =>
                   if (BitsN.bits(imm12,7,0)) = (BitsN.B(0x0,8))
                     then raise UNPREDICTABLE ("ThumbExpandImm_C")
                   else BitsN.concat
                          [BitsN.B(0x0,8),BitsN.bits(imm12,7,0),
                           BitsN.B(0x0,8),BitsN.bits(imm12,7,0)]
              | BitsN.B(0x2,2) =>
                   if (BitsN.bits(imm12,7,0)) = (BitsN.B(0x0,8))
                     then raise UNPREDICTABLE ("ThumbExpandImm_C")
                   else BitsN.concat
                          [BitsN.bits(imm12,7,0),BitsN.B(0x0,8),
                           BitsN.bits(imm12,7,0),BitsN.B(0x0,8)]
              | BitsN.B(0x3,2) =>
                   if (BitsN.bits(imm12,7,0)) = (BitsN.B(0x0,8))
                     then raise UNPREDICTABLE ("ThumbExpandImm_C")
                   else BitsN.concat
                          [BitsN.bits(imm12,7,0),BitsN.bits(imm12,7,0),
                           BitsN.bits(imm12,7,0),BitsN.bits(imm12,7,0)]
              | _ => raise General.Bind
         in
           (imm32,carry_in)
         ...
         val unroatated_value =
           BitsN.zeroExtend 32
             (BitsN.@@(BitsN.B(0x1,1),BitsN.bits(imm12,6,0)))
       in
         ROR_C 32 (unroatated_value,BitsN.toNat(BitsN.bits(imm12,11,7)))
       end;
...
fun AddWithCarry N (x,(y,carry_in)) =
  let
    ...
    val signed_sum =
      Int.+(Int.+(BitsN.toInt x,BitsN.toInt y),IntExtra.fromBool carry_in)
...
fun DataProcessingALU (opc,(a,(b,c))) =
  case opc of
     BitsN.B(0x0,4) => (BitsN.&&(a,b),(c,false))
   | BitsN.B(0x8,4) => (BitsN.&&(a,b),(c,false))
   | BitsN.B(0x1,4) => (BitsN.??(a,b),(c,false))
   | BitsN.B(0x9,4) => (BitsN.??(a,b),(c,false))
   | BitsN.B(0x2,4) => AddWithCarry 32 (a,(BitsN.~ b,true))
   | BitsN.B(0xA,4) => AddWithCarry 32 (a,(BitsN.~ b,true))
   | BitsN.B(0x3,4) => AddWithCarry 32 (BitsN.~ a,(b,true))
   | BitsN.B(0x4,4) => AddWithCarry 32 (a,(b,false))
   | BitsN.B(0xB,4) => AddWithCarry 32 (a,(b,false))
   | BitsN.B(0x5,4) => AddWithCarry 32 (a,(b,c))
   | BitsN.B(0x6,4) => AddWithCarry 32 (a,(BitsN.~ b,c))
   | BitsN.B(0x7,4) => AddWithCarry 32 (BitsN.~ a,(b,c))
   | BitsN.B(0xC,4) => (BitsN.||(a,b),(c,false))
   | BitsN.B(0xD,4) => (b,(c,false))
   | BitsN.B(0xE,4) => (BitsN.&&(a,BitsN.~ b),(c,false))
   | BitsN.B(0xF,4) => (BitsN.||(a,BitsN.~ b),(c,false))
   | _ => raise General.Bind;
...
fun ExcVectorBase () =
  ...
  else if HaveSecurityExt () then (#VBAR) (!CP15) else BitsN.B(0x0,32);
...
fun TakeUndefInstrException () =
  let
    ...
    val take_to_hyp =
      (((HaveVirtExt ()) andalso (HaveSecurityExt ())) andalso
       ((#NS)((#SCR) (!CP15)))) andalso
      (((#M) (!CPSR)) = (BitsN.B(0x1A,5)))
    val route_to_hyp =
      ((((HaveVirtExt ()) andalso (HaveSecurityExt ())) andalso
        (not(IsSecure ()))) andalso ((#TGE)((#HCR) (!CP15)))) andalso
      (((#M) (!CPSR)) = (BitsN.B(0x10,5)))
    val return_offset =
      if (#T) (!CPSR) then BitsN.B(0x2,32) else BitsN.B(0x4,32)
...
fun TakeSMCException () =
  ...
  ; let
      val new_lr_value =
        if (#T) (!CPSR) then PC () else BitsN.-(PC (),BitsN.B(0x4,32))
      val new_spsr_value = (!CPSR)
      val vect_offset = BitsN.B(0x8,32)
    in
      ( if ((#M) (!CPSR)) = (BitsN.B(0x16,5))
          then let
                 val x0 = (#SCR) (!CP15)
               in
                 CP15 := (CP15_SCR_rupd((!CP15),SCR_NS_rupd(x0,false)))
  ...
  in
    if route_to_monitor
      ...
      then EnterHypMode
         ...
         ; write'R(new_lr_value,BitsN.B(0xE,4))
         ; CPSR := (PSR_I_rupd((!CPSR),true))
         ; if (((not(HaveSecurityExt ())) orelse (HaveVirtExt ())) orelse
               (not((#NS)((#SCR) (!CP15))))) orelse
              ((#AW)((#SCR) (!CP15)))
...
fun TakePhysicalIRQException () =
  let
    ...
    val route_to_monitor =
      (HaveSecurityExt ()) andalso ((#IRQ)((#SCR) (!CP15)))
    val route_to_hyp =
      (((((HaveVirtExt ()) andalso (HaveSecurityExt ())) andalso
         (not((#IRQ)((#SCR) (!CP15))))) andalso ((#IMO)((#HCR) (!CP15)))) andalso
       (not(IsSecure ()))) orelse (((#M) (!CPSR)) = (BitsN.B(0x1A,5)))
  in
    if route_to_monitor
      then ( if ((#M) (!CPSR)) = (BitsN.B(0x16,5))
               then let
...
fun TakePhysicalFIQException () =
  let
    ...
    val route_to_monitor =
      (HaveSecurityExt ()) andalso ((#FIQ)((#SCR) (!CP15)))
    val route_to_hyp =
      (((((HaveVirtExt ()) andalso (HaveSecurityExt ())) andalso
         (not((#FIQ)((#SCR) (!CP15))))) andalso ((#FMO)((#HCR) (!CP15)))) andalso
       (not(IsSecure ()))) orelse (((#M) (!CPSR)) = (BitsN.B(0x1A,5)))
  in
    if route_to_monitor
      then ( if ((#M) (!CPSR)) = (BitsN.B(0x16,5))
...
fun WriteHSR (ec,HSRString) =
  ...
  in
    ( HSRValue := (BitsN.bitFieldInsert((!HSRValue),ec,31,26))
    ; if (not((BitsN.bits(ec,5,3)) = (BitsN.B(0x4,3)))) orelse
         ((BitsN.bit(ec,2)) andalso (BitsN.bit(HSRString,24)))
        then HSRValue :=
             (BitsN.bitFieldInsert
                ((!HSRValue),BitsN.fromBit((ThisInstrLength ()) = 32),25,
                 25))
      else ()
    ; if ((BitsN.bits(ec,5,4)) = (BitsN.B(0x0,2))) andalso
         (not((BitsN.bits(ec,3,0)) = (BitsN.B(0x0,4))))
        then if (CurrentInstrSet ()) = InstrSet_ARM
               then ( HSRValue :=
                      (BitsN.bitFieldInsert
                         ((!HSRValue),BitsN.fromBit true,24,24))
                    ; HSRValue :=
                      (BitsN.bitFieldInsert
                         ((!HSRValue),CurrentCond (),23,20))
                    )
             else ( HSRValue :=
                    (BitsN.bitFieldInsert
                       ((!HSRValue),BitsN.fromBit false,24,24))
                  ...
                  ; HSRValue :=
                    (BitsN.bitFieldInsert
                       ((!HSRValue),BitsN.bits(HSRString,19,0),19,0))
                  )
      else HSRValue := (BitsN.bitFieldInsert((!HSRValue),HSRString,24,0))
    ; let
        val x0 = (#HSR) (!CP15)
      in
...
fun CallSupervisor immediate =
  ( if (CurrentModeIsHyp ()) orelse
       ((((HaveVirtExt ()) andalso (not(IsSecure ()))) andalso
         (not(CurrentModeIsNotUser ()))) andalso ((#TGE)((#HCR) (!CP15))))
      then let
...
fun BankedRegisterAccessValid (SYSm,mode) =
  if (BitsN.bits(SYSm,4,3)) = (BitsN.B(0x0,2))
    then if (BitsN.bits(SYSm,2,0)) = (BitsN.B(0x7,3))
           then raise UNPREDICTABLE ("BankedRegisterAccessValid")
         else if (BitsN.bits(SYSm,2,0)) = (BitsN.B(0x6,3))
           then if L3.mem(mode,[BitsN.B(0x1A,5),BitsN.B(0x1F,5)])
                  then raise UNPREDICTABLE ("BankedRegisterAccessValid")
                else ()
         else if (BitsN.bits(SYSm,2,0)) = (BitsN.B(0x5,3))
  ...
  else if (BitsN.bits(SYSm,4,3)) = (BitsN.B(0x1,2))
    then if (((BitsN.bits(SYSm,2,0)) = (BitsN.B(0x7,3))) orelse
             (mode = (BitsN.B(0x11,5)))) orelse
            (((#RFR)((#NSACR) (!CP15))) andalso (not(IsSecure ())))
           then raise UNPREDICTABLE ("BankedRegisterAccessValid")
         else ()
  else if (BitsN.bits(SYSm,4,3)) = (BitsN.B(0x3,2))
...
fun SPSRAccessValid (SYSm,mode) =
  case SYSm of
     BitsN.B(0xE,5) =>
        if ((not(IsSecure ())) andalso ((#RFR)((#NSACR) (!CP15)))) orelse
           (mode = (BitsN.B(0x11,5)))
...
fun dfn'BranchLinkExchangeImmediate (targetInstrSet,imm32) =
  ( if (CurrentInstrSet ()) = InstrSet_ARM
    ...
    else write'LR(BitsN.@@(BitsN.bits(PC (),31,1),BitsN.B(0x1,1)))
  ; let
      val targetAddress =
  ...
  in
    ( if (CurrentInstrSet ()) = InstrSet_ARM
        then let
           ...
           in
             write'LR
               (BitsN.@@(BitsN.bits(next_instr_addr,31,1),BitsN.B(0x1,1)))
           end
    ; BXWritePC target
    )
  end;
...
fun dfn'CheckArray (m,n) =
  if BitsN.<=+(R n,R m)
    then ( write'LR(BitsN.@@(BitsN.bits(PC (),31,1),BitsN.B(0x1,1)))
         ; write'ITSTATE(BitsN.B(0x0,8))
         ; BranchWritePC(BitsN.-((#TEEHBR) (!CP14),BitsN.B(0x8,32)))
         )
  else IncPC ();
...
fun dfn'HandlerBranchLink (generate_link,handler_offset) =
  ...
  ; BranchWritePC(BitsN.+((#TEEHBR) (!CP14),handler_offset))
  );
...
fun dfn'MoveHalfword (high,(d,imm16)) =
  ( if high
      then let
             val w = R d
           in
             write'R(BitsN.bitFieldInsert(w,imm16,31,16),d)
           end
...
fun DataProcessingPC (opc,(setflags,(n,(imm32,C)))) =
  let
    val rn =
      if (opc = (BitsN.B(0xD,4))) orelse
         ((opc = (BitsN.B(0xF,4))) andalso (n = (BitsN.B(0xF,4))))
...
fun dfn'Move (setflags,(negate,(d,imm12))) =
  let
    ...
    val (imm32,carry) = ExpandImm_C(imm12,(#C) (!CPSR))
  in
    if d = (BitsN.B(0xF,4))
      then DataProcessingPC(opc,(setflags,(BitsN.B(0xF,4),(imm32,carry))))
...
fun dfn'ArithLogicImmediate (opc,(setflags,(d,(n,imm12)))) =
  ...
  in
    if d = (BitsN.B(0xF,4))
      then DataProcessingPC(opc,(setflags,(n,(imm32,carry))))
...
fun doRegister (opc,(setflags,(d,(n,(m,(shift_t,shift_n)))))) =
  let
    val (shifted,carry) =
      Shift_C 32 (R m,(shift_t,(shift_n,(#C) (!CPSR))))
    val carry = if ArithmeticOpcode opc then (#C) (!CPSR) else carry
  in
    if d = (BitsN.B(0xF,4))
      then DataProcessingPC(opc,(setflags,(n,(shifted,carry))))
...
fun doRegisterShiftedRegister (opc,(setflags,(d,(n,(m,(shift_t,s)))))) =
  let
    val (shifted,carry) =
      Shift_C 32
        (R m,(shift_t,(BitsN.toNat(BitsN.bits(R s,7,0)),(#C) (!CPSR))))
    val carry = if ArithmeticOpcode opc then (#C) (!CPSR) else carry
  in
      ...
      ( case opc of
           BitsN.B(0x0,2) =>
              let
                val (r,s) =
                  SignedSatQ 32
                    (Int.+(BitsN.toInt(R m),BitsN.toInt(R n)),32)
              in
                ( result := r; sat := s )
              end
         | BitsN.B(0x1,2) =>
         ...
         | BitsN.B(0x2,2) =>
              let
                val (doubled,sat1) =
                  SignedSatQ 32 (Int.*(2,BitsN.toInt(R n)),32)
                val (r,sat2) =
                  SignedSatQ 32
                    (Int.+(BitsN.toInt(R m),BitsN.toInt doubled),32)
              in
                ( result := r; sat := sat1 )
              end
         | BitsN.B(0x3,2) =>
    ...
    ; if setflags
        then ( CPSR := (PSR_N_rupd((!CPSR),BitsN.bit(result,31)))
             ...
             ; if (ArchVersion ()) = 4
                 then CPSR :=
                      (PSR_C_rupd
                         ((!CPSR),(L3.K false) (rn,(rm,(ra,(#C) (!CPSR))))))
               else ()
             )
      else ()
    ; IncPC ()
...
fun dfn'MultiplyLong (accumulate,(signed,(setflags,(dhi,(dlo,(n,m)))))) =
  ...
  in
    ( write'R(BitsN.bits(result,63,32),dhi)
    ; write'R(BitsN.bits(result,31,0),dlo)
    ; if setflags
             ...
             ; if (ArchVersion ()) = 4
                 then ( CPSR :=
                        (PSR_C_rupd
                           ((!CPSR),
                            (L3.K false)
                              (rn,(rm,(rdhi,(rdlo,(#C) (!CPSR)))))))
                      ; CPSR :=
                        (PSR_V_rupd
                           ((!CPSR),
                            (L3.K false)
                              (rn,(rm,(rdhi,(rdlo,(#V) (!CPSR)))))))
                      )
               else ()
             )
      else ()
...
fun dfn'Signed16Multiply32Accumulate (m_high,(n_high,(d,(n,(m,a))))) =
  let
    val operand1 =
      if n_high then BitsN.bits(R n,31,16) else BitsN.bits(R n,15,0)
    val operand2 =
      if m_high then BitsN.bits(R m,31,16) else BitsN.bits(R m,15,0)
    val result =
      Int.+
        (Int.*(BitsN.toInt operand1,BitsN.toInt operand2),BitsN.toInt(R a))
...
fun dfn'Signed16Multiply32Result (m_high,(n_high,(d,(n,m)))) =
  let
    ...
    val operand2 =
      if m_high then BitsN.bits(R m,31,16) else BitsN.bits(R m,15,0)
    val result = Int.*(BitsN.toInt operand1,BitsN.toInt operand2)
  in
...
fun dfn'Signed16x32Multiply32Accumulate (m_high,(d,(n,(m,a)))) =
  let
    ...
    val result =
      Int.div
        (Int.+
           (Int.*(BitsN.toInt(R n),BitsN.toInt operand2),
            Int.*(BitsN.toInt(R a),sh16)),sh16)
    val result32 = BitsN.fromInt(result,32)
  in
    ( write'R(result32,d)
    ; if not(result = (BitsN.toInt result32))
...
fun dfn'Signed16x32Multiply32Result (m_high,(d,(n,m))) =
  let
    ...
    val result =
      Int.div
        (Int.*(BitsN.toInt(R n),BitsN.toInt operand2),IntInf.pow(2,16))
  in
    ( write'R(BitsN.fromInt(result,32),d); IncPC () )
  end;
...
fun dfn'Signed16Multiply64Accumulate (m_high,(n_high,(dhi,(dlo,(n,m))))) =
  let
    ...
    val result =
      Int.+
        (Int.*(BitsN.toInt operand1,BitsN.toInt operand2),
         BitsN.toInt(BitsN.@@(R dhi,R dlo)))
    val result64 = BitsN.fromInt(result,64)
  in
    ( write'R(BitsN.bits(result64,63,32),dhi)
    ; write'R(BitsN.bits(result64,31,0),dlo)
    ; IncPC ()
    )
  end;
...
fun dfn'SignedMultiplyDual (sub,(m_swap,(d,(n,(m,a))))) =
  let
    ...
    val product1 =
      Int.*
        (BitsN.toInt(BitsN.bits(R n,15,0)),
         BitsN.toInt(BitsN.bits(operand2,15,0)))
    val product2 =
      Int.*
        (BitsN.toInt(BitsN.bits(R n,31,16)),
         BitsN.toInt(BitsN.bits(operand2,31,16)))
    val acc = if a = (BitsN.B(0xF,4)) then BitsN.B(0x0,32) else R a
    val result =
      if sub
        then Int.+(Int.-(product1,product2),BitsN.toInt acc)
      else Int.+(Int.+(product1,product2),BitsN.toInt acc)
    val result32 = BitsN.fromInt(result,32)
  in
    ( write'R(result32,d)
    ; if not(result = (BitsN.toInt result32))
...
fun dfn'SignedMultiplyLongDual (sub,(m_swap,(dhi,(dlo,(n,m))))) =
  let
    ...
    val product1 =
      Int.*
        (BitsN.toInt(BitsN.bits(Rn,15,0)),
         BitsN.toInt(BitsN.bits(operand2,15,0)))
    val product2 =
      Int.*
        (BitsN.toInt(BitsN.bits(Rn,31,16)),
         BitsN.toInt(BitsN.bits(operand2,31,16)))
    ...
    val result =
      Int.+
        (BitsN.toInt(BitsN.<<(BitsN.fromNat(BitsN.toNat acc,64),32)),
         Int.*(BitsN.toInt(R n),BitsN.toInt(R m)))
    val result = if round then Int.+(result,2147483648) else result
  in
    ( write'R(BitsN.bits(BitsN.fromInt(result,64),63,32),d); IncPC () )
  end;
  ...
  in
    case op' of
       BitsN.B(0x0,2) =>
          (Int.+
             (BitsN.toInt(BitsN.bits(Rn,15,0)),
              BitsN.toInt(BitsN.bits(Rm,15,0))),
           Int.+
             (BitsN.toInt(BitsN.bits(Rn,31,16)),
              BitsN.toInt(BitsN.bits(Rm,31,16))))
     | BitsN.B(0x1,2) =>
          (Int.-
             (BitsN.toInt(BitsN.bits(Rn,15,0)),
              BitsN.toInt(BitsN.bits(Rm,31,16))),
      ...
      in
        ...
        (PSR_GE_rupd
           ((!CPSR),
            BitsN.bitFieldInsert
              (w,
               if Int.>=(res1,0) then BitsN.B(0x3,2) else BitsN.B(0x0,2),
               1,0)))
      end
    ; let
        val w = (#GE) (!CPSR)
      in
        ...
        (PSR_GE_rupd
           ((!CPSR),
            BitsN.bitFieldInsert
              (w,
               if Int.>=(res2,0) then BitsN.B(0x3,2) else BitsN.B(0x0,2),
               3,2)))
      end
    ; IncPC ()
    )
...
fun dfn'SignedHalvingAddSub16 (op',(d,(n,m))) =
  ...
  in
    ( write'R
        (BitsN.@@
           (BitsN.fromInt(Int.div(res2,2),16),
            BitsN.fromInt(Int.div(res1,2),16)),d)
    ; IncPC ()
    )
  end;
...
fun SignedParallelAddSub8 (sub,(n,m)) =
  ...
  in
    if sub
      then (Int.-
              (BitsN.toInt(BitsN.bits(Rn,7,0)),
               BitsN.toInt(BitsN.bits(Rm,7,0))),
            (Int.-
               (BitsN.toInt(BitsN.bits(Rn,15,8)),
                BitsN.toInt(BitsN.bits(Rm,15,8))),
             (Int.-
                (BitsN.toInt(BitsN.bits(Rn,23,16)),
                 BitsN.toInt(BitsN.bits(Rm,23,16))),
              Int.-
                (BitsN.toInt(BitsN.bits(Rn,31,24)),
                 BitsN.toInt(BitsN.bits(Rm,31,24))))))
    else (Int.+
            (BitsN.toInt(BitsN.bits(Rn,7,0)),
             BitsN.toInt(BitsN.bits(Rm,7,0))),
          (Int.+
  ...
  in
    ...
    ; let
      ...
      in
        ...
        (PSR_GE_rupd
           ((!CPSR),
            BitsN.bitFieldInsert(w,BitsN.fromBit(Int.>=(res1,0)),0,0)))
      end
    ; let
        val w = (#GE) (!CPSR)
      in
        ...
        (PSR_GE_rupd
           ((!CPSR),
            BitsN.bitFieldInsert(w,BitsN.fromBit(Int.>=(res2,0)),1,1)))
      end
    ; let
        val w = (#GE) (!CPSR)
      in
        ...
        (PSR_GE_rupd
           ((!CPSR),
            BitsN.bitFieldInsert(w,BitsN.fromBit(Int.>=(res3,0)),2,2)))
      end
    ; let
        val w = (#GE) (!CPSR)
      in
        ...
        (PSR_GE_rupd
           ((!CPSR),
            BitsN.bitFieldInsert(w,BitsN.fromBit(Int.>=(res4,0)),3,3)))
      end
    ; IncPC ()
    )
  end;
...
fun dfn'SignedHalvingAddSub8 (sub,(d,(n,m))) =
  ...
  in
    ( write'R
        (BitsN.concat
           [BitsN.fromInt(Int.div(res4,2),8),
            BitsN.fromInt(Int.div(res3,2),8),
            BitsN.fromInt(Int.div(res2,2),8),
            BitsN.fromInt(Int.div(res1,2),8)],d)
    ; IncPC ()
    )
  end;
...
fun UnsignedParallelAddSub16 (op',(n,m)) =
  ...
  in
    case op' of
       BitsN.B(0x0,2) =>
          (Int.+
             (UInt 16 (BitsN.bits(Rn,15,0)),UInt 16 (BitsN.bits(Rm,15,0))),
           Int.+
             (UInt 16 (BitsN.bits(Rn,31,16)),
              UInt 16 (BitsN.bits(Rm,31,16))))
     | BitsN.B(0x1,2) =>
          (Int.-
             (UInt 16 (BitsN.bits(Rn,15,0)),UInt 16 (BitsN.bits(Rm,31,16))),
           Int.+
             (UInt 16 (BitsN.bits(Rn,31,16)),UInt 16 (BitsN.bits(Rm,15,0))))
     | BitsN.B(0x2,2) =>
          (Int.+
             (UInt 16 (BitsN.bits(Rn,15,0)),UInt 16 (BitsN.bits(Rm,31,16))),
           Int.-
           ...
           ((!CPSR),
            BitsN.bitFieldInsert
              (w,
               if Int.>=
                    (res1,
                     if L3.mem(op',[BitsN.B(0x1,2),BitsN.B(0x2,2)])
                       then 0
                     else 65536)
                 then BitsN.B(0x3,2)
               else BitsN.B(0x0,2),1,0)))
      end
    ; let
        val w = (#GE) (!CPSR)
      in
           ...
           ((!CPSR),
            BitsN.bitFieldInsert
              (w,
               if Int.>=
                    (res2,
                     if L3.mem(op',[BitsN.B(0x2,2),BitsN.B(0x3,2)])
                       then 0
                     else 65536)
                 then BitsN.B(0x3,2)
               else BitsN.B(0x0,2),3,2)))
      end
    ; IncPC ()
    )
  end;
...
fun UnsignedParallelAddSub8 (sub,(n,m)) =
  ...
  in
    if sub
      then (Int.-(UInt 8 (BitsN.bits(Rn,7,0)),UInt 8 (BitsN.bits(Rm,7,0))),
            (Int.-
               (UInt 8 (BitsN.bits(Rn,15,8)),UInt 8 (BitsN.bits(Rm,15,8))),
             (Int.-
                (UInt 8 (BitsN.bits(Rn,23,16)),
                 UInt 8 (BitsN.bits(Rm,23,16))),
              Int.-
                (UInt 8 (BitsN.bits(Rn,31,24)),
                 UInt 8 (BitsN.bits(Rm,31,24))))))
    else (Int.+(UInt 8 (BitsN.bits(Rn,7,0)),UInt 8 (BitsN.bits(Rm,7,0))),
          (Int.+
             (UInt 8 (BitsN.bits(Rn,15,8)),UInt 8 (BitsN.bits(Rm,15,8))),
           (Int.+
              (UInt 8 (BitsN.bits(Rn,23,16)),UInt 8 (BitsN.bits(Rm,23,16))),
            Int.+
              (UInt 8 (BitsN.bits(Rn,31,24)),UInt 8 (BitsN.bits(Rm,31,24))))))
  end;
        ...
        ( let
          ...
          in
            ...
            (PSR_GE_rupd
               ((!CPSR),
                BitsN.bitFieldInsert
                  (w,BitsN.fromBit(Int.>=(res1,ge_lim)),0,0)))
          end
        ; let
            val w = (#GE) (!CPSR)
          in
            ...
            (PSR_GE_rupd
               ((!CPSR),
                BitsN.bitFieldInsert
                  (w,BitsN.fromBit(Int.>=(res2,ge_lim)),1,1)))
          end
        ; let
            val w = (#GE) (!CPSR)
          in
            ...
            (PSR_GE_rupd
               ((!CPSR),
                BitsN.bitFieldInsert
                  (w,BitsN.fromBit(Int.>=(res3,ge_lim)),2,2)))
          end
        ; let
            val w = (#GE) (!CPSR)
          in
            ...
            (PSR_GE_rupd
               ((!CPSR),
                BitsN.bitFieldInsert
                  (w,BitsN.fromBit(Int.>=(res4,ge_lim)),3,3)))
          end
        ; IncPC ()
        )
      end
...
fun dfn'UnsignedSumAbsoluteDifferences (d,(n,(m,a))) =
  let
    ...
    val absdiff1 =
      Int.abs
        (Int.-(UInt 8 (BitsN.bits(Rn,7,0)),UInt 8 (BitsN.bits(Rm,7,0))))
    val absdiff2 =
      Int.abs
        (Int.-(UInt 8 (BitsN.bits(Rn,15,8)),UInt 8 (BitsN.bits(Rm,15,8))))
    val absdiff3 =
      Int.abs
        (Int.-
           (UInt 8 (BitsN.bits(Rn,23,16)),UInt 8 (BitsN.bits(Rm,23,16))))
    ...
    val result =
      Int.+
        (Int.+(Int.+(Int.+(UInt 32 acc,absdiff1),absdiff2),absdiff3),
         absdiff4)
  in
    ( write'R(BitsN.fromInt(result,32),d); IncPC () )
  end;
...
fun dfn'PackHalfword (shift_t,(shift_n,(tbform,(d,(n,m))))) =
  let
    val operand2 = Shift 32 (R m,(shift_t,(shift_n,(#C) (!CPSR))))
    val bot =
      if tbform then BitsN.bits(operand2,15,0) else BitsN.bits(R n,15,0)
    val top =
      if tbform then BitsN.bits(R n,31,16) else BitsN.bits(operand2,31,16)
  in
...
fun dfn'Saturate (shift_t,(shift_n,(saturate_to,(unsigned,(d,n))))) =
  let
    val operand = Shift 32 (R n,(shift_t,(shift_n,(#C) (!CPSR))))
    val (result,sat) =
      if unsigned
    ...
    val ((result1,sat1),(result2,sat2)) =
      if unsigned
        then (UnsignedSatQ 16
                (BitsN.toInt(BitsN.bits(Rn,15,0)),saturate_to),
              UnsignedSatQ 16
                (BitsN.toInt(BitsN.bits(Rn,31,16)),saturate_to))
      else (SignedSatQ 16 (BitsN.toInt(BitsN.bits(Rn,15,0)),saturate_to),
            SignedSatQ 16 (BitsN.toInt(BitsN.bits(Rn,31,16)),saturate_to))
  in
    ( write'R
        (if unsigned
...
fun dfn'ExtendByte (unsigned,(d,(n,(m,rotation)))) =
  ...
  in
    ( write'R
        (BitsN.+(acc,Extend (8,32) (unsigned,BitsN.bits(rotated,7,0))),d)
    ; IncPC ()
    )
  end;
...
fun dfn'ExtendByte16 (unsigned,(d,(n,(m,rotation)))) =
  let
    ...
    val r1 =
      BitsN.+
        (BitsN.bits(acc,15,0),
         Extend (8,16) (unsigned,BitsN.bits(rotated,7,0)))
    val r2 =
      BitsN.+
        (BitsN.bits(acc,31,16),
         Extend (8,16) (unsigned,BitsN.bits(rotated,23,16)))
  in
    ( write'R(BitsN.@@(r1,r1),d); IncPC () )
  end;
...
fun dfn'ExtendHalfword (unsigned,(d,(n,(m,rotation)))) =
  ...
  in
    ( write'R
        (BitsN.+(acc,Extend (16,32) (unsigned,BitsN.bits(rotated,15,0))),d)
    ; IncPC ()
    )
  end;
...
fun dfn'SelectBytes (d,(n,m)) =
  let
    ...
    val Rm = R m
    val r1 =
      if BitsN.bit((#GE) (!CPSR),0)
        then BitsN.bits(Rn,7,0)
      else BitsN.bits(Rm,7,0)
    val r2 =
      if BitsN.bit((#GE) (!CPSR),1)
        then BitsN.bits(Rn,15,8)
      else BitsN.bits(Rm,15,8)
    val r3 =
      if BitsN.bit((#GE) (!CPSR),2)
        then BitsN.bits(Rn,23,16)
      else BitsN.bits(Rm,23,16)
    val r4 =
      if BitsN.bit((#GE) (!CPSR),3)
        then BitsN.bits(Rn,31,24)
      else BitsN.bits(Rm,31,24)
  in
...
fun dfn'ByteReverse (d,m) =
  ...
  in
    ( write'R
        (BitsN.concat
           [BitsN.bits(Rm,7,0),BitsN.bits(Rm,15,8),BitsN.bits(Rm,23,16),
            BitsN.bits(Rm,31,24)],d)
    ; IncPC ()
    )
  end;
...
fun dfn'ByteReversePackedHalfword (d,m) =
  ...
  in
    ( write'R
        (BitsN.concat
           [BitsN.bits(Rm,23,16),BitsN.bits(Rm,31,24),BitsN.bits(Rm,7,0),
            BitsN.bits(Rm,15,8)],d)
    ; IncPC ()
    )
  end;
...
fun dfn'ByteReverseSignedHalfword (d,m) =
  ...
  in
    ( write'R
        (BitsN.@@
           (BitsN.signExtend 24 (BitsN.bits(Rm,7,0)),BitsN.bits(Rm,15,8)),
         d)
    ; IncPC ()
    )
  end;
...
fun dfn'BitFieldExtract (unsigned,(d,(n,(lsbit,widthminus1)))) =
  ...
  in
    ( write'R
        (if unsigned
           then BitsN.bits(R n,msbit,lsbit)
         else SignExtendFrom 32 (BitsN.bits(R n,msbit,lsbit),widthminus1),
         d)
    ; IncPC ()
    )
  end;
...
fun dfn'BitFieldClearOrInsert (d,(n,(lsbit,msbit))) =
  ...
  in
    ...
    in
      ( result :=
        (Bitstring.bitFieldInsert
           ((!result),Bitstring.bits(field,Nat.-(msbit,lsbit),0),msbit,
            lsbit))
           ...
           val offset =
             case m of
                register_form1(m,(shift_t,shift_n)) =>
                 Shift 32 (R m,(shift_t,(shift_n,(#C) (!CPSR))))
               ...
               then if Aligned 32 (address,4)
                      ...
                      (if (UnalignedSupport ()) orelse
                         ...
                         then ROR 32
                                (data,
                                 Nat.*
                                   (8,BitsN.toNat(BitsN.bits(address,1,0))))
         ...
         in
           ...
           ; write'R
               (if (UnalignedSupport ()) orelse (Aligned 32 (address,4))
                  ...
                  then ROR 32
                         (data,
                          Nat.*(8,BitsN.toNat(BitsN.bits(address,1,0))))
                else BitsN.B(0x0,32),t)
           ; IncPC ()
           )
         end
         ...
         in
           ...
           ; let
             ...
             in
               ( write'R
                   (if BigEndian ()
                      then BitsN.bits(value,63,32)
                    else BitsN.bits(value,31,0),t)
               ; write'R
                   (if BigEndian ()
                      then BitsN.bits(value,31,0)
                    else BitsN.bits(value,63,32),t2)
               ; IncPC ()
               )
             end
           )
...
fun dfn'StoreWord (add,(index,(wback,(t,(n,m))))) =
  if NullCheckIfThumbEE n
    then let
         ...
         in
           ( if ((UnalignedSupport ()) orelse (Aligned 32 (address,4))) orelse
                ((CurrentInstrSet ()) = InstrSet_ARM)
    ...
    then let
         ...
         in
           ( let
               val x = (address,1)
             in
               write'MemU 8 (BitsN.bits(R t,7,0),x)
             end
           ; if wback then write'R(offset_addr,n) else ()
           ; IncPC ()
           )
    ...
    then let
         ...
         in
           ( let
               val x = (address,1)
             in
               write'MemU_unpriv 8 (BitsN.bits(R t,7,0),x)
             end
           ; if postindex then write'R(offset_addr,n) else ()
           ; IncPC ()
           )
         ...
         in
           ( if (UnalignedSupport ()) orelse (Aligned 32 (address,2))
               then let
                      val x = (address,2)
                    in
                      write'MemU 16 (BitsN.bits(R t,15,0),x)
                    end
             else let
                    val x = (address,2)
                  in
         ...
         in
           ( if (UnalignedSupport ()) orelse (Aligned 32 (address,2))
               then let
                      val x = (address,2)
                    in
                      write'MemU_unpriv 16 (BitsN.bits(R t,15,0),x)
                    end
             else let
                    val x = (address,2)
                  in
           ...
           in
             ...
             ; L3.for
                 (0,14,
                  fn i =>
                    if BitsN.bit(registers,i)
                      then ( if (((BitsN.fromNat(i,4)) = n) andalso wback) andalso
                                (not(i = lowest))
                               then let
                                      val x = ((!address),4)
                                    in
         ...
         in
           ( if ExclusiveMonitorsPass(address,1)
               then ( let
                        val x = (address,1)
                      in
                        write'MemA 8 (BitsN.bits(R t,7,0),x)
                      end
                    ; write'R(BitsN.B(0x0,32),d)
                    )
             else write'R(BitsN.B(0x1,32),d)
         ...
         in
           ( if ExclusiveMonitorsPass(address,2)
               then ( let
                        val x = (address,2)
                      in
                        write'MemA 16 (BitsN.bits(R t,15,0),x)
                      end
                    ; write'R(BitsN.B(0x0,32),d)
                    )
             else write'R(BitsN.B(0x1,32),d)
        ...
        then let
             ...
             in
               ( let
                   val x = (Rn,1)
                 in
                   write'MemA 8 (BitsN.bits(R t2,7,0),x)
                 end
           ...
           in
             ...
             ; write'R
                 (ROR 32 (data,Nat.*(8,BitsN.toNat(BitsN.bits(Rn,1,0)))),t)
             )
           end
    ; IncPC ()
    )
...
fun dfn'HypervisorCall imm16 =
  if ((not(HaveVirtExt ())) orelse (IsSecure ())) orelse
     (not(CurrentModeIsNotUser ()))
    then raise UNPREDICTABLE ("HypervisorCall")
  else if not((#HCE)((#SCR) (!CP15)))
    then if CurrentModeIsHyp ()
           then raise UNPREDICTABLE ("HypervisorCall")
       ...
       in
         ( if read_spsr
             then ( SPSRAccessValid(SYSm,mode)
                  ; case SYSm of
                       BitsN.B(0xE,5) => write'R(reg'PSR (!SPSR_fiq),d)
                     | BitsN.B(0x10,5) => write'R(reg'PSR (!SPSR_irq),d)
                     | BitsN.B(0x12,5) => write'R(reg'PSR (!SPSR_svc),d)
                     | BitsN.B(0x14,5) => write'R(reg'PSR (!SPSR_abt),d)
                     | BitsN.B(0x16,5) => write'R(reg'PSR (!SPSR_und),d)
                     | BitsN.B(0x1C,5) => write'R(reg'PSR (!SPSR_mon),d)
                     | BitsN.B(0x1E,5) => write'R(reg'PSR (!SPSR_hyp),d)
                     | _ => ()
                  )
                ...
                ; if (BitsN.bits(SYSm,4,3)) = (BitsN.B(0x0,2))
                    then let
                           val m =
                             BitsN.+
                               (BitsN.fromNat
                                  (BitsN.toNat(BitsN.bits(SYSm,2,0)),4),
                                BitsN.B(0x8,4))
                         in
                              ...
                              ((!targetmode),
                               BitsN.fromBit
                                 ((BitsN.bit(SYSm,2)) orelse
                                  (BitsN.bit(SYSm,1))),0,0))
                         ; targetmode :=
                           (BitsN.bitFieldInsert
                              ((!targetmode),BitsN.fromBit true,1,1))
                         ; targetmode :=
                           (BitsN.bitFieldInsert
                              ((!targetmode),
                               BitsN.fromBit
                                 ((BitsN.bit(SYSm,2)) andalso
                                  (not(BitsN.bit(SYSm,1)))),2,2))
                         ; targetmode :=
                           (BitsN.bitFieldInsert
                              ((!targetmode),
                               BitsN.fromBit
                                 ((BitsN.bit(SYSm,2)) andalso
                                  (BitsN.bit(SYSm,1))),3,3))
                         ; targetmode :=
                           (BitsN.bitFieldInsert
                              ((!targetmode),BitsN.fromBit true,4,4))
                         ; if mode = (!targetmode)
                             then raise UNPREDICTABLE
       ...
       in
         ( CPSRWriteByInstr
             (MemA 32 (BitsN.+(address,BitsN.B(0x4,32)),4),
              (BitsN.B(0xF,4),true))
         ; if ((((#M) (!CPSR)) = (BitsN.B(0x1A,5))) andalso ((#J) (!CPSR))) andalso
              ((#T) (!CPSR))
             then raise UNPREDICTABLE ("ReturnFromException")
           else BranchWritePC new_pc_value
         )
...
fun dfn'SecureMonitorCall imm4 =
  if (HaveSecurityExt ()) andalso (CurrentModeIsNotUser ())
    then if (((HaveVirtExt ()) andalso (not(IsSecure ()))) andalso
             (not(CurrentModeIsHyp ()))) andalso ((#TSC)((#HCR) (!CP15)))
           then let
...
fun dfn'SupervisorCall imm32 = CallSupervisor(BitsN.bits(imm32,15,0));
...
fun rec'FPSCR x =
  {AHP = BitsN.bit(x,26), C = BitsN.bit(x,29), DN = BitsN.bit(x,25),
   ...
   QC = BitsN.bit(x,27), RMode = BitsN.bits(x,23,22),
   UFC = BitsN.bit(x,3), UFE = BitsN.bit(x,11), V = BitsN.bit(x,28),
   Z = BitsN.bit(x,30),
   fpscr'rst =
     BitsN.concat
       [BitsN.bits(x,6,5),BitsN.bits(x,14,13),BitsN.bits(x,21,16)]};
      ...
      BitsN.modify
        (fn (i,_) =>
           if i = 31
             ...
             then BitsN.bit(RMode,1)
           else if i = 22
             then BitsN.bit(RMode,0)
           else if i = 21
             then BitsN.bit(fpscr'rst,5)
           else if i = 20
             then BitsN.bit(fpscr'rst,4)
           else if i = 19
             then BitsN.bit(fpscr'rst,3)
           else if i = 18
             then BitsN.bit(fpscr'rst,2)
           else if i = 17
             then BitsN.bit(fpscr'rst,1)
           else if i = 16
             then BitsN.bit(fpscr'rst,0)
           else if i = 15
             then IDE
           else if i = 14
             then BitsN.bit(fpscr'rst,7)
           else if i = 13
             then BitsN.bit(fpscr'rst,6)
           else if i = 12
             then IXE
           else if i = 11
             then UFE
             ...
             then BitsN.bit(fpscr'rst,9)
           else if i = 5
             then BitsN.bit(fpscr'rst,8)
           else if i = 4
             then IXC
           else if i = 3
             then UFC
           else if i = 2 then OFC else if i = 1 then DZC else IOC,
         BitsN.B(0x0,32));
...
fun RoundingMode () =
  case (#RMode)((#FPSCR) (!FP)) of
     BitsN.B(0x0,2) => IEEEReal.TO_NEAREST
   | BitsN.B(0x1,2) => IEEEReal.TO_POSINF
   | BitsN.B(0x2,2) => IEEEReal.TO_NEGINF
   | BitsN.B(0x3,2) => IEEEReal.TO_ZERO
   | _ => raise General.Bind;

fun FPAdd32 (op1,op2) =
  (fn _ => raise Fail "FP32_Add") (RoundingMode (),(op1,op2));

fun FPSub32 (op1,op2) =
  (fn _ => raise Fail "FP32_Sub") (RoundingMode (),(op1,op2));

fun FPMul32 (op1,op2) =
  (fn _ => raise Fail "FP32_Mul") (RoundingMode (),(op1,op2));
...
fun D n = Map.lookup((#REG) (!FP),BitsN.toNat n);

fun write'D (value,n) =
  let
    val f = Map.copy((#REG) (!FP))
  in
...
fun S n =
  if BitsN.bit(n,0)
    then BitsN.bits(D(BitsN.div(n,BitsN.B(0x2,5))),63,32)
  else BitsN.bits(D(BitsN.div(n,BitsN.B(0x2,5))),31,0);
...
fun write'S (value,n) =
  if BitsN.bit(n,0)
    then let
           ...
           val w = D x
         in
           write'D(BitsN.bitFieldInsert(w,value,63,32),x)
         end
  else let
         val x = BitsN.div(n,BitsN.B(0x2,5))
         val w = D x
       in
         write'D(BitsN.bitFieldInsert(w,value,31,0),x)
       end;
...
fun VFPExpandImm (imm8,single) =
  if single
    then BitsN.zeroExtend 64
           (BitsN.concat
              [BitsN.bits(imm8,7,7),BitsN.~(BitsN.bits(imm8,6,6)),
               BitsN.replicate(BitsN.bits(imm8,6,6),5),
               BitsN.bits(imm8,5,0),BitsN.replicate(BitsN.B(0x0,1),19)])
  else BitsN.concat
         [BitsN.bits(imm8,7,7),BitsN.~(BitsN.bits(imm8,6,6)),
          BitsN.replicate(BitsN.bits(imm8,6,6),8),BitsN.bits(imm8,5,0),
          BitsN.replicate(BitsN.B(0x0,1),48)];

fun FPCompare32 (op1,op2) =
  if ((fn _ => raise Fail "FP32_IsNan") op1) orelse
     ((fn _ => raise Fail "FP32_IsNan") op2)
    then BitsN.B(0x3,4)
  else if (fn _ => raise Fail "FP32_Equal") (op1,op2)
    then BitsN.B(0x6,4)
  else if (fn _ => raise Fail "FP32_LessThan") (op1,op2)
    then BitsN.B(0x8,4)
  else BitsN.B(0x2,4);
...
fun dfn'vmov_imm (single_register,(d,imm64)) =
  ( if single_register
      then write'S(BitsN.bits(imm64,31,0),d)
      ...
      then let
           ...
           in
             ...
             (FP_FPSCR_rupd
                ((!FP),
                 write'reg'FPSCR
                   (x0,BitsN.bitFieldInsert(w,FPCompare64(D d,op2),31,28))))
           end
    else let
           val op2 =
             case m_with_zero of
         ...
         in
           ...
           (FP_FPSCR_rupd
              ((!FP),
               write'reg'FPSCR
                 (x0,BitsN.bitFieldInsert(w,FPCompare32(S d,op2),31,28))))
         end
  ; IncPC ()
  );
...
fun dfn'vmrs t =
  ( if not(t = (BitsN.B(0xF,4)))
      then write'R(reg'FPSCR((#FPSCR) (!FP)),t)
    else ( CPSR := (PSR_N_rupd((!CPSR),(#N)((#FPSCR) (!FP))))
         ; CPSR := (PSR_Z_rupd((!CPSR),(#Z)((#FPSCR) (!FP))))
         ; CPSR := (PSR_C_rupd((!CPSR),(#C)((#FPSCR) (!FP))))
         ; CPSR := (PSR_V_rupd((!CPSR),(#V)((#FPSCR) (!FP))))
         )
  ; IncPC ()
  );
...
fun dfn'vmla_vmls (dp_operation,(add,(d,(n,m)))) =
  ( if dp_operation
      then let
             ...
             val addend = if add then product else FP64.neg product
           in
           ...
           val addend =
             if add
               then product
             else (fn _ => raise Fail "FP32_Neg") product
         in
  ...
  ( if dp_operation
      then let
           ...
           in
             case typ of
                VFPNegMul_VNMLA =>
                   write'D(FPAdd64(FP64.neg(D d),FP64.neg product),d)
              | VFPNegMul_VNMLS =>
                   write'D(FPAdd64(FP64.neg(D d),product),d)
              | VFPNegMul_VNMUL => write'D(FP64.neg product,d)
           end
    else let
           val product = FPMul32(S n,S m)
         in
           case typ of
              VFPNegMul_VNMLA =>
                 write'S
                   (FPAdd32
                      ((fn _ => raise Fail "FP32_Neg") (S d),
                       (fn _ => raise Fail "FP32_Neg") product),d)
            | VFPNegMul_VNMLS =>
                 write'S
                   (FPAdd32((fn _ => raise Fail "FP32_Neg") (S d),product),
                    d)
            | VFPNegMul_VNMUL =>
                 write'S((fn _ => raise Fail "FP32_Neg") product,d)
         end
  ; IncPC ()
  );
           ...
           in
             ( let
               ...
               in
                 write'MemA 32
                   (if BigEndian ()
                      then BitsN.bits(word,63,32)
                    else BitsN.bits(word,31,0),x)
               end
             ; let
                 val x = (BitsN.+(address,BitsN.B(0x4,32)),4)
               in
                 write'MemA 32
                   (if BigEndian ()
                      then BitsN.bits(word,31,0)
                    else BitsN.bits(word,63,32),x)
               end
             )
           end
    ; IncPC ()
...
fun dfn'UndefinedVFP () = TakeUndefInstrException ();

fun Run v0 =
  case v0 of
     ClearExclusive => dfn'ClearExclusive ()
   | NoOperation => dfn'NoOperation ()
   | Divide v137 => dfn'Divide v137
   | IfThen v138 => dfn'IfThen v138
   | Swap v139 => dfn'Swap v139
   | Undefined v140 => dfn'Undefined v140
   | Branch v1 =>
      (case v1 of
   ...
   | VFP v125 =>
      (case v125 of
          UndefinedVFP => dfn'UndefinedVFP ()
        | vadd v126 => dfn'vadd v126
        | vcmp v127 => dfn'vcmp v127
        | vldr v128 => dfn'vldr v128
        | vmla_vmls v129 => dfn'vmla_vmls v129
        | vmov v130 => dfn'vmov v130
        | vmov_imm v131 => dfn'vmov_imm v131
        | vmrs v132 => dfn'vmrs v132
        | vmul v133 => dfn'vmul v133
        | vneg_mul v134 => dfn'vneg_mul v134
        | vstr v135 => dfn'vstr v135
        | vsub v136 => dfn'vsub v136);
  ...
  in
    if (iset = InstrSet_ARM) orelse ((!Architecture) = ARMv4)
      ...
      then BadCode("Fetch")
         ...
         in
           if ((BitsN.bits(ireg,15,13)) = (BitsN.B(0x7,3))) andalso
              (not((BitsN.bits(ireg,12,11)) = (BitsN.B(0x0,2))))
...
fun DecodeHint (cond,op') =
  if ((!Architecture) = ARMv6T2) orelse
     ((((BitsN.bits(op',7,4)) = (BitsN.B(0xF,4))) andalso
...
fun DecodeVFP w =
  case boolify'28(BitsN.bits(w,27,0)) of
     (true,
      (true,
       (false,
        (true,
      ...
      in
        if (BitsN.fromBitstring([L'0],1)) = (BitsN.B(0x1,1))
          then vldr(single_reg,(add,(d,(Rn,imm32))))
        else vstr(single_reg,(add,(d,(Rn,imm32))))
      end
   | (true,
      (true,
       (true,
      ...
      in
        case BitsN.fromBitstring([op1'1,op1'0],2) of
           BitsN.B(0x0,2) =>
              vmla_vmls(dp_operation,(op2 = (BitsN.B(0x0,1)),(d,(n,m))))
         | BitsN.B(0x1,2) =>
              let
                val typ =
                  ...
                  (Vd'2,
                   (Vd'1,
                    (Vd'0,
                     (true,
                      (false,
                       (true,(sz'0,(E'0,(true,(_,(false,(_,(_,(_,_))))))))))))))))))))))))))) =>
      let
        val Vd = BitsN.fromBitstring([Vd'3,Vd'2,Vd'1,Vd'0],4)
        val D = BitsN.fromBitstring([D'0],1)
      in
                       ...
                       (true,
                        (sz'0,
                         (_,
                          (false,
                           (_,
                            (false,(imm4L'3,(imm4L'2,(imm4L'1,imm4L'0))))))))))))))))))))))))))) =>
      let
        val Vd = BitsN.fromBitstring([Vd'3,Vd'2,Vd'1,Vd'0],4)
        val D = BitsN.fromBitstring([D'0],1)
        val single_register =
                  ...
                  (Rt'2,
                   (Rt'1,
                    (Rt'0,
                     (true,
                      (false,
                       (true,(false,(_,(_,(_,(true,(_,(_,(_,_))))))))))))))))))))))))))) =>
      let
        val Rt = BitsN.fromBitstring([Rt'3,Rt'2,Rt'1,Rt'0],4)
      in
        if Rt = (BitsN.B(0xD,4))
          then raise UNPREDICTABLE ("DecodeVFP: mrs")
        else vmrs Rt
      end
   | (_,
      (_,
...
fun DecodeARM w =
  let
    val mc = ARM w
    val cond = BitsN.bits(w,31,28)
  in
    if cond = (BitsN.B(0xF,4))
      then case boolify'28(BitsN.bits(w,27,0)) of
              (false,
               (false,
                (false,
                 (true,
               ...
               (if Take(BitsN.B(0xE,4),Nat.>=(ArchVersion (),6))
                  then System
                         (Setend
            ...
            | (false,
               ...
               (if Take(BitsN.B(0xE,4),Nat.>=(ArchVersion (),7))
                  then let
                         val add =
            ...
            | (false,
               ...
               (if Take
                     (BitsN.B(0xE,4),
                      L3.mem((!Architecture),[ARMv6K,ARMv7_A,ARMv7_R]))
                  then ClearExclusive
                else Skip ())
            | (false,
               (true,
                                  ...
                                  (imm12'7,
                                   (imm12'6,
                                    (imm12'5,
                                     (imm12'4,
                                      (imm12'3,(imm12'2,(imm12'1,imm12'0))))))))))))))))))))))))))) =>
               (if Take(BitsN.B(0xE,4),HaveDSPSupport ())
                  then let
                         val add =
                           (BitsN.fromBitstring([U'0],1)) =
                           (BitsN.B(0x1,1))
                 ...
                 if Take
                      (BitsN.B(0xE,4),
                       (((R = (BitsN.B(0x1,1))) andalso
                         (Nat.>=(ArchVersion (),7))) andalso
                        (L3.mem(Extension_Multiprocessing,(!Extensions)))) orelse
            ...
            | (true,
               ...
               (if Take(BitsN.B(0xE,4),Nat.>=(ArchVersion (),5))
                  then let
                         val imm32 =
                           BitsN.signExtend 32
                             (BitsN.concat
    ...
    else case boolify'28(BitsN.bits(w,27,0)) of
            (false,
             (true,
              (true,
               (true,
          ...
          | (false,
             ...
             in
               if Take(cond,HaveVirtExt ())
                 then ( if L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)])
                          then DECODE_UNPREDICTABLE
          ...
          | (false,
             ...
             (if Take(cond,not((!Architecture) = ARMv4))
                then Branch
                       (BranchExchange
          ...
          | (false,
             ...
             let
               ...
               val Rd = BitsN.fromBitstring([Rd'3,Rd'2,Rd'1,Rd'0],4)
             in
               if Take(cond,Nat.>=(ArchVersion (),5))
                          ...
                          DecodeImmShift
                            (BitsN.fromBitstring([typ'1,typ'0],2),
                             BitsN.fromBitstring
                               ([imm5'4,imm5'3,imm5'2,imm5'1,imm5'0],5))
                      in
                        if (BitsN.bits(opc,3,2)) = (BitsN.B(0x2,2))
                          then Data
                                 (TestCompareRegister
                                    (BitsN.bits(opc,1,0),
             ...
             in
               if Take(cond,true)
                 then ( if ((((Rd = (BitsN.B(0xF,4))) andalso
                              (not((BitsN.bits(opc,3,2)) =
                                   (BitsN.B(0x2,2))))) orelse
                             (Rn = (BitsN.B(0xF,4)))) orelse
                            (Rm = (BitsN.B(0xF,4)))) orelse
                           (Rs = (BitsN.B(0xF,4)))
                          then DECODE_UNPREDICTABLE
          ...
          | (false,
             ...
             let
               ...
               val RdHi =
                 BitsN.fromBitstring([RdHi'3,RdHi'2,RdHi'1,RdHi'0],4)
             in
               if Take(cond,Nat.>=(ArchVersion (),6))
             ...
             in
               if Take(cond,true)
                 then ( if (((((RdLo = (BitsN.B(0xF,4))) orelse
                               (RdHi = (BitsN.B(0xF,4)))) orelse
                              (Rn = (BitsN.B(0xF,4)))) orelse
                             (Rm = (BitsN.B(0xF,4)))) orelse (RdHi = RdLo)) orelse
             ...
             in
               if Take(cond,Nat.>=(ArchVersion (),6))
                 then ( if ((((Rd = (BitsN.B(0xF,4))) orelse
                             ...
                             (Rn = (BitsN.B(0xF,4)))) orelse (Rd = Rn)) orelse
                           (Rd = Rt)
                          then DECODE_UNPREDICTABLE(mc,"StoreExclusive")
                        else ()
                      ; Store
                          (StoreExclusive(Rd,(Rt,(Rn,BitsN.B(0x0,32)))))
                      )
               else Skip ()
             end
          | (false,
          ...
          | (false,
             ...
             in
               if Take
                    (cond,L3.mem((!Architecture),[ARMv6K,ARMv7_A,ARMv7_R]))
                 then let
                 ...
                 then let
                      ...
                      in
                        ( if (((Rt = (BitsN.B(0xF,4))) orelse
                              ...
                              (wback andalso
                               ((Rn = (BitsN.B(0xF,4))) orelse (Rn = Rt)))) orelse
                             (((Nat.<(ArchVersion (),6)) andalso wback) andalso
                              (Rm = Rn))
                 ...
                 then let
                      ...
                      in
                        ( if (((((((BitsN.bit(Rt,0)) orelse
                                  ...
                                  (Rt2 = (BitsN.B(0xF,4)))) orelse
                                 (Rm = (BitsN.B(0xF,4)))) orelse (Rm = Rt)) orelse
                               (Rm = Rt2)) orelse
                              (wback andalso
                               (((Rn = (BitsN.B(0xF,4))) orelse (Rn = Rt)) orelse
                                (Rn = Rt2)))) orelse
          ...
          | (true,
             ...
             (if Take(cond,L3.mem(Extension_VFP,(!Extensions)))
                then VFP(DecodeVFP w)
              else Skip ())
          | (_,
             (_,
              (_,
    ...
    case boolify'16 h of
            ...
            (Rd'2,
             (Rd'1,
              (Rd'0,
               (imm8'7,
                (imm8'6,
                 (imm8'5,(imm8'4,(imm8'3,(imm8'2,(imm8'1,imm8'0))))))))))))))) =>
        (if Take(ThumbCondition (),true)
           then let
                  val d =
                    BitsN.fromNat
          ...
          (false,
           (false,
            (false,
             (opc'3,
              (opc'2,
               (opc'1,(opc'0,(Rx'2,(Rx'1,(Rx'0,(Ry'2,(Ry'1,Ry'0))))))))))))))) =>
        let
                    ...
                    BitsN.B(0x0,4) =>
                       ...
                       in
                         Data
                           (Register
                              (opc,
                               (setflags,(d,(n,(m,(shift_t,shift_n)))))))
                       end
                  | BitsN.B(0x1,4) =>
                       let
                         val d = BitsN.fromNat(BitsN.toNat Ry,4)
                  ...
                  | BitsN.B(0x2,4) =>
                       let
                         ...
                         val shift_t =
                           DecodeRegShift
                             (BitsN.fromNat
                                (BitsN.toNat(BitsN.-(opc,BitsN.B(0x2,4))),
                                 2))
                       in
                         Data
                           (ShiftRegister
     ...
     | (false,
        ...
        in
          if Take
               (ThumbCondition (),
                ((BitsN.msb Rm) orelse (DN = (BitsN.B(0x1,1)))) orelse
                (HaveThumb2 ()))
            then let
                   val d =
                     BitsN.@@
                 ...
                 in
                   ( if ((n = (BitsN.B(0xF,4))) andalso
                         (Rm = (BitsN.B(0xF,4)))) orelse
                        (((d = (BitsN.B(0xF,4))) andalso (InITBlock ())) andalso
                         (not(LastInITBlock ())))
     ...
     | (false,
        (true,
         (false,
          (false,
           (false,
            (true,(false,(true,(false,(false,(_,(_,(_,(_,(_,_))))))))))))))) =>
     ...
     | (false,
        ...
        in
          if Take
               (ThumbCondition (),
                ((BitsN.msb Rm) orelse (D = (BitsN.B(0x1,1)))) orelse
                (Nat.>=(ArchVersion (),6)))
            then let
                   val d =
                     BitsN.@@(D,BitsN.fromBitstring([Rd'2,Rd'1,Rd'0],3))
                 in
                   ( if ((d = (BitsN.B(0xF,4))) andalso (InITBlock ())) andalso
                        (not(LastInITBlock ()))
        ...
        (true,
         (false,
          (false,
           (false,
            (true,
             (true,(true,(false,(Rm'3,(Rm'2,(Rm'1,(Rm'0,(_,(_,_))))))))))))))) =>
        (if Take(ThumbCondition (),true)
        ...
        (true,
         (false,
          (false,
           (false,
            (true,
             (true,(true,(true,(Rm'3,(Rm'2,(Rm'1,(Rm'0,(_,(_,_))))))))))))))) =>
        let
          val Rm = BitsN.fromBitstring([Rm'3,Rm'2,Rm'1,Rm'0],4)
        in
          if Take(ThumbCondition (),Nat.>=(ArchVersion (),5))
            ...
            (false,
             (false,
              (false,
               (S'0,
                (imm7'6,
                 (imm7'5,(imm7'4,(imm7'3,(imm7'2,(imm7'1,imm7'0))))))))))))))) =>
        (if Take(ThumbCondition (),true)
           then let
                  val imm12 =
                    BitsN.@@
                      (BitsN.B(0x1E,5),
                       BitsN.fromBitstring
                         ([imm7'6,imm7'5,imm7'4,imm7'3,imm7'2,imm7'1,
                           imm7'0],7))
                  val opc =
                    if (BitsN.fromBitstring([S'0],1)) = (BitsN.B(0x1,1))
                      then BitsN.B(0x2,4)
                ...
                in
                  Data
                    (ArithLogicImmediate
                       (opc,
                        (false,(BitsN.B(0xD,4),(BitsN.B(0xD,4),imm12)))))
                end
         else Skip ())
     | (true,
        (false,
        ...
        (if Take(BitsN.B(0xE,4),HaveThumb2 ())
           then ( if InITBlock ()
     ...
     | (true,
        ...
        (if Take(ThumbCondition (),Nat.>=(ArchVersion (),6))
           then let
                  val unsigned =
        ...
        (false,
         (true,
          (true,
           (false,
            (true,
             (true,(false,(false,(true,(false,(_,(E'0,(_,(_,_))))))))))))))) =>
        (if Take(BitsN.B(0xE,4),Nat.>=(ArchVersion (),6))
           then ( if InITBlock ()
         ...
         (true,
          (true,
           (false,
            (true,
             (true,
              (false,(false,(true,(true,(im'0,(_,(A'0,(I'0,F'0))))))))))))))) =>
        let
          val F = BitsN.fromBitstring([F'0],1)
          val I = BitsN.fromBitstring([I'0],1)
          val A = BitsN.fromBitstring([A'0],1)
          ...
          (true,
           (true,
            (false,
             (true,
              (false,
               (opc'1,(opc'0,(Rm'2,(Rm'1,(Rm'0,(Rd'2,(Rd'1,Rd'0))))))))))))))) =>
        let
           ...
           then let
                ...
                in
                  ( if (Nat.<(BitCount 16 registers,1)) orelse
                       (((BitsN.bit(registers,15)) andalso (InITBlock ())) andalso
                        (not(LastInITBlock ())))
                      then DECODE_UNPREDICTABLE(mc,"LoadMultiple")
                    else ()
                  ; let
            ...
            then let
                 ...
                 in
                   ...
                   ; let
                       ...
                       val index = false
                       val wback =
                         not(BitsN.bit(registers,BitsN.toNat Rn))
                     in
                       Load
                         (LoadMultiple
                            (increment,
              ...
              (cond'0,
               (imm8'7,
                (imm8'6,
                 (imm8'5,(imm8'4,(imm8'3,(imm8'2,(imm8'1,imm8'0))))))))))))))) =>
        (if Take
              (BitsN.fromBitstring([cond'3,cond'2,cond'1,cond'0],4),true)
           then ( if InITBlock ()
    ...
    case boolify'16 h of
     ...
     | (true,
        (true,
         (false,
          (false,
           (false,(false,(false,(true,(_,(_,(_,(_,(_,(_,(_,_))))))))))))))) =>
        Undefined(BitsN.B(0x0,32))
     | (true,
        (true,
         (false,
                       ...
                       (add,
                        (index,
                         (wback,
                          (BitsN.fromNat
                             (BitsN.toNat
                                (BitsN.fromBitstring([Rt'2,Rt'1,Rt'0],3)),
                              4),
                           (BitsN.fromNat
                              (BitsN.toNat
                                 (BitsN.fromBitstring([Rn'2,Rn'1,Rn'0],3)),
            ...
            then let
                 ...
                 in
                   ( if (n = (BitsN.B(0xF,4))) orelse
                        (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
            ...
            (ireg'10,
             (ireg'9,
              (ireg'8,
               (ireg'7,
                (ireg'6,
                 (ireg'5,(ireg'4,(ireg'3,(ireg'2,(ireg'1,ireg'0))))))))))))))) =>
        DecodeThumb
          (BitsN.fromBitstring
    ...
    case (boolify'16(L3.fst h),boolify'16(L3.snd h)) of
       ((true,
        ...
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then let
                   val registers =
                     BitsN.concat
                       [BitsN.B(0x0,1),BitsN.fromBitstring([M'0],1),
           ...
           (false,
            (true,
             (false,
              (false,
               (true,
                (false,(false,(W'0,(false,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (_,
         (M'0,
          (_,
           (register_list'12,
           ...
           (false,
            (true,
             (false,
              (false,
               (false,
                (true,(false,(W'0,(true,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (P'0,
         (M'0,
          (_,
           (register_list'12,
           ...
           (false,
            (true,
             (false,
              (false,
               (true,
                (false,(false,(W'0,(true,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (P'0,
         (M'0,
          (_,
           (register_list'12,
         ...
         (true,
          (true,
           (false,
            (true,
             (false,
              (false,(op'1,(op'0,(false,(W'0,(false,(_,(_,(_,_))))))))))))))),
        (_,
         (_,
          (_,
           (_,
            (_,
             (_,
              (_,
               (_,(_,(_,(_,(mode'4,(mode'3,(mode'2,(mode'1,mode'0)))))))))))))))) =>
        let
          val op' = BitsN.fromBitstring([op'1,op'0],2)
        in
          if Take
               (ThumbCondition (),
                (L3.mem(op',[BitsN.B(0x0,2),BitsN.B(0x3,2)])) andalso
                (HaveThumb2 ()))
     ...
     | ((true,
        ...
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then ( if ((((L3.mem(Rd,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                         (L3.mem(Rt,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                        (Rn = (BitsN.B(0xF,4)))) orelse (Rd = Rn)) orelse
                      (Rd = Rt)
                     then DECODE_UNPREDICTABLE(mc,"StoreExclusive")
                   else ()
     ...
     | ((true,
        ...
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then ( if (L3.mem(Rt,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                      (Rn = (BitsN.B(0xF,4)))
                     then DECODE_UNPREDICTABLE(mc,"StoreExclusive")
                   else ()
                 ; let
          ...
          (Rt'1,
           (Rt'0,
            (_,
             (_,
              (_,
               (_,(false,(true,(false,(H'0,(Rd'3,(Rd'2,(Rd'1,Rd'0)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
          val Rd = BitsN.fromBitstring([Rd'3,Rd'2,Rd'1,Rd'0],4)
          val Rt = BitsN.fromBitstring([Rt'3,Rt'2,Rt'1,Rt'0],4)
        in
          if Take(ThumbCondition (),Nat.>=(ArchVersion (),7))
            then ( if ((((L3.mem(Rd,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                         (L3.mem(Rt,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                        (Rn = (BitsN.B(0xF,4)))) orelse (Rd = Rn)) orelse
                      (Rd = Rt)
     ...
     | ((true,
           ...
           (Rt'0,
            (Rt2'3,
             (Rt2'2,
              (Rt2'1,
               (Rt2'0,
                (false,(true,(true,(true,(Rd'3,(Rd'2,(Rd'1,Rd'0)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
          val Rd = BitsN.fromBitstring([Rd'3,Rd'2,Rd'1,Rd'0],4)
          val Rt2 = BitsN.fromBitstring([Rt2'3,Rt2'2,Rt2'1,Rt2'0],4)
        ...
        in
          if Take(ThumbCondition (),Nat.>=(ArchVersion (),7))
            then ( if (((((L3.mem(Rd,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                          (L3.mem(Rt,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                         (L3.mem(Rt2,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                        (Rn = (BitsN.B(0xF,4)))) orelse (Rd = Rn)) orelse
                      (Rd = Rt)
                     then DECODE_UNPREDICTABLE
           ...
           (false,
            (true,
             (false,
              (false,
               (false,
                (true,(true,(false,(true,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (_,
         (_,
          (_,
           (_,
            (_,
             (_,
              (_,
               (_,(false,(false,(false,(H'0,(Rm'3,(Rm'2,(Rm'1,Rm'0)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
          val Rm = BitsN.fromBitstring([Rm'3,Rm'2,Rm'1,Rm'0],4)
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then ( if ((Rn = (BitsN.B(0xD,4))) orelse
                       (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                      ((InITBlock ()) andalso (not(LastInITBlock ())))
         ...
         (Rt'2,
          (Rt'1,
           (Rt'0,
            (Rt2'3,
             (Rt2'2,
              (Rt2'1,(Rt2'0,(false,(true,(true,(true,(_,(_,(_,_)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
          val Rt2 = BitsN.fromBitstring([Rt2'3,Rt2'2,Rt2'1,Rt2'0],4)
          val Rt = BitsN.fromBitstring([Rt'3,Rt'2,Rt'1,Rt'0],4)
            ...
            then let
                 ...
                 in
                   ( if (((wback andalso ((Rn = Rt) orelse (Rn = Rt2))) orelse
                          (Rn = (BitsN.B(0xF,4)))) orelse
                         (L3.mem(Rt,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                        (L3.mem(Rt2,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
            ...
            then let
                 ...
                 in
                   case (BitsN.fromBitstring([op'3,op'2,op'1,op'0],4),
                    (Rn,(Rd,S))) of
                      (BitsN.B(0x0,4),(_,(BitsN.B(0xF,4),BitsN.B(0x1,1)))) =>
                       ( if (L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                            (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
                    ...
                    | (BitsN.B(0x0,4),_) =>
                       ( if (((Rd = (BitsN.B(0xD,4))) orelse
                              ((Rd = (BitsN.B(0xF,4))) andalso
                               (not setflags))) orelse
                             (L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                            (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
                    ...
                    | (BitsN.B(0x1,4),_) =>
                       ( if ((L3.mem(Rd,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                             (L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                            (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
                    ...
                    | (BitsN.B(0x2,4),(BitsN.B(0xF,4),_)) =>
                       ( if ((typ = (BitsN.B(0x0,2))) andalso
                           ...
                           then if (setflags andalso
                                    ((L3.mem
                                        (Rd,
                                         [BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                                     (L3.mem
                                        (Rm,
                                         [BitsN.B(0xD,4),BitsN.B(0xF,4)])))) orelse
                    ...
                    | (BitsN.B(0x4,4),(_,(BitsN.B(0xF,4),BitsN.B(0x1,1)))) =>
                       ( if (L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                            (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
                    ...
                    | (BitsN.B(0x6,4),(_,(_,BitsN.B(0x0,1)))) =>
                       (if BitsN.bit(typ,0)
                          then Undefined(BitsN.B(0x0,32))
                        else ( if ((L3.mem
                                      (Rd,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                    ...
                    | (BitsN.B(0x8,4),(_,(BitsN.B(0xF,4),BitsN.B(0x1,1)))) =>
                       ( if (Rn = (BitsN.B(0xF,4))) orelse
                            (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
                    ...
                    | (BitsN.B(0xD,4),(_,(BitsN.B(0xF,4),BitsN.B(0x1,1)))) =>
                       ( if (Rn = (BitsN.B(0xF,4))) orelse
                            (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
                     ...
                     BitsN.concat
                       [BitsN.fromBitstring([i'0],1),
                        ...
                        BitsN.fromBitstring
                          ([imm8'7,imm8'6,imm8'5,imm8'4,imm8'3,imm8'2,
                            imm8'1,imm8'0],8)]
                   val x = ThumbExpandImm_C(imm12,(#C) (!CPSR))
                   val setflags = S = (BitsN.B(0x1,1))
                 in
                   case (BitsN.fromBitstring([op'3,op'2,op'1,op'0],4),
                    (Rn,(Rd,S))) of
                      (BitsN.B(0x0,4),(_,(BitsN.B(0xF,4),BitsN.B(0x1,1)))) =>
                       ( if L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)])
                    ...
                    | (BitsN.B(0x0,4),_) =>
                       ( if ((Rd = (BitsN.B(0xD,4))) orelse
                             ((Rd = (BitsN.B(0xF,4))) andalso
                              (not setflags))) orelse
                            (L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
                    ...
                    | (BitsN.B(0x2,4),(BitsN.B(0xF,4),_)) =>
                       ( if L3.mem(Rd,[BitsN.B(0xD,4),BitsN.B(0xF,4)])
     ...
     | ((true,
        ...
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then ( if L3.mem(Rd,[BitsN.B(0xD,4),BitsN.B(0xF,4)])
           ...
           (true,
            (false,
             (_,
              (true,
               (true,
                (U'0,(false,(true,(false,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (false,
         (false,
          (false,
           (false,
           ...
           (true,
            (false,
             (_,
              (true,
               (true,
                (U'0,(false,(sh'0,(false,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (false,
         (imm3'2,
          (imm3'1,
           (imm3'0,
               ...
               (Rd'0,
                (imm2'1,
                 (imm2'0,
                  (_,
                   (sat_imm'4,
                    (sat_imm'3,(sat_imm'2,(sat_imm'1,sat_imm'0)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
          val sat_imm =
            BitsN.fromBitstring
           ...
           (true,
            (false,
             (_,
              (true,
               (true,
                (U'0,(true,(false,(false,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (false,
         (imm3'2,
          (imm3'1,
           (imm3'0,
               ...
               (Rd'0,
                (imm2'1,
                 (imm2'0,
                  (_,
                   (widthm1'4,
                    (widthm1'3,(widthm1'2,(widthm1'1,widthm1'0)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
          val Rd = BitsN.fromBitstring([Rd'3,Rd'2,Rd'1,Rd'0],4)
        in
           ...
           (true,
            (false,
             (_,
              (true,
               (true,
                (false,(true,(true,(false,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (false,
         (imm3'2,
          (imm3'1,
           (imm3'0,
           ...
           (true,
            (false,
             (false,
              (true,
               (true,
                (true,(false,(false,(R'0,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (true,
         (false,
          (_,
           (false,
            (m1'3,(m1'2,(m1'1,(m1'0,(_,(_,(true,(m'0,(_,(_,(_,_)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
        in
          if Take(ThumbCondition (),HaveVirtExt ())
            then ( if L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)])
                     then DECODE_UNPREDICTABLE
                            (mc,"MoveToBankedOrSpecialRegister")
                   else ()
        ...
        (true,
         (false,
          (_,
           (false,
            (mask'3,
             (mask'2,(mask'1,(mask'0,(_,(_,(false,(_,(_,(_,(_,_)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
          val mask = BitsN.fromBitstring([mask'3,mask'2,mask'1,mask'0],4)
        in
         ...
         (true,
          (true,
           (true,
            (false,
             (false,
              (true,(true,(true,(false,(true,(false,(_,(_,(_,_))))))))))))))),
        (true,
         (false,
          (_,
           (false,
            ...
            (_,
             (imod'1,
              (imod'0,
               (M'0,
                (A'0,
                 (I'0,(F'0,(mode'4,(mode'3,(mode'2,(mode'1,mode'0)))))))))))))))) =>
        let
          val mode =
         ...
         (true,
          (true,
           (true,
            (false,
             (false,
              (true,(true,(true,(false,(true,(true,(_,(_,(_,_))))))))))))))),
        (true,
         (false,
          (_,
           (false,
            (_,(_,(_,(_,(false,(false,(false,(J'0,(_,(_,(_,_)))))))))))))))) =>
        let
          val J = BitsN.fromBitstring([J'0],1)
        in
          if (Take(ThumbCondition (),HaveThumbEE ())) andalso
        ...
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then case BitsN.fromBitstring([op'3,op'2,op'1,op'0],4) of
                    BitsN.B(0x2,4) => ClearExclusive
                  | BitsN.B(0x4,4) =>
                       Hint(DataSynchronizationBarrier option)
                  | BitsN.B(0x5,4) => Hint(DataMemoryBarrier option)
                  | BitsN.B(0x6,4) =>
         ...
         (true,
          (true,
           (true,
            (false,
             (false,
              (true,(true,(true,(true,(false,(true,(_,(_,(_,_))))))))))))))),
        (true,
         (false,
          (_,
           (false,
     ...
     | ((true,
        ...
        (true,
         (false,
          (_,
           (false,
            (Rd'3,(Rd'2,(Rd'1,(Rd'0,(_,(_,(true,(m'0,(_,(_,(_,_)))))))))))))))) =>
        let
          val Rd = BitsN.fromBitstring([Rd'3,Rd'2,Rd'1,Rd'0],4)
        in
          if Take(ThumbCondition (),HaveVirtExt ())
     ...
     | ((true,
         (true,
          (true,
           (true,
            (false,
             (false,(true,(true,(true,(true,(true,(R'0,(_,(_,(_,_))))))))))))))),
        (true,
         (false,
          (_,
           (false,
            (Rd'3,(Rd'2,(Rd'1,(Rd'0,(_,(_,(false,(_,(_,(_,(_,_)))))))))))))))) =>
        let
          val Rd = BitsN.fromBitstring([Rd'3,Rd'2,Rd'1,Rd'0],4)
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            ...
            (false,
             (true,
              (true,
               (true,
                (true,
                 (true,(true,(true,(imm4'3,(imm4'2,(imm4'1,imm4'0))))))))))))))),
        (true,
         (false,
          (false,(false,(_,(_,(_,(_,(_,(_,(_,(_,(_,(_,(_,_)))))))))))))))) =>
        (if Take
              (ThumbCondition (),
               (HaveSecurityExt ()) andalso
               (not((!Architecture) = ARMv6K)))
           then ( if (InITBlock ()) andalso (not(LastInITBlock ()))
     ...
     | ((true,
        ...
        in
          if Take
               (ThumbCondition (),
                (((L = (BitsN.B(0x1,1))) andalso (J1 = (BitsN.B(0x1,1)))) andalso
                 (J1 = J2)) orelse (HaveThumb2 ()))
            then ( if (InITBlock ()) andalso (not(LastInITBlock ()))
                     then DECODE_UNPREDICTABLE
                            (mc,
              ...
              (imm10L'8,
               (imm10L'7,
                (imm10L'6,
                 (imm10L'5,
                  (imm10L'4,
                   (imm10L'3,(imm10L'2,(imm10L'1,(imm10L'0,H'0)))))))))))))))) =>
        let
          val S = BitsN.fromBitstring([S'0],1)
          val J2 = BitsN.fromBitstring([J2'0],1)
          val J1 = BitsN.fromBitstring([J1'0],1)
     ...
     | ((true,
        ...
        (true,
         (true,(true,(true,(_,(_,(_,(_,(_,(_,(_,(_,(_,(_,(_,_)))))))))))))))) =>
           ...
           (true,
            (true,
             (false,
              (false,
               (true,
                (U'0,(false,(false,(true,(true,(true,(true,true))))))))))))))),
        (true,
         (true,
          (true,
           (true,
     ...
     | ((true,
           ...
           (true,
            (true,
             (false,
              (false,
               (false,
                (U'0,(true,(false,(true,(true,(true,(true,true))))))))))))))),
        (Rt'3,
         (Rt'2,
          (Rt'1,
           (Rt'0,
        ...
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then ( if ((Rt = (BitsN.B(0xF,4))) andalso (InITBlock ())) andalso
                      (not(LastInITBlock ()))
     ...
     | ((true,
         (true,
          (true,
           (true,
            (true,
             (false,(false,(_,(false,(false,(_,(true,(_,(_,(_,_))))))))))))))),
        (_,
         (_,
          (_,(_,(true,(false,(_,(false,(_,(_,(_,(_,(_,(_,(_,_)))))))))))))))) =>
        Undefined(BitsN.B(0x0,32))
     | ((true,
         (true,
          (true,
        ...
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then ( if L3.mem(Rt,[BitsN.B(0xD,4),BitsN.B(0xF,4)])
         ...
         (true,
          (true,
           (true,
            (true,
             (false,
              (false,(true,(false,(false,(true,(true,(_,(_,(_,_))))))))))))))),
        (true,
         (true,
          (true,
           (true,
            (true,(true,(false,(false,(_,(_,(_,(_,(_,(_,(_,_)))))))))))))))) =>
        NoOperation
     | ((true,
         (true,
          (true,
            ...
            then let
                 ...
                 in
                   ( if (wback andalso (Rn = Rt)) orelse
                        (((Rt = (BitsN.B(0xF,4))) andalso (InITBlock ())) andalso
                         (not(LastInITBlock ())))
                       then DECODE_UNPREDICTABLE(mc,"LoadWord")
                     else ()
                   ; let
     ...
     | ((true,
        ...
        in
          if Take
            ...
            then ( if L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)])
        ...
        (true,
         (true,
          (true,
           (true,
            (false,
             (false,(false,(false,(false,(false,(_,(_,(_,(_,(_,_)))))))))))))))) =>
        NoOperation
     | ((true,
         (true,
          (true,
        ...
        in
          if Take
            ...
            then let
                   val wback = W = (BitsN.B(0x1,1))
                 in
                   ( if (L3.mem(Rt,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                        (wback andalso (Rn = Rt))
                       then DECODE_UNPREDICTABLE
           ...
           (true,
            (true,
             (false,
              (false,
               (false,
                (true,(false,(H'0,(false,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (Rt'3,
         (Rt'2,
          (Rt'1,
           (Rt'0,
           ...
           (true,
            (true,
             (false,
              (true,
               (false,
                (false,(op'1,(op'0,(S'0,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (true,
         (true,
          (true,
           (true,
           ...
           (true,
            (true,
             (false,
              (true,
               (false,
                (false,(op'1,(op'0,(U'0,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (true,
         (true,
          (true,
           (true,
                 ...
                 ; let
                   ...
                   in
                     case BitsN.fromBitstring([op'1,op'0],2) of
                        BitsN.B(0x0,2) => Media(ExtendHalfword args)
                      | BitsN.B(0x1,2) => Media(ExtendByte16 args)
                      | BitsN.B(0x2,2) => Media(ExtendByte args)
                      | BitsN.B(0x3,2) => Undefined(BitsN.B(0x0,32))
                      | _ => raise General.Bind
                   end
                 )
          else Skip ()
           ...
           (true,
            (Rd'3,
             (Rd'2,
              (Rd'1,
               (Rd'0,
                (false,(U'0,(op2'1,(op2'0,(Rm'3,(Rm'2,(Rm'1,Rm'0)))))))))))))))) =>
        let
          val Rn = BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)
          val Rm = BitsN.fromBitstring([Rm'3,Rm'2,Rm'1,Rm'0],4)
          val Rd = BitsN.fromBitstring([Rd'3,Rd'2,Rd'1,Rd'0],4)
                 ...
                 ; let
                     val opc =
                       case BitsN.fromBitstring([op1'2,op1'1,op1'0],3) of
                          BitsN.B(0x1,3) => BitsN.B(0x0,3)
                        | BitsN.B(0x2,3) => BitsN.B(0x1,3)
                        | BitsN.B(0x6,3) => BitsN.B(0x2,3)
                        | BitsN.B(0x5,3) => BitsN.B(0x3,3)
                        | BitsN.B(0x0,3) => BitsN.B(0x4,3)
                        | BitsN.B(0x4,3) => BitsN.B(0x7,3)
                        | _ => BitsN.B(0x5,3)
                   in
                     DecodeParallelAdditionSubtraction
                       (BitsN.+
        ...
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then ( if ((not((BitsN.fromBitstring([Rn'3,Rn'2,Rn'1,Rn'0],4)) =
                            Rm)) orelse
                       (L3.mem(Rd,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                      (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))
                     then DECODE_UNPREDICTABLE(mc,"Reverses")
                   else ()
                 ; case BitsN.fromBitstring([op2'1,op2'0],2) of
                      BitsN.B(0x0,2) => Media(ByteReverse(Rd,Rm))
                    | BitsN.B(0x1,2) =>
                         Media(ByteReversePackedHalfword(Rd,Rm))
                    | BitsN.B(0x2,2) => Media(ReverseBits(Rd,Rm))
                    | BitsN.B(0x3,2) =>
                         Media(ByteReverseSignedHalfword(Rd,Rm))
                    | _ => raise General.Bind
                 )
           ...
           (true,
            (true,
             (false,
              (true,
               (false,
                (true,(false,(true,(true,(Rn'3,(Rn'2,(Rn'1,Rn'0))))))))))))))),
        (true,
         (true,
          (true,
           (true,
                 ...
                 ; case (BitsN.fromBitstring([opc'2,opc'1,opc'0],3),
                    (Ra,
                     ((BitsN.fromBitstring([N'0],1)) = (BitsN.B(0x1,1)),
                      ...
                      (BitsN.B(0x0,3),(BitsN.B(0xF,4),(false,false))) =>
                         Multiply(Multiply32(false,(Rd,(Rn,Rm))))
                    | (BitsN.B(0x0,3),(_,(false,false))) =>
                       Multiply
                         (MultiplyAccumulate(false,(Rd,(Rn,(Rm,Ra)))))
                    | (BitsN.B(0x0,3),(BitsN.B(0xF,4),(false,true))) =>
                         ( DECODE_UNPREDICTABLE(mc,"MultiplySubtract")
                         ; Branch(BranchExchange(BitsN.B(0x0,4)))
                         )
                    | (BitsN.B(0x0,3),(_,(false,true))) =>
                       Multiply(MultiplySubtract(Rd,(Rn,(Rm,Ra))))
                    | (BitsN.B(0x1,3),(BitsN.B(0xF,4),(n_high,m_high))) =>
                       Multiply
                         (Signed16Multiply32Result
                            (m_high,(n_high,(Rd,(Rn,Rm)))))
                    | (BitsN.B(0x1,3),(_,(n_high,m_high))) =>
                       Multiply
                         (Signed16Multiply32Accumulate
                            (m_high,(n_high,(Rd,(Rn,(Rm,Ra))))))
                    | (BitsN.B(0x2,3),(_,(false,m_swap))) =>
                       Multiply
                         (SignedMultiplyDual
                            (false,(m_swap,(Rd,(Rn,(Rm,Ra))))))
                    | (BitsN.B(0x3,3),(BitsN.B(0xF,4),(false,m_high))) =>
                       Multiply
                         (Signed16x32Multiply32Result(m_high,(Rd,(Rn,Rm))))
                    | (BitsN.B(0x3,3),(_,(false,m_high))) =>
                       Multiply
                         (Signed16x32Multiply32Accumulate
                            (m_high,(Rd,(Rn,(Rm,Ra)))))
                    | (BitsN.B(0x4,3),(_,(false,m_swap))) =>
                       Multiply
                         (SignedMultiplyDual
                            (true,(m_swap,(Rd,(Rn,(Rm,Ra))))))
                    | (BitsN.B(0x5,3),(_,(false,round))) =>
                       Multiply
                         (SignedMostSignificantMultiply
                            (round,(Rd,(Rn,(Rm,Ra)))))
                    | (BitsN.B(0x6,3),(BitsN.B(0xF,4),(false,_))) =>
                       ( DECODE_UNPREDICTABLE
                           (mc,"SignedMostSignificantMultiplySubtract")
                       ; Branch(BranchExchange(BitsN.B(0x0,4)))
                       )
                    | (BitsN.B(0x6,3),(_,(false,round))) =>
                       Multiply
                         (SignedMostSignificantMultiplySubtract
                            (round,(Rd,(Rn,(Rm,Ra)))))
                    | (BitsN.B(0x7,3),(_,(false,false))) =>
                       SIMD
     ...
     | ((true,
        ...
        in
          if Take(ThumbCondition (),HaveThumb2 ())
            then ( if ((((L3.mem(RdLo,[BitsN.B(0xD,4),BitsN.B(0xF,4)])) orelse
                         (L3.mem(RdHi,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                        (L3.mem(Rn,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                       (L3.mem(Rm,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) orelse
                      (RdHi = RdLo)
                     then DECODE_UNPREDICTABLE
...
fun NextN n =
  if (Nat.<(0,n)) andalso (not (!undefined))
    then ( Next (); NextN(Nat.-(n,1)) )
  else ();
                         ...
                         (BitsN.@@
                            (BitsN.+
                               (BitsN.-
                                ...
                                BitsN.B(0x8,5)),BitsN.bits(n,6,0)))
                else NONE
              end
        end
  end;
...
fun EncodeARMImmediate_aux (n,x) =
  if (BitsN.bits(x,31,8)) = (BitsN.B(0x0,24))
    then Option.SOME
           (BitsN.@@(BitsN.-(BitsN.B(0xF,4),n),BitsN.bits(x,7,0)))
...
fun EncodeAddSubOpc opc =
  case opc of
     BitsN.B(0x0,2) => BitsN.B(0x1,3)
   | BitsN.B(0x1,2) => BitsN.B(0x2,3)
   | BitsN.B(0x2,2) => BitsN.B(0x6,3)
   | BitsN.B(0x3,2) => BitsN.B(0x5,3)
   | _ => raise General.Bind;

fun EncodeVFPImmediate (imm64,single_register) =
  if single_register
    then if ((((BitsN.bits(imm64,18,0)) = (BitsN.B(0x0,19))) andalso
              (L3.mem
                 (BitsN.bits(imm64,29,25),[BitsN.B(0x0,5),BitsN.B(0x1F,5)]))) andalso
             (not((BitsN.bit(imm64,25)) = (BitsN.bit(imm64,30))))) andalso
            ((BitsN.bits(imm64,63,32)) = (BitsN.B(0x0,32)))
           then Option.SOME
                  (BitsN.concat
                     [BitsN.bits(imm64,31,31),BitsN.bits(imm64,25,25),
                      BitsN.bits(imm64,24,19)])
         else NONE
  else if (((BitsN.bits(imm64,47,0)) = (BitsN.B(0x0,48))) andalso
      (L3.mem(BitsN.bits(imm64,61,54),[BitsN.B(0x0,8),BitsN.B(0xFF,8)]))) andalso
     (not((BitsN.bit(imm64,61)) = (BitsN.bit(imm64,62))))
    then Option.SOME
           (BitsN.concat
              [BitsN.bits(imm64,63,63),BitsN.bits(imm64,54,54),
               BitsN.bits(imm64,53,48)])
  else NONE;

fun EncodeVFPReg (d,single_register) =
  if single_register
    then (BitsN.bits(d,0,0),BitsN.bits(d,4,1))
  else (BitsN.bits(d,4,4),BitsN.bits(d,3,0));
  ...
  case ast of
      ...
      (if e = Enc_ARM
         ...
         then if ((BitsN.<=(BitsN.neg(BitsN.B(0x800,32)),imm32)) andalso
                ...
                then let
                 ...
                 (not(e = Enc_Narrow))
                then let
                       val S = BitsN.bits(imm32,24,24)
                       val I1 = BitsN.bits(imm32,23,23)
                       val I2 = BitsN.bits(imm32,22,22)
                       val J1 = BitsN.fromBit(I1 = S)
                       val J2 = BitsN.fromBit(I2 = S)
                       val imm10 = BitsN.bits(imm32,21,12)
                       val imm11 = BitsN.bits(imm32,11,1)
                     in
                       Thumb2
         ...
         then let
          ...
          (not(e = Enc_Narrow))
         then let
                val S = BitsN.bits(imm32,20,20)
                val J2 = BitsN.bits(imm32,19,19)
                val J1 = BitsN.bits(imm32,18,18)
                val imm6 = BitsN.bits(imm32,17,12)
                val imm11 = BitsN.bits(imm32,11,1)
              in
                Thumb2
                  (BitsN.concat[BitsN.B(0x1E,5),S,c,imm6],
                   BitsN.concat[BitsN.B(0x2,2),J1,BitsN.B(0x0,1),J2,imm11])
              end
       else BadCode("B: bad offset"))
   | BranchExchange Rm =>
      (if e = Enc_ARM
   ...
   | BranchLinkExchangeImmediate(targetInstrSet,imm32) =>
      (if e = Enc_ARM
         then if c = (BitsN.B(0xE,4))
                then if targetInstrSet = InstrSet_ARM
                       then if ((BitsN.<=
                        ...
                        (not(BitsN.bit(imm32,0)))
                       then let
                              val imm24 = BitsN.bits(imm32,25,2)
                              val H = BitsN.bits(imm32,1,1)
                            in
         ...
         then if (((BitsN.<=(BitsN.neg(BitsN.B(0x1000000,32)),imm32)) andalso
                  ...
                  ((BitsN.bits(imm32,1,0)) = (BitsN.B(0x0,2)))) andalso
                 (not(e = Enc_Narrow))
                then let
                       val S = BitsN.bits(imm32,24,24)
                       val I1 = BitsN.bits(imm32,23,23)
                       ...
                       val J1 = BitsN.fromBit(I1 = S)
                       val J2 = BitsN.fromBit(I2 = S)
                       val imm10H = BitsN.bits(imm32,21,12)
                       val imm10L = BitsN.bits(imm32,11,2)
                     in
                       Thumb2
           ...
           (BitsN.<=(imm32,BitsN.B(0xFFFFFE,32)))) andalso
          (not((BitsN.bit(imm32,0)) orelse (e = Enc_Narrow)))
         then let
                val S = BitsN.bits(imm32,24,24)
                val I1 = BitsN.bits(imm32,23,23)
                val I2 = BitsN.bits(imm32,22,22)
   ...
   | CompareBranch(nonzero,(n,imm32)) =>
      (if ((BitsN.<=+(imm32,BitsN.B(0x7E,32))) andalso
           (not((BitsN.bit(imm32,0)) orelse (BitsN.bit(n,3))))) andalso
          (L3.mem(e,[Enc_Thumb,Enc_Narrow]))
         then let
                val op' = BitsN.fromBit nonzero
                val i = BitsN.bits(imm32,6,6)
                val imm5 = BitsN.bits(imm32,5,1)
                val Rn = BitsN.bits(n,2,0)
              in
                Thumb
                  (BitsN.concat
   ...
   | TableBranchByte(is_tbh,(Rm,Rn)) =>
      (if L3.mem(e,[Enc_Thumb,Enc_Wide])
         then let
   ...
   | CheckArray(Rm,n) =>
      (if L3.mem(e,[Enc_Thumb,Enc_Narrow])
         then let
                val N = BitsN.bits(n,3,3)
                val Rn = BitsN.bits(n,2,0)
              in
   ...
   | HandlerBranchLink(generate_link,handler_offset) =>
      (if ((BitsN.<=+(handler_offset,BitsN.B(0x1FE0,32))) andalso
           ((BitsN.bits(handler_offset,4,0)) = (BitsN.B(0x0,5)))) andalso
          (L3.mem(e,[Enc_Thumb,Enc_Narrow]))
         then let
                val L = BitsN.fromBit generate_link
                val handler = BitsN.bits(handler_offset,12,5)
              in
   ...
   | HandlerBranchLinkParameter(imm32,handler_offset) =>
      (if (((BitsN.<+(imm32,BitsN.B(0x20,32))) andalso
          ...
          (L3.mem(e,[Enc_Thumb,Enc_Narrow]))
         then let
                val imm5 = BitsN.bits(imm32,4,0)
                val handler = BitsN.bits(handler_offset,9,5)
              in
...
fun e_vfp (c,(ast,e)) =
  case ast of
              ...
              in
                ARM(BitsN.concat
                      [c,BitsN.B(0x1C,5),D,op1,Vn,Vd,BitsN.B(0x5,3),
                       BitsN.fromBit dp_operation,N,op2,M,BitsN.B(0x0,1),
                       Vm])
              end
       else BadCode("VNMUL"))
   ...
   | vldr(single_register,(add,(d,(n,imm32)))) =>
      (if e = Enc_ARM
         then if (not((BitsN.bits(imm32,1,0)) = (BitsN.B(0x0,2)))) orelse
                 (not((BitsN.bits(imm32,31,10)) = (BitsN.B(0x0,22))))
                then BadCode("VLDR: bad immediate")
              else let
                     val imm8 = BitsN.bits(imm32,9,2)
                     val (D,Vd) = EncodeVFPReg(d,single_register)
                   in
                     ARM(BitsN.concat
   ...
   | UndefinedVFP =>
        if e = Enc_ARM
          then ARM(BitsN.@@(c,BitsN.B(0xC000A00,28)))
        else BadCode("UndefinedVFP");
  ...
  case ast of
   ...
   | MoveHalfword(high,(Rd,imm16)) =>
      ...
      in
        if e = Enc_ARM
          then let
                 val imm4 = BitsN.bits(imm16,15,12)
                 val imm12 = BitsN.bits(imm16,11,0)
               in
                 ARM(BitsN.concat
          ...
          then let
                 val imm4 = BitsN.bits(imm16,15,12)
                 val i = BitsN.bits(imm16,11,11)
                 val imm3 = BitsN.bits(imm16,10,8)
                 val imm8 = BitsN.bits(imm16,7,0)
               in
                 Thumb2
                   (BitsN.concat
   ...
   | Move(setflags,(negate,(d,imm12))) =>
      (if e = Enc_ARM
       ...
       else if ((BitsN.bits(imm12,11,8)) = (BitsN.B(0x0,4))) andalso
          (not(((negate orelse (setflags = (not(c = (BitsN.B(0xE,4)))))) orelse
                (BitsN.bit(d,3))) orelse (e = Enc_Wide)))
         then let
                val Rd = BitsN.bits(d,2,0)
                val imm8 = BitsN.bits(imm12,7,0)
              in
         ...
         then let
                val Rd = d
                val S = BitsN.fromBit setflags
                val i = BitsN.bits(imm12,11,11)
                val imm3 = BitsN.bits(imm12,10,8)
                val imm8 = BitsN.bits(imm12,7,0)
                val N = BitsN.fromBit negate
              in
                Thumb2
   ...
   | TestCompareImmediate(op',(Rn,imm12)) =>
      (if e = Enc_ARM
         then ARM(BitsN.concat
                    [c,BitsN.B(0x6,5),op',BitsN.B(0x1,1),Rn,
                     BitsN.B(0x0,4),imm12])
       else if ((op' = (BitsN.B(0x2,2))) andalso
           ((BitsN.bits(imm12,11,8)) = (BitsN.B(0x0,4)))) andalso
          (not((BitsN.bit(Rn,3)) orelse (e = Enc_Wide)))
         then let
                val n = BitsN.bits(Rn,2,0)
                val imm8 = BitsN.bits(imm12,7,0)
              in
         ...
         then let
                ...
                val opc =
                  case op' of
                     BitsN.B(0x0,2) => BitsN.B(0x0,4)
                   | BitsN.B(0x1,2) => BitsN.B(0x4,4)
                   | BitsN.B(0x2,2) => BitsN.B(0xD,4)
                   | BitsN.B(0x3,2) => BitsN.B(0x8,4)
                   | _ => raise General.Bind
              in
                Thumb2
                  (BitsN.concat
   ...
   | ArithLogicImmediate(opc,(setflags,(d,(n,imm12)))) =>
      (if e = Enc_ARM
         then let
           ...
           ((BitsN.bits(imm12,11,3)) = (BitsN.B(0x0,9)))) andalso
          (not((((setflags = (not(c = (BitsN.B(0xE,4))))) orelse
                 (BitsN.bit(d,3))) orelse (BitsN.bit(n,3))) orelse
               (e = Enc_Wide)))
         then let
                val Rd = BitsN.bits(d,2,0)
                val Rn = BitsN.bits(n,2,0)
                val imm3 = BitsN.bits(imm12,2,0)
                val S = BitsN.bits(opc,1,1)
              in
                Thumb(BitsN.concat[BitsN.B(0x7,6),S,imm3,Rn,Rd])
              end
       else if (((L3.mem(opc,[BitsN.B(0x4,4),BitsN.B(0x2,4)])) andalso
            (d = n)) andalso ((BitsN.bits(imm12,11,8)) = (BitsN.B(0x0,4)))) andalso
          (not(((setflags = (not(c = (BitsN.B(0xE,4))))) orelse
                (BitsN.bit(d,3))) orelse (e = Enc_Wide)))
         then let
                val Rdn = BitsN.bits(d,2,0)
                val imm8 = BitsN.bits(imm12,7,0)
                val S = BitsN.bits(opc,1,1)
              in
       ...
       else if ((((opc = (BitsN.B(0x4,4))) andalso (not setflags)) andalso
            (L3.mem(n,[BitsN.B(0xD,4),BitsN.B(0xF,4)]))) andalso
           ((BitsN.bits(imm12,11,8)) = (BitsN.B(0xF,4)))) andalso
         ...
         then let
             ...
             (d = (BitsN.B(0xD,4)))) andalso (n = (BitsN.B(0xD,4)))) andalso
           ((BitsN.bits(imm12,11,7)) = (BitsN.B(0x1E,5)))) andalso
          (not(setflags orelse (e = Enc_Wide)))
         then let
                val imm7 = BitsN.bits(imm12,6,0)
                val S = BitsN.bits(opc,1,1)
              in
                Thumb(BitsN.concat[BitsN.B(0xB0,8),S,imm7])
              end
       else if (((((opc = (BitsN.B(0x2,4))) andalso setflags) andalso
             (d = (BitsN.B(0xF,4)))) andalso (n = (BitsN.B(0xE,4)))) andalso
           ((BitsN.bits(imm12,11,8)) = (BitsN.B(0x0,4)))) andalso
          (not(e = Enc_Narrow))
         then let
                val imm8 = BitsN.bits(imm12,7,0)
         ...
         then let
                ...
                val op' =
                  case opc of
                     BitsN.B(0x0,4) => BitsN.B(0x0,4)
                   | BitsN.B(0xE,4) => BitsN.B(0x1,4)
                   | BitsN.B(0xC,4) => BitsN.B(0x2,4)
                   | BitsN.B(0xF,4) => BitsN.B(0x3,4)
                   | BitsN.B(0x1,4) => BitsN.B(0x4,4)
                   | BitsN.B(0x4,4) => BitsN.B(0x8,4)
                   | BitsN.B(0x5,4) => BitsN.B(0xA,4)
                   | BitsN.B(0x6,4) => BitsN.B(0xB,4)
                   | BitsN.B(0x2,4) => BitsN.B(0xD,4)
                   | BitsN.B(0x3,4) => BitsN.B(0xE,4)
                   | _ => BitsN.B(0xF,4)
              in
                if op' = (BitsN.B(0xF,4))
                  then BadCode
   ...
   | Register(opc,(setflags,(d,(n,(m,(shift_t,shift_n)))))) =>
      (if e = Enc_ARM
       ...
       else if (((L3.mem(opc,[BitsN.B(0x2,4),BitsN.B(0x4,4)])) andalso
            (shift_t = SRType_LSL)) andalso (shift_n = 0)) andalso
          (not(((((setflags = (not(c = (BitsN.B(0xE,4))))) orelse
                  (BitsN.bit(d,3))) orelse (BitsN.bit(n,3))) orelse
         ...
         then let
              ...
              in
                ...
                (opc,
                 [BitsN.B(0x0,4),BitsN.B(0x1,4),BitsN.B(0x5,4),
                  BitsN.B(0x6,4),BitsN.B(0xC,4),BitsN.B(0xE,4)])) andalso
             (d = n)) andalso (shift_t = SRType_LSL)) andalso
           (shift_n = 0)) andalso
          (not((((setflags = (not(c = (BitsN.B(0xE,4))))) orelse
                 (BitsN.bit(d,3))) orelse (BitsN.bit(m,3))) orelse
               (e = Enc_Wide)))
         then let
                val Rdn = BitsN.bits(d,2,0)
                val Rm = BitsN.bits(m,2,0)
         ...
         then let
                ...
                val Rm = m
                val (typ,imm5) = EncodeImmShift(shift_t,shift_n)
                val imm3 = BitsN.bits(imm5,4,2)
                val imm2 = BitsN.bits(imm5,1,0)
                val op' =
                  case opc of
                     BitsN.B(0x0,4) => BitsN.B(0x0,4)
                   | BitsN.B(0xE,4) => BitsN.B(0x1,4)
   ...
   | TestCompareRegister(opc,(n,(m,(shift_t,shift_n)))) =>
      (if e = Enc_ARM
       ...
       else if ((shift_t = SRType_LSL) andalso (shift_n = 0)) andalso
          (not((((opc = (BitsN.B(0x1,2))) orelse (BitsN.bit(n,3))) orelse
                (BitsN.bit(m,3))) orelse (e = Enc_Wide)))
         then let
                val Rn = BitsN.bits(n,2,0)
                val Rm = BitsN.bits(m,2,0)
       ...
       else if (((not(e = Enc_Wide)) andalso (shift_t = SRType_LSL)) andalso
   ...
   | ShiftImmediate(negate,(setflags,(d,(m,(shift_t,shift_n))))) =>
      (if e = Enc_ARM
       ...
       else if ((negate andalso (shift_t = SRType_LSL)) andalso
           (shift_n = 0)) andalso
          (not((((setflags = (not(c = (BitsN.B(0xE,4))))) orelse
                 (BitsN.bit(m,3))) orelse (BitsN.bit(d,3))) orelse
               (e = Enc_Wide)))
         then let
                val Rm = BitsN.bits(m,2,0)
                val Rd = BitsN.bits(d,2,0)
       ...
       else if (L3.mem(shift_t,[SRType_LSL,SRType_LSR,SRType_ASR])) andalso
          (not((((negate orelse (setflags = (not(c = (BitsN.B(0xE,4)))))) orelse
                 (BitsN.bit(m,3))) orelse (BitsN.bit(d,3))) orelse
               (e = Enc_Wide)))
         then let
          ...
          (not(((negate orelse setflags) orelse (e = Enc_Wide)) orelse
               ((d = (BitsN.B(0xF,4))) andalso (not(c = (BitsN.B(0xE,4)))))))
         then let
                val D = BitsN.bits(d,3,3)
                val Rd = BitsN.bits(d,2,0)
                val Rm = m
              in
   ...
   | ShiftRegister(negate,(setflags,(d,(n,(shift_t,m))))) =>
      (if e = Enc_ARM
         then let
          ...
          (not((((negate orelse (BitsN.bit(d,3))) orelse (BitsN.bit(m,3))) orelse
  ...
  case ast of
   ...
   | Saturate(shift_t,(shift_n,(saturate_to,(unsigned,(Rd,Rn))))) =>
      ...
      in
        if e = Enc_ARM
          then ARM(BitsN.concat
                     [c,BitsN.B(0xD,5),U,BitsN.B(0x1,1),sat_imm,Rd,imm5,
                      sh,BitsN.B(0x1,2),Rn])
        else if not(e = Enc_Narrow)
          then let
                 val imm3 = BitsN.bits(imm5,4,2)
   ...
   | ExtendByte(unsigned,(d,(Rn,(m,rotation)))) =>
      ...
      in
        ...
        else if ((Rn = (BitsN.B(0xF,4))) andalso (rotation = 0)) andalso
           (not(((BitsN.bit(d,3)) orelse (BitsN.bit(m,3))) orelse
                (e = Enc_Wide)))
          then let
                 val Rd = BitsN.bits(d,2,0)
                 val Rm = BitsN.bits(m,2,0)
   ...
   | ByteReverse(d,m) =>
      (if e = Enc_ARM
         then let
              ...
              in
                ARM(BitsN.concat
                      [c,BitsN.B(0x6BF,12),Rd,BitsN.B(0xF3,8),Rm])
              end
       else if not(((BitsN.bit(d,3)) orelse (BitsN.bit(m,3))) orelse
              (e = Enc_Wide))
         then let
                val Rd = BitsN.bits(d,2,0)
                val Rm = BitsN.bits(m,2,0)
   ...
   | ByteReversePackedHalfword(d,m) =>
      (if e = Enc_ARM
         then let
              ...
              in
                ARM(BitsN.concat
                      [c,BitsN.B(0x6BF,12),Rd,BitsN.B(0xFB,8),Rm])
              end
       else if not(((BitsN.bit(d,3)) orelse (BitsN.bit(m,3))) orelse
              (e = Enc_Wide))
         then let
   ...
   | ByteReverseSignedHalfword(d,m) =>
      (if e = Enc_ARM
         then let
              ...
              in
                ARM(BitsN.concat
                      [c,BitsN.B(0x6FF,12),Rd,BitsN.B(0xFB,8),Rm])
              end
       else if not(((BitsN.bit(d,3)) orelse (BitsN.bit(m,3))) orelse
              (e = Enc_Wide))
         then let
   ...
   | BitFieldExtract(unsigned,(Rd,(Rn,(lsbit,widthminus1)))) =>
      ...
      in
        if e = Enc_ARM
          ...
          then let
                 val imm3 = BitsN.bits(lsb,4,2)
                 val imm2 = BitsN.bits(lsb,1,0)
               in
                 Thumb2
...
fun e_hint (c,(ast,e)) =
  case ast of
     Breakpoint imm32 =>
      (if e = Enc_ARM
         then let
                val imm12 = BitsN.bits(imm32,15,4)
                val imm4 = BitsN.bits(imm32,3,0)
              in
                ARM(BitsN.concat
   ...
   | Debug option =>
      (if e = Enc_ARM
         ...
         then Thumb2
                (BitsN.B(0xF3AF,16),BitsN.@@(BitsN.B(0x80F,12),option))
       else BadCode("Debug"))
   | DataMemoryBarrier option =>
      (if e = Enc_ARM
         ...
         then Thumb2
                (BitsN.B(0xF3BF,16),BitsN.@@(BitsN.B(0x8F5,12),option))
       else BadCode("DataMemoryBarrier"))
   | DataSynchronizationBarrier option =>
      (if e = Enc_ARM
         ...
         then Thumb2
                (BitsN.B(0xF3BF,16),BitsN.@@(BitsN.B(0x8F4,12),option))
       else BadCode("DataSynchronizationBarrier"))
   | InstructionSynchronizationBarrier option =>
      (if e = Enc_ARM
         ...
         then Thumb2
                (BitsN.B(0xF3BF,16),BitsN.@@(BitsN.B(0x8F6,12),option))
       else BadCode("InstructionSynchronizationBarrier"))
   | SendEvent =>
        if e = Enc_ARM
   ...
   | PreloadData(add,(is_pldw,(Rn,immediate_form1 imm32))) =>
      (if e = Enc_ARM
         then let
                ...
                val imm12 = BitsN.bits(imm32,11,0)
              in
                ARM(BitsN.concat
   ...
   | PreloadData(add,(is_pldw,(Rn,register_form1(Rm,(shift_t,shift_n))))) =>
      (if e = Enc_ARM
       ...
       else if ((not(e = Enc_Narrow)) andalso add) andalso
          (shift_t = SRType_LSL)
         then let
                val W = BitsN.fromBit is_pldw
...
fun e_system (c,(ast,e)) =
  case ast of
        ...
        if e = Enc_ARM
          then if c = (BitsN.B(0xE,4))
                 then let
                      ...
                      in
                        ARM(BitsN.concat
                              [BitsN.B(0xF10,12),imod,M,BitsN.B(0x0,8),A,
                               I,F,BitsN.B(0x0,1),mode])
                      end
          ...
          then let
               ...
               in
                 Thumb
                   (BitsN.concat
                      [BitsN.B(0x5B3,11),im,BitsN.B(0x0,1),A,I,F])
               end
        else if not(e = Enc_Narrow)
          then let
                 val imod =
   ...
   | HypervisorCall imm16 =>
      (if e = Enc_ARM
         then let
                val imm12 = BitsN.bits(imm16,15,4)
                val imm4 = BitsN.bits(imm16,3,0)
              in
                ARM(BitsN.concat
   ...
   | MoveToRegisterFromBankedOrSpecial(read_spsr,(SYSm,Rd)) =>
      let
        val R = BitsN.fromBit read_spsr
        val m = BitsN.bits(SYSm,4,4)
        val m1 = BitsN.bits(SYSm,3,0)
      in
        if e = Enc_ARM
          then ARM(BitsN.concat
   ...
   | MoveToBankedOrSpecialRegister(write_spsr,(SYSm,Rn)) =>
      ...
      in
        if e = Enc_ARM
          then ARM(BitsN.concat
                     [c,BitsN.B(0x2,5),R,BitsN.B(0x2,2),m1,
                      BitsN.B(0x79,7),m,BitsN.B(0x0,4),Rn])
        else if not(e = Enc_Narrow)
          then Thumb2
                 (BitsN.concat[BitsN.B(0x79C,11),R,Rn],
                  BitsN.concat
   ...
   | ReturnFromException(increment,(wordhigher,(wback,Rn))) =>
      ...
      in
        if e = Enc_ARM
          ...
          then Thumb2
                 (BitsN.concat
                    [BitsN.B(0x74,7),U,U,BitsN.B(0x0,1),W,BitsN.B(0x1,1),
                     Rn],BitsN.B(0xC000,16))
        else BadCode("ReturnFromException")
      end
   ...
   | SupervisorCall imm32 =>
      (if e = Enc_ARM
         then let
                val imm24 = BitsN.bits(imm32,23,0)
              in
...
fun e_multiply (c,(ast,e)) =
  case ast of
   ...
   | MultiplySubtract(Rd,(Rn,(Rm,Ra))) =>
      (if e = Enc_ARM
         then ARM(BitsN.concat
                    [c,BitsN.B(0x6,8),Rd,Ra,Rm,BitsN.B(0x9,4),Rn])
       else if not(e = Enc_Narrow)
         then Thumb2
                (BitsN.@@(BitsN.B(0xFB0,12),Rn),
  ...
  case ast of
      ...
      (if e = Enc_ARM
         ...
         then if (((n = (BitsN.B(0xD,4))) andalso
                ...
                then let
                  ...
                  ((BitsN.bits(imm32,1,0)) = (BitsN.B(0x0,2)))) andalso
                 (not(((BitsN.bit(t,3)) orelse (BitsN.bit(n,3))) orelse
                      (e = Enc_Wide)))
                then let
                       val Rt = BitsN.bits(t,2,0)
                       val Rn = BitsN.bits(n,2,0)
                       val imm5 = BitsN.bits(imm32,6,2)
                     in
   ...
   | LoadWord
      ...
      in
        ...
        else if (((shift_t = SRType_LSL) andalso index) andalso add) andalso
           (not wback)
          then if (shift_n = 0) andalso
                  (not((((BitsN.bit(m,3)) orelse (BitsN.bit(n,3))) orelse
   ...
   | LoadLiteral(add,(t,imm32)) =>
      (if e = Enc_ARM
       ...
       else if ((add andalso (BitsN.<=+(imm32,BitsN.B(0x3FC,32)))) andalso
           ((BitsN.bits(imm32,1,0)) = (BitsN.B(0x0,2)))) andalso
          (not((BitsN.bit(t,3)) orelse (e = Enc_Wide)))
         then let
                val Rt = BitsN.bits(t,2,0)
   ...
   | LoadUnprivileged(add,(postindex,(Rt,(Rn,immediate_form1 imm32)))) =>
      (if ((e = Enc_ARM) andalso postindex) andalso
          (BitsN.<=+(imm32,BitsN.B(0xFFF,32)))
         then let
                val imm12 = BitsN.bits(imm32,11,0)
                val U = BitsN.fromBit add
              in
       ...
       else if (((L3.mem(e,[Enc_Thumb,Enc_Wide])) andalso add) andalso
   ...
   | LoadByte
      ...
      (if e = Enc_ARM
         then let
              ...
              in
                if unsigned andalso (BitsN.<=+(imm32,BitsN.B(0xFFF,32)))
                  ...
                  then let
                         val imm4H = BitsN.bits(imm32,7,4)
                         val imm4L = BitsN.bits(imm32,3,0)
                       in
                         ARM(BitsN.concat
         ...
         then if (unsigned andalso (BitsN.<=+(imm32,BitsN.B(0x1F,32)))) andalso
                 (not(((BitsN.bit(t,3)) orelse (BitsN.bit(n,3))) orelse
                      (e = Enc_Wide)))
                then let
                       val Rt = BitsN.bits(t,2,0)
                ...
                then let
                     ...
                     in
                       Thumb2
                         (BitsN.concat
                            [BitsN.B(0x7C,7),S,BitsN.B(0x9,4),Rn],
                          BitsN.@@(Rt,imm12))
                     end
              else BadCode("LoadByte")
       else if (BitsN.<=+(imm32,BitsN.B(0xFF,32))) andalso
              ...
              in
                if unsigned andalso (BitsN.<=+(imm32,BitsN.B(0xFFF,32)))
                  then let
                       ...
                       in
                         ARM(BitsN.concat
                               [c,BitsN.B(0x5,4),U,BitsN.B(0x5F,7),Rt,
                                imm12])
                       end
                else if BitsN.<=+(imm32,BitsN.B(0xFF,32))
                  then let
   ...
   | LoadHalf
      ...
      (if e = Enc_ARM
         ...
         then if ((unsigned andalso (BitsN.<=+(imm32,BitsN.B(0x3E,32)))) andalso
                  (not(BitsN.bit(imm32,0)))) andalso
                 (not(((BitsN.bit(t,3)) orelse (BitsN.bit(n,3))) orelse
                      (e = Enc_Wide)))
                then let
                       val Rt = BitsN.bits(t,2,0)
                ...
                then let
                     ...
                     in
                       Thumb2
                         (BitsN.concat
                            [BitsN.B(0x7C,7),S,BitsN.B(0xB,4),Rn],
                          BitsN.@@(Rt,imm12))
                     end
              else BadCode("LoadHalf")
       else if (BitsN.<=+(imm32,BitsN.B(0xFF,32))) andalso
          ...
          then if BitsN.<=+(imm32,BitsN.B(0xFF,32))
                 then let
                      ...
                      in
                        ARM(BitsN.concat
                              [c,BitsN.B(0x1,4),U,BitsN.B(0x5F,7),Rt,
                               imm4H,BitsN.B(0x1,1),S,BitsN.B(0x3,2),imm4L])
                      end
   ...
   | LoadMultiple(increment,(index,(wback,(n,registers)))) =>
      (if e = Enc_ARM
       ...
       else if (((((n = (BitsN.B(0xD,4))) andalso increment) andalso
             (not index)) andalso wback) andalso
           ((BitsN.bits(registers,14,8)) = (BitsN.B(0x0,7)))) andalso
          (not(e = Enc_Wide))
         then let
                val P = BitsN.bits(registers,15,15)
                val register_list = BitsN.bits(registers,7,0)
              in
                Thumb(BitsN.concat[BitsN.B(0x5E,7),P,register_list])
              end
       else if (((((not(BitsN.bit(n,3))) andalso increment) andalso
             (not index)) andalso
            (not(wback = (BitsN.bit(registers,BitsN.toNat n))))) andalso
           ((BitsN.bits(registers,15,8)) = (BitsN.B(0x0,8)))) andalso
          (not(e = Enc_Wide))
         then let
                val Rn = BitsN.bits(n,2,0)
                val register_list = BitsN.bits(registers,7,0)
       ...
       else if (increment andalso (not index)) andalso
          (not(e = Enc_Narrow))
         then let
                val Rn = n
                val W = BitsN.fromBit wback
       ...
       else if ((not increment) andalso index) andalso
          (not(e = Enc_Narrow))
         then let
                val Rn = n
                val W = BitsN.fromBit wback
        ...
        if e = Enc_ARM
          ...
          then let
               ...
               in
                 Thumb2
                   (BitsN.concat
                      [BitsN.B(0x74,7),P,U,BitsN.B(0x1,1),W,
                       BitsN.B(0x1,1),Rn],BitsN.concat[Rt,Rt2,imm8])
               end
        else BadCode("LoadDual")
      end
        ...
        if e = Enc_ARM
          then if ((BitsN.+(Rt,BitsN.B(0x1,4))) = Rt2) andalso
                 ...
                 then let
                      ...
                      in
                        ARM(BitsN.concat
                              [c,BitsN.B(0x1,4),U,BitsN.B(0x4F,7),Rt,
                               imm4H,BitsN.B(0xD,4),imm4L])
                      end
  ...
  case ast of
   ...
   | StoreMultiple(increment,(index,(wback,(n,registers)))) =>
      (if e = Enc_ARM
       ...
       else if ((((((n = (BitsN.B(0xD,4))) andalso (not increment)) andalso
              index) andalso wback) andalso (not(BitsN.bit(registers,15)))) andalso
           ((BitsN.bits(registers,13,8)) = (BitsN.B(0x0,6)))) andalso
          (not(e = Enc_Wide))
         then let
                val M = BitsN.bits(registers,14,14)
                val register_list = BitsN.bits(registers,7,0)
              in
          ...
          then let
               ...
               in
                 Thumb2
                   (BitsN.concat
                      [BitsN.B(0x74,7),P,U,BitsN.B(0x1,1),W,
                       BitsN.B(0x0,1),Rn],BitsN.concat[Rt,Rt2,imm8])
               end
        else BadCode("StoreDual")
      end
   ...
   | Undefined imm32 =>
      (if e = Enc_ARM
         then let
          ...
          ((BitsN.bits(imm32,31,8)) = (BitsN.B(0x0,24)))
         then let
                val imm8 = BitsN.bits(imm32,7,0)
              in
         ...
         then let
                val imm4 = BitsN.bits(imm32,15,12)
                val imm12 = BitsN.bits(imm32,11,0)
              in
                Thumb2
...
fun SetPassCondition c =
  case c of
     BitsN.B(0x0,4) => CPSR := (PSR_Z_rupd((!CPSR),true))
   | BitsN.B(0x1,4) => CPSR := (PSR_Z_rupd((!CPSR),false))
   | BitsN.B(0x2,4) => CPSR := (PSR_C_rupd((!CPSR),true))
   | BitsN.B(0x3,4) => CPSR := (PSR_C_rupd((!CPSR),false))
   | BitsN.B(0x4,4) => CPSR := (PSR_N_rupd((!CPSR),true))
   | BitsN.B(0x5,4) => CPSR := (PSR_N_rupd((!CPSR),false))
   | BitsN.B(0x6,4) => CPSR := (PSR_V_rupd((!CPSR),true))
   | BitsN.B(0x7,4) => CPSR := (PSR_V_rupd((!CPSR),false))
   | BitsN.B(0x8,4) =>
        ( CPSR := (PSR_C_rupd((!CPSR),true))
        ; CPSR := (PSR_Z_rupd((!CPSR),false))
        )
   | BitsN.B(0x9,4) => CPSR := (PSR_C_rupd((!CPSR),false))
   | BitsN.B(0xA,4) =>
...
fun p_encode_signed_offset N x =
  case p_signed_number x of
     Option.SOME(sub,n) =>
      let
        val i = Int.-(if sub then Int.~(Nat.toInt n) else Nat.toInt n,8)
  ...
  case L3.uncurry String.tokens (fn c => Char.isSpace c,s) of
     [t] =>
      let
        val (l,r) =
          L3.splitl
            (fn c => (Char.isAlphaNum c) orelse (L3.mem(c,[#"_",#"."])),t)
      in
        if ((r = ("")) andalso (not(l = ("")))) andalso
           (not(Char.isDigit(L3.strHd l)))
          then Option.SOME l
        else NONE
      end
   | _ => NONE;
...
fun p_suffix s =
  case L3.uncurry String.fields (fn c => c = #".",s) of
     [cond,s] =>
      (case (p_cond cond,L3.mem(s,["w","n","f32","f64","32","64"])) of
  ...
  case l of
     [r1,r2,r3,r4] =>
      (case (p_register r1,(p_register r2,(p_register r3,p_register r4))) of
          (Option.SOME v1,(Option.SOME v2,(Option.SOME v3,Option.SOME v4))) =>
...
fun p_any_fp_register (s,t) =
  case (p_fp_register(true,s),L3.mem(t,["","32"])) of
     (Option.SOME r,true) => Option.SOME(true,r)
   | _ =>
      (case (p_fp_register(false,s),L3.mem(t,["","64"])) of
...
fun p_shift_amount (typ,(h,s)) =
  if Char.isSpace h
    then case p_unbounded_immediate s of
            Option.SOME n =>
             (if (Nat.<(n,32)) orelse
                 ((n = 32) andalso (L3.mem(typ,[SRType_LSR,SRType_ASR])))
                then ("",(typ,NAT n))
  ...
  case (p_suffix c,l) of
   ...
   | (Option.SOME c,[r1,r2,r3,sh]) =>
      (case (p_register3[r1,r2,r3],p_shift_imm_or_reg sh) of
        ...
        | (Option.SOME _,(err,(_,_))) => FAIL err
        | _ => FAIL("syntax error"))
   | _ => FAIL("syntax error");
      ...
      (case p_register r1 of
          Option.SOME rn =>
           (case p_register x of
               Option.SOME rm =>
                OK(c,
                   Data(TestCompareRegister(opc,(rn,(rm,(SRType_LSL,0))))))
             | NONE =>
                  (case p_arm_immediate x of
                      Option.SOME("",imm12) =>
          ...
          Option.SOME(rd,rn) =>
           (case p_register s of
               Option.SOME rm =>
                OK(c,
                   Data
                     (ShiftRegister(false,(setflags,(rd,(rn,(typ,rm)))))))
             | NONE =>
                  (case p_unbounded_immediate s of
                      Option.SOME n =>
                       (if (Nat.<(n,32)) orelse
                           ((n = 32) andalso
                            (L3.mem(typ,[SRType_LSR,SRType_ASR])))
                          then OK(c,
                                  Data
                                    (ShiftImmediate
...
fun p_usad8 (c,l) =
  case (p_suffix c,p_register3 l) of
     (Option.SOME c,Option.SOME(rd,(rn,rm))) =>
      OK(c,
         SIMD(UnsignedSumAbsoluteDifferences(rd,(rn,(rm,BitsN.B(0xF,4))))))
   | _ => FAIL("syntax error");
     ...
     (Option.SOME c,[r1,r2,r3]) =>
      (case p_register3[r1,r2,r3] of
          Option.SOME(rd,(rn,rm)) =>
           ...
           in
             OK(c,Media(PackHalfword(SRType_LSL,(0,(false,(rd,(rn,rm)))))))
           end
        | NONE => FAIL("syntax error"))
   | (Option.SOME c,[r1,r2,r3,sh]) =>
      (case p_register3[r1,r2,r3] of
                 ...
                 (case p_shift_imm_or_reg sh of
                     ("",(SRType_LSL,NAT n)) =>
                      OK(c,
                         Media
                           (Saturate
                              (SRType_LSL,(n,(sat_to,(unsigned,(rd,rn)))))))
                   | ("",(SRType_ASR,NAT n)) =>
                      OK(c,
                         Media
                           (Saturate
                ...
                (case p_range_imm(1,(Nat.-(32,l),width)) of
                    ("",w) =>
                     OK(c,
                        Media
                          (BitFieldClearOrInsert
                             (rd,(BitsN.B(0xF,4),(l,Nat.-(Nat.+(l,w),1))))))
                  | (err,_) => FAIL err)
             | (err,_) => FAIL err)
        | NONE => FAIL("syntax error"))
   | _ => FAIL("syntax error");
...
fun closingRegList s =
  ...
  in
    if (r = ("}")) andalso (Nat.<(String.size caret,2))
...
fun closingAddress s =
  let
    ...
    val (l,r) = L3.splitr(fn c => c = #"]",stripSpaces l)
  in
    if (r = ("]")) andalso (Nat.<(String.size wb,2))
                           ...
                           (case p_signed_immediate 32 offset1 of
                               Option.SOME(sub,(true,imm32)) =>
                                ("",
                                 Option.SOME
                                   (not sub,
                                    (true,(wb,(rn,immediate_form1 imm32)))))
...
fun p_address_mode2 l =
  case p_address_mode1 l of
   ...
   | ("",
      Option.SOME
        (add,(index,(wback,(r,register_form1(m,(SRType_LSL,0))))))) =>
  ...
  in
    if load
      then case (index,(wback,(rn,offset))) of
              (true,(false,(BitsN.B(0xF,4),immediate_form2 imm32))) =>
          ...
          Option.SOME(rt1,rt2) =>
           (case p_address_mode2 t of
               ("",Option.SOME(add,(index,(wback,(rn,offset))))) =>
                OK(c,
                   pick_ldrd_strd
                     (load,(add,(index,(wback,(rt1,(rt2,(rn,offset))))))))
             | (err,_) =>
                (case t of
                    [l] =>
                     (case p_label l of
...
fun p_ldrt_strt1 (c,(opc,l)) =
  case p_ldr_str(c,(3,l)) of
     OK(c,Store(StoreWord(_,(true,(_,(_,(_,register_form1 _))))))) =>
      FAIL("syntax error")
   | OK(c,Store(StoreWord(false,(true,(_,(_,(_,_))))))) =>
      FAIL("syntax error")
   | OK(c,Store(StoreWord(_,(true,(true,(_,(_,_))))))) =>
      FAIL("syntax error")
...
fun p_ldrt_strt2 (c,(opc,l)) =
  case p_ldrd_strd(c,(false,("r0") :: l)) of
     OK(c,Store(StoreDual(_,(true,(_,(_,(_,(_,register_form2 _)))))))) =>
      FAIL("syntax error")
   | OK(c,Store(StoreDual(false,(true,(_,(_,(_,(_,_)))))))) =>
      FAIL("syntax error")
   | OK(c,Store(StoreDual(_,(true,(true,(_,(_,(_,_)))))))) =>
      FAIL("syntax error")
...
fun p_pop_push (c,(pop,l)) =
  case (p_suffix c,p_registers l) of
     (Option.SOME c,Option.SOME(false,w)) =>
      OK(c,
         if pop
           then Load(LoadMultiple(true,(false,(true,(BitsN.B(0xD,4),w)))))
         else Store(StoreMultiple(false,(true,(true,(BitsN.B(0xD,4),w))))))
...
fun p_ldm_stm (c,(load,(inc,(index,l)))) =
  case (p_suffix c,l) of
     (Option.SOME c,h :: t) =>
      ...
      in
        case (p_register r,(p_registers t,L3.mem(wb,["","!"]))) of
                      ...
                      then OK(c,
                              Load
                                (LoadMultipleExceptionReturn
                                   (inc,
                                    (index = inc,
                                     (wb = ("!"),(rn,BitsN.bits(w,14,0)))))))
                    else if wb = ("")
                      then OK(c,
                              Load
                                (LoadMultipleUserRegisters
                                   (inc,
                                    (index = inc,(rn,BitsN.bits(w,14,0))))))
                    else FAIL
           ...
           (if enable orelse disable
              then FAIL("syntax error")
                    ...
                    System
                      (ChangeProcessorState
                         (false,
                          (false,(false,(false,(false,Option.SOME mode))))))))
        | Option.SOME(false,_) =>
           (if enable orelse disable
              then FAIL("syntax error")
...
fun banked_register (r,mode) =
  case mode of
     "usr" =>
        ...
        in
          if BitsN.<+(i,BitsN.B(0x7,4))
            then Option.SOME
                   (BitsN.@@
                      (BitsN.B(0x0,2),BitsN.fromNat(BitsN.toNat i,3)))
          else NONE
        end
   | "fiq" =>
        let
        ...
        in
          if BitsN.<+(i,BitsN.B(0x7,4))
            then Option.SOME
                   (BitsN.@@
                      (BitsN.B(0x1,2),BitsN.fromNat(BitsN.toNat i,3)))
          else NONE
        end
   | "irq" =>
        if r = (BitsN.B(0xD,4))
   ...
   | "hyp" =>
        if r = (BitsN.B(0xD,4))
          then Option.SOME(BitsN.B(0x1F,5))
        else NONE
   | _ => NONE;
  ...
  case (p_suffix c,l) of
     (Option.SOME c,[h]) =>
      let
        val (r,wb) = L3.splitr(fn c => c = #"!",stripSpaces h)
      in
        case (p_register r,L3.mem(wb,["","!"])) of
           (Option.SOME n,true) =>
            OK(c,
               System
                 (ReturnFromException
  ...
  case (p_suffix c,l) of
     (Option.SOME c,[h,m]) =>
      let
        val (r,wb) = L3.splitr(fn c => c = #"!",stripSpaces h)
      in
        case (p_register r,(L3.mem(wb,["","!"]),p_immediate_number 5 m)) of
           (Option.SOME(BitsN.B(0xD,4)),(true,Option.SOME(ok,mode))) =>
            (if ok
               then OK(c,
                       System
                         (StoreReturnState
             ...
             val ast =
               case e of
                ...
                | 4 =>
                     System
                       (HypervisorCall
                          (BitsN.fromNat(BitsN.toNat imm32,16)))
...
fun p_isb (c,l) =
  case (p_suffix c,p_barrier_option l) of
     (Option.SOME c,Option.SOME(BitsN.B(0xF,4))) =>
          ...
          then case p_fp_register(single,d) of
                  Option.SOME dd =>
                   (case p_fp_register(single,v) of
                       Option.SOME dm =>
                        OK((c,""),VFP(vmov(single,(dd,dm))))
                     | NONE =>
                          (case p_arm_fp_immediate(single,v) of
                              Option.SOME("",imm64) =>
                               OK((c,""),VFP(vmov_imm(single,(dd,imm64))))
...
fun p_vmrs (c,l) =
  case (p_suffix c,l) of
     (Option.SOME c,[t,s]) =>
      (case (p_register t,stripSpaces s) of
                  ...
                  Option.SOME(d,(n,m)) =>
                   OK((c,""),
                      VFP(case opc of
                           ...
                           | 1 => vsub(double,(d,(n,m)))
                           | 2 => vmul(double,(d,(n,m)))
                           | 3 => vmla_vmls(double,(true,(d,(n,m))))
                           | 4 => vmla_vmls(double,(false,(d,(n,m))))
                           | 5 =>
                                vneg_mul
                           ...
                           | _ =>
                              vneg_mul(double,(VFPNegMul_VNMUL,(d,(n,m))))))
                | NONE => FAIL("syntax error")
        else FAIL("syntax error")
      end
   | _ => FAIL("syntax error");
     ...
     (Option.SOME(c,s),r :: t) =>
      (case p_any_fp_register(r,s) of
          Option.SOME(single,d) =>
           (case p_address_mode2 t of
               ("",
                Option.SOME(add,(true,(false,(n,immediate_form2 imm32))))) =>
                let
                     ...
                     (case p_label l of
                         Option.SOME s =>
                          let
                            val arg =
                              (single,
                               (false,(d,(BitsN.B(0xF,4),BitsN.B(0x0,32)))))
                          in
                            PENDING
                              (s,
                               ((c,""),
...
fun p_tokens s =
  let
    ...
    val r =
      if ((List.length r) = 1) andalso ((stripSpaces(List.hd r)) = (""))
        then []
      else r
  in
    l :: r
  ...
  case instructionFromString s of
     OK((c,""),ast) =>
      (case instructionEncode(c,(ast,Enc_ARM)) of
        ...
        | _ => ("Error: Thumb?!",NONE))
   | OK((_,s),_) =>
      (String.concat["Parse error: contains .",s," suffix"],NONE)
...
fun EncodeThumb s =
  case instructionFromString s of
     OK((c,e),ast) =>
      ...
      in
        if enc = Enc_ARM
          then (String.concat["Parse error: contains .",e," suffix"],NONE)
        else case instructionEncode(c,(ast,enc)) of
                Thumb w => ("",Option.SOME(halfString w))
              | ThumbEE w => ("",Option.SOME(halfString w))
              | Thumb2(w1,w2) =>
                 ("",
                  Option.SOME
                    (String.concat[halfString w1," ",halfString w2]))
              | BadCode err => (("Encode error: ") ^ err,NONE)
              | _ => ("Error: ARM?!",NONE)
      end
   | WORD w =>
      ("",
       Option.SOME
         (String.concat
            [halfString(BitsN.bits(w,31,16))," ",
             halfString(BitsN.bits(w,15,0))]))
   | PENDING _ => ("Contains label",NONE)
   | FAIL err => (("Parse error: ") ^ err,NONE);
...
fun s_vfp (c,ast) =
  case ast of
     vmrs t => (("vmrs") ^ (s_cond c),(s_reg t) ^ (", fpscr"))
   | vmov_imm(sp,(d,imm64)) =>
...
fun s_data (c,ast) =
  case ast of
   ...
   | ShiftImmediate(false,(setflags,(d,(m,(shift_t,shift_n))))) =>
      (String.concat
         [s_shift shift_t,if setflags then "s" else "",s_cond c],
       (s_reg2(d,m))
         ^
   ...
   | RegisterShiftedRegister(opc,(setflags,(d,(n,(m,(shift_t,s)))))) =>
      let
        val tstcmp = (BitsN.bits(opc,3,2)) = (BitsN.B(0x2,2))
      in
        (String.concat
           [s_arith_logic opc,
...
fun s_registers N l =
  case String.explode
    (s_registers_from_contiguous
       ("",
        contiguous
          ([],(Nat.-(BitsN.size(BitsN.B(0x0,N)),1),BitsN.toBitstring l)))) of
     [] => "{}"
...
fun s_store (c,ast) =
  case ast of
   ...
   | StoreMultiple(false,(true,(true,(BitsN.B(0xD,4),registers)))) =>
      (("push") ^ (s_cond c),s_registers 16 registers)
   | StoreMultiple(increment,(index,(wback,(n,registers)))) =>
   ...
   | StoreMultipleUserRegisters(increment,(wordhigher,(n,registers))) =>
      (String.concat["stm",s_stack(increment,wordhigher),s_cond c],
       String.concat[s_reg n,", ",s_registers 16 registers,"^"])
   ...
   | StoreExclusiveByte(d,(t,n)) =>
      (("strexb") ^ (s_cond c),
       String.concat[s_reg2(d,t),", [",s_reg n,"]"])
...
fun s_it_mask (c0,mask) =
  case (c0,mask) of
     (_,BitsN.B(0x8,4)) => ""
   | (true,BitsN.B(0xC,4)) => "t"
   | (false,BitsN.B(0x4,4)) => "t"
   | (true,BitsN.B(0x4,4)) => "e"
   | (false,BitsN.B(0xC,4)) => "e"
   | (true,BitsN.B(0xE,4)) => "tt"
   | (false,BitsN.B(0x2,4)) => "tt"
   | (true,BitsN.B(0x6,4)) => "et"
   | (false,BitsN.B(0xA,4)) => "et"
   | (true,BitsN.B(0xA,4)) => "te"
   | (false,BitsN.B(0x6,4)) => "te"
   | (true,BitsN.B(0x2,4)) => "ee"
   | (false,BitsN.B(0xE,4)) => "ee"
   | (true,BitsN.B(0xF,4)) => "ttt"
   | (false,BitsN.B(0x1,4)) => "ttt"
   | (true,BitsN.B(0x7,4)) => "ett"
   | (false,BitsN.B(0x9,4)) => "ett"
   | (true,BitsN.B(0xB,4)) => "tet"
   | (false,BitsN.B(0x5,4)) => "tet"
   | (true,BitsN.B(0x3,4)) => "eet"
   | (false,BitsN.B(0xD,4)) => "eet"
   | (true,BitsN.B(0xD,4)) => "tte"
   | (false,BitsN.B(0x3,4)) => "tte"
   | (true,BitsN.B(0x5,4)) => "ete"
   | (false,BitsN.B(0xB,4)) => "ete"
   | (true,BitsN.B(0x9,4)) => "tee"
   | (false,BitsN.B(0x7,4)) => "tee"
   | (true,BitsN.B(0x1,4)) => "eee"
   | (false,BitsN.B(0xF,4)) => "eee"
   | _ => "???";
