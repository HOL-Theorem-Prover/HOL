...
val ClearExclusiveLocal: int -> unit
...
val HighestSetBit:Nat.nat-> BitsN.nbit -> int
...
val UInt:Nat.nat-> BitsN.nbit -> int
val SignedSatQ:Nat.nat-> (int * Nat.nat) -> (BitsN.nbit * bool)
val UnsignedSatQ:Nat.nat-> (int * Nat.nat) -> (BitsN.nbit * bool)
val SignedSat:Nat.nat-> (int * Nat.nat) -> BitsN.nbit
val UnsignedSat:Nat.nat-> (int * Nat.nat) -> BitsN.nbit
...
val SignedParallelAddSub16:
  (BitsN.nbit * (BitsN.nbit * BitsN.nbit)) -> (int * int)
...
val SignedParallelAddSub8:
  (bool * (BitsN.nbit * BitsN.nbit)) -> (int * (int * (int * int)))
...
val dfn'vstr:
  (bool * (bool * (BitsN.nbit * (BitsN.nbit * BitsN.nbit)))) -> unit
val dfn'UndefinedVFP: unit -> unit
val Run: instruction -> unit
val Fetch: unit -> MachineCode
val Take: (BitsN.nbit * bool) -> bool
...
val p_vmov: (string * (string list)) -> maybe_instruction
