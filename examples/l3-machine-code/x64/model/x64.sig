...
val ICACHE: (BitsN.nbit option Map.map) ref
val MEM: (BitsN.nbit option Map.map) ref
...
val immediate8: (BitsN.nbit list) -> (BitsN.nbit * (BitsN.nbit list))
val immediate16: (BitsN.nbit list) -> (BitsN.nbit * (BitsN.nbit list))
val immediate32: (BitsN.nbit list) -> (BitsN.nbit * (BitsN.nbit list))
val immediate64: (BitsN.nbit list) -> (BitsN.nbit * (BitsN.nbit list))
val immediate:
  (Zsize * (BitsN.nbit list)) -> (BitsN.nbit * (BitsN.nbit list))
val full_immediate:
  (Zsize * (BitsN.nbit list)) -> (BitsN.nbit * (BitsN.nbit list))
...
val readDisplacement:
  (BitsN.nbit * (BitsN.nbit list)) -> (BitsN.nbit * (BitsN.nbit list))
val readSibDisplacement:
  (bool * (BitsN.nbit * (BitsN.nbit list))) ->
  (BitsN.nbit * (BitsN.nbit list))
val readSIB:
  (REX * (BitsN.nbit * (BitsN.nbit list))) -> (Zrm * (BitsN.nbit list))
val readModRM:
  (REX * (BitsN.nbit list)) -> (Zreg * (Zrm * (BitsN.nbit list)))
val readOpcodeModRM:
  (REX * (BitsN.nbit list)) -> (BitsN.nbit * (Zrm * (BitsN.nbit list)))
...
val e_imm_no_16: BitsN.nbit -> (Nat.nat * (BitsN.nbit list))
val e_ModRM: (BitsN.nbit * Zrm) -> (BitsN.nbit * (BitsN.nbit list))
...
val p_signed_number: string -> (int option)
