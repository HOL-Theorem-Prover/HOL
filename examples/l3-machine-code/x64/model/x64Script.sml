(* x64Script.sml - generated by L<3> - Tue Aug 26 15:02:06 2014 *)
...
val readSibDisplacement_def = Def
  ("readSibDisplacement",TP[bVar"w",Var("Mod",FTy 2),Var("strm",LTy F8)],
   ITB([(Bop(And,EQ(Var("Mod",FTy 2),LW(0,2)),Mop(Not,bVar"w")),
         TP[LW(0,64),Var("strm",LTy F8)]),
       ...
       (Call
          ("Zm",CTy"Zrm",
           TP[LO(PTy(FTy 2,CTy"Zreg")),Const("ZnoBase",CTy"Zbase"),
              Var("imm",F64)]),
        CS(Call("e_imm32",LTy F8,Var("imm",F64)),
           [(LNL F8,TP[LX F4,LNL F8]),
            (Var("l",LTy F8),
             TP[CC[LW(0,1),EX(Var("r",F4),LN 3,LN 3,F1),LW(0,2)],
                CC[LL[CC[LW(0,2),EX(Var("r",F4),LN 2,LN 0,FTy 3),LW(4,3)],
                      LW(37,8)],Var("l",LTy F8)]])])),
       (Call
          ("Zm",CTy"Zrm",
                        ...
                        TP[CC[LW(0,1),EX(Var("r",F4),LN 3,LN 3,F1),
                           ...
                           CC[LLC([CC[CS(nVar"s",
                                  ...
                                  ITE(EQ(Var("base20",FTy 3),LW(4,3)),
                                      LL[CC[LW(4,5),Var("base20",FTy 3)]],
                                      LNL F8)),Var("l",LTy F8)]],
                        TP[LX F4,LNL F8]))))),
       (AVar(CTy"Zrm"),TP[LX F4,LNL F8])]))
;
...
val e_opc_def = Def
  ("e_opc",TP[Var("opc1",F8),Var("opc2",FTy 3),Var("rm",CTy"Zrm")],
   CS(Call
        ("e_ModRM",PTy(F4,LTy F8),
         TP[Mop(Cast F4,Var("opc2",FTy 3)),Var("rm",CTy"Zrm")]),
      [(TP[AVar F4,LNL F8],LNL F8),
       (TP[Var("rex",F4),Var("strm",LTy F8)],
...
val e_gen_rm_reg_def = Def
  ("e_gen_rm_reg",
   ...
   CS(Call("e_ModRM",PTy(F4,LTy F8),TP[Var("r",F4),Var("rm",CTy"Zrm")]),
      [(TP[AVar F4,LNL F8],LNL F8),
       (TP[Var("rex",F4),Var("strm",LTy F8)],
        Let(TP[Var("prefixes",LTy F8),Var("v",F8)],
            Call
...
val e_rm_imm_def = Def
  ("e_rm_imm",
   ...
   CS(Call("e_ModRM",PTy(F4,LTy F8),TP[Var("opc1",F4),Var("rm",CTy"Zrm")]),
      [(TP[AVar F4,LNL F8],LNL F8),
       (TP[Var("rex",F4),Var("strm",LTy F8)],
        CS(Call
...
val encode_def = Def
  ("encode",Var("i",CTy"instruction"),
   CS(Var("i",CTy"instruction"),
      [(Call
          ("Zbinop",CTy"instruction",
           TP[LC("Ztest",CTy"Zbinop_name"),Var("sz",CTy"Zsize"),
              Call
                ("Zrm_r",CTy"Zdest_src",
        ...
        Let(Var("opc",F4),Mop(Cast F4,Var("bop",CTy"Zbinop_name")),
            ITB([(Bop(Bit,Var("opc",F4),LN 3),
                 ...
                 (Bop(And,Call("not_byte",bTy,Var("sz",CTy"Zsize")),
                      Mop(Not,
                          EQ(Call("e_imm8",LTy F8,Var("imm",F64)),LNL F8))),
                  Call
                    ("e_rm_imm8",LTy F8,
                     TP[Var("sz",CTy"Zsize"),Var("rm",CTy"Zrm"),
            ...
            ITE(Bop(Bit,Var("opc",F4),LN 3),
                ITE(EQ(Var("r",CTy"Zreg"),LC("RCX",CTy"Zreg")),
                    Call
                      ("e_rm_reg",LTy F8,
                       TP[Var("sz",CTy"Zsize"),Var("rm",CTy"Zrm"),
                          Bop(BAnd,Var("opc",F4),LW(7,4)),LNL F8,LW(210,8)]),
                    LNL F8),
                Call
                  ("e_rm_reg",LTy F8,
                   TP[Var("sz",CTy"Zsize"),Var("rm",CTy"Zrm"),
                      Mop(Cast F4,Var("r",CTy"Zreg")),LNL F8,
                      CC[LW(0,2),EX(Var("opc",F4),LN 2,LN 0,FTy 3),LW(0,3)]])))),
       (Call
          ("Zbinop",CTy"instruction",
           TP[Var("bop",CTy"Zbinop_name"),Var("sz",CTy"Zsize"),
              Call
       ...
       (Const("Zcpuid",CTy"instruction"),LL[LW(15,8),LW(162,8)]),
       (Call
