(* x64Script.sml - generated by L<3> - Fri Jul 19 14:05:22 2013 *)
...
val _ = Construct
  [("instruction",
    [("Zbinop",[PTy(CTy"Zbinop_name",PTy(CTy"Zsize",CTy"Zdest_src"))]),
     ("Zcall",[CTy"Zimm_rm"]),
     ("Zcmpxchg",[PTy(CTy"Zsize",PTy(CTy"Zrm",CTy"Zreg"))]),("Zcpuid",[]),
...
val _ = Construct
  [("Zinst",
    [("Zdec_fail",[sTy]),
     ("Zfull_inst",[PTy(LTy F8,PTy(CTy"instruction",LTy F8))])])]
;
...
val _ = Construct
  [("exception",
    [("BadFlagAccess",[sTy]),("BadMemAccess",[F64]),("FAIL",[sTy]),
     ("NoException",[])])]
;

val _ = Record
  ("x64_state",
   [("EFLAGS",ATy(CTy"Zeflags",OTy bTy)),("ICACHE",ATy(F64,OTy F8)),
    ("MEM",ATy(F64,OTy F8)),("REG",ATy(CTy"Zreg",F64)),("RIP",F64),
  ...
  ("mem8",Var("addr",F64),
   Close
     (qVar"state",
      CS
        (Apply(Dest("MEM",ATy(F64,OTy F8),qVar"state"),Var("addr",F64)),
         [(Mop(Some,Var("b",F8)),TP[Var("b",F8),qVar"state"]),
          (LO F8,
           Apply
             (Call
                ("raise'exception",ATy(qTy,PTy(F8,qTy)),
                 Call("BadMemAccess",CTy"exception",Var("addr",F64))),
              qVar"state"))])))
;
  ...
  ("write'mem16",TP[Var("w",F16),Var("addr",F64)],
   Close
     (qVar"state",
      Apply
        (Call
           ("write'mem8",ATy(qTy,PTy(uTy,qTy)),
            TP
              [EX(Var("w",F16),LN 15,LN 8,F8),
     ...
     (qVar"state",
      Let
        (TP[Var("v",F8),qVar"s"],
         Apply
           (Call
              ("mem8",ATy(qTy,PTy(F8,qTy)),
               Bop(Add,Var("addr",F64),LW(1,64))),qVar"state"),
         Let
           (TP[Var("v0",F8),qVar"s"],
            Apply
              (Call("mem8",ATy(qTy,PTy(F8,qTy)),Var("addr",F64)),qVar"s"),
            TP[CC[Var("v",F8),Var("v0",F8)],qVar"s"]))))
;
  ...
  ("write'mem32",TP[Var("w",F32),Var("addr",F64)],
   Close
     (qVar"state",
      Apply
        (Call
           ("write'mem16",ATy(qTy,PTy(uTy,qTy)),
            TP
              [EX(Var("w",F32),LN 31,LN 16,F16),
     ...
     (qVar"state",
      Let
        (TP[Var("v",F16),qVar"s"],
         Apply
           (Call
              ("mem16",ATy(qTy,PTy(F16,qTy)),
               Bop(Add,Var("addr",F64),LW(2,64))),qVar"state"),
         Let
           (TP[Var("v0",F16),qVar"s"],
            Apply
              (Call("mem16",ATy(qTy,PTy(F16,qTy)),Var("addr",F64)),
               qVar"s"),TP[CC[Var("v",F16),Var("v0",F16)],qVar"s"]))))
;
  ...
  ("write'mem64",TP[Var("w",F64),Var("addr",F64)],
   Close
     (qVar"state",
      Apply
        (Call
           ("write'mem32",ATy(qTy,PTy(uTy,qTy)),
            TP
              [EX(Var("w",F64),LN 63,LN 32,F32),
     ...
     (qVar"state",
      Let
        (TP[Var("v",F32),qVar"s"],
         Apply
           (Call
              ("mem32",ATy(qTy,PTy(F32,qTy)),
               Bop(Add,Var("addr",F64),LW(4,64))),qVar"state"),
         Let
           (TP[Var("v0",F32),qVar"s"],
            Apply
              (Call("mem32",ATy(qTy,PTy(F32,qTy)),Var("addr",F64)),
               qVar"s"),TP[CC[Var("v",F32),Var("v0",F32)],qVar"s"]))))
;
  ...
  ("write'CF",bVar"b",
   Close
     (qVar"state",
      Apply
        (Call
           ("write'Eflag",ATy(qTy,PTy(uTy,qTy)),
            TP[bVar"b",LC("Z_CF",CTy"Zeflags")]),qVar"state")))
;
   ...
   Close
     (qVar"state",
      Apply
        (Call
           ("write'Eflag",ATy(qTy,PTy(uTy,qTy)),
            TP[bVar"b",LC("Z_PF",CTy"Zeflags")]),qVar"state")))
;
   ...
   Close
     (qVar"state",
      Apply
        (Call
           ("write'Eflag",ATy(qTy,PTy(uTy,qTy)),
            TP[bVar"b",LC("Z_AF",CTy"Zeflags")]),qVar"state")))
;
   ...
   Close
     (qVar"state",
      Apply
        (Call
           ("write'Eflag",ATy(qTy,PTy(uTy,qTy)),
            TP[bVar"b",LC("Z_ZF",CTy"Zeflags")]),qVar"state")))
;
   ...
   Close
     (qVar"state",
      Apply
        (Call
           ("write'Eflag",ATy(qTy,PTy(uTy,qTy)),
            TP[bVar"b",LC("Z_SF",CTy"Zeflags")]),qVar"state")))
;
   ...
   Close
     (qVar"state",
      Apply
        (Call
           ("write'Eflag",ATy(qTy,PTy(uTy,qTy)),
            TP[bVar"b",LC("Z_OF",CTy"Zeflags")]),qVar"state")))
;
     ...
     (qVar"state",
      CS
        (Var("index",OTy(PTy(FTy 2,CTy"Zreg"))),
         [(LO(PTy(FTy 2,CTy"Zreg")),TP[LW(0,64),qVar"state"]),
          (Mop(Some,TP[Var("scale",FTy 2),Var("idx",CTy"Zreg")]),
           TP
             [Bop
                (Mul,Bop(Lsl,LW(1,64),Mop(Cast nTy,Var("scale",FTy 2))),
                 Apply
  ...
  ("ea_base",Var("base",CTy"Zbase"),
   Close
     (qVar"state",
      CS
        (Var("base",CTy"Zbase"),
         [(Const("ZnoBase",CTy"Zbase"),TP[LW(0,64),qVar"state"]),
          (Const("ZripBase",CTy"Zbase"),
           TP[Dest("RIP",F64,qVar"state"),qVar"state"]),
                         ...
                         (Add,
                          ...
                          Mop
                            (Fst,
                             Apply
                               (Call
                                  ("ea_base",ATy(qTy,PTy(F64,qTy)),
                                   Var("base",CTy"Zbase")),qVar"state"))),
                       Var("displacement",F64))]),qVar"state"])])))
;
      ...
      CS
        (Var("ds",CTy"Zdest_src"),
         [(Call("Zrm_i",CTy"Zdest_src",TP[Var("rm",CTy"Zrm"),AVar F64]),
           TP
             [Mop
                (Fst,
                 Apply
                   (Call
                      ("ea_Zrm",ATy(qTy,PTy(CTy"Zea",qTy)),
          ...
          (Call
             ("Zr_rm",CTy"Zdest_src",
              TP[Var("r",CTy"Zreg"),AVar(CTy"Zrm")]),
           TP
             [Call
                ("Zea_r",CTy"Zea",
                 TP[Var("size",CTy"Zsize"),Var("r",CTy"Zreg")]),
      ...
      CS
        (Var("ds",CTy"Zdest_src"),
         [(Call("Zrm_i",CTy"Zdest_src",TP[AVar(CTy"Zrm"),Var("i",F64)]),
           TP
             [Call
                ("Zea_i",CTy"Zea",TP[Var("size",CTy"Zsize"),Var("i",F64)]),
              qVar"state"]),
          (Call
             ("Zrm_r",CTy"Zdest_src",
              TP[AVar(CTy"Zrm"),Var("r",CTy"Zreg")]),
           TP
             [Call
                ("Zea_r",CTy"Zea",
                 TP[Var("size",CTy"Zsize"),Var("r",CTy"Zreg")]),
         ...
         [(Call("Zrm",CTy"Zimm_rm",Var("rm",CTy"Zrm")),
          ...
          (Call("Zimm",CTy"Zimm_rm",Var("imm",F64)),
           TP
             [Call
                ("Zea_i",CTy"Zea",
                 TP[Var("size",CTy"Zsize"),Var("imm",F64)]),qVar"state"])])))
;
        ...
        (Var("ea",CTy"Zea"),
         [(Call("Zea_i",CTy"Zea",Var("i",PTy(CTy"Zsize",F64))),
                         ...
                         [qVar"state",
                          Fupd
                            (Var("v",ATy(CTy"Zreg",F64)),
                             Var("r",CTy"Zreg"),
                             BFI
                               (LN 7,LN 0,EX(Var("w",F64),LN 7,LN 0,F8),
                                Apply
                                  (Var("v",ATy(CTy"Zreg",F64)),
                                   Var("r",CTy"Zreg"))))])]),
              Let
                 ...
                 Rupd
                   ("REG",
                    TP
                      [qVar"state",
                       Fupd
                         (Var("v",ATy(CTy"Zreg",F64)),Var("r",CTy"Zreg"),
                          BFI
                            (LN 15,LN 0,EX(Var("w",F64),LN 15,LN 0,F16),
                             Apply
                               (Var("v",ATy(CTy"Zreg",F64)),
                                Var("r",CTy"Zreg"))))])])),
          (Call
          ...
          (Call("Zea_m",CTy"Zea",TP[Const("Z64",CTy"Zsize"),Var("a",F64)]),
           Apply
             (Call
                ("write'mem64",ATy(qTy,PTy(uTy,qTy)),
                 TP[Var("w",F64),Var("a",F64)]),qVar"state"))])))
;
         ...
         [(Call("Zea_i",CTy"Zea",Var("i",PTy(CTy"Zsize",F64))),
                       ...
                       Apply
                         (Dest("REG",ATy(CTy"Zreg",F64),qVar"state"),
                          Mop
                            (Cast(CTy"Zreg"),
                             Bop
                               (Sub,Mop(Cast nTy,Var("r",CTy"Zreg")),LN 4))),
                       LN 8),LW(255,64))),qVar"state"]),
          (Call
          ...
          (Call
           ...
           Let
             (TP[Var("v",F8),qVar"s"],
              Apply
                (Call("mem8",ATy(qTy,PTy(F8,qTy)),Var("a",F64)),
                 qVar"state"),TP[Mop(Cast F64,Var("v",F8)),qVar"s"])),
          (Call("Zea_m",CTy"Zea",TP[Const("Z16",CTy"Zsize"),Var("a",F64)]),
           Let
             (TP[Var("v",F16),qVar"s"],
              Apply
                (Call("mem16",ATy(qTy,PTy(F16,qTy)),Var("a",F64)),
                 qVar"state"),TP[Mop(Cast F64,Var("v",F16)),qVar"s"])),
          (Call("Zea_m",CTy"Zea",TP[Const("Z32",CTy"Zsize"),Var("a",F64)]),
           Let
             (TP[Var("v",F32),qVar"s"],
              Apply
                (Call("mem32",ATy(qTy,PTy(F32,qTy)),Var("a",F64)),
                 qVar"state"),TP[Mop(Cast F64,Var("v",F32)),qVar"s"])),
          (Call("Zea_m",CTy"Zea",TP[Const("Z64",CTy"Zsize"),Var("a",F64)]),
           Apply
             (Call("mem64",ATy(qTy,PTy(F64,qTy)),Var("a",F64)),
              qVar"state"))])))
;
        ...
        (Var("v",CTy"Zea"),
         Mop
           (Fst,
            Apply
              (Call
                 ("ea_Zdest",ATy(qTy,PTy(CTy"Zea",qTy)),
                  Var("sd",PTy(CTy"Zsize",CTy"Zdest_src"))),qVar"state")),
         Let
           (TP[Var("v0",F64),qVar"s"],
            Apply
              (Call("EA",ATy(qTy,PTy(F64,qTy)),Var("v",CTy"Zea")),
               qVar"state"),
            Let
              (TP[Var("v0",PTy(F64,F64)),qVar"s"],
               Let
                 (TP[Var("v1",F64),qVar"s"],
                  Apply
                    (Call
                       ("EA",ATy(qTy,PTy(F64,qTy)),
                        Mop
                          (Fst,
                           Apply
                             (Call
                                ("ea_Zsrc",ATy(qTy,PTy(CTy"Zea",qTy)),
                                 Var("sd",PTy(CTy"Zsize",CTy"Zdest_src"))),
                              qVar"s"))),qVar"s"),
                  TP[TP[Var("v0",F64),Var("v1",F64)],qVar"s"]),
               TP[TP[Var("v",CTy"Zea"),Var("v0",PTy(F64,F64))],qVar"s"])))))
;
     ...
     (qVar"state",
      Let
        (TP[Var("v",F64),qVar"s"],
         Apply
           (Call
              ("call_dest_from_ea",ATy(qTy,PTy(F64,qTy)),
               Var("ea",CTy"Zea")),qVar"state"),
         TP[LU,Rupd("RIP",TP[qVar"s",Var("v",F64)])])))
;
                     ...
                     Bop
                       (Add,
                        Bop
                          (Add,
                           Bop
                             (Add,Mop(Cast nTy,Bop(Bit,Var("b",F8),LN 7)),
  ...
  ("write_logical_eflags",TP[Var("size",CTy"Zsize"),Var("w",F64)],
   Close
     (qVar"state",
      Apply
        (Call
           ("FlagUnspecified",ATy(qTy,PTy(uTy,qTy)),
            LC("Z_AF",CTy"Zeflags")),
         Mop
           (Snd,
            Apply
              (Call
                 ("write_ZF",ATy(qTy,PTy(uTy,qTy)),
                  TP[Var("size",CTy"Zsize"),Var("w",F64)]),
               Mop
                 (Snd,
                  Apply
                    (Call
                       ("write_SF",ATy(qTy,PTy(uTy,qTy)),
                        TP[Var("size",CTy"Zsize"),Var("w",F64)]),
                     Mop
                       (Snd,
                        Apply
                          (Call
                             ("write_PF",ATy(qTy,PTy(uTy,qTy)),
                              Var("w",F64)),
                           Mop
                             (Snd,
                              Apply
                                (Call("write'OF",ATy(qTy,PTy(uTy,qTy)),LF),
                                 Mop
                                   (Snd,
                                    Apply
                                      (Call
                                         ("write'CF",
                                          ATy(qTy,PTy(uTy,qTy)),LF),
                                       qVar"state")))))))))))))
;
...
val write_arith_eflags_def = Def
  ("write_arith_eflags",
   ...
   Close
     (qVar"state",
      Let
        (TP[Var("w",F64),bVar"c",bVar"x"],Var("r",PTy(F64,PTy(bTy,bTy))),
         Apply
           (Call
              ("write_arith_eflags_except_CF_OF",ATy(qTy,PTy(uTy,qTy)),
               TP[Var("size",CTy"Zsize"),Var("w",F64)]),
            Mop
              (Snd,
               Apply
                 (Call("write'OF",ATy(qTy,PTy(uTy,qTy)),bVar"x"),
                  Mop
                    (Snd,
                     Apply
                       (Call("write'CF",ATy(qTy,PTy(uTy,qTy)),bVar"c"),
                        qVar"state"))))))))
;

val erase_eflags_def = Def
  ("erase_eflags",qVar"state",
   TP[LU,Rupd("EFLAGS",TP[qVar"state",Mop(K1(CTy"Zeflags"),LO bTy)])])
;
...
val word_signed_overflow_add_def = Def
  ("word_signed_overflow_add",
   ...
   Bop
     (And,
      EQ
        (Call("word_size_msb",bTy,TP[Var("size",CTy"Zsize"),Var("a",F64)]),
         Call("word_size_msb",bTy,TP[Var("size",CTy"Zsize"),Var("b",F64)])),
      Mop
        (Not,
         EQ
           (Call
  ...
  ("add_with_carry_out",
   ...
   TP
     [Bop(Add,Var("x",F64),Var("y",F64)),
      Bop
        (Le,Call("value_width",nTy,Var("size",CTy"Zsize")),
...
val write_arith_result_def = Def
  ("write_arith_result",
   TP
     [Var("size",CTy"Zsize"),Var("r",PTy(F64,PTy(bTy,bTy))),
      Var("ea",CTy"Zea")],
   Close
     (qVar"state",
      Apply
        (Call
           ("write'EA",ATy(qTy,PTy(uTy,qTy)),
            TP[Mop(Fst,Var("r",PTy(F64,PTy(bTy,bTy)))),Var("ea",CTy"Zea")]),
         Mop
           (Snd,
            Apply
              (Call
                 ("write_arith_eflags",ATy(qTy,PTy(uTy,qTy)),
                  TP
                    [Var("size",CTy"Zsize"),Var("r",PTy(F64,PTy(bTy,bTy)))]),
               qVar"state")))))
;
        ...
        (Call
         ...
         Mop
           (Snd,
            Apply
              (Call
                 ("write_logical_eflags",ATy(qTy,PTy(uTy,qTy)),
                  TP[Var("size",CTy"Zsize"),Var("w",F64)]),qVar"state")))))
;
...
val SignExtension_def = Def
  ("SignExtension",
   ...
   Close
     (qVar"state",
      Let
        (TP[Var("r",F64),Var("s1",PTy(F64,qTy))],
         Let
           (Var("s",PTy(F64,qTy)),
            CS
              (TP[Var("size1",CTy"Zsize"),Var("size2",CTy"Zsize")],
               [(TP
                   [Call("Z8",CTy"Zsize",AVar bTy),Const("Z16",CTy"Zsize")],
                 TP
                   [BFI
                      (LN 15,LN 0,
                       ...
                       Var("w",F64)),qVar"state"]),
                (TP
                   [Call("Z8",CTy"Zsize",AVar bTy),Const("Z32",CTy"Zsize")],
                 TP
                   [BFI
                      (LN 31,LN 0,
                       ...
                       Var("w",F64)),qVar"state"]),
                (TP
                   [Call("Z8",CTy"Zsize",AVar bTy),Const("Z64",CTy"Zsize")],
                 TP[Mop(SE F64,EX(Var("w",F64),LN 7,LN 0,F8)),qVar"state"]),
                ...
                (TP[Const("Z16",CTy"Zsize"),Const("Z64",CTy"Zsize")],
                 TP
                   [Mop(SE F64,EX(Var("w",F64),LN 15,LN 0,F16)),
                    qVar"state"]),
                (TP[Const("Z32",CTy"Zsize"),Const("Z64",CTy"Zsize")],
                 TP
                   [Mop(SE F64,EX(Var("w",F64),LN 31,LN 0,F32)),
                    qVar"state"]),
                    ...
                    Mop
                      (Snd,
                       Apply
                         (Call
                            ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                             Call("FAIL",CTy"exception",LS"SignExtension")),
                          qVar"state"))])]),
...
val maskShift_def = Def
  ("maskShift",TP[Var("size",CTy"Zsize"),Var("w",F64)],
   ITE
     (EQ(Var("size",CTy"Zsize"),Const("Z64",CTy"Zsize")),
     ...
     (Var("size",CTy"Zsize"),
      [(Call("Z8",CTy"Zsize",AVar bTy),
        Mop
          (Cast F64,
           Bop
             (Rol,EX(Var("x",F64),LN 7,LN 0,F8),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z16",CTy"Zsize"),
        Mop
          (Cast F64,
           Bop
             (Rol,EX(Var("x",F64),LN 15,LN 0,F16),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z32",CTy"Zsize"),
        Mop
          (Cast F64,
           Bop
             (Rol,EX(Var("x",F64),LN 31,LN 0,F32),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z64",CTy"Zsize"),
        Bop
          (Rol,Var("x",F64),
     ...
     (Var("size",CTy"Zsize"),
      [(Call("Z8",CTy"Zsize",AVar bTy),
        Mop
          (Cast F64,
           Bop
             (Ror,EX(Var("x",F64),LN 7,LN 0,F8),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z16",CTy"Zsize"),
        Mop
          (Cast F64,
           Bop
             (Ror,EX(Var("x",F64),LN 15,LN 0,F16),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z32",CTy"Zsize"),
        Mop
          (Cast F64,
           Bop
             (Ror,EX(Var("x",F64),LN 31,LN 0,F32),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z64",CTy"Zsize"),
        Bop
          (Ror,Var("x",F64),
     ...
     (Var("size",CTy"Zsize"),
      [(Call("Z8",CTy"Zsize",AVar bTy),
        Mop
          (Cast F64,
           Bop
             (Asr,EX(Var("x",F64),LN 7,LN 0,F8),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z16",CTy"Zsize"),
        Mop
          (Cast F64,
           Bop
             (Asr,EX(Var("x",F64),LN 15,LN 0,F16),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z32",CTy"Zsize"),
        Mop
          (Cast F64,
           Bop
             (Asr,EX(Var("x",F64),LN 31,LN 0,F32),
              Mop(Cast nTy,EX(Var("y",F64),LN 4,LN 0,FTy 5))))),
       (Const("Z64",CTy"Zsize"),
        Bop
          (Asr,Var("x",F64),
...
val write_binop_def = Def
  ("write_binop",
   TP
     [Var("s",CTy"Zsize"),Var("bop",CTy"Zbinop_name"),Var("x",F64),
      ...
      CS
        (Var("bop",CTy"Zbinop_name"),
         [(LC("Zadd",CTy"Zbinop_name"),
           Apply
             (Call
                ("write_arith_result",ATy(qTy,PTy(uTy,qTy)),
                 TP
                   [Var("s",CTy"Zsize"),
                    Call
          ...
          (LC("Zand",CTy"Zbinop_name"),
           Apply
             (Call
                ("write_logical_result",ATy(qTy,PTy(uTy,qTy)),
                 TP
                   [Var("s",CTy"Zsize"),
          ...
          (LC("Zrol",CTy"Zbinop_name"),
           Apply
             (Call
                ("write_result_erase_eflags",ATy(qTy,PTy(uTy,qTy)),
                 TP
                   [Call
                      ("ROL",F64,
                       TP[Var("s",CTy"Zsize"),Var("x",F64),Var("y",F64)]),
          ...
          (LC("Zadc",CTy"Zbinop_name"),
           Let
             (TP[bVar"v",qVar"s0"],
              ...
              Apply
                (Call
                   ("write_arith_result_no_CF_OF",ATy(qTy,PTy(uTy,qTy)),
                    TP
                      [Var("s",CTy"Zsize"),
                       Bop
                         (Add,Bop(Add,Var("x",F64),Var("y",F64)),
                         ...
                         (Snd,
                          Apply
                            (Call
                               ("write'CF",ATy(qTy,PTy(uTy,qTy)),
                                Bop
                                  (Lt,Mop(Cast nTy,Var("x",F64)),
                                   Bop
                                     (Add,Mop(Cast nTy,Var("y",F64)),
                                      Mop(Cast nTy,bVar"v")))),qVar"s0"))))))),
...
val write_monop_def = Def
  ("write_monop",
   TP
     [Var("s",CTy"Zsize"),Var("mop",CTy"Zmonop_name"),Var("x",F64),
      Var("ea",CTy"Zea")],
   Close
     (qVar"state",
      CS
        (Var("mop",CTy"Zmonop_name"),
          ...
          (LC("Zdec",CTy"Zmonop_name"),
           Apply
             (Call
                ("write_arith_result_no_CF_OF",ATy(qTy,PTy(uTy,qTy)),
                 TP
                   [Var("s",CTy"Zsize"),Bop(Sub,Var("x",F64),LW(1,64)),
                    Var("ea",CTy"Zea")]),qVar"state")),
          (LC("Zinc",CTy"Zmonop_name"),
           Apply
             (Call
                ("write_arith_result_no_CF_OF",ATy(qTy,PTy(uTy,qTy)),
                 TP
                   [Var("s",CTy"Zsize"),Bop(Add,Var("x",F64),LW(1,64)),
                    Var("ea",CTy"Zea")]),qVar"state")),
                 ...
                 Apply
                   (Call
                      ("write_arith_result_no_CF_OF",
                       ATy(qTy,PTy(uTy,qTy)),
                       TP
                         [Var("s",CTy"Zsize"),Mop(Neg,Var("x",F64)),
                          Var("ea",CTy"Zea")]),qVar"state"))))])))
;
              ...
              [(TP[Mop(Some,bVar"a"),Mop(Some,bVar"b")],
                Let
                  (TP[bVar"v",qVar"s"],
                   Apply(Const("ZF",ATy(qTy,PTy(bTy,qTy))),qVar"state"),
                   TP
                     [Bop(And,EQ(bVar"a",bVar"b"),Mop(Not,bVar"v")),
                      qVar"s"])),
               (AVar(PTy(OTy bTy,OTy bTy)),
                CS
                  (Apply
              ...
              [(TP[Mop(Some,bVar"a"),Mop(Some,bVar"b")],
                Let
                  (TP[bVar"v",qVar"s"],
                   Apply(Const("ZF",ATy(qTy,PTy(bTy,qTy))),qVar"state"),
                   TP
                     [Bop(Or,Mop(Not,EQ(bVar"a",bVar"b")),bVar"v"),qVar"s"])),
               (AVar(PTy(OTy bTy,OTy bTy)),
                CS
                  (Apply
                     (Dest("EFLAGS",ATy(CTy"Zeflags",OTy bTy),qVar"state"),
   ...
   Let
     (Var("v",F64),
      ...
      Let
        (TP[Var("v0",F64),qVar"s"],
         Apply
           (Call("mem64",ATy(qTy,PTy(F64,qTy)),Var("v",F64)),qVar"state"),
         TP
           [Var("v0",F64),
            Rupd
              ("REG",
              ...
              ("EA",ATy(qTy,PTy(F64,qTy)),
               Mop
                 (Fst,
                  Apply
                    (Call
                       ("ea_Zimm_rm",ATy(qTy,PTy(CTy"Zea",qTy)),
                        TP
                          [Const("Z64",CTy"Zsize"),
                           Var("imm_rm",CTy"Zimm_rm")]),qVar"state"))),
            qVar"state"),
         Apply
           (Call("x64_push_aux",ATy(qTy,PTy(uTy,qTy)),Var("v",F64)),
            qVar"s"))))
;
...
val x64_push_rip_def = Def
  ("x64_push_rip",qVar"state",
   Apply
     (Call
        ("x64_push_aux",ATy(qTy,PTy(uTy,qTy)),Dest("RIP",F64,qVar"state")),
      qVar"state"))
;
   ...
   Close
     (qVar"state",
      Let
        (qVar"s",
         ITE
           (Mop(Not,EQ(EX(Var("imm",F64),LN 7,LN 0,F8),LW(0,8))),
            Mop
              (Snd,
               Apply
                 (Call
                    ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                     Call("FAIL",CTy"exception",LS"x64_drop")),
                  qVar"state")),qVar"state"),
         TP
           [LU,
            Rupd
...
val dfn'Zbinop_def = Def
  ("dfn'Zbinop",
   TP
     [Var("bop",CTy"Zbinop_name"),Var("size",CTy"Zsize"),
      Var("dst_src",CTy"Zdest_src")],
   Close
     (qVar"state",
      Let
        (TP[Var("v",PTy(CTy"Zea",PTy(F64,F64))),qVar"s"],
         Apply
           (Call
              ("read_dest_src_ea",
            ...
            qVar"state"),
         Let
           (TP[Var("ea",CTy"Zea"),Var("val_dst",F64),Var("val_src",F64)],
            Var("v",PTy(CTy"Zea",PTy(F64,F64))),
            Apply
              (Call
                 ("write_binop",ATy(qTy,PTy(uTy,qTy)),
                  TP
                    [Var("size",CTy"Zsize"),Var("bop",CTy"Zbinop_name"),
     ...
     (qVar"state",
      Let
        (qVar"s",
         ...
         Apply
           (Call
              ("jump_to_ea",ATy(qTy,PTy(uTy,qTy)),
               Mop
                 (Fst,
                  Apply
                    (Call
              ...
              (TP[Var("v0",F64),qVar"s"],
               ...
               Let
                 (TP[Var("v1",F64),qVar"s"],
                  Apply
                    (Call
                       ("EA",ATy(qTy,PTy(F64,qTy)),Var("ea_src",CTy"Zea")),
                     qVar"s"),
                  Let
                    (qVar"s",
                     Mop
                                ...
                                [Var("v0",F64),
                                 Call
                                   ("Zea_r",CTy"Zea",
                                    TP
                                      [Var("size",CTy"Zsize"),
                                       LC("RAX",CTy"Zreg")])]),qVar"s")))))))))
;

val dfn'Zcpuid_def = Def
  ("dfn'Zcpuid",qVar"state",
   Let
     (qVar"s",
      Rupd
        ("ICACHE",TP[qVar"state",Dest("MEM",ATy(F64,OTy F8),qVar"state")]),
      Let
        (qVar"s",
         Rupd
           ("REG",
...
val dfn'Zdiv_def = Def
  ("dfn'Zdiv",TP[Var("size",CTy"Zsize"),Var("rm",CTy"Zrm")],
   Close
     (qVar"state",
      Let
        (nVar"w",Call("value_width",nTy,Var("size",CTy"Zsize")),
         Let
           (Var("ea_eax",CTy"Zea"),
            Call
              ("Zea_r",CTy"Zea",
              ...
              (Var("ea_edx",CTy"Zea"),
               ...
               Let
                 (TP[Var("v",F64),qVar"s"],
                  Apply
                    (Call
                       ("EA",ATy(qTy,PTy(F64,qTy)),Var("ea_eax",CTy"Zea")),
                     qVar"state"),
                  Let
                    (TP[nVar"v",qVar"s"],
                     Let
                       (TP[Var("v0",F64),qVar"s"],
                        ...
                        TP
                          [Bop
                             (Add,
                              Bop(Mul,Mop(Cast nTy,Var("v",F64)),nVar"w"),
                              Mop(Cast nTy,Var("v0",F64))),qVar"s"]),
                     Let
                       (TP[nVar"v0",qVar"s"],
                        Let
                          (TP[Var("v",F64),qVar"s"],
                           Apply
                             (Call
                              ...
                              qVar"s"),
                           TP[Mop(Cast nTy,Var("v",F64)),qVar"s"]),
                        Let
                          (nVar"q",Bop(Div,nVar"v",nVar"v0"),
                           Apply
                             (Const("erase_eflags",ATy(qTy,PTy(uTy,qTy))),
                              Mop
                                (Snd,
                                 Apply
                                   (Call
...
val dfn'Zleave_def = Def
  ("dfn'Zleave",qVar"state",
   Apply
     (Call
        ("x64_pop",ATy(qTy,PTy(uTy,qTy)),
         Call("Zr",CTy"Zrm",LC("RBP",CTy"Zreg"))),
      Rupd
        ("REG",
         TP
           [qVar"state",
         ...
         Let
           (TP[bVar"v0",qVar"s"],
            ...
            TP
              [LU,
               ITE
                 (Bop(And,Mop(Not,EQ(Var("v",F64),LW(0,64))),bVar"v0"),
                  Rupd
                    ("RIP",
                     TP
                       [qVar"s",
...
val dfn'Zmonop_def = Def
  ("dfn'Zmonop",
   TP
     [Var("mop",CTy"Zmonop_name"),Var("size",CTy"Zsize"),
      Var("rm",CTy"Zrm")],
   Close
     (qVar"state",
      Let
        (Var("v",CTy"Zea"),
         ...
         Let
           (TP[Var("v0",F64),qVar"s"],
            ...
            Apply
              (Call
                 ("write_monop",ATy(qTy,PTy(uTy,qTy)),
                  TP
                    [Var("size",CTy"Zsize"),Var("mop",CTy"Zmonop_name"),
...
val dfn'Zmov_def = Def
  ("dfn'Zmov",
   TP
     [Var("cond",CTy"Zcond"),Var("size",CTy"Zsize"),
      Var("dst_src",CTy"Zdest_src")],
   Close
     (qVar"state",
      Let
                             ...
                             (Call
                                ("ea_Zdest",ATy(qTy,PTy(CTy"Zea",qTy)),
                                 TP
                                   [Var("size",CTy"Zsize"),
                                    Var("dst_src",CTy"Zdest_src")]),
                              qVar"s"))]),qVar"s0")),TP[LU,qVar"s"]))))
;

val dfn'Zmovsx_def = Def
  ("dfn'Zmovsx",
   TP
     [Var("size1",CTy"Zsize"),Var("dst_src",CTy"Zdest_src"),
      Var("size2",CTy"Zsize")],
   Close
     (qVar"state",
      Let
        (TP[Var("v",PTy(F64,CTy"Zea")),qVar"s"],
         Let
           (TP[Var("v0",F64),qVar"s"],
            Let
              (TP[Var("v",PTy(F64,PTy(CTy"Zsize",CTy"Zsize"))),qVar"s"],
               Let
                 (TP[Var("v",F64),qVar"s"],
                  Apply
                    (Call
                  ...
                  TP
                    [TP
                       [Var("v",F64),Var("size1",CTy"Zsize"),
                        Var("size2",CTy"Zsize")],qVar"s"]),
               Apply
                 (Call
                    ("SignExtension",ATy(qTy,PTy(F64,qTy)),
                     Var("v",PTy(F64,PTy(CTy"Zsize",CTy"Zsize")))),
                  qVar"s")),
            TP
              [TP
                 [Var("v0",F64),
                       ...
                       (Fst,
                        Apply
                          (Call
                             ("ea_Zrm",ATy(qTy,PTy(CTy"Zea",qTy)),
                              TP
                                [Var("size",CTy"Zsize"),Var("rm",CTy"Zrm")]),
                           qVar"s"))),qVar"s"),
               Apply
                 (Const("erase_eflags",ATy(qTy,PTy(uTy,qTy))),
                  CS
...
val dfn'Zpop_def = Def
  ("dfn'Zpop",Var("rm",CTy"Zrm"),
   Close
     (qVar"state",
      Apply
        (Call("x64_pop",ATy(qTy,PTy(uTy,qTy)),Var("rm",CTy"Zrm")),
         qVar"state")))
;
...
val dfn'Zpush_def = Def
  ("dfn'Zpush",Var("imm_rm",CTy"Zimm_rm"),
   Close
     (qVar"state",
      Apply
        (Call("x64_push",ATy(qTy,PTy(uTy,qTy)),Var("imm_rm",CTy"Zimm_rm")),
         qVar"state")))
;
...
val dfn'Zret_def = Def
  ("dfn'Zret",Var("imm",F64),
   Close
     (qVar"state",
      Apply
        (Call("x64_drop",ATy(qTy,PTy(uTy,qTy)),Var("imm",F64)),
         Mop
           (Snd,
     ...
     (qVar"state",
      CS
        (Var("v0",CTy"instruction"),
         [(Const("Zcpuid",CTy"instruction"),
           Apply(Const("dfn'Zcpuid",ATy(qTy,PTy(uTy,qTy))),qVar"state")),
          (Const("Zleave",CTy"instruction"),
           Apply(Const("dfn'Zleave",ATy(qTy,PTy(uTy,qTy))),qVar"state")),
          (Const("Znop",CTy"instruction"),
           TP[Const("dfn'Znop",uTy),qVar"state"]),
          (Call
           ...
           Apply
             (Call
                ("dfn'Zbinop",ATy(qTy,PTy(uTy,qTy)),
                 Var
                   ("v1",
                    PTy(CTy"Zbinop_name",PTy(CTy"Zsize",CTy"Zdest_src")))),
              qVar"state")),
          (Call("Zcall",CTy"instruction",Var("v2",CTy"Zimm_rm")),
           Apply
             (Call
                ("dfn'Zcall",ATy(qTy,PTy(uTy,qTy)),Var("v2",CTy"Zimm_rm")),
              qVar"state")),
          (Call
           ...
           Apply
             (Call
                ("dfn'Zcmpxchg",ATy(qTy,PTy(uTy,qTy)),
                 Var("v3",PTy(CTy"Zsize",PTy(CTy"Zrm",CTy"Zreg")))),
              qVar"state")),
          (Call
          ...
          (Call
           ...
           Apply
             (Call
                ("dfn'Zmonop",ATy(qTy,PTy(uTy,qTy)),
                 Var("v9",PTy(CTy"Zmonop_name",PTy(CTy"Zsize",CTy"Zrm")))),
              qVar"state")),
          (Call
          ...
          (Call
           ...
           Apply
             (Call
                ("dfn'Zmovsx",ATy(qTy,PTy(uTy,qTy)),
                 Var("v11",PTy(CTy"Zsize",PTy(CTy"Zdest_src",CTy"Zsize")))),
              qVar"state")),
          (Call
           ...
           Apply
             (Call
                ("dfn'Zmovzx",ATy(qTy,PTy(uTy,qTy)),
                 Var("v12",PTy(CTy"Zsize",PTy(CTy"Zdest_src",CTy"Zsize")))),
              qVar"state")),
          (Call
           ...
           Apply
             (Call
                ("dfn'Zmul",ATy(qTy,PTy(uTy,qTy)),
                 Var("v13",PTy(CTy"Zsize",CTy"Zrm"))),qVar"state")),
          (Call("Zpop",CTy"instruction",Var("v14",CTy"Zrm")),
           Apply
             (Call("dfn'Zpop",ATy(qTy,PTy(uTy,qTy)),Var("v14",CTy"Zrm")),
              qVar"state")),
          (Call("Zpush",CTy"instruction",Var("v15",CTy"Zimm_rm")),
           Apply
             (Call
                ("dfn'Zpush",ATy(qTy,PTy(uTy,qTy)),
                 Var("v15",CTy"Zimm_rm")),qVar"state")),
          (Call("Zret",CTy"instruction",Var("v16",F64)),
           Apply
             (Call("dfn'Zret",ATy(qTy,PTy(uTy,qTy)),Var("v16",F64)),
              qVar"state")),
          (Call
...
val immediate8_def = Def
  ("immediate8",Var("strm",LTy F8),
   CS
     (Var("strm",LTy F8),
      [(LLC([Var("b",F8)],Var("t",LTy F8)),
        TP[Mop(SE F64,Var("b",F8)),Var("t",LTy F8)]),
   ...
   CS
     (Var("strm",LTy F8),
      [(LLC([Var("b1",F8),Var("b2",F8)],Var("t",LTy F8)),
        TP[Mop(SE F64,CC[Var("b2",F8),Var("b1",F8)]),Var("t",LTy F8)]),
       (AVar(LTy F8),LX(PTy(F64,LTy F8)))]))
;
...
val immediate32_def = Def
  ("immediate32",Var("strm",LTy F8),
   CS
     (Var("strm",LTy F8),
      [(LLC
          ([Var("b1",F8),Var("b2",F8),Var("b3",F8),Var("b4",F8)],
           Var("t",LTy F8)),
        TP
          [Mop
             (SE F64,
              CC[Var("b4",F8),Var("b3",F8),Var("b2",F8),Var("b1",F8)]),
           Var("t",LTy F8)]),(AVar(LTy F8),LX(PTy(F64,LTy F8)))]))
;
     ...
     (Var("strm",LTy F8),
      [(LLC
          ([Var("b1",F8),Var("b2",F8),Var("b3",F8),Var("b4",F8),
           ...
           Var("t",LTy F8)),
        TP
          [CC[Var("b8",F8),Var("b7",F8),Var("b6",F8),Var("b5",F8),
        ...
        Bop
          (Mdfy,
           Close
             (TP[nVar"i",AVar bTy],
              ITB
                ([(EQ(nVar"i",LN 3),bVar"W"),(EQ(nVar"i",LN 2),bVar"R"),
                  (EQ(nVar"i",LN 1),bVar"X")],bVar"B")),LW(0,4)))]))
;
           ...
           Let
             (Var("index",CTy"Zreg"),
              Call
                ("RexReg",CTy"Zreg",
                 TP
                   [Dest("X",bTy,Var("REX",CTy"REX")),
                    EX(Var("v#0",F8),LN 5,LN 3,FTy 3)]),
              Let
                (Var("scaled_index",OTy(PTy(FTy 2,CTy"Zreg"))),
                 ITE
                   (EQ(Var("index",CTy"Zreg"),LC("RSP",CTy"Zreg")),
                    LO(PTy(FTy 2,CTy"Zreg")),
                    Mop
                      (Some,
                       TP
                         [EX(Var("v#0",F8),LN 7,LN 6,FTy 2),
                          Var("index",CTy"Zreg")])),
                 ITE
                   (EQ(Var("base",CTy"Zreg"),LC("RBP",CTy"Zreg")),
                    Let
                      (TP[Var("displacement",F64),Var("strm2",LTy F8)],
                       Call
                         ("readSibDisplacement",PTy(F64,LTy F8),
                          TP[Var("Mod",FTy 2),Var("v#1",LTy F8)]),
                       TP
                         [Call
                            ("Zm",CTy"Zrm",
                             TP
                    ...
                    Let
                      (TP[Var("displacement",F64),Var("strm2",LTy F8)],
                       Call
                         ("readDisplacement",PTy(F64,LTy F8),
                          TP[Var("Mod",FTy 2),Var("v#1",LTy F8)]),
                       TP
                         [Call
                            ("Zm",CTy"Zrm",
                             TP
                               [Var
                                ...
                                Var("displacement",F64)]),
                          Var("strm2",LTy F8)])))))),
       (AVar(LTy F8),TP[LX(CTy"Zrm"),Var("strm",LTy F8)])]))
;
  ...
  ("readModRM",TP[Var("REX",CTy"REX"),Var("strm",LTy F8)],
   CS
     (Var("strm",LTy F8),
      [(LLC([Var("v#0",F8)],Var("v#1",LTy F8)),
        CS
          (TP[BL(8,Var("v#0",F8)),Var("v#1",LTy F8)],
           [(TP
               [TP[LF,LF,AVar bTy,AVar bTy,AVar bTy,LT,LF,LT],
                Var("strm1",LTy F8)],
             Let
               (TP[Var("displacement",F64),Var("strm2",LTy F8)],
                Call("immediate32",PTy(F64,LTy F8),Var("strm1",LTy F8)),
                TP
                  [Call
                     ("RexReg",CTy"Zreg",
                      TP
                        [Dest("R",bTy,Var("REX",CTy"REX")),
                         EX(Var("v#0",F8),LN 5,LN 3,FTy 3)]),
                   Call
                     ("Zm",CTy"Zrm",
                      TP
                        [LO(PTy(FTy 2,CTy"Zreg")),
                         Const("ZripBase",CTy"Zbase"),
                         Var("displacement",F64)]),Var("strm2",LTy F8)])),
            (TP
               [TP
                  [LT,LT,AVar bTy,AVar bTy,AVar bTy,AVar bTy,AVar bTy,
                   AVar bTy],Var("strm1",LTy F8)],
             TP
               [Call
                  ("RexReg",CTy"Zreg",
                   TP
                ...
                Var("strm1",LTy F8)]),
            (TP
               [TP[AVar bTy,AVar bTy,AVar bTy,AVar bTy,AVar bTy,LT,LF,LF],
                Var("strm1",LTy F8)],
             Let
               (TP[Var("sib",CTy"Zrm"),Var("strm2",LTy F8)],
                Call
                  ("readSIB",PTy(CTy"Zrm",LTy F8),
                   TP
                     [Var("REX",CTy"REX"),
                      EX(Var("v#0",F8),LN 7,LN 6,FTy 2),
                      Var("strm1",LTy F8)]),
                  ...
                  [Call
                     ("RexReg",CTy"Zreg",
                      TP
                        [Dest("R",bTy,Var("REX",CTy"REX")),
                         EX(Var("v#0",F8),LN 5,LN 3,FTy 3)]),
                   Var("sib",CTy"Zrm"),Var("strm2",LTy F8)])),
            (TP
               [TP
                  [AVar bTy,AVar bTy,AVar bTy,AVar bTy,AVar bTy,AVar bTy,
                   AVar bTy,AVar bTy],Var("strm1",LTy F8)],
             Let
               (TP[Var("displacement",F64),Var("strm2",LTy F8)],
                Call
                  ("readDisplacement",PTy(F64,LTy F8),
                              ...
                              ("RexReg",CTy"Zreg",
                               TP
                                 [Dest("B",bTy,Var("REX",CTy"REX")),
                                  EX(Var("v#0",F8),LN 2,LN 0,FTy 3)])),
                         Var("displacement",F64)]),Var("strm2",LTy F8)]))])),
       (AVar(LTy F8),TP[LX(CTy"Zreg"),LX(CTy"Zrm"),Var("strm",LTy F8)])]))
;

val readOpcodeModRM_def = Def
  ("readOpcodeModRM",TP[Var("REX",CTy"REX"),Var("strm",LTy F8)],
   Let
     (TP[Var("opcode",CTy"Zreg"),Var("rm",CTy"Zrm"),Var("strm1",LTy F8)],
      Call
        ("readModRM",PTy(CTy"Zreg",PTy(CTy"Zrm",LTy F8)),
   ...
   CS
     (Var("strm",LTy F8),
      [(LLC([Var("h",F8)],Var("strm1",LTy F8)),
        Let
          (nVar"group",Call("prefixGroup",nTy,Var("h",F8)),
           ITB
             ([(EQ(nVar"group",LN 0),
                Mop
                  (Some,
                   TP
                     [Var("p",LTy F8),LF,Call("rec'REX",CTy"REX",LW(0,4)),
                      Var("strm",LTy F8)])),
               (EQ(nVar"group",LN 5),
                Mop
                  (Some,
                   TP
                     [Var("p",LTy F8),LT,
                      Call
                        ("rec'REX",CTy"REX",EX(Var("h",F8),LN 3,LN 0,F4)),
                      Var("strm1",LTy F8)])),
              ...
              Call
                ("readPrefix",
                 ...
                 TP
                   [Bop(Insert,nVar"group",Var("s",STy nTy)),
                    LLC([Var("h",F8)],Var("p",LTy F8)),Var("strm1",LTy F8)])))),
       (LNL F8,
...
val OpSize_def = Def
  ("OpSize",TP[bVar"have_rex",bVar"w",Var("v",F1),bVar"override"],
   ITB
     ([(EQ(Var("v",F1),LW(0,1)),Call("Z8",CTy"Zsize",bVar"have_rex")),
     ...
     (Call
      ...
      [(LO(PTy(LTy F8,PTy(bTy,PTy(CTy"REX",LTy F8)))),
       ...
       (Mop
          (Some,
           TP
             [Var("p",LTy F8),bVar"have_rex",Var("REX",CTy"REX"),
              Var("strm1",LTy F8)]),
        Let
          (bVar"op_size_override",
           ...
           ITE
             (Bop
                (And,Dest("W",bTy,Var("REX",CTy"REX")),
                 bVar"op_size_override"),
              Call
                ("Zdec_fail",CTy"Zinst",
                 ...
                 [(LLC([Var("v#0",F8)],Var("v#1",LTy F8)),
                   CS
                     (TP[BL(8,Var("v#0",F8)),Var("v#1",LTy F8)],
                      [(TP
                          [TP
                             [LF,LF,AVar bTy,AVar bTy,AVar bTy,LF,
                              AVar bTy,AVar bTy],Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                           Call
                             ("readModRM",
                              PTy(CTy"Zreg",PTy(CTy"Zrm",LTy F8)),
                              TP[Var("REX",CTy"REX"),Var("strm2",LTy F8)]),
                           Call
                                ...
                                [Var("p",LTy F8),
                                 Call
                                   ("Zbinop",CTy"instruction",
                                    TP
                                      [Mop
                                         (Cast(CTy"Zbinop_name"),
                                          EX
                                            (Var("v#0",F8),LN 5,LN 3,
                                             FTy 3)),
                                       Call
                                         ("OpSize",CTy"Zsize",
                                          TP
                                            [bVar"have_rex",
                                             Dest
                                               ("W",bTy,
                                                Var("REX",CTy"REX")),
                                             EX
                                               (Var("v#0",F8),LN 0,LN 0,
                                                F1),bVar"op_size_override"]),
                                       ITE
                                         (EQ
                                            (EX
                                               (Var("v#0",F8),LN 1,LN 1,
                                                F1),LW(0,1)),
                                          Call
                                            ("Zrm_r",CTy"Zdest_src",
                                             TP
                       ...
                       (TP
                          [TP
                             [LF,LF,AVar bTy,AVar bTy,AVar bTy,LT,LF,
                             ...
                             ("OpSize",CTy"Zsize",
                              TP
                                [bVar"have_rex",
                                 ...
                                 EX(Var("v#0",F8),LN 0,LN 0,F1),
                                 bVar"op_size_override"]),
                           Let
                             (TP[Var("imm",F64),Var("strm3",LTy F8)],
                              Call
                                ("immediate",PTy(F64,LTy F8),
                                 TP
                                   [Var("size",CTy"Zsize"),
                       ...
                       (TP
                          [TP
                             [LF,LT,LF,LT,AVar bTy,AVar bTy,AVar bTy,
                              AVar bTy],Var("strm2",LTy F8)],
                        Let
                          (Var("reg",CTy"Zrm"),
                           Call
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm2",LTy F8)]))),
                       (TP
                          [TP[LF,LT,LT,LF,LF,LF,LT,LT],Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LF,LT,LT,LF,LT,LF,AVar bTy,LF],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           ITE
                             (EQ(EX(Var("v#0",F8),LN 1,LN 1,F1),LW(1,1)),
                              Call
                                ("immediate8",PTy(F64,LTy F8),
                                 Var("strm2",LTy F8)),
                              Call
                              ...
                              TP
                                [Var("p",LTy F8),
                                 Call
                                   ("Zpush",CTy"instruction",
                                    Call
                                      ("Zimm",CTy"Zimm_rm",Var("imm",F64))),
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP
                             [LF,LT,LT,LT,AVar bTy,AVar bTy,AVar bTy,
                              AVar bTy],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           Call
                                 ...
                                 Call
                                   ("Zjcc",CTy"instruction",
                                    TP
                                      [Mop
                                         (Cast(CTy"Zcond"),
                                          EX(Var("v#0",F8),LN 3,LN 0,F4)),
                                       Var("imm",F64)]),
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LT,LF,LF,LF,LF,LF,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                           ...
                           Let
                             (TP
                                [Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                                 Var("strm3",LTy F8)],
                              Call
                                ("readOpcodeModRM",
                                 ...
                                 TP
                                   [Var("REX",CTy"REX"),
                                    Var("strm2",LTy F8)]),
                              Let
                                (TP[Var("imm",F64),Var("strm4",LTy F8)],
                                 Call
                                   ("immediate",PTy(F64,LTy F8),
                                    TP
                                      [Var("size",CTy"Zsize"),
                                   ...
                                   ("Zfull_inst",CTy"Zinst",
                                    TP
                                      [Var("p",LTy F8),
                                       ...
                                       Var("strm4",LTy F8)]))))),
                       (TP
                          [TP[LT,LF,LF,LF,LF,LF,LT,LT],Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                                ...
                                ("Zfull_inst",CTy"Zinst",
                                 TP
                                   [Var("p",LTy F8),
                                    ...
                                    Var("strm4",LTy F8)])))),
                       (TP
                          [TP[LT,LF,LF,LF,LF,LT,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LT,LF,LF,LF,LF,LT,LT,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LT,LF,LF,LF,LT,LF,AVar bTy,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LT,LF,LF,LF,LT,LT,LF,LT],Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                       ...
                       (TP
                          [TP[LT,LF,LF,LF,LT,LT,LT,LT],Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                       ...
                       (TP
                          [TP[LT,LF,LF,LT,LF,AVar bTy,AVar bTy,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("reg",CTy"Zreg"),
                           Call
                             ("RexReg",CTy"Zreg",
                              TP
                                [Dest("B",bTy,Var("REX",CTy"REX")),
                                 EX(Var("v#0",F8),LN 2,LN 0,FTy 3)]),
                           ITE
                             (EQ(Var("reg",CTy"Zreg"),LC("RAX",CTy"Zreg")),
                              Call
                                ("Zfull_inst",CTy"Zinst",
                                 TP
                                   [Var("p",LTy F8),
                                ...
                                ("Zfull_inst",CTy"Zinst",
                                 TP
                                   [Var("p",LTy F8),
                                    ...
                                    Var("strm2",LTy F8)])))),
                       (TP
                          [TP[LT,LF,LT,LF,LT,LF,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                       ...
                       (TP
                          [TP
                             [LT,LF,LT,LT,AVar bTy,AVar bTy,AVar bTy,
                              AVar bTy],Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                                ...
                                ("Zfull_inst",CTy"Zinst",
                                 TP
                                   [Var("p",LTy F8),
                                    ...
                                    Var("strm3",LTy F8)])))),
                       (TP
                          [TP[LT,LT,LF,LF,LF,LF,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                             ...
                             (TP[Var("imm",F64),Var("strm4",LTy F8)],
                              Call
                                ("immediate8",PTy(F64,LTy F8),
                                 Var("strm3",LTy F8)),
                              ITE
                                (EQ(Var("opcode",FTy 3),LW(6,3)),
                                 Call
                                   ("Zdec_fail",CTy"Zinst",
                                    LS"Unsupported opcode: Shift Group 2"),
                                 Call
                                   ("Zfull_inst",CTy"Zinst",
                                    TP
                                      [Var("p",LTy F8),
                                       ...
                                       Var("strm4",LTy F8)]))))),
                       (TP
                          [TP[LT,LT,LF,LF,LF,LF,LT,AVar bTy],
                           Var("strm2",LTy F8)],
                        ITE
                          (EQ(EX(Var("v#0",F8),LN 0,LN 0,F1),LW(0,1)),
                           Let
                             (TP[Var("imm",F64),Var("strm3",LTy F8)],
                              Call
                                   ...
                                   [Var("p",LTy F8),
                                    Call
                                      ("Zret",CTy"instruction",
                                       Var("imm",F64)),Var("strm3",LTy F8)])),
                           Call
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 Call("Zret",CTy"instruction",LW(0,64)),
                                 Var("strm2",LTy F8)]))),
                       (TP
                          [TP[LT,LT,LF,LF,LF,LT,LT,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                                ...
                                (TP[Var("imm",F64),Var("strm4",LTy F8)],
                                 ...
                                 ITE
                                   (EQ(Var("opcode",FTy 3),LW(0,3)),
                                    ...
                                    Call
                                      ("Zdec_fail",CTy"Zinst",
                                       LS"Unsupported opcode: Group 11")))))),
                       (TP
                          [TP[LT,LT,LF,LF,LT,LF,LF,LT],Var("strm2",LTy F8)],
                        Call
                          ("Zfull_inst",CTy"Zinst",
                           TP
                             [Var("p",LTy F8),
                              ...
                              Var("strm2",LTy F8)])),
                       (TP
                          [TP[LT,LT,LF,LT,LF,LF,AVar bTy,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                                ...
                                ("Zfull_inst",CTy"Zinst",
                                 TP
                                   [Var("p",LTy F8),
                                    ...
                                    Var("strm3",LTy F8)])))),
                       (TP
                          [TP[LT,LT,LT,LF,LF,LF,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           Call
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LT,LT,LT,LF,LF,LF,LT,LF],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           Call
                             ("immediate8",PTy(F64,LTy F8),
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LT,LT,LT,LF,LT,LF,LF,LF],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           Call
                             ("immediate32",PTy(F64,LTy F8),
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LT,LT,LT,LF,LT,LF,AVar bTy,LT],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           ITE
                             (EQ(EX(Var("v#0",F8),LN 1,LN 1,F1),LW(0,1)),
                              Call
                                ("immediate32",PTy(F64,LTy F8),
                                 Var("strm2",LTy F8)),
                              Call
                             ...
                             ("Zfull_inst",CTy"Zinst",
                              TP
                                [Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP
                          [TP[LT,LT,LT,LT,LF,LT,LT,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                       ...
                       (TP
                          [TP[LT,LT,LT,LT,LT,LT,LT,LF],Var("strm2",LTy F8)],
                        Let
                          (TP
                             [Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                           ...
                           ITB
                             ([(EQ(Var("opcode",FTy 3),LW(0,3)),
                              ...
                              Call
                                ("Zdec_fail",CTy"Zinst",
                                 LS"Unsupported opcode: INC/DEC Group 4")))),
                       (TP
                          [TP[LT,LT,LT,LT,LT,LT,LT,LT],Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                             ("OpSize",CTy"Zsize",
...
val x64_fetch_def = Def
  ("x64_fetch",qVar"state",
   Let
     (TP[Var("r",LTy F8),Var("s1",PTy(LTy F8,qTy))],
      Let
        (Var("s",PTy(LTy F8,qTy)),
         ...
         TP[Mop(Fst,Var("s",PTy(LTy F8,qTy))),Var("s",PTy(LTy F8,qTy))]),
      TP[Var("r",LTy F8),Mop(Snd,Var("s1",PTy(LTy F8,qTy)))]))
;

val checkIcache_def = Def
  ("checkIcache",nVar"n",
   Close
     (qVar"state",
      Apply
                          ...
                          (Mop
                             (Not,
                              EQ
                                (Apply
                                   (Dest
                                      ("MEM",ATy(F64,OTy F8),qVar"state"),
                                    Var("v",F64)),
                                 Apply
                                   (Dest
                                      ("ICACHE",ATy(F64,OTy F8),
                                       qVar"state"),Var("v",F64)))),
                           Apply
                             (Call
                                ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                                 Call
                                   ("FAIL",CTy"exception",LS"icache miss")),
   ...
   CS
     (Call
        ("x64_decode",CTy"Zinst",
         Mop
           (Fst,
            Apply(Const("x64_fetch",ATy(qTy,PTy(LTy F8,qTy))),qVar"state"))),
      [(Call
          ("Zfull_inst",CTy"Zinst",
           TP[AVar(LTy F8),Var("i",CTy"instruction"),Var("strm1",LTy F8)]),
        Let
          (nVar"len",Bop(Sub,LN 20,Mop(Length,Var("strm1",LTy F8))),
           Let
             (qVar"s",
              Mop
                (Snd,
                 Apply
                   (Call("checkIcache",ATy(qTy,PTy(uTy,qTy)),nVar"len"),
                    qVar"state")),
              Apply
                (Call
                   ("Run",ATy(qTy,PTy(uTy,qTy)),Var("i",CTy"instruction")),
                 Rupd
                   ("RIP",
                    TP
                      [qVar"s",
                       Bop
                         (Add,Dest("RIP",F64,qVar"s"),
