(* x64Script.sml - generated by L3 - Tue Jun 06 11:11:43 2017 *)
...
val _ = Construct
  [("exception",
    [("BadFlagAccess",[sTy]),("FAILURE",[sTy]),("NoException",[])])]
;
val _ = Record
  ("x64_state",
     ...
     (qVar"state",
      CS(Var("v0",CTy"instruction"),
         [(Const("Zclc",CTy"instruction"),
          ...
          (Call
             ("Zidiv",CTy"instruction",Var("v5",PTy(CTy"Zsize",CTy"Zrm"))),
           Apply
             (Call
                ("dfn'Zidiv",ATy(qTy,qTy),
                 Var("v5",PTy(CTy"Zsize",CTy"Zrm"))),qVar"state")),
          (Call
             ("Zimul",CTy"instruction",Var("v6",PTy(CTy"Zsize",CTy"Zrm"))),
           Apply
             (Call
          ...
          (Call
             ("Zimul2",CTy"instruction",
              Var("v7",PTy(CTy"Zsize",PTy(CTy"Zreg",CTy"Zrm")))),
           Apply
             (Call
          ...
          (Call
             ("Zimul3",CTy"instruction",
              Var("v8",PTy(CTy"Zsize",PTy(CTy"Zreg",PTy(CTy"Zrm",F64))))),
           Apply
             (Call
                ("dfn'Zimul3",ATy(qTy,qTy),
                 Var("v8",PTy(CTy"Zsize",PTy(CTy"Zreg",PTy(CTy"Zrm",F64))))),
              qVar"state")),
          (Call("Zjcc",CTy"instruction",Var("v9",PTy(CTy"Zcond",F64))),
           Apply
             (Call("dfn'Zjcc",ATy(qTy,qTy),Var("v9",PTy(CTy"Zcond",F64))),
              qVar"state")),
          (Call("Zjmp",CTy"instruction",Var("v10",CTy"Zrm")),
           Apply
             (Call("dfn'Zjmp",ATy(qTy,qTy),Var("v10",CTy"Zrm")),
              qVar"state")),
          (Call
             ("Zlea",CTy"instruction",
              Var("v11",PTy(CTy"Zsize",CTy"Zdest_src"))),
           Apply
             (Call
                ("dfn'Zlea",ATy(qTy,qTy),
                 Var("v11",PTy(CTy"Zsize",CTy"Zdest_src"))),qVar"state")),
          (Call("Zloop",CTy"instruction",Var("v12",PTy(CTy"Zcond",F64))),
           Apply
             (Call
                ("dfn'Zloop",ATy(qTy,qTy),Var("v12",PTy(CTy"Zcond",F64))),
              qVar"state")),
          (Call
             ("Zmonop",CTy"instruction",
              Var("v13",PTy(CTy"Zmonop_name",PTy(CTy"Zsize",CTy"Zrm")))),
           Apply
             (Call
          ...
          (Call
             ("Zmov",CTy"instruction",
              Var("v14",PTy(CTy"Zcond",PTy(CTy"Zsize",CTy"Zdest_src")))),
           Apply
             (Call
          ...
          (Call
             ("Zmovsx",CTy"instruction",
              Var("v15",PTy(CTy"Zsize",PTy(CTy"Zdest_src",CTy"Zsize")))),
           Apply
             (Call
          ...
          (Call
           ...
           Apply
             (Call
              ...
              qVar"state")),
          (Call
             ("Zmul",CTy"instruction",Var("v17",PTy(CTy"Zsize",CTy"Zrm"))),
           Apply
             (Call
                ("dfn'Zmul",ATy(qTy,qTy),
                 Var("v17",PTy(CTy"Zsize",CTy"Zrm"))),qVar"state")),
          (Call("Znop",CTy"instruction",nVar"v18"),qVar"state"),
          (Call("Zpop",CTy"instruction",Var("v19",CTy"Zrm")),
           Apply
             (Call("dfn'Zpop",ATy(qTy,qTy),Var("v19",CTy"Zrm")),
              qVar"state")),
          (Call("Zpush",CTy"instruction",Var("v20",CTy"Zimm_rm")),
           Apply
             (Call("dfn'Zpush",ATy(qTy,qTy),Var("v20",CTy"Zimm_rm")),
              qVar"state")),
          (Call("Zret",CTy"instruction",Var("v21",F64)),
           Apply(Call("dfn'Zret",ATy(qTy,qTy),Var("v21",F64)),qVar"state")),
          (Call
             ("Zset",CTy"instruction",
              Var("v22",PTy(CTy"Zcond",PTy(bTy,CTy"Zrm")))),
           Apply
             (Call
                ("dfn'Zset",ATy(qTy,qTy),
                 Var("v22",PTy(CTy"Zcond",PTy(bTy,CTy"Zrm")))),qVar"state")),
          (Call
             ("Zxadd",CTy"instruction",
              Var("v23",PTy(CTy"Zsize",PTy(CTy"Zrm",CTy"Zreg")))),
           Apply
             (Call
