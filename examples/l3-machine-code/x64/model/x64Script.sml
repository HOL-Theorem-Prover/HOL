(* x64Script.sml - generated by L<3> - Tue Jul 23 14:50:44 2013 *)
...
val mem8_def = Def
  ("mem8",Var("addr",F64),
   Close
     (qVar"state",
      CS(Apply(Dest("MEM",ATy(F64,OTy F8),qVar"state"),Var("addr",F64)),
     ...
     (qVar"state",
      CS(Var("ea",CTy"Zea"),
         [(Call("Zea_i",CTy"Zea",Var("i",PTy(CTy"Zsize",F64))),
           TP[Call("restrictSize",F64,Var("i",PTy(CTy"Zsize",F64))),
              qVar"state"]),
          (Call
             ("Zea_r",CTy"Zea",
     ...
     (qVar"state",
      CS(Var("ea",CTy"Zea"),
         [(Call("Zea_i",CTy"Zea",TP[AVar(CTy"Zsize"),Var("i",F64)]),
           TP[Bop(Add,Dest("RIP",F64,qVar"state"),Var("i",F64)),
              qVar"state"]),
...
val word_signed_overflow_add_def = Def
  ("word_signed_overflow_add",
   ...
   Bop
     (And,
      EQ(Call("word_size_msb",bTy,TP[Var("size",CTy"Zsize"),Var("a",F64)]),
         ...
         Let
           (Var("s",PTy(F64,qTy)),
            CS(TP[Var("size1",CTy"Zsize"),Var("size2",CTy"Zsize")],
               [(TP[Call("Z8",CTy"Zsize",AVar bTy),Const("Z16",CTy"Zsize")],
                 TP[BFI
                      (LN 15,LN 0,
                       Mop(SE F16,EX(Var("w",F64),LN 7,LN 0,F8)),
                       Var("w",F64)),qVar"state"]),
                (TP[Call("Z8",CTy"Zsize",AVar bTy),Const("Z32",CTy"Zsize")],
                 TP[BFI
                      (LN 31,LN 0,
                       Mop(SE F32,EX(Var("w",F64),LN 7,LN 0,F8)),
                       Var("w",F64)),qVar"state"]),
                (TP[Call("Z8",CTy"Zsize",AVar bTy),Const("Z64",CTy"Zsize")],
           ...
           CS(TP[Apply
              ...
              [(TP[Mop(Some,bVar"a"),Mop(Some,bVar"b")],
                Let
                  (TP[bVar"v",qVar"s"],
                   Apply(Const("ZF",ATy(qTy,PTy(bTy,qTy))),qVar"state"),
                   TP[Bop(And,EQ(bVar"a",bVar"b"),Mop(Not,bVar"v")),
                      qVar"s"])),
               (AVar(PTy(OTy bTy,OTy bTy)),
                CS(Apply
                     (Dest("EFLAGS",ATy(CTy"Zeflags",OTy bTy),qVar"state"),
           ...
           CS(TP[Apply
              ...
              [(TP[Mop(Some,bVar"a"),Mop(Some,bVar"b")],
                Let
                  (TP[bVar"v",qVar"s"],
                   Apply(Const("ZF",ATy(qTy,PTy(bTy,qTy))),qVar"state"),
                   TP[Bop(Or,Mop(Not,EQ(bVar"a",bVar"b")),bVar"v"),qVar"s"])),
               (AVar(PTy(OTy bTy,OTy bTy)),
                CS(Apply
                     (Dest("EFLAGS",ATy(CTy"Zeflags",OTy bTy),qVar"state"),
                      LC("Z_ZF",CTy"Zeflags")),
                             ...
                             (Call
                                ("ea_Zsrc",ATy(qTy,PTy(CTy"Zea",qTy)),
                                 TP[Var("size1",CTy"Zsize"),
                                    Var("dst_src",CTy"Zdest_src")]),
                              qVar"state"))),qVar"state"),
                  TP[TP[Var("v",F64),Var("size1",CTy"Zsize"),
                ...
                (Var("scaled_index",OTy(PTy(FTy 2,CTy"Zreg"))),
                 ITE
                   (EQ(Var("index",CTy"Zreg"),LC("RSP",CTy"Zreg")),
                    ...
                    Mop
                      (Some,
                       TP[EX(Var("v#0",F8),LN 7,LN 6,FTy 2),
                          Var("index",CTy"Zreg")])),
                 ITE
   ...
   CS(Var("strm",LTy F8),
      [(LLC([Var("v#0",F8)],Var("v#1",LTy F8)),
        CS(TP[BL(8,Var("v#0",F8)),Var("v#1",LTy F8)],
           [(TP[TP[LF,LF,AVar bTy,AVar bTy,AVar bTy,LT,LF,LT],
                Var("strm1",LTy F8)],
             Let
               (TP[Var("displacement",F64),Var("strm2",LTy F8)],
            ...
            (TP[TP[LT,LT,AVar bTy,AVar bTy,AVar bTy,AVar bTy,AVar bTy,
                   ...
                   Call
                     ("RexReg",CTy"Zreg",
                      TP[Dest("B",bTy,Var("REX",CTy"REX")),
                         EX(Var("v#0",F8),LN 2,LN 0,FTy 3)])),
                Var("strm1",LTy F8)]),
            (TP[TP[AVar bTy,AVar bTy,AVar bTy,AVar bTy,AVar bTy,LT,LF,LF],
                Var("strm1",LTy F8)],
             Let
            ...
            (TP[TP[AVar bTy,AVar bTy,AVar bTy,AVar bTy,AVar bTy,AVar bTy,
          ...
          (nVar"group",Call("prefixGroup",nTy,Var("h",F8)),
           ITB
             ([(EQ(nVar"group",LN 0),
                Mop
                  (Some,
                   TP[Var("p",LTy F8),LF,Call("rec'REX",CTy"REX",LW(0,4)),
                      Var("strm",LTy F8)])),
               (EQ(nVar"group",LN 5),
                Mop
                  (Some,
           ...
           ITE
             (Bop
              ...
              CS(Var("strm1",LTy F8),
                 [(LLC([Var("v#0",F8)],Var("v#1",LTy F8)),
                   CS(TP[BL(8,Var("v#0",F8)),Var("v#1",LTy F8)],
                      [(TP[TP[LF,LF,AVar bTy,AVar bTy,AVar bTy,LF,
                              AVar bTy,AVar bTy],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                           Call
                             ("readModRM",
                                         ...
                                         ("OpSize",CTy"Zsize",
                                          TP[bVar"have_rex",
                                             Dest
                                               ("W",bTy,
                                                Var("REX",CTy"REX")),
                                             EX(Var("v#0",F8),LN 0,LN 0,
                                                F1),bVar"op_size_override"]),
                                       ITE
                                         (EQ(EX(Var("v#0",F8),LN 1,LN 1,
                                                F1),LW(0,1)),
                                          Call
                                            ("Zrm_r",CTy"Zdest_src",
                                             TP[Var("rm",CTy"Zrm"),
                                          ...
                                          Call
                                            ("Zr_rm",CTy"Zdest_src",
                                             TP[Var("reg",CTy"Zreg"),
                                                Var("rm",CTy"Zrm")]))]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LF,LF,AVar bTy,AVar bTy,AVar bTy,LT,LF,
                                          ...
                                          Call
                                            ("Zrm_i",CTy"Zdest_src",
                                             TP[Call
                                                ...
                                                Var("imm",F64)])]),
                                    Var("strm3",LTy F8)])))),
                       (TP[TP[LF,LT,LF,LT,AVar bTy,AVar bTy,AVar bTy,
                              AVar bTy],Var("strm2",LTy F8)],
                        Let
                          (Var("reg",CTy"Zrm"),
                           Call
                                   ...
                                   (EQ(EX(Var("v#0",F8),LN 3,LN 3,F1),
                                    ...
                                    Call
                                      ("Zpop",CTy"instruction",
                                       Var("reg",CTy"Zrm"))),
                                 Var("strm2",LTy F8)]))),
                       (TP[TP[LF,LT,LT,LF,LF,LF,LT,LT],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                           Call
                                 ...
                                 Call
                                   ("Zmovsx",CTy"instruction",
                                    TP[Const("Z32",CTy"Zsize"),
                                       ...
                                       Const("Z64",CTy"Zsize")]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LF,LT,LT,LF,LT,LF,AVar bTy,LF],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           ITE
                           ...
                           Call
                             ("Zfull_inst",CTy"Zinst",
                              TP[Var("p",LTy F8),
                                 ...
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LF,LT,LT,LT,AVar bTy,AVar bTy,AVar bTy,
                              AVar bTy],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           Call
                                 ...
                                 Call
                                   ("Zjcc",CTy"instruction",
                                    TP[Mop
                                       ...
                                       Var("imm",F64)]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LT,LF,LF,LF,LF,LF,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                             ("OpSize",CTy"Zsize",
                              TP[bVar"have_rex",
                                 ...
                                 bVar"op_size_override"]),
                           Let
                             (TP[Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                                 Var("strm3",LTy F8)],
                              Call
                                ("readOpcodeModRM",
                                             ...
                                             Call
                                               ("Zrm_i",CTy"Zdest_src",
                                                TP[Var("rm",CTy"Zrm"),
                                                   Var("imm",F64)])]),
                                       Var("strm4",LTy F8)]))))),
                       (TP[TP[LT,LF,LF,LF,LF,LF,LT,LT],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                           Call
                                          ...
                                          Call
                                            ("Zrm_i",CTy"Zdest_src",
                                             TP[Var("rm",CTy"Zrm"),
                                                Var("imm",F64)])]),
                                    Var("strm4",LTy F8)])))),
                       (TP[TP[LT,LF,LF,LF,LF,LT,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                                       ...
                                       Call
                                         ("Zrm_r",CTy"Zdest_src",
                                          TP[Var("rm",CTy"Zrm"),
                                             Var("reg",CTy"Zreg")])]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LT,LF,LF,LF,LF,LT,LT,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                                 ...
                                 Call
                                   ("Zxchg",CTy"instruction",
                                    TP[Call
                                       ...
                                       Var("reg",CTy"Zreg")]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LT,LF,LF,LF,LT,LF,AVar bTy,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                                          ...
                                          Call
                                            ("Zr_rm",CTy"Zdest_src",
                                             TP[Var("reg",CTy"Zreg"),
                                                Var("rm",CTy"Zrm")]))]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LT,LF,LF,LF,LT,LT,LF,LT],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                           Call
                       ...
                       (TP[TP[LT,LF,LF,LF,LT,LT,LT,LT],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                           Call
                       ...
                       (TP[TP[LT,LF,LF,LT,LF,AVar bTy,AVar bTy,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("reg",CTy"Zreg"),
                           Call
                                    ...
                                    Call
                                      ("Zxchg",CTy"instruction",
                                       TP[Call
                                          ...
                                          Var("reg",CTy"Zreg")]),
                                    Var("strm2",LTy F8)])))),
                       (TP[TP[LT,LF,LT,LF,LT,LF,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                             ("OpSize",CTy"Zsize",
                              TP[LT,Dest("W",bTy,Var("REX",CTy"REX")),
                                 EX(Var("v#0",F8),LN 0,LN 0,F1),
                                 bVar"op_size_override"]),
                           Let
                             (TP[Var("imm",F64),Var("strm3",LTy F8)],
                                          ...
                                          Call
                                            ("Zrm_i",CTy"Zdest_src",
                                             TP[Call
                                                ...
                                                Var("imm",F64)])]),
                                    Var("strm3",LTy F8)])))),
                       (TP[TP[LT,LF,LT,LT,AVar bTy,AVar bTy,AVar bTy,
                              AVar bTy],Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                                          ...
                                          Call
                                            ("Zrm_i",CTy"Zdest_src",
                                             TP[Call
                                                ...
                                                Var("imm",F64)])]),
                                    Var("strm3",LTy F8)])))),
                       (TP[TP[LT,LT,LF,LF,LF,LF,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                                             ...
                                             Call
                                               ("Zrm_i",CTy"Zdest_src",
                                                TP[Var("rm",CTy"Zrm"),
                                                   Var("imm",F64)])]),
                                       Var("strm4",LTy F8)]))))),
                       (TP[TP[LT,LT,LF,LF,LF,LF,LT,AVar bTy],
                           Var("strm2",LTy F8)],
                        ITE
                           ...
                           Call
                             ("Zfull_inst",CTy"Zinst",
                              TP[Var("p",LTy F8),
                                 ...
                                 Var("strm2",LTy F8)]))),
                       (TP[TP[LT,LT,LF,LF,LF,LT,LT,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                       ...
                       (TP[TP[LT,LT,LF,LF,LT,LF,LF,LT],Var("strm2",LTy F8)],
                        Call
                          ("Zfull_inst",CTy"Zinst",
                           TP[Var("p",LTy F8),
                              Const("Zleave",CTy"instruction"),
                              Var("strm2",LTy F8)])),
                       (TP[TP[LT,LT,LF,LT,LF,LF,AVar bTy,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                                             ...
                                             Call
                                               ("Zrm_r",CTy"Zdest_src",
                                                TP[Var("rm",CTy"Zrm"),
                                                   LC("RCX",CTy"Zreg")]))]),
                                    Var("strm3",LTy F8)])))),
                       (TP[TP[LT,LT,LT,LF,LF,LF,LF,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           Call
                              ...
                              TP[Var("p",LTy F8),
                                 Call
                                   ("Zloop",CTy"instruction",
                                    TP[ITE
                                         (EQ(EX(Var("v#0",F8),LN 0,LN 0,
                                                F1),LW(0,1)),
                                          LC("Z_NE",CTy"Zcond"),
                                          LC("Z_E",CTy"Zcond")),
                                       Var("imm",F64)]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LT,LT,LT,LF,LF,LF,LT,LF],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           Call
                             ("immediate8",PTy(F64,LTy F8),
                                 ...
                                 Call
                                   ("Zloop",CTy"instruction",
                                    TP[LC("Z_ALWAYS",CTy"Zcond"),
                                       Var("imm",F64)]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LT,LT,LT,LF,LT,LF,LF,LF],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           Call
                             ("immediate32",PTy(F64,LTy F8),
                                 ...
                                 Call
                                   ("Zcall",CTy"instruction",
                                    Call
                                      ("Zimm",CTy"Zimm_rm",Var("imm",F64))),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LT,LT,LT,LF,LT,LF,AVar bTy,LT],
                           Var("strm2",LTy F8)],
                        Let
                          (TP[Var("imm",F64),Var("strm3",LTy F8)],
                           ITE
                                 ...
                                 Call
                                   ("Zjcc",CTy"instruction",
                                    TP[LC("Z_ALWAYS",CTy"Zcond"),
                                       Var("imm",F64)]),
                                 Var("strm3",LTy F8)]))),
                       (TP[TP[LT,LT,LT,LT,LF,LT,LT,AVar bTy],
                           Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                       ...
                       (TP[TP[LT,LT,LT,LT,LT,LT,LT,LF],Var("strm2",LTy F8)],
                        Let
                          (TP[Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                              Var("strm3",LTy F8)],
                           Call
                       ...
                       (TP[TP[LT,LT,LT,LT,LT,LT,LT,LT],Var("strm2",LTy F8)],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
                             ("OpSize",CTy"Zsize",
                       ...
                       (TP[TP[LF,LF,LF,LF,LT,LT,LT,LT],
                        ...
                        Let
                          (TP[bVar"b'7",bVar"b'6",bVar"b'5",bVar"b'4",
