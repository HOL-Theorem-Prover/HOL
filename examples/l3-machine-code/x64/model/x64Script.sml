(* x64Script.sml - generated by L<3> - Thu Nov 29 15:18:49 2012 *)
        ...
        (Var("index",OTy(PTy(FTy 2,CTy"Zreg"))),
         [(LO(PTy(FTy 2,CTy"Zreg")),TP[LW(0,64), qVar"state"]),
          (Mop(Some,TP[Var("scale",FTy 2), Var("idx",CTy"Zreg")]),
           TP[Bop
                (Mul,Bop(Lsl,LW(1,64),Mop(Cast(F64),Var("scale",FTy 2))),
                 Apply
      ...
      Apply
        (Call
           ("write'EA",ATy(qTy,PTy(uTy,qTy)),
            TP[Mop(Fst,Var("r",PTy(F64,PTy(bTy,bTy)))),
               Var("ea",CTy"Zea")]),
         Mop
           (Snd,
            Apply
...
val readOpcodeModRM_def = Def
  ("readOpcodeModRM",TP[Var("REX",CTy"REX"), Var("strm",LTy(F8))],
   Let
     (TP[Var("opcode",CTy"Zreg"), Var("rm",CTy"Zrm"),
         Var("strm1",LTy(F8))],
      Call
                   ...
                   CS
                     (TP[BL(8,Var("v#0",F8)), Var("v#1",LTy(F8))],
                      [(TP[TP[LF, LF, AVar(bTy), AVar(bTy), AVar(bTy), LF,
                                 ...
                                 Call
                                   ("Zxchg",CTy"instruction",
                                    TP[Call
                                       ...
                                       Var("reg",CTy"Zreg")]),
                                 Var("strm3",LTy(F8))]))),
                       (TP[TP[LT, LF, LF, LF, LT, LF, AVar(bTy),
                       ...
                       (TP[TP[LT, LT, LF, LT, LF, LF, AVar(bTy),
                              AVar(bTy)], Var("strm2",LTy(F8))],
                        Let
                          (TP[Var("opcode",FTy 3), Var("rm",CTy"Zrm"),
                              Var("strm3",LTy(F8))],
