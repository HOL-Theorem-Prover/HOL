(* x64Script.sml - generated by L<3> - Tue Nov 26 10:58:54 2013 *)
      ...
      CS(Var("index",OTy(PTy(FTy 2,CTy"Zreg"))),
         [(LO(PTy(FTy 2,CTy"Zreg")),TP[LW(0,64),qVar"state"]),
          (Mop(Some,TP[Var("scale",FTy 2),Var("idx",CTy"Zreg")]),
           TP[Bop(Mul,Bop(Lsl,LW(1,64),Mop(Cast nTy,Var("scale",FTy 2))),
                  Apply
      ...
      CS(Var("ea",CTy"Zea"),
         [(Call("Zea_i",CTy"Zea",Var("i",PTy(CTy"Zsize",F64))),
          ...
          (Call("Zea_m",CTy"Zea",TP[Const("Z64",CTy"Zsize"),Var("a",F64)]),
           Apply
             (Call("mem64",ATy(qTy,PTy(F64,qTy)),Var("a",F64)),qVar"state"))])))
;
                            ...
                            Fupd
                              (Dest("REG",ATy(CTy"Zreg",F64),qVar"state"),
                               ...
                               BFI(LN 15,LN 8,
                                   ...
                                   Apply
                                     (Dest
                                        ("REG",ATy(CTy"Zreg",F64),
                                         qVar"state"),Var("x",CTy"Zreg"))))])]))),
          (Call
             ("Zea_r",CTy"Zea",
          ...
          Let(TP[Var("v0",F64),qVar"s"],
              Apply
                (Call("EA",ATy(qTy,PTy(F64,qTy)),Var("v",CTy"Zea")),
                 qVar"state"),
              Let(TP[Var("v0",PTy(F64,F64)),qVar"s"],
     ...
     (qVar"state",
      Apply
        (Call
         ...
         Mop(Snd,
             Apply
               (Const("erase_eflags",ATy(qTy,PTy(uTy,qTy))),qVar"state")))))
;
                      ...
                      Mop(Snd,
                          Apply
                            (Call
                               ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                                Call
                                  ("FAIL",CTy"exception",LS"SignExtension")),
                             qVar"state"))])]),
...
val dfn'Zbinop_def = Def
  ("dfn'Zbinop",
   ...
   Close
     (qVar"state",
      Let(TP[Var("v",PTy(CTy"Zea",PTy(F64,F64))),qVar"s"],
          Apply
            (Call
               ("read_dest_src_ea",
   ...
   Close
     (qVar"state",
      Let(qVar"s",
          Mop(Snd,
              Apply
                (Const("x64_push_rip",ATy(qTy,PTy(uTy,qTy))),qVar"state")),
          Apply
            (Call
     ...
     (qVar"state",
      Let(Var("v",F64),
          ...
          Let(TP[bVar"v0",qVar"s"],
              ...
              TP[LU,
                 ITE(Bop(And,Mop(Not,EQ(Var("v",F64),LW(0,64))),bVar"v0"),
                     Rupd
                       ("RIP",
                        TP[qVar"s",
                           Bop(Add,Dest("RIP",F64,qVar"s"),Var("imm",F64))]),
   ...
   Close
     (qVar"state",
      Let(TP[Var("v",PTy(F64,CTy"Zea")),qVar"s"],
          Let(TP[Var("v0",F64),qVar"s"],
              Let(TP[Var("v",PTy(F64,PTy(CTy"Zsize",CTy"Zsize"))),qVar"s"],
                  Let(TP[Var("v",F64),qVar"s"],
                      Apply
                        (Call
                           ("EA",ATy(qTy,PTy(F64,qTy)),
          ...
          Let(Var("v",CTy"Zea"),
              ...
              Let(TP[Var("v0",F64),qVar"s"],
                  ...
                  Let(TP[Var("v1",F64),qVar"s"],
                      Apply
                        (Call
                           ("EA",ATy(qTy,PTy(F64,qTy)),Var("v",CTy"Zea")),
                         qVar"s"),
                      Apply
                        (Call
                           ("write_binop",ATy(qTy,PTy(uTy,qTy)),
      ...
      CS(Var("v0",CTy"instruction"),
         [(Const("Zcpuid",CTy"instruction"),
          ...
          (Call("Zpush",CTy"instruction",Var("v15",CTy"Zimm_rm")),
           Apply
             (Call
                ("dfn'Zpush",ATy(qTy,PTy(uTy,qTy)),Var("v15",CTy"Zimm_rm")),
              qVar"state")),
   ...
   CS(Var("x",CTy"REX"),
      [(Rec(CTy"REX",[bVar"B",bVar"R",bVar"W",bVar"X"]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 3),bVar"W"),(EQ(nVar"i",LN 2),bVar"R"),
...
val readSibDisplacement_def = Def
  ("readSibDisplacement",TP[Var("Mod",FTy 2),Var("strm",LTy F8)],
   ITB([(EQ(Var("Mod",FTy 2),LW(0,2)),TP[LW(0,64),Var("strm",LTy F8)]),
      ...
      [(LLC([Var("v#0",F8)],Var("v#1",LTy F8)),
        CS(TP[BL(8,Var("v#0",F8)),Var("v#1",LTy F8)],
           [(TP[TP[LF,LF,bVar"RegOpc'2",bVar"RegOpc'1",bVar"RegOpc'0",LT,
             ...
             Let(TP[Var("displacement",F64),Var("strm2",LTy F8)],
            ...
            (TP[TP[bVar"Mod'1",bVar"Mod'0",bVar"RegOpc'2",bVar"RegOpc'1",
             ...
             Let(TP[Var("sib",CTy"Zrm"),Var("strm2",LTy F8)],
                 Call
...
val readOpcodeModRM_def = Def
  ("readOpcodeModRM",TP[Var("REX",CTy"REX"),Var("strm",LTy F8)],
   Let(TP[Var("opcode",CTy"Zreg"),Var("rm",CTy"Zrm"),Var("strm1",LTy F8)],
       Call
      ...
      [(LO(PTy(LTy F8,PTy(bTy,PTy(CTy"REX",LTy F8)))),
       ...
       (Mop(Some,
        ...
        Let(bVar"op_size_override",
            ...
            ITE(Bop(And,Dest("W",bTy,Var("REX",CTy"REX")),
                ...
                CS(Var("strm1",LTy F8),
                   [(LLC([Var("v#0",F8)],Var("v#1",LTy F8)),
                     CS(TP[BL(8,Var("v#0",F8)),Var("v#1",LTy F8)],
                        [(TP[TP[LF,LF,bVar"opc'2",bVar"opc'1",bVar"opc'0",
                                LF,bVar"x'0",bVar"v'0"],
                             Var("strm2",LTy F8)],
                          Let(TP[Var("reg",CTy"Zreg"),Var("rm",CTy"Zrm"),
                                 Var("strm3",LTy F8)],
                              Call
                                ("readModRM",
                              ...
                              Call
                                ("Zfull_inst",CTy"Zinst",
                                 TP[Var("p",LTy F8),
                                          ...
                                          Call
                                            ("OpSize",CTy"Zsize",
                                             TP[bVar"have_rex",
                                                ...
                                                bVar"op_size_override"]),
                                          ITE(EQ(Mop(Cast F1,LL[bVar"x'0"]),
                                                 LW(0,1)),
                                              Call
                                                ("Zrm_r",CTy"Zdest_src",
                                                 TP[Var("rm",CTy"Zrm"),
                                    ...
                                    Var("strm3",LTy F8)]))),
                         (TP[TP[LF,LF,bVar"opc'2",bVar"opc'1",bVar"opc'0",
                                LT,LF,bVar"v'0"],Var("strm2",LTy F8)],
                              ...
                              Call
                                ("OpSize",CTy"Zsize",
                                 TP[bVar"have_rex",
                                    ...
                                    Mop(Cast F1,LL[bVar"v'0"]),
                                    bVar"op_size_override"]),
                              Let(TP[Var("imm",F64),Var("strm3",LTy F8)],
                                  Call
                                    ("immediate",PTy(F64,LTy F8),
                                     TP[Var("size",CTy"Zsize"),
                                        Var("strm2",LTy F8)]),
                                              ...
                                              Call
                                                ("Zrm_i",CTy"Zdest_src",
                                                 TP[Call
                                                    ...
                                                    Var("imm",F64)])]),
                                        Var("strm3",LTy F8)])))),
                         (TP[TP[LF,LT,LF,LT,bVar"b'0",bVar"r'2",bVar"r'1",
                         ...
                         (TP[TP[LF,LT,LT,LF,LT,LF,bVar"b'0",LF],
                             Var("strm2",LTy F8)],
                          Let(TP[Var("imm",F64),Var("strm3",LTy F8)],
                              ITE(EQ(Mop(Cast F1,LL[bVar"b'0"]),LW(1,1)),
                                  Call
                                      ...
                                      ("Zpush",CTy"instruction",
                                       Call
                                         ("Zimm",CTy"Zimm_rm",
                                          Var("imm",F64))),
                                    Var("strm3",LTy F8)]))),
                         (TP[TP[LF,LT,LT,LT,bVar"c'3",bVar"c'2",bVar"c'1",
                                bVar"c'0"],Var("strm2",LTy F8)],
                          Let(TP[Var("imm",F64),Var("strm3",LTy F8)],
                              Call
                                ("immediate8",PTy(F64,LTy F8),
                                 Var("strm2",LTy F8)),
                         ...
                         (TP[TP[LT,LF,LF,LF,LF,LF,LT,LT],
                             Var("strm2",LTy F8)],
                          Let(TP[Var("opcode",FTy 3),Var("rm",CTy"Zrm"),
                                 Var("strm3",LTy F8)],
                              Call
                                ("readOpcodeModRM",
                                 PTy(FTy 3,PTy(CTy"Zrm",LTy F8)),
                                 TP[Var("REX",CTy"REX"),
                                    Var("strm2",LTy F8)]),
                              Let(TP[Var("imm",F64),Var("strm4",LTy F8)],
                                  Call
                                    ("immediate8",PTy(F64,LTy F8),
                                     Var("strm3",LTy F8)),
                                  Call
                                              ...
                                              Call
                                                ("Zrm_i",CTy"Zdest_src",
                                                 TP[Call
                                                    ...
                                                    Var("imm",F64)])]),
                                        Var("strm3",LTy F8)])))),
                         (TP[TP[LT,LF,LT,LT,bVar"v'0",bVar"r'2",bVar"r'1",
                                bVar"r'0"],Var("strm2",LTy F8)],
                          Let(Var("size",CTy"Zsize"),
                              Call
                                ("OpSize",CTy"Zsize",
                                 ...
                                 TP[Var("p",LTy F8),
                                    Call
                                      ("Zloop",CTy"instruction",
                                       TP[ITE(EQ(Mop(Cast F1,LL[bVar"b'0"]),
                                                 LW(0,1)),
                                              LC("Z_NE",CTy"Zcond"),
                                              LC("Z_E",CTy"Zcond")),
                                          Var("imm",F64)]),
                         ...
                         (TP[TP[LT,LT,LT,LF,LT,LF,bVar"b'0",LT],
                             Var("strm2",LTy F8)],
                          Let(TP[Var("imm",F64),Var("strm3",LTy F8)],
                              ITE(EQ(Mop(Cast F1,LL[bVar"b'0"]),LW(0,1)),
                                  Call
                                    ("immediate32",PTy(F64,LTy F8),
                                     Var("strm2",LTy F8)),
                                  Call
                         ...
                         (TP[TP[LF,LF,LF,LF,LT,LT,LT,LT],
                          ...
                          Let(TP[bVar"b'7",bVar"b'6",bVar"b'5",bVar"b'4",
...
val x64_fetch_def = Def
  ("x64_fetch",qVar"state",
   Let(TP[Var("r",LTy F8),Var("s1",PTy(LTy F8,qTy))],
...
val checkIcache_def = Def
  ("checkIcache",nVar"n",
   Close
     (qVar"state",
      Apply
        (For(TP[LN 0,Bop(Sub,nVar"n",LN 1),
                Close
                  (nVar"i",
                   Close
                     (qVar"state",
