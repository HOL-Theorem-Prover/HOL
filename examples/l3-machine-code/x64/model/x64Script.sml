(* x64Script.sml - generated by L<3> - Wed Jun 10 13:04:51 2015 *)
...
val mem8_def = Def
  ("mem8",Var("addr",F64),
   Close
     (qVar"state",
      TP[Apply(Dest("MEM",ATy(F64,F8),qVar"state"),Var("addr",F64)),
         qVar"state"]))
;
   ...
   Close
     (qVar"state",
      TP[CC[Mop(Fst,
            ...
            Mop(Fst,
                Apply
                  (Call("mem8",ATy(qTy,PTy(F8,qTy)),Var("addr",F64)),
...
val x64_pop_aux_def = Def
  ("x64_pop_aux",qVar"state",
   Let(Var("v",F64),
       ...
       TP[Mop(Fst,
              Apply
                (Call("mem64",ATy(qTy,PTy(F64,qTy)),Var("v",F64)),
                 qVar"state")),
          Rupd
            ("REG",
             TP[qVar"state",
  ...
  ("x64_push",Var("imm_rm",CTy"Zimm_rm"),
   Close
     (qVar"state",
      Apply
        (Call
           ("x64_push_aux",ATy(qTy,PTy(uTy,qTy)),
            Mop(Fst,
                Apply
                  (Call
                     ("EA",ATy(qTy,PTy(F64,qTy)),
                  ...
                  Let(nVar"v",
                      ...
                      Let(nVar"v0",
                          ...
                          Let(nVar"q",Bop(Div,nVar"v",nVar"v0"),
                              Apply
                                (Const
                                   ("erase_eflags",ATy(qTy,PTy(uTy,qTy))),
                                 Mop(Snd,
                                     Apply
                                       (Call
                                          ("write'EA",
                           ...
                           Mop(Fst,
                               Apply
                                 (Call
                                    ("EA",ATy(qTy,PTy(F64,qTy)),
                                     Var("ea_src",CTy"Zea")),qVar"state")),
                           Var("v0",F64),Var("v",CTy"Zea")]),
                     Mop(Snd,
                         Apply
                           (Call
                              ("write'EA",ATy(qTy,PTy(uTy,qTy)),
                               TP[Var("v0",F64),Var("ea_src",CTy"Zea")]),
                            qVar"state"))))))))
;
  ...
  ("x64_next",qVar"state",
   CS(Call
      ...
      [(Call
        ...
        Apply
          (Call("Run",ATy(qTy,PTy(uTy,qTy)),Var("i",CTy"instruction")),
           Rupd
             ("RIP",
              TP[qVar"state",
