(* x64Script.sml - generated by L<3> - Tue Apr 30 09:57:12 2013 *)

open HolKernel boolLib bossLib Import

val () = Import.start "x64"

val _ = Construct[("Zreg",
    [("RAX",[]), ("RCX",[]), ("RDX",[]), ("RBX",[]), ("RSP",[]),
     ("RBP",[]), ("RSI",[]), ("RDI",[]), ("zR8",[]), ("zR9",[]),
...
val _ = Construct[("Zeflags",
    [("Z_CF",[]), ("Z_PF",[]), ("Z_AF",[]), ("Z_ZF",[]), ("Z_SF",[]),
     ("Z_OF",[])])]
;

val _ = Construct[("Zsize",
    [("Z16",[]), ("Z32",[]), ("Z64",[]), ("Z8",[bTy])])]
;

val _ = Construct[("Zbase",
    [("ZnoBase",[]), ("ZregBase",[CTy"Zreg"]), ("ZripBase",[])])]
;
...
val _ = Construct[("Zmonop_name",
    [("Zdec",[]), ("Zinc",[]), ("Znot",[]), ("Zneg",[])])]
;

val _ = Construct[("Zbinop_name",
...
val _ = Construct[("Zcond",
    [("Z_O",[]), ("Z_NO",[]), ("Z_B",[]), ("Z_NB",[]), ("Z_E",[]),
     ("Z_NE",[]), ("Z_NA",[]), ("Z_A",[]), ("Z_S",[]), ("Z_NS",[]),
     ("Z_P",[]), ("Z_NP",[]), ("Z_L",[]), ("Z_NL",[]), ("Z_NG",[]),
     ("Z_G",[]), ("Z_ALWAYS",[])])]
;
...
val _ = Construct[("instruction",
    [("Zbinop",[PTy(CTy"Zbinop_name",PTy(CTy"Zsize",CTy"Zdest_src"))]),
     ...
     ("Zcpuid",[]), ("Zdiv",[PTy(CTy"Zsize",CTy"Zrm")]),
     ("Zjcc",[PTy(CTy"Zcond",F64)]), ("Zjmp",[CTy"Zrm"]),
     ("Zlea",[PTy(CTy"Zsize",CTy"Zdest_src")]),
...
val _ = Construct[("exception",
    [("BadFlagAccess",[sTy]), ("BadMemAccess",[F64]), ("FAIL",[sTy]),
     ("NoException",[])])]
;

val _ = Record("x64_state",
     ...
     (qVar"state",
      ITE
        (Mop
           (IsSome,
            Apply
              (Dest("MEM",ATy(F64,OTy(F8)),qVar"state"),Var("addr",F64))),
         TP[LU,
            Rupd
              ("MEM",
               TP[qVar"state",
      ...
      CS
        (Var("ds",CTy"Zdest_src"),
         [(Call("Zrm_i",CTy"Zdest_src",TP[AVar(CTy"Zrm"), Var("i",F64)]),
           TP[Call
                ("Zea_i",CTy"Zea",
                 TP[Var("size",CTy"Zsize"), Var("i",F64)]), qVar"state"]),
          (Call
             ("Zrm_r",CTy"Zdest_src",
      ...
      CS
        (Var("ea",CTy"Zea"),
         [(Call("Zea_i",CTy"Zea",Var("i",PTy(CTy"Zsize",F64))),
             ...
             (Bop
              ...
              TP[Bop
                   (BAnd,
                    Apply
                      (Dest("REG",ATy(CTy"Zreg",F64),qVar"state"),
                       Var("r",CTy"Zreg")),LW(255,64)), qVar"state"],
              TP[Bop
                   (BAnd,
                    Bop
                      (Lsr,
                       Apply
                         (Dest("REG",ATy(CTy"Zreg",F64),qVar"state"),
                          Mop
                            (Cast(CTy"Zreg"),
                             Bop
                               (Sub,Mop(Cast(nTy),Var("r",CTy"Zreg")),
                                LN 4))),LN 8),LW(255,64)), qVar"state"])),
          (Call
             ("Zea_r",CTy"Zea",
              TP[Var("s",CTy"Zsize"), Var("r",CTy"Zreg")]),
           TP[Call
                ("restrictSize",F64,
                 TP[Var("s",CTy"Zsize"),
                    Apply
          ...
          (Call
             ("Zea_m",CTy"Zea",TP[Const("Z16",CTy"Zsize"), Var("a",F64)]),
           Let
             (TP[Var("v",F16), qVar"s"],
              Apply
          ...
          (Call
             ("Zea_m",CTy"Zea",TP[Const("Z32",CTy"Zsize"), Var("a",F64)]),
           Let
             (TP[Var("v",F32), qVar"s"],
              Apply
          ...
          (Call
             ("Zea_m",CTy"Zea",TP[Const("Z64",CTy"Zsize"), Var("a",F64)]),
           Apply
                       ...
                       (Add,
                        Bop
                          (Add,
                           Bop
                             (Add,
                              Mop(Cast(nTy),Bop(Bit,Var("b",F8),LN 7)),
              ...
              [(TP[Mop(Some,bVar"a"), Mop(Some,bVar"b")],
               ...
               (AVar(PTy(OTy(bTy),OTy(bTy))),
                CS
                  (Apply
                     (Dest
                        ("EFLAGS",ATy(CTy"Zeflags",OTy(bTy)),qVar"state"),
                      LC("Z_ZF",CTy"Zeflags")),
             ...
             (TP[Apply
              ...
              [(TP[Mop(Some,bVar"a"), Mop(Some,bVar"b")],
                Let
                  (TP[bVar"v", qVar"s"],
                   Apply(Const("ZF",ATy(qTy,PTy(bTy,qTy))),qVar"state"),
                   TP[Bop(Or,Mop(Not,EQ(bVar"a",bVar"b")),bVar"v"),
                      qVar"s"])),
               (AVar(PTy(OTy(bTy),OTy(bTy))),
                CS
                  (Apply
  ...
  ("dfn'Zcpuid",qVar"state",
   Let
     (qVar"s",
      Rupd
        ("ICACHE",
         TP[qVar"state", Dest("MEM",ATy(F64,OTy(F8)),qVar"state")]),
      Let
        (qVar"s",
         Rupd
           ("REG",
        ...
        (Var("v0",CTy"instruction"),
         [(Const("Zcpuid",CTy"instruction"),
          ...
          (Call
           ...
           Apply
             (Call
              ...
              qVar"state")),
          (Call
             ("Zmul",CTy"instruction",Var("v12",PTy(CTy"Zsize",CTy"Zrm"))),
           Apply
             (Call
          ...
          (Call("Zpop",CTy"instruction",Var("v13",CTy"Zrm")),
           Apply
             (Call("dfn'Zpop",ATy(qTy,PTy(uTy,qTy)),Var("v13",CTy"Zrm")),
              qVar"state")),
...
val readSIB_def = Def
  ("readSIB",
   TP[Var("REX",CTy"REX"), Var("Mod",FTy 2), Var("strm",LTy(F8))],
   CS
     (Var("strm",LTy(F8)),
        ...
        CS
          (TP[BL(8,Var("v#0",F8)), Var("v#1",LTy(F8))],
           [(TP[TP[LF, LF, AVar(bTy), AVar(bTy), AVar(bTy), LT, LF, LT],
            ...
            (TP[TP[LT, LT, AVar(bTy), AVar(bTy), AVar(bTy), AVar(bTy),
            ...
            (TP[TP[AVar(bTy), AVar(bTy), AVar(bTy), AVar(bTy), AVar(bTy),
                   AVar(bTy), AVar(bTy), AVar(bTy)], Var("strm1",LTy(F8))],
             Let
               (TP[Var("displacement",F64), Var("strm2",LTy(F8))],
                Call
                  ("readDisplacement",PTy(F64,LTy(F8)),
                   ...
                   Call
                     ("Zm",CTy"Zrm",
                      TP[LO(PTy(FTy 2,CTy"Zreg")),
                         ...
                         Var("displacement",F64)]), Var("strm2",LTy(F8))]))])),
       (AVar(LTy(F8)),
        TP[LX(CTy"Zreg"), LX(CTy"Zrm"), Var("strm",LTy(F8))])]))
;
...
val prefixGroup_def = Def
  ("prefixGroup",Var("b",F8),
   CS
     (Var("b",F8),
      [(LW(240,8),LN 1), (LW(242,8),LN 1), (LW(243,8),LN 1),
       (LW(38,8),LN 2), (LW(46,8),LN 2), (LW(54,8),LN 2), (LW(62,8),LN 2),
       (LW(100,8),LN 2), (LW(101,8),LN 2), (LW(102,8),LN 3),
       (LW(103,8),LN 4),
...
val readPrefix_def = Def
  ("readPrefix",
   TP[Var("s",STy(nTy)), Var("p",LTy(F8)), Var("strm",LTy(F8))],
   CS
     (Var("strm",LTy(F8)),
      [(LLC([Var("h",F8)],Var("strm1",LTy(F8))),
       ...
       (LNL(F8),
        Mop
          (Some,
           TP[Var("p",LTy(F8)), LF, LX(CTy"REX"), Var("strm",LTy(F8))]))]))
;
                   ...
                   CS
                     (TP[BL(8,Var("v#0",F8)), Var("v#1",LTy(F8))],
                      [(TP[TP[LF, LF, AVar(bTy), AVar(bTy), AVar(bTy), LF,
                                          ...
                                          Call
                                            ("Zr_rm",CTy"Zdest_src",
                                             TP[Var("reg",CTy"Zreg"),
                                                Var("rm",CTy"Zrm")]))]),
                                 Var("strm3",LTy(F8))]))),
                       (TP[TP[LF, LF, AVar(bTy), AVar(bTy), AVar(bTy), LT,
                                          ...
                                          Call
                                            ("Zrm_i",CTy"Zdest_src",
                                             TP[Call
                                                ...
                                                Var("imm",F64)])]),
                                    Var("strm3",LTy(F8))])))),
                       (TP[TP[LF, LT, LF, LT, AVar(bTy), AVar(bTy),
                              AVar(bTy), AVar(bTy)], Var("strm2",LTy(F8))],
                        Let
                          (Var("reg",CTy"Zrm"),
                           Call
                           ...
                           Call
                             ("Zfull_inst",CTy"Zinst",
                              TP[Var("p",LTy(F8)),
                                 ...
                                 Var("strm3",LTy(F8))]))),
                       (TP[TP[LF, LT, LT, LT, AVar(bTy), AVar(bTy),
                              AVar(bTy), AVar(bTy)], Var("strm2",LTy(F8))],
                        Let
                          (TP[Var("imm",F64), Var("strm3",LTy(F8))],
                           Call
                       ...
                       (TP[TP[LT, LF, LF, LT, LF, AVar(bTy), AVar(bTy),
                                          ...
                                          Call
                                            ("Zrm_i",CTy"Zdest_src",
                                             TP[Call
                                                ...
                                                Var("imm",F64)])]),
                                    Var("strm3",LTy(F8))])))),
                       (TP[TP[LT, LF, LT, LT, AVar(bTy), AVar(bTy),
                              AVar(bTy), AVar(bTy)], Var("strm2",LTy(F8))],
                        Let
                          (Var("size",CTy"Zsize"),
                           Call
     ...
     (Call
        ("x64_decode",CTy"Zinst",
         Mop
           (Fst,
            Apply
              (Const("x64_fetch",ATy(qTy,PTy(LTy(F8),qTy))),qVar"state"))),
      [(Call
          ("Zfull_inst",CTy"Zinst",
