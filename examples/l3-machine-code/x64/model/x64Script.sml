(* x64Script.sml - generated by L3 - Wed Apr 27 15:57:44 2016 *)
  ...
  ("dfn'Zcall",Var("imm_rm",CTy"Zimm_rm"),
   Close
     (qVar"state",
      Apply
        (Call
           ("jump_to_ea",ATy(qTy,qTy),
            Apply
              (Call
                 ("ea_Zimm_rm",ATy(qTy,CTy"Zea"),
                  TP[Const("Z64",CTy"Zsize"),Var("imm_rm",CTy"Zimm_rm")]),
