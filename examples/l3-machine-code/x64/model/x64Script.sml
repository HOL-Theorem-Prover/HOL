(* x64Script.sml - generated by L3 - Mon Nov 21 13:41:31 2016 *)
      ...
      [(Call
       ...
       (Call
          ("Zset",CTy"instruction",
           TP[Var("cond",CTy"Zcond"),bVar"have_rex",Var("rm",CTy"Zrm")]),
        CS(Call
             ("e_ModRM",OTy(PTy(F4,LTy F8)),TP[LW(0,4),Var("rm",CTy"Zrm")]),
           [(LO(PTy(F4,LTy F8)),LNL F8),
            (Mop(Some,TP[Var("rex",F4),Var("strm",LTy F8)]),
             Let(TP[Var("prefixes",LTy F8),AVar F8],
                 Call
                   ("e_opsize",PTy(LTy F8,F8),
                    TP[Call("Z8",CTy"Zsize",bVar"have_rex"),Var("rex",F4)]),
                 CC[Var("prefixes",LTy F8),
                    LL[LW(15,8),
