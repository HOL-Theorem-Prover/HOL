(* x64Script.sml - generated by L3 - Mon Sep 18 10:36:39 2017 *)
     ...
     (qVar"state",
      CS(Var("v0",CTy"instruction"),
         [(Const("Zclc",CTy"instruction"),
          ...
          (Call("Zcall",CTy"instruction",Var("v3",CTy"Zimm_rm")),
           Apply
             (Call("dfn'Zcall",ATy(qTy,qTy),Var("v3",CTy"Zimm_rm")),
              qVar"state")),
          (Call
             ("Zcmpxchg",CTy"instruction",
              Var("v4",PTy(CTy"Zsize",PTy(CTy"Zrm",CTy"Zreg")))),
           Apply
             (Call
              ...
              qVar"state")),
          (Call
             ("Zdiv",CTy"instruction",Var("v5",PTy(CTy"Zsize",CTy"Zrm"))),
           Apply
             (Call
                ("dfn'Zdiv",ATy(qTy,qTy),
                 Var("v5",PTy(CTy"Zsize",CTy"Zrm"))),qVar"state")),
          (Call
             ("Zidiv",CTy"instruction",Var("v6",PTy(CTy"Zsize",CTy"Zrm"))),
           Apply
             (Call
                ("dfn'Zidiv",ATy(qTy,qTy),
                 Var("v6",PTy(CTy"Zsize",CTy"Zrm"))),qVar"state")),
          (Call
             ("Zimul",CTy"instruction",Var("v7",PTy(CTy"Zsize",CTy"Zrm"))),
           Apply
             (Call
                ("dfn'Zimul",ATy(qTy,qTy),
                 Var("v7",PTy(CTy"Zsize",CTy"Zrm"))),qVar"state")),
          (Call
             ("Zimul2",CTy"instruction",
              Var("v8",PTy(CTy"Zsize",PTy(CTy"Zreg",CTy"Zrm")))),
           Apply
             (Call
          ...
          (Call
             ("Zimul3",CTy"instruction",
              Var("v9",PTy(CTy"Zsize",PTy(CTy"Zreg",PTy(CTy"Zrm",F64))))),
           Apply
             (Call
                ("dfn'Zimul3",ATy(qTy,qTy),
                 Var("v9",PTy(CTy"Zsize",PTy(CTy"Zreg",PTy(CTy"Zrm",F64))))),
              qVar"state")),
          (Call("Zjcc",CTy"instruction",Var("v10",PTy(CTy"Zcond",F64))),
           Apply
             (Call("dfn'Zjcc",ATy(qTy,qTy),Var("v10",PTy(CTy"Zcond",F64))),
              qVar"state")),
          (Call("Zjmp",CTy"instruction",Var("v11",CTy"Zrm")),
           Apply
             (Call("dfn'Zjmp",ATy(qTy,qTy),Var("v11",CTy"Zrm")),
              qVar"state")),
          (Call
             ("Zlea",CTy"instruction",
              Var("v12",PTy(CTy"Zsize",CTy"Zdest_src"))),
           Apply
             (Call
                ("dfn'Zlea",ATy(qTy,qTy),
                 Var("v12",PTy(CTy"Zsize",CTy"Zdest_src"))),qVar"state")),
          (Call("Zloop",CTy"instruction",Var("v13",PTy(CTy"Zcond",F64))),
           Apply
             (Call
                ("dfn'Zloop",ATy(qTy,qTy),Var("v13",PTy(CTy"Zcond",F64))),
              qVar"state")),
          (Call
             ("Zmonop",CTy"instruction",
              Var("v14",PTy(CTy"Zmonop_name",PTy(CTy"Zsize",CTy"Zrm")))),
           Apply
             (Call
          ...
          (Call
             ("Zmov",CTy"instruction",
              Var("v15",PTy(CTy"Zcond",PTy(CTy"Zsize",CTy"Zdest_src")))),
           Apply
             (Call
          ...
          (Call
             ("Zmovsx",CTy"instruction",
              Var("v16",PTy(CTy"Zsize",PTy(CTy"Zdest_src",CTy"Zsize")))),
           Apply
             (Call
          ...
          (Call
             ("Zmovzx",CTy"instruction",
              Var("v17",PTy(CTy"Zsize",PTy(CTy"Zdest_src",CTy"Zsize")))),
           Apply
             (Call
              ...
              qVar"state")),
          (Call
             ("Zmul",CTy"instruction",Var("v18",PTy(CTy"Zsize",CTy"Zrm"))),
           Apply
             (Call
                ("dfn'Zmul",ATy(qTy,qTy),
                 Var("v18",PTy(CTy"Zsize",CTy"Zrm"))),qVar"state")),
          (Call("Znop",CTy"instruction",nVar"v19"),qVar"state"),
          (Call("Zpop",CTy"instruction",Var("v20",CTy"Zrm")),
           Apply
             (Call("dfn'Zpop",ATy(qTy,qTy),Var("v20",CTy"Zrm")),
              qVar"state")),
          (Call("Zpush",CTy"instruction",Var("v21",CTy"Zimm_rm")),
           Apply
             (Call("dfn'Zpush",ATy(qTy,qTy),Var("v21",CTy"Zimm_rm")),
              qVar"state")),
          (Call("Zret",CTy"instruction",Var("v22",F64)),
           Apply(Call("dfn'Zret",ATy(qTy,qTy),Var("v22",F64)),qVar"state")),
          (Call
             ("Zset",CTy"instruction",
              Var("v23",PTy(CTy"Zcond",PTy(bTy,CTy"Zrm")))),
           Apply
             (Call
                ("dfn'Zset",ATy(qTy,qTy),
                 Var("v23",PTy(CTy"Zcond",PTy(bTy,CTy"Zrm")))),qVar"state")),
          (Call
             ("Zxadd",CTy"instruction",
              Var("v24",PTy(CTy"Zsize",PTy(CTy"Zrm",CTy"Zreg")))),
           Apply
             (Call
          ...
          (Call
             ("Zxchg",CTy"instruction",
              Var("v25",PTy(CTy"Zsize",PTy(CTy"Zrm",CTy"Zreg")))),
           Apply
             (Call
      ...
      [(Call
       ...
       (Call
        ...
        Call
          ("e_rm_reg",LTy F8,
           TP[Var("sz",CTy"Zsize"),Var("rm",CTy"Zrm"),
              Mop(Cast F4,Var("r",CTy"Zreg")),LL[LW(15,8)],LW(175,8)])),
       (Call
          ("Zimul3",CTy"instruction",
           TP[Call("Z8",CTy"Zsize",AVar bTy),AVar(CTy"Zreg"),
            ...
            ITB([(EQ(nVar"s",LN 1),
                  CC[Call
                       ("e_rm_reg",LTy F8,
                        TP[Var("sz",CTy"Zsize"),Var("rm",CTy"Zrm"),
                           Mop(Cast F4,Var("r",CTy"Zreg")),LNL F8,
                           LW(107,8)]),Var("l",LTy F8)]),
                 (EQ(nVar"s",LN 4),
                  CC[Call
                       ("e_rm_reg",LTy F8,
                        TP[Var("sz",CTy"Zsize"),Var("rm",CTy"Zrm"),
                           Mop(Cast F4,Var("r",CTy"Zreg")),LNL F8,
                           LW(105,8)]),Var("l",LTy F8)])],LNL F8))),
