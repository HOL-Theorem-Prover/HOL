(* x64 - generated by L<3> - Wed Aug 27 11:32:40 2014 *)
...
fun e_imm32 imm =
  if (BitsN.<=(BitsN.B(0xFFFFFFFF80000000,64),imm)) andalso
    ...
    then [BitsN.bits(imm,7,0),BitsN.bits(imm,15,8),BitsN.bits(imm,23,16),
          BitsN.bits(imm,31,24)]
  else [];
         ...
         then let
              ...
              in
                if v = (BitsN.B(0x1,8))
                  then prefixes
                         @
                         [BitsN.@@(BitsN.B(0x12,5),BitsN.bits(r,2,0))]
                else []
              end
       else e_rm_reg
              (sz,
