(* x64 - generated by L3 - Wed Jul 15 10:49:59 2015 *)
...
fun SAR (size,(x,y)) =
  case size of
     Z8 _ =>
      BitsN.fromNat
        (BitsN.toNat
           (BitsN.>>(BitsN.bits(7,0) x,BitsN.toNat(BitsN.bits(4,0) y))),64)
   | Z16 =>
        BitsN.fromNat
          (BitsN.toNat
             (BitsN.>>(BitsN.bits(15,0) x,BitsN.toNat(BitsN.bits(4,0) y))),
          ...
          then (BitsN.concat
                ...
                [BitsN.concat
                   [case s of
                    ...
                    BitsN.B(0x4,3)],BitsN.concat[ss,BitsN.bits(2,0) i,b20]]
                  @
                  l)
        else (BitsN.B(0x0,4),[])
      end
      ...
      (case p_register b of
        ...
        | NONE =>
             (case p_imm_of_size(sz,b) of
                 Option.SOME imm =>
                  (if (sz = Z64) andalso
                      (not((BitsN.signExtend 64 (BitsN.bits(31,0) imm)) =
                           imm))
                     then ("syntax error: bad immediate",NONE)
