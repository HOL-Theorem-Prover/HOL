(* x64 - generated by L3 - Mon Nov 21 15:22:28 2016 *)
...
fun encode i =
  case i of
   ...
   | Zset(cond,(have_rex,rm)) =>
     (case e_ModRM(BitsN.B(0x0,4),rm) of
         NONE => []
       | Option.SOME(rex,strm) =>
         let
           val (prefixes,_) = e_opsize(Z8 have_rex,rex)
         in
           List.concat
             [prefixes,
              [BitsN.B(0xF,8),
               BitsN.@@
                 (BitsN.B(0x9,4),BitsN.fromNat(Cast.ZcondToNat cond,4))],
              strm]
         end)
   | Zxadd(sz,(rm,r)) =>
     e_rm_reg
