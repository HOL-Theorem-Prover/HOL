(* x64 - generated by L3 - Mon Sep 18 10:36:50 2017 *)
...
fun Run v0 =
  case v0 of
   ...
   | Zbit_test v2 => dfn'Zbit_test v2
   | Zcall v3 => dfn'Zcall v3
   | Zcmpxchg v4 => dfn'Zcmpxchg v4
   | Zdiv v5 => dfn'Zdiv v5
   | Zidiv v6 => dfn'Zidiv v6
   | Zimul v7 => dfn'Zimul v7
   | Zimul2 v8 => dfn'Zimul2 v8
   | Zimul3 v9 => dfn'Zimul3 v9
   | Zjcc v10 => dfn'Zjcc v10
   | Zjmp v11 => dfn'Zjmp v11
   | Zlea v12 => dfn'Zlea v12
   | Zloop v13 => dfn'Zloop v13
   | Zmonop v14 => dfn'Zmonop v14
   | Zmov v15 => dfn'Zmov v15
   | Zmovsx v16 => dfn'Zmovsx v16
   | Zmovzx v17 => dfn'Zmovzx v17
   | Zmul v18 => dfn'Zmul v18
   | Znop v19 => dfn'Znop v19
   | Zpop v20 => dfn'Zpop v20
   | Zpush v21 => dfn'Zpush v21
   | Zret v22 => dfn'Zret v22
   | Zset v23 => dfn'Zset v23
   | Zxadd v24 => dfn'Zxadd v24
   | Zxchg v25 => dfn'Zxchg v25;
...
fun encode i =
  case i of
       ...
       (sz,
        (rm,
         (BitsN.fromNat(Cast.ZregToNat r,4),
          ([BitsN.B(0xF,8)],
           BitsN.concat
             [BitsN.B(0x5,3),BitsN.fromNat(Cast.Zbit_test_nameToNat bt,2),
              BitsN.B(0x3,3)]))))
   ...
   | Zidiv(sz,rm) =>
     e_rm_reg(sz,(rm,(BitsN.B(0x7,4),([],BitsN.B(0xF6,8)))))
   | Zjcc(cond,imm) =>
     let
   ...
   | Zimul(sz,rm) =>
     e_rm_reg(sz,(rm,(BitsN.B(0x5,4),([],BitsN.B(0xF6,8)))))
   | Zimul2(Z8 _,_) => []
   | Zimul2(sz,(r,rm)) =>
     e_rm_reg
       (sz,
     ...
     in
       if s = 1
         then (e_rm_reg
                 (sz,
                  (rm,
                   (BitsN.fromNat(Cast.ZregToNat r,4),([],BitsN.B(0x6B,8))))))
                @
                l
       else if s = 4
         then (e_rm_reg
                 (sz,
                  (rm,
                   (BitsN.fromNat(Cast.ZregToNat r,4),([],BitsN.B(0x69,8))))))
                @
                l
       else []
     end
       ...
       (case v'1 of
               ...
               | ((a,[]),#"j" :: cond) =>
                 ...
                 in
                   case condition of
                    ...
                    | NONE =>
                      FAIL
                        (String.concat["Unrecognised mnemonic: ","j",cond])
                 end
               | ((a,[]),[#"d",#"i",#"v"]) => p_monop(0,String.implode a)
               | ((a,[]),[#"i",#"d",#"i",#"v"]) =>
                 p_monop(1,String.implode a)
               | ((a,[]),[#"m",#"u",#"l"]) => p_monop(2,String.implode a)
               | ((a,[]),[#"i",#"m",#"u",#"l"]) =>
                 p_monop(3,String.implode a)
               | ((a,[]),[#"d",#"e",#"c"]) => p_monop(4,String.implode a)
               | ((a,[]),[#"i",#"n",#"c"]) => p_monop(5,String.implode a)
               | ((a,[]),[#"n",#"o",#"t"]) => p_monop(6,String.implode a)
               | ((a,[]),[#"n",#"e",#"g"]) => p_monop(7,String.implode a)
               | ((i,[]),[#"r",#"e",#"t"]) =>
                 ...
                 in
                   if Set.mem(s,["","s","r","c"])
                     then let
                          ...
                          (String.concat["Unrecognised mnemonic: ","bt",s])
                 end
               | ((a,[b]),[#"i",#"m",#"u",#"l"]) =>
                 (case p_dest_src(false,(String.implode a,b)) of
         ...
         | [] =>
           (case v'0 of
             ...
             | v'2 =>
               FAIL("Unrecognised mnemonic or wrong number of args: " ^ s)))
