(* x64 - generated by L3 - Mon Feb 15 14:39:04 2016 *)
     ...
     in
       (BitsN.concat
          [BitsN.B(0x0,1),BitsN.bits(3,3) r,BitsN.B(0x0,1),
           BitsN.bits(3,3) rm],
        [BitsN.concat[BitsN.B(0x3,2),BitsN.bits(2,0) r,BitsN.bits(2,0) rm]])
     end
   | Zm(NONE,(ZnoBase,imm)) =>
     (case e_imm32 imm of
         [] => (BitsN.B(0x0,4),[])
         ...
         then (BitsN.concat
               ...
               [BitsN.concat
                  [case s of
                      0 => BitsN.B(0x0,2)
                    | 1 => BitsN.B(0x1,2)
                    | _ => BitsN.B(0x2,2),BitsN.bits(2,0) r,BitsN.B(0x4,3)],
