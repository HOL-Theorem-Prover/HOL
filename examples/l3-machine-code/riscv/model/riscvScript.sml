(* riscvScript.sml - generated by L3 - Thu Apr 28 13:52:46 2016 *)
      ...
      Let(TP[Var("r",CTy"sip"),Var("s1",PTy(CTy"sip",qTy))],
          Let(Var("s",PTy(CTy"sip",qTy)),
              ...
              Let(Var("s",PTy(CTy"sip",qTy)),
                  ...
                  TP[Mop(Fst,Var("s",PTy(CTy"sip",qTy))),
                     Var("s",PTy(CTy"sip",qTy))])),Var("r",CTy"sip"))))
;
      ...
      Let(TP[Var("r",CTy"sie"),Var("s1",PTy(CTy"sie",qTy))],
          Let(Var("s",PTy(CTy"sie",qTy)),
              ...
              Let(Var("s",PTy(CTy"sie",qTy)),
                  ...
                  TP[Mop(Fst,Var("s",PTy(CTy"sie",qTy))),
                     Var("s",PTy(CTy"sie",qTy))])),Var("r",CTy"sie"))))
;
      ...
      Let(TP[Var("r",CTy"mip"),Var("s1",PTy(CTy"mip",qTy))],
          Let(Var("s",PTy(CTy"mip",qTy)),
              ...
              Let(Var("s",PTy(CTy"mip",qTy)),
                  ...
                  TP[Mop(Fst,Var("s",PTy(CTy"mip",qTy))),
                     Var("s",PTy(CTy"mip",qTy))])),Var("r",CTy"mip"))))
;
      ...
      Let(TP[Var("r",CTy"mie"),Var("s1",PTy(CTy"mie",qTy))],
          Let(Var("s",PTy(CTy"mie",qTy)),
              ...
              Let(Var("s",PTy(CTy"mie",qTy)),
                  ...
                  TP[Mop(Fst,Var("s",PTy(CTy"mie",qTy))),
                     Var("s",PTy(CTy"mie",qTy))])),Var("r",CTy"mie"))))
;
   ...
   Close
     (qVar"state",
      Let(TP[bVar"v",qVar"s"],
          ...
          Let(TP[bVar"v",qVar"s"],
              ITE(Bop(And,Bop(Ge,Var("csr",FTy 12),LW(3200,12)),
                      Bop(And,Bop(Le,Var("csr",FTy 12),LW(3202,12)),
                          bVar"v")),TP[LT,qVar"s"],
                  Let(TP[bVar"v",qVar"s"],
                      Apply
                              ...
                              Let(TP[bVar"v",qVar"s"],
                                  Let(TP[bVar"v",qVar"s"],
                                      ...
                                      TP[Bop(Or,
                                         ...
                                         qVar"s"]),
                                  TP[Bop(Or,
                                         EQ(Var("csr",FTy 12),LW(289,12)),
                                         bVar"v"),qVar"s"]),
                              TP[Bop(Or,EQ(Var("csr",FTy 12),LW(260,12)),
                                     bVar"v"),qVar"s"]),
                          TP[Bop(Or,
                                 Bop(And,
                                     Bop(Ge,Var("csr",FTy 12),LW(256,12)),
                                     Bop(Le,Var("csr",FTy 12),LW(257,12))),
                                 bVar"v"),qVar"s"]))),
              TP[Bop(Or,
                     Bop(And,Bop(Ge,Var("csr",FTy 12),LW(3072,12)),
                         Bop(Le,Var("csr",FTy 12),LW(3074,12))),bVar"v"),
                 qVar"s"]))))
;
val CSRMap_def = Def
          ...
          (LW(256,12),
           TP[Call
                ("reg'sstatus",F64,
                 Apply
                   (Call
                      ("lift_mstatus_sstatus",ATy(qTy,CTy"sstatus"),
                       Dest
                         ("mstatus",CTy"mstatus",
                          Apply
                            (Dest
                    ...
                    Rupd
                      ("mie",
                       TP[Apply
                          ...
                          Apply
                            (Call
                               ("lower_sie_mie",ATy(qTy,CTy"mie"),
                                TP[Call
                                     ("rec'sie",CTy"sie",Var("value",F64)),
                                   Dest
                                     ("mie",CTy"mie",
                                      Apply
                                        (Dest
                    ...
                    Rupd
                      ("mip",
                       TP[Apply
                          ...
                          Apply
                            (Call
                               ("lower_sip_mip",ATy(qTy,CTy"mip"),
                                TP[Call
                                     ("rec'sip",CTy"sip",Var("value",F64)),
                                   Dest
                                     ("mip",CTy"mip",
                                      Apply
                                        (Dest
                    ...
                    Rupd
                      ("mstatus",
                       TP[Apply
                          ...
                          Apply
                            (Call
                               ("update_mstatus",ATy(qTy,CTy"mstatus"),
                                TP[Dest
                                     ("mstatus",CTy"mstatus",
                                      Apply
                                        (Dest
...
val setupDelta_def = Def
  ("setupDelta",TP[Var("pc",F64),Var("instr",F32)],
   Close
     (qVar"state",
      Let(Var("v",CTy"StateDelta"),
          Apply(Const("Delta",ATy(qTy,CTy"StateDelta")),qVar"state"),
                    ...
                    Apply
                      (Call
                         ("write'Delta",ATy(qTy,qTy),
                          Rupd
                            ("exc_taken",TP[Var("v",CTy"StateDelta"),LF])),
                       qVar"state")),
                 Apply
                   (Call
                      ("write'Delta",ATy(qTy,qTy),
                       Rupd("exc_taken",TP[Var("v",CTy"StateDelta"),LF])),
                    qVar"state")],
              Let(TP[Var("v",CTy"StateDelta"),qVar"s"],
                  TP[Apply
                       (Const("Delta",ATy(qTy,CTy"StateDelta")),
                        Apply
                          (Call
                             ("write'Delta",ATy(qTy,qTy),
                              Rupd
                                ("fetch_exc",
                                 TP[Var("v",CTy"StateDelta"),LF])),qVar"s")),
                     Apply
                       (Call
                          ("write'Delta",ATy(qTy,qTy),
                           Rupd
                             ("fetch_exc",TP[Var("v",CTy"StateDelta"),LF])),
                        qVar"s")],
                  Let(TP[Var("v",CTy"StateDelta"),qVar"s"],
                      TP[Apply
                           (Const("Delta",ATy(qTy,CTy"StateDelta")),
                        ...
                        (Const("Delta",ATy(qTy,CTy"StateDelta")),
                         Apply
                           (Call
                            ...
                            qVar"state")),Mop(Some,Var("val",F64))])),
             Apply
               (Call
                  ("write'Delta",ATy(qTy,qTy),
                   Rupd
                     ("addr",
                      TP[Var("v",CTy"StateDelta"),
                         Mop(Some,Var("addr",F64))])),qVar"state")))))
;
        ...
        (Call
           ("write'Delta",ATy(qTy,qTy),
            Rupd
              ("exc_taken",
               TP[Apply
                    (Const("Delta",ATy(qTy,CTy"StateDelta")),qVar"state"),
                  LT])),qVar"state")))
;
                         ...
                         Apply
                           (Call
                              ("write'Delta",ATy(qTy,qTy),
                               Rupd
                                 ("fetch_exc",
                                  TP[Var("v",CTy"StateDelta"),LT])),
                            qVar"state")),Var("pc",F64)])),
             Apply
               (Call
                  ("write'Delta",ATy(qTy,qTy),
                   Rupd("fetch_exc",TP[Var("v",CTy"StateDelta"),LT])),
                qVar"state")))))
;
val hex32_def = Def
  ("hex32",Var("x",F32),
                    ...
                    Mop(Some,
                        Call
                          ("Trap",CTy"TransferControl",
                           Mop(Fst,Var("s",PTy(CTy"SynchronousTrap",qTy)))))),
                 Mop(Snd,Var("s",PTy(CTy"SynchronousTrap",qTy))))))))
;
val signalException_def = Def
  ("signalException",Var("e",CTy"ExceptionType"),
   Close
     (qVar"state",
      Apply
        (Call("recordException",ATy(qTy,qTy),LU),
         Apply
           (Call
              ("setTrap",ATy(qTy,qTy),
            ...
            Apply
              (Call
                 ("mark_log",ATy(qTy,qTy),
                  TP[Const("LOG_INSN",nTy),
                     CC[LS"signalling exception ",
                        Call("excName",sTy,Var("e",CTy"ExceptionType"))]]),
               qVar"state")))))
;
                 ...
                 ("mark_log",ATy(qTy,qTy),
                  TP[Const("LOG_INSN",nTy),
                     CC[LS"signalling address exception ",
                        Call("excName",sTy,Var("e",CTy"ExceptionType")),
                        LS" at ",Mop(Cast sTy,Var("vAddr",F64))]]),
               qVar"state")))))
;
                      ...
                      (Call
                         ("mark_log",ATy(qTy,qTy),
                          TP[Const("LOG_INSN",nTy),
                             CC[LS"trapping from ",
                                Call
                                  ("privName",sTy,Var("v",CTy"Privilege")),
                                LS" to ",
                                Call
                                  ("privName",sTy,
                                   Var("toPriv",CTy"Privilege")),
                                LS" at pc ",Mop(Cast sTy,Var("epc",F64)),
                                ITE(bVar"intr",LS" [intr] ",LS" [exc] "),
                                Mop(Cast sTy,Mop(Cast nTy,Var("ec",F4)))]]),
                       qVar"state"))),
              Let(qVar"s",
                  Apply
                    (Call
     ...
     (qVar"state",
      Apply
        (Call
         ...
         Apply
           (Call
              ("write'GPR",ATy(qTy,qTy),TP[Var("val",F64),Var("rd",FTy 5)]),
            qVar"state"))))
;
val MEM_def = Def
  ("MEM",Var("a",FTy 61),
          ...
          Apply
            (Call
             ...
             Apply
               (Call
                  ("write'MEM",ATy(qTy,qTy),
                   TP[Var("data",F64),Var("pAddrIdx",FTy 61)]),qVar"state")))))
;
   ...
   Close
     (qVar"state",
      Let(Var("v",FTy 6),
          ...
          CS(Apply
               (Call
                  ("lookupTLB",ATy(qTy,OTy(PTy(CTy"TLBEntry",F4))),
                   ...
                   ITE(bVar"v",
                       Let(qVar"s",
                           Apply
                             (Call
                                ("mark_log",ATy(qTy,qTy),
                                 TP[Const("LOG_ADDRTR",nTy),LS"TLB hit!"]),
                              qVar"s"),
                           TP[Mop(Some,
                                  Bop(BOr,
                                      Dest
           ...
           ("write'Delta",ATy(qTy,qTy),
            Rupd
              ("addr",
               TP[Apply
                    (Const("Delta",ATy(qTy,CTy"StateDelta")),qVar"state"),
                  Mop(Some,Var("nextPC",F64))])),qVar"state")))
;
...
val dfn'REM_def = Def
  ("dfn'REM",TP[Var("rd",FTy 5),Var("rs1",FTy 5),Var("rs2",FTy 5)],
   Close
     (qVar"state",
      ITB([(EQ(Apply
                 (Call("GPR",ATy(qTy,F64),Var("rs2",FTy 5)),qVar"state"),
               LW(0,64)),
            Apply
              (Call
                 ("writeRD",ATy(qTy,qTy),
           ...
           (Bop(And,
                ...
                EQ(Apply
                     (Call("GPR",ATy(qTy,F64),Var("rs2",FTy 5)),
                      qVar"state"),Mop(SE F64,LW(1,1)))),
            Apply
              (Call("writeRD",ATy(qTy,qTy),TP[Var("rd",FTy 5),LW(0,64)]),
               qVar"state"))],
          Apply
            (Call
               ("writeRD",ATy(qTy,qTy),
      ...
      Let(Var("v",F64),
          ...
          ITB([(Mop(Not,EQ(EX(Var("v",F64),LN 1,LN 0,FTy 2),LW(0,2))),
               ...
               (Mop(Not,
                ...
                Apply
                  (Call
                     ("writeRD",ATy(qTy,qTy),TP[Var("rd",FTy 5),LW(1,64)]),
                   qVar"state"))],
              Let(TP[Var("v0",OTy F64),qVar"s"],
                  Apply
                    (Call
                  ...
                  CS(Var("v0",OTy F64),
                     [(Mop(Some,Var("pAddr",F64)),
                       Let(Var("v0",F64),
                           ...
                           Apply
                             (Call
                                ("write'ReserveLoad",ATy(qTy,qTy),LO F64),
                              Apply
                                (Call
                                   ("writeRD",ATy(qTy,qTy),
      ...
      Apply
        (Call
           ("write'TLB",ATy(qTy,qTy),
            Apply
              (Call
                 ("flushTLB",ATy(qTy,ATy(F4,OTy(CTy"TLBEntry"))),
...
val dfn'FETCH_MISALIGNED_def = Def
  ("dfn'FETCH_MISALIGNED",Var("addr",F64),
   Close
     (qVar"state",
      Apply
        (Call("recordFetchException",ATy(qTy,qTy),Var("addr",F64)),
         Apply
           (Call
              ("signalAddressException",ATy(qTy,qTy),
               TP[LC("Fetch_Misaligned",CTy"ExceptionType"),
          ...
          (Call("Internal",CTy"instruction",Var("v53",CTy"Internal")),
           CS(Var("v53",CTy"Internal"),
              [(Call("FETCH_FAULT",CTy"Internal",Var("v54",F64)),
                Apply
                  (Call("dfn'FETCH_FAULT",ATy(qTy,qTy),Var("v54",F64)),
                   qVar"state")),
               (Call("FETCH_MISALIGNED",CTy"Internal",Var("v55",F64)),
                Apply
                  (Call
                     ("dfn'FETCH_MISALIGNED",ATy(qTy,qTy),Var("v55",F64)),
                   qVar"state"))])),
           ...
           CS(Var("v96",CTy"System"),
              [(Const("EBREAK",CTy"System"),
               ...
               (Call("SFENCE_VM",CTy"System",Var("v103",FTy 5)),
                Apply
                  (Call("dfn'SFENCE_VM",ATy(qTy,qTy),Var("v103",FTy 5)),
                   qVar"state"))]))])))
;
val Fetch_def = Def
  ("Fetch",AVar uTy,
                      ...
                      EQ(Dest
                           ("mtohost",F64,
                            Apply
                              (Const("MCSR",ATy(qTy,CTy"MachineCSR")),
                               Apply
                                 (Call("clear_logs",ATy(qTy,qTy),LU),
                                  qVar"state"))),LW(0,64))),
                  Let(Var("v",CTy"MachineCSR"),
                      Apply
                        (Const("MCSR",ATy(qTy,CTy"MachineCSR")),qVar"s"),
                      Let(qVar"s",
                          Apply
                            (Call
                               ("mark_log",ATy(qTy,qTy),
                                          ...
                                          ("mtohost",F64,
                                           Apply
                                             (Const
                                                ("MCSR",
                                                 ATy(qTy,CTy"MachineCSR")),
                                              Rupd("done",TP[qVar"s",LT]))),
                                        LN 1)),Rupd("done",TP[qVar"s",LT])),
                              Apply
                                (Call
                                   ("write'MCSR",ATy(qTy,qTy),
                                    Rupd
              ...
              Let(TP[Var("v",
                  ...
                  Let(TP[Var("v0",OTy(PTy(CTy"Interrupt",CTy"Privilege"))),
                      ...
                      TP[TP[Apply
                              (Const
                                 ("NextFetch",
                                  ATy(qTy,OTy(CTy"TransferControl"))),
                               Apply
                                 (Call("checkTimers",ATy(qTy,qTy),LU),
                                  CS(Var("v",CTy"FetchResult"),
                                     [(Call
                     ...
                     [(TP[LO(CTy"TransferControl"),
                                   ...
                                   (Const("PC",ATy(qTy,F64)),
                                    Apply
                                      (Call("incrInstret",ATy(qTy,qTy),LU),
                                       qVar"s")),LW(4,64))),
                          Apply
                            (Call("incrInstret",ATy(qTy,qTy),LU),qVar"s"))),
                      (TP[LO(CTy"TransferControl"),
                          Mop(Some,
                      ...
                      (TP[Mop(Some,
                              Call
                                ("BranchTo",CTy"TransferControl",
                                 Var("addr",F64))),
                          AVar(OTy(PTy(CTy"Interrupt",CTy"Privilege")))],
                       Apply
                         (Call("write'PC",ATy(qTy,qTy),Var("addr",F64)),
                          Apply
                            (Call
                               ("write'NextFetch",ATy(qTy,qTy),
                             ...
                             Apply
                               (Call("incrInstret",ATy(qTy,qTy),LU),
                                qVar"s")))),
                      (TP[Mop(Some,Const("Ereturn",CTy"TransferControl")),
                          AVar(OTy(PTy(CTy"Interrupt",CTy"Privilege")))],
                       Let(TP[Var("v",F64),qVar"s"],
                           Apply
                           ...
                           Let(qVar"s",
                               Apply
                                 (Call
                                    ("write'PC",ATy(qTy,qTy),Var("v",F64)),
                                  qVar"s"),
                               Let(Var("v0",CTy"MachineCSR"),
                                   Apply
                                     (Const
