(* riscvScript.sml - generated by L3 - Wed May 18 13:48:24 2016 *)
     ...
     (qVar"state",
      Let(Var("v",F64),
          ...
          TP[ITE(Bop(Bit,Var("pAddr",F64),LN 2),
                 ...
                 EX(Var("v",F64),LN 31,LN 0,F32)),qVar"state"])))
;
          ...
          Let(Var("v",F64),
              ...
              ITE(Bop(And,
                  ...
                  Apply
                    (Call
                       ("write'GPR",ATy(qTy,qTy),
                        TP[Var("v",F64),Var("rd",FTy 5)]),qVar"state"),
                  Apply
                    (Call
                       ("write'GPR",ATy(qTy,qTy),
                        TP[Bop(Quot,
                          ...
                          Let(Var("minus_max",F32),
                              ...
                              ITE(Bop(And,
                                  ...
                                  Apply
                                    (Call
                                       ("write'GPR",ATy(qTy,qTy),
                                        TP[Mop(SE F64,Var("minus_max",F32)),
                                           Var("rd",FTy 5)]),qVar"s"),
                                  Apply
                                    (Call
                                       ("write'GPR",ATy(qTy,qTy),
                   ...
                   (Call
                      ("write'GPR",ATy(qTy,qTy),
                       TP[Bop(Add,
                              ...
                              LW(4,64)),Var("rd",FTy 5)]),qVar"state"))))))
;
                 ...
                 [(Mop(Some,Var("pAddr",F64)),
                   Let(TP[Var("v",F64),qVar"s"],
                       ...
                       Apply
                         (Call
                            ("write'GPR",ATy(qTy,qTy),
                             TP[Mop(SE F64,EX(Var("v",F64),LN 15,LN 0,F16)),
                                Var("rd",FTy 5)]),qVar"s"))),
                  (LO F64,
                   Apply
                     (Call
                 ...
                 [(Mop(Some,Var("pAddr",F64)),
                   Let(TP[Var("v",F64),qVar"s"],
                       ...
                       Apply
                         (Call
                            ("write'GPR",ATy(qTy,qTy),
                             TP[Mop(SE F64,EX(Var("v",F64),LN 7,LN 0,F8)),
                                Var("rd",FTy 5)]),qVar"s"))),
                  (LO F64,
                   Apply
                     (Call
                 ...
                 [(Mop(Some,Var("pAddr",F64)),
                   Let(TP[Var("v",F64),qVar"s"],
                       ...
                       Apply
                         (Call
                            ("write'GPR",ATy(qTy,qTy),
                             TP[Mop(Cast F64,EX(Var("v",F64),LN 7,LN 0,F8)),
                                Var("rd",FTy 5)]),qVar"s"))),
                  (LO F64,
                   Apply
                     (Call
                                    ...
                                    (Call
                                     ...
                                     Apply
                                       (Call
                                        ...
                                        qVar"s"))),
                               Let(TP[Var("v",CTy"Privilege"),qVar"s"],
                                   Let(qVar"s0",
                                       Apply
                                         (Call
                                            ("write'PC",ATy(qTy,qTy),
