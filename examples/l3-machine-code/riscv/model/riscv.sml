(* riscv - generated by L3 - Wed Jun 21 13:22:02 2017 *)
...
fun dfn'FADD_S (rd,(rs1,(rs2,fprnd))) =
  case round fprnd of
     Option.SOME r => writeFPRS(rd,FP32.add(r,(FPRS rs1,FPRS rs2)))
   | NONE => signalException Illegal_Instr;

fun dfn'FSUB_S (rd,(rs1,(rs2,fprnd))) =
  case round fprnd of
     Option.SOME r => writeFPRS(rd,FP32.sub(r,(FPRS rs1,FPRS rs2)))
   | NONE => signalException Illegal_Instr;

fun dfn'FMUL_S (rd,(rs1,(rs2,fprnd))) =
  case round fprnd of
     Option.SOME r => writeFPRS(rd,FP32.mul(r,(FPRS rs1,FPRS rs2)))
   | NONE => signalException Illegal_Instr;

fun dfn'FDIV_S (rd,(rs1,(rs2,fprnd))) =
  case round fprnd of
     Option.SOME r => writeFPRS(rd,FP32.div(r,(FPRS rs1,FPRS rs2)))
   | NONE => signalException Illegal_Instr;

fun dfn'FSQRT_S (rd,(rs,fprnd)) =
  case round fprnd of
     Option.SOME r => writeFPRS(rd,FP32.sqrt(r,FPRS rs))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FMADD_S (rd,(rs1,(rs2,(rs3,fprnd)))) =
  case round fprnd of
     Option.SOME r =>
       writeFPRS
         (rd,FP32.add(r,(FP32.mul(r,(FPRS rs1,FPRS rs2)),FPRS rs3)))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FMSUB_S (rd,(rs1,(rs2,(rs3,fprnd)))) =
  case round fprnd of
     Option.SOME r =>
       writeFPRS
         (rd,FP32.sub(r,(FP32.mul(r,(FPRS rs1,FPRS rs2)),FPRS rs3)))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FNMADD_S (rd,(rs1,(rs2,(rs3,fprnd)))) =
  case round fprnd of
     Option.SOME r =>
       writeFPRS
         (rd,
          FP32.neg(FP32.add(r,(FP32.mul(r,(FPRS rs1,FPRS rs2)),FPRS rs3))))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FNMSUB_S (rd,(rs1,(rs2,(rs3,fprnd)))) =
  case round fprnd of
     Option.SOME r =>
       writeFPRS
         (rd,
          FP32.neg(FP32.sub(r,(FP32.mul(r,(FPRS rs1,FPRS rs2)),FPRS rs3))))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FADD_D (rd,(rs1,(rs2,fprnd))) =
  case round fprnd of
     Option.SOME r => writeFPRD(rd,FP64.add(r,(FPRD rs1,FPRD rs2)))
   | NONE => signalException Illegal_Instr;

fun dfn'FSUB_D (rd,(rs1,(rs2,fprnd))) =
  case round fprnd of
     Option.SOME r => writeFPRD(rd,FP64.sub(r,(FPRD rs1,FPRD rs2)))
   | NONE => signalException Illegal_Instr;

fun dfn'FMUL_D (rd,(rs1,(rs2,fprnd))) =
  case round fprnd of
     Option.SOME r => writeFPRD(rd,FP64.mul(r,(FPRD rs1,FPRD rs2)))
   | NONE => signalException Illegal_Instr;

fun dfn'FDIV_D (rd,(rs1,(rs2,fprnd))) =
  case round fprnd of
     Option.SOME r => writeFPRD(rd,FP64.div(r,(FPRD rs1,FPRD rs2)))
   | NONE => signalException Illegal_Instr;

fun dfn'FSQRT_D (rd,(rs,fprnd)) =
  case round fprnd of
     Option.SOME r => writeFPRD(rd,FP64.sqrt(r,FPRD rs))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FMADD_D (rd,(rs1,(rs2,(rs3,fprnd)))) =
  case round fprnd of
     Option.SOME r =>
       writeFPRD
         (rd,FP64.add(r,(FP64.mul(r,(FPRD rs1,FPRD rs2)),FPRD rs3)))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FMSUB_D (rd,(rs1,(rs2,(rs3,fprnd)))) =
  case round fprnd of
     Option.SOME r =>
       writeFPRD
         (rd,FP64.sub(r,(FP64.mul(r,(FPRD rs1,FPRD rs2)),FPRD rs3)))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FNMADD_D (rd,(rs1,(rs2,(rs3,fprnd)))) =
  case round fprnd of
     Option.SOME r =>
       writeFPRD
         (rd,
          FP64.neg(FP64.add(r,(FP64.mul(r,(FPRD rs1,FPRD rs2)),FPRD rs3))))
   | NONE => signalException Illegal_Instr;
...
fun dfn'FNMSUB_D (rd,(rs1,(rs2,(rs3,fprnd)))) =
  case round fprnd of
     Option.SOME r =>
       writeFPRD
         (rd,
          FP64.neg(FP64.sub(r,(FP64.mul(r,(FPRD rs1,FPRD rs2)),FPRD rs3))))
   | NONE => signalException Illegal_Instr;
