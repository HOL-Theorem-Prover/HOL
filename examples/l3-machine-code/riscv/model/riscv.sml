(* riscv - generated by L3 - Tue May 02 14:09:56 2017 *)
  ...
  case round fprnd of
     Option.SOME r =>
       writeFPRS
         (rd,
          FP32.neg2008
            (FP32.add(r,(FP32.mul(r,(FPRS rs1,FPRS rs2)),FPRS rs3))))
   | NONE => signalException Illegal_Instr;
  ...
  case round fprnd of
     Option.SOME r =>
       writeFPRS
         (rd,
          FP32.neg2008
            (FP32.sub(r,(FP32.mul(r,(FPRS rs1,FPRS rs2)),FPRS rs3))))
   | NONE => signalException Illegal_Instr;
  ...
  case round fprnd of
     Option.SOME r =>
       writeFPRD
         (rd,
          FP64.neg2008
            (FP64.add(r,(FP64.mul(r,(FPRD rs1,FPRD rs2)),FPRD rs3))))
   | NONE => signalException Illegal_Instr;
  ...
  case round fprnd of
     Option.SOME r =>
       writeFPRD
         (rd,
          FP64.neg2008
            (FP64.sub(r,(FP64.mul(r,(FPRD rs1,FPRD rs2)),FPRD rs3))))
   | NONE => signalException Illegal_Instr;
