(* mipsScript.sml - generated by L<3> - Wed Feb 19 11:28:42 2014 *)
...
val _ = Record
  ("StatusRegister",
   [("BEV",bTy),("ERL",bTy),("EXL",bTy),("FR",bTy),("IE",bTy),("IM0",bTy),
    ("IM1",bTy),("KSU",FTy 2),("KX",bTy),("RE",bTy),("SX",bTy),("UX",bTy),
    ("statusregister'rst",FTy 19)])
;
val _ = Record
...
val _ = Record
  ("CauseRegister",
   [("BD",bTy),("ExcCode",FTy 5),("causeregister'rst",FTy 26)])
;
val _ = Record
  ("CP0",
   [("BadVAddr",F64),("Cause",CTy"CauseRegister"),
    ("Config",CTy"ConfigRegister"),("Count",F32),("Debug",F32),
    ("EPC",F64),("ErrCtl",F32),("ErrorEPC",F64),("LLAddr",F64),
    ("PRId",F32),("Status",CTy"StatusRegister")])
;
val _ = Construct
  [("ExceptionType",
...
val _ = Record
  ("mips_state",
   [("BranchStatus",OTy F64),("CP0",CTy"CP0"),("LLbit",OTy bTy),
    ...
    ("exceptionSignalled",bTy),("gpr",ATy(FTy 5,F64)),("hi",OTy F64),
    ("lo",OTy F64)])
;
  ...
  ("rec'StatusRegister",Var("x",F32),
   Rec(CTy"StatusRegister",
       [Bop(Bit,Var("x",F32),LN 22),Bop(Bit,Var("x",F32),LN 2),
        ...
        CC[EX(Var("x",F32),LN 21,LN 10,FTy 12),
...
val reg'StatusRegister_def = Def
  ("reg'StatusRegister",Var("x",CTy"StatusRegister"),
   CS(Var("x",CTy"StatusRegister"),
      [(Rec(CTy"StatusRegister",
            [bVar"BEV",bVar"ERL",bVar"EXL",bVar"FR",bVar"IE",bVar"IM0",
             bVar"IM1",Var("KSU",FTy 2),bVar"KX",bVar"RE",bVar"SX",
             bVar"UX",Var("statusregister'rst",FTy 19)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 4)),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 3)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 2)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 1)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 0)),
                    (EQ(nVar"i",LN 26),bVar"FR"),
                    (EQ(nVar"i",LN 25),bVar"RE"),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 6)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 5)),
                    (EQ(nVar"i",LN 22),bVar"BEV"),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 18)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 17)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 16)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 15)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 14)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 13)),
                    (EQ(nVar"i",LN 15),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 12)),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 11)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 10)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 9)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 8)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("statusregister'rst",FTy 19),LN 7)),
   ...
   Rec(CTy"CauseRegister",
       [Bop(Bit,Var("x",F32),LN 31),EX(Var("x",F32),LN 6,LN 2,FTy 5),
        CC[EX(Var("x",F32),LN 1,LN 0,FTy 2),
           EX(Var("x",F32),LN 30,LN 7,FTy 24)]]))
;
val reg'CauseRegister_def = Def
  ("reg'CauseRegister",Var("x",CTy"CauseRegister"),
   CS(Var("x",CTy"CauseRegister"),
      [(Rec(CTy"CauseRegister",
            [bVar"BD",Var("ExcCode",FTy 5),Var("causeregister'rst",FTy 26)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),bVar"BD"),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 23)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 22)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 21)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 20)),
                    (EQ(nVar"i",LN 26),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 19)),
                    (EQ(nVar"i",LN 25),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 18)),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 17)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 16)),
                    (EQ(nVar"i",LN 22),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 15)),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 14)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 13)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 12)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 11)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 10)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 9)),
                    (EQ(nVar"i",LN 15),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 8)),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 7)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 6)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 5)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 4)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 3)),
                    (EQ(nVar"i",LN 9),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 2)),
                    (EQ(nVar"i",LN 8),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 1)),
                    (EQ(nVar"i",LN 7),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 0)),
                    ...
                    (EQ(nVar"i",LN 1),
                     Bop(Bit,Var("causeregister'rst",FTy 26),LN 25))],
                   Bop(Bit,Var("causeregister'rst",FTy 26),LN 24))),
            LW(0,32)))]))
;
     ...
     (qVar"state",
      Let(qVar"s",
          ITE(Mop(Not,
              ...
              ITE(Mop(IsSome,Dest("BranchStatus",OTy F64,qVar"state")),
                  Let(qVar"s",
                      Rupd
                        ("CP0",
                         TP[qVar"state",
       ...
       Mop(Snd,
           Apply
             (Call
              ...
              Rupd
                ("exceptionSignalled",
                 TP[Rupd("BranchStatus",TP[qVar"state",LO F64]),LF]))),
       Let(qVar"s",
