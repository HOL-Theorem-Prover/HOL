(* mipsScript.sml - generated by L<3> - Fri Jan 24 15:37:46 2014 *)
...
val _ = Record
  ("mips_state",
   [("BranchStatus",OTy F64),("CP0",CTy"CP0"),("LLbit",OTy bTy),
          ...
          Let(TP[Var("v",F64),qVar"s"],
              Let(TP[Var("v0",F64),qVar"s"],
                  ...
                  TP[CC[EX(Var("v",F64),LN 31,LN 0,F32),
                        Bop(Add,EX(Var("v0",F64),LN 31,LN 0,F32),
                            Bop(Mul,
                                Mop(SE F32,
                                    EX(Mop(Fst,
                                           Apply
      ...
      Let(TP[Var("v",F64),qVar"s"],
          ...
          Let(TP[Var("v",F64),qVar"s"],
              Let(TP[Var("v0",F64),qVar"s"],
                  Apply(Const("LO",ATy(qTy,PTy(F64,qTy))),qVar"s"),
                  TP[CC[EX(Var("v",F64),LN 31,LN 0,F32),
                        Bop(Sub,EX(Var("v0",F64),LN 31,LN 0,F32),
                            Bop(Mul,
                                Mop(SE F32,
                                    EX(Mop(Fst,
                                           Apply
               ...
               Mop(Some,
                   Bop(Sub,
                       CC[EX(Dest("PC",F64,qVar"state"),LN 63,LN 28,FTy 36),
                          Var("instr_index",FTy 26),LW(0,2)],LW(4,64)))])]))
;
val dfn'JAL_def = Def
                   ...
                   Bop(Sub,
                       Mop(Fst,
                           Apply
                             (Call
                                ("GPR",ATy(qTy,PTy(F64,qTy)),
                                 Var("rs",FTy 5)),qVar"state")),LW(4,64)))])]))
;
     ...
     (qVar"state",
      CS(Var("v0",CTy"instruction"),
         [(Const("BREAK",CTy"instruction"),
          ...
          (Call("SYNC",CTy"instruction",Var("v127",FTy 5)),
           TP[Call("dfn'SYNC",uTy,Var("v127",FTy 5)),qVar"state"]),
