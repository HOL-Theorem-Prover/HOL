(* mipsScript.sml - generated by L<3> - Tue Apr 29 15:06:34 2014 *)
open HolKernel boolLib bossLib Import

val () = Import.start "mips"

val _ = Record ("Index",[("Index",FTy 6),("P",bTy),("index'rst",FTy 25)])
;
val _ = Record ("Random",[("Random",FTy 6),("random'rst",FTy 26)])
;
val _ = Record ("Wired",[("Wired",FTy 6),("wired'rst",FTy 26)])
;
val _ = Record
  ("EntryLo",
...
val _ = Record
  ("ConfigRegister",
   [("BE",bTy),("K0",FTy 3),("MT",FTy 3),("configregister'rst",FTy 25)])
;
val _ = Record
  ("CauseRegister",
...
;
val _ = Record
  ("XContext",[("BadVPN2",FTy 27),("R",FTy 2),("xcontext'rst",FTy 35)])
;
val _ = Record
  ("CP0",
   [("BadVAddr",F64),("Cause",CTy"CauseRegister"),("Compare",F32),
    ("Config",CTy"ConfigRegister"),("Count",F32),("Debug",F32),
    ("EPC",F64),("EntryHi",CTy"EntryHi"),("EntryLo0",CTy"EntryLo"),
    ("EntryLo1",CTy"EntryLo"),("ErrCtl",F32),("ErrorEPC",F64),
    ("Index",CTy"Index"),("LLAddr",F64),("PRId",F32),
    ("PageMask",CTy"PageMask"),("Random",CTy"Random"),
    ("Status",CTy"StatusRegister"),("Wired",CTy"Wired"),
...
val _ = Construct
  [("instruction",
    [("ArithI",[CTy"ArithI"]),("ArithR",[CTy"ArithR"]),("BREAK",[]),
     ...
     ("MultDiv",[CTy"MultDiv"]),("ReservedInstruction",[]),
...
val _ = Record
  ("mips_state",
   [("BranchDelay",OTy F64),("BranchTo",OTy F64),("CP0",CTy"CP0"),
    ("LLbit",OTy bTy),("MEM",ATy(F64,F8)),("PC",F64),
  ...
  ("rec'Index",Var("x",F32),
   Rec(CTy"Index",
       [EX(Var("x",F32),LN 5,LN 0,FTy 6),Bop(Bit,Var("x",F32),LN 31),
        EX(Var("x",F32),LN 30,LN 6,FTy 25)]))
;
val reg'Index_def = Def
  ("reg'Index",Var("x",CTy"Index"),
   CS(Var("x",CTy"Index"),
      [(Rec(CTy"Index",
            [Var("Index",FTy 6),bVar"P",Var("index'rst",FTy 25)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),bVar"P"),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("index'rst",FTy 25),LN 24)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("index'rst",FTy 25),LN 23)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("index'rst",FTy 25),LN 22)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("index'rst",FTy 25),LN 21)),
                    (EQ(nVar"i",LN 26),
                     Bop(Bit,Var("index'rst",FTy 25),LN 20)),
                    (EQ(nVar"i",LN 25),
                     Bop(Bit,Var("index'rst",FTy 25),LN 19)),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("index'rst",FTy 25),LN 18)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("index'rst",FTy 25),LN 17)),
                    (EQ(nVar"i",LN 22),
                     Bop(Bit,Var("index'rst",FTy 25),LN 16)),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("index'rst",FTy 25),LN 15)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("index'rst",FTy 25),LN 14)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("index'rst",FTy 25),LN 13)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("index'rst",FTy 25),LN 12)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("index'rst",FTy 25),LN 11)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("index'rst",FTy 25),LN 10)),
                    (EQ(nVar"i",LN 15),
                     Bop(Bit,Var("index'rst",FTy 25),LN 9)),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("index'rst",FTy 25),LN 8)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("index'rst",FTy 25),LN 7)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("index'rst",FTy 25),LN 6)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("index'rst",FTy 25),LN 5)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("index'rst",FTy 25),LN 4)),
                    (EQ(nVar"i",LN 9),
                     Bop(Bit,Var("index'rst",FTy 25),LN 3)),
                    (EQ(nVar"i",LN 8),
                     Bop(Bit,Var("index'rst",FTy 25),LN 2)),
                    (EQ(nVar"i",LN 7),
                     Bop(Bit,Var("index'rst",FTy 25),LN 1)),
                    (EQ(nVar"i",LN 6),
                     Bop(Bit,Var("index'rst",FTy 25),LN 0)),
                    (EQ(nVar"i",LN 5),Bop(Bit,Var("Index",FTy 6),LN 5)),
                    (EQ(nVar"i",LN 4),Bop(Bit,Var("Index",FTy 6),LN 4)),
                    (EQ(nVar"i",LN 3),Bop(Bit,Var("Index",FTy 6),LN 3)),
                    (EQ(nVar"i",LN 2),Bop(Bit,Var("Index",FTy 6),LN 2)),
                    (EQ(nVar"i",LN 1),Bop(Bit,Var("Index",FTy 6),LN 1))],
                   Bop(Bit,Var("Index",FTy 6),LN 0))),LW(0,32)))]))
;
...
val rec'Random_def = Def
  ("rec'Random",Var("x",F32),
   Rec(CTy"Random",
       [EX(Var("x",F32),LN 5,LN 0,FTy 6),
        EX(Var("x",F32),LN 31,LN 6,FTy 26)]))
;
val reg'Random_def = Def
  ("reg'Random",Var("x",CTy"Random"),
   CS(Var("x",CTy"Random"),
      [(Rec(CTy"Random",[Var("Random",FTy 6),Var("random'rst",FTy 26)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),
                     Bop(Bit,Var("random'rst",FTy 26),LN 25)),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("random'rst",FTy 26),LN 24)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("random'rst",FTy 26),LN 23)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("random'rst",FTy 26),LN 22)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("random'rst",FTy 26),LN 21)),
                    (EQ(nVar"i",LN 26),
                     Bop(Bit,Var("random'rst",FTy 26),LN 20)),
                    (EQ(nVar"i",LN 25),
                     Bop(Bit,Var("random'rst",FTy 26),LN 19)),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("random'rst",FTy 26),LN 18)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("random'rst",FTy 26),LN 17)),
                    (EQ(nVar"i",LN 22),
                     Bop(Bit,Var("random'rst",FTy 26),LN 16)),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("random'rst",FTy 26),LN 15)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("random'rst",FTy 26),LN 14)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("random'rst",FTy 26),LN 13)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("random'rst",FTy 26),LN 12)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("random'rst",FTy 26),LN 11)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("random'rst",FTy 26),LN 10)),
                    (EQ(nVar"i",LN 15),
                     Bop(Bit,Var("random'rst",FTy 26),LN 9)),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("random'rst",FTy 26),LN 8)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("random'rst",FTy 26),LN 7)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("random'rst",FTy 26),LN 6)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("random'rst",FTy 26),LN 5)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("random'rst",FTy 26),LN 4)),
                    (EQ(nVar"i",LN 9),
                     Bop(Bit,Var("random'rst",FTy 26),LN 3)),
                    (EQ(nVar"i",LN 8),
                     Bop(Bit,Var("random'rst",FTy 26),LN 2)),
                    (EQ(nVar"i",LN 7),
                     Bop(Bit,Var("random'rst",FTy 26),LN 1)),
                    (EQ(nVar"i",LN 6),
                     Bop(Bit,Var("random'rst",FTy 26),LN 0)),
                    (EQ(nVar"i",LN 5),Bop(Bit,Var("Random",FTy 6),LN 5)),
                    (EQ(nVar"i",LN 4),Bop(Bit,Var("Random",FTy 6),LN 4)),
                    (EQ(nVar"i",LN 3),Bop(Bit,Var("Random",FTy 6),LN 3)),
                    (EQ(nVar"i",LN 2),Bop(Bit,Var("Random",FTy 6),LN 2)),
                    (EQ(nVar"i",LN 1),Bop(Bit,Var("Random",FTy 6),LN 1))],
                   Bop(Bit,Var("Random",FTy 6),LN 0))),LW(0,32)))]))
;
...
val reg'Wired_def = Def
  ("reg'Wired",Var("x",CTy"Wired"),
   CS(Var("x",CTy"Wired"),
      [(Rec(CTy"Wired",[Var("Wired",FTy 6),Var("wired'rst",FTy 26)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 25)),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 24)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 23)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 22)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 21)),
                    (EQ(nVar"i",LN 26),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 20)),
                    (EQ(nVar"i",LN 25),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 19)),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 18)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 17)),
                    (EQ(nVar"i",LN 22),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 16)),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 15)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 14)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 13)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 12)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 11)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 10)),
                    (EQ(nVar"i",LN 15),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 9)),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 8)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 7)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 6)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 5)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 4)),
                    (EQ(nVar"i",LN 9),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 3)),
                    (EQ(nVar"i",LN 8),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 2)),
                    (EQ(nVar"i",LN 7),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 1)),
                    (EQ(nVar"i",LN 6),
                     Bop(Bit,Var("wired'rst",FTy 26),LN 0)),
                    (EQ(nVar"i",LN 5),Bop(Bit,Var("Wired",FTy 6),LN 5)),
                    (EQ(nVar"i",LN 4),Bop(Bit,Var("Wired",FTy 6),LN 4)),
                    (EQ(nVar"i",LN 3),Bop(Bit,Var("Wired",FTy 6),LN 3)),
                    (EQ(nVar"i",LN 2),Bop(Bit,Var("Wired",FTy 6),LN 2)),
                    (EQ(nVar"i",LN 1),Bop(Bit,Var("Wired",FTy 6),LN 1))],
                   Bop(Bit,Var("Wired",FTy 6),LN 0))),LW(0,32)))]))
;
...
val rec'ConfigRegister_def = Def
  ("rec'ConfigRegister",Var("x",F32),
   Rec(CTy"ConfigRegister",
       [Bop(Bit,Var("x",F32),LN 15),EX(Var("x",F32),LN 2,LN 0,FTy 3),
        EX(Var("x",F32),LN 9,LN 7,FTy 3),
        CC[EX(Var("x",F32),LN 6,LN 3,F4),
           EX(Var("x",F32),LN 14,LN 10,FTy 5),
...
val reg'ConfigRegister_def = Def
  ("reg'ConfigRegister",Var("x",CTy"ConfigRegister"),
   CS(Var("x",CTy"ConfigRegister"),
      [(Rec(CTy"ConfigRegister",
            [bVar"BE",Var("K0",FTy 3),Var("MT",FTy 3),
             Var("configregister'rst",FTy 25)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 15)),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 14)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 13)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 12)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 11)),
                    (EQ(nVar"i",LN 26),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 10)),
                    (EQ(nVar"i",LN 25),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 9)),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 8)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 7)),
                    (EQ(nVar"i",LN 22),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 6)),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 5)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 4)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 3)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 2)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 1)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 0)),
                    (EQ(nVar"i",LN 15),bVar"BE"),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 20)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 19)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 18)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 17)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 16)),
                    (EQ(nVar"i",LN 9),Bop(Bit,Var("MT",FTy 3),LN 2)),
                    (EQ(nVar"i",LN 8),Bop(Bit,Var("MT",FTy 3),LN 1)),
                    (EQ(nVar"i",LN 7),Bop(Bit,Var("MT",FTy 3),LN 0)),
                    (EQ(nVar"i",LN 6),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 24)),
                    (EQ(nVar"i",LN 5),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 23)),
                    (EQ(nVar"i",LN 4),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 22)),
                    (EQ(nVar"i",LN 3),
                     Bop(Bit,Var("configregister'rst",FTy 25),LN 21)),
  ...
  ("rec'XContext",Var("x",F64),
   Rec(CTy"XContext",
       [EX(Var("x",F64),LN 30,LN 4,FTy 27),
        EX(Var("x",F64),LN 32,LN 31,FTy 2),
        CC[EX(Var("x",F64),LN 3,LN 0,F4),
...
val reg'XContext_def = Def
  ("reg'XContext",Var("x",CTy"XContext"),
   CS(Var("x",CTy"XContext"),
      [(Rec(CTy"XContext",
            [Var("BadVPN2",FTy 27),Var("R",FTy 2),
             Var("xcontext'rst",FTy 35)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 63),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 30)),
                    (EQ(nVar"i",LN 62),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 29)),
                    (EQ(nVar"i",LN 61),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 28)),
                    (EQ(nVar"i",LN 60),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 27)),
                    (EQ(nVar"i",LN 59),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 26)),
                    (EQ(nVar"i",LN 58),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 25)),
                    (EQ(nVar"i",LN 57),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 24)),
                    (EQ(nVar"i",LN 56),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 23)),
                    (EQ(nVar"i",LN 55),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 22)),
                    (EQ(nVar"i",LN 54),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 21)),
                    (EQ(nVar"i",LN 53),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 20)),
                    (EQ(nVar"i",LN 52),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 19)),
                    (EQ(nVar"i",LN 51),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 18)),
                    (EQ(nVar"i",LN 50),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 17)),
                    (EQ(nVar"i",LN 49),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 16)),
                    (EQ(nVar"i",LN 48),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 15)),
                    (EQ(nVar"i",LN 47),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 14)),
                    (EQ(nVar"i",LN 46),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 13)),
                    (EQ(nVar"i",LN 45),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 12)),
                    (EQ(nVar"i",LN 44),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 11)),
                    (EQ(nVar"i",LN 43),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 10)),
                    (EQ(nVar"i",LN 42),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 9)),
                    (EQ(nVar"i",LN 41),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 8)),
                    (EQ(nVar"i",LN 40),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 7)),
                    (EQ(nVar"i",LN 39),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 6)),
                    (EQ(nVar"i",LN 38),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 5)),
                    (EQ(nVar"i",LN 37),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 4)),
                    (EQ(nVar"i",LN 36),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 3)),
                    (EQ(nVar"i",LN 35),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 2)),
                    (EQ(nVar"i",LN 34),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 1)),
                    (EQ(nVar"i",LN 33),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 0)),
                    ...
                    (EQ(nVar"i",LN 3),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 34)),
                    (EQ(nVar"i",LN 2),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 33)),
                    (EQ(nVar"i",LN 1),
                     Bop(Bit,Var("xcontext'rst",FTy 35),LN 32))],
                   Bop(Bit,Var("xcontext'rst",FTy 35),LN 31))),LW(0,64)))]))
;
...
val ExceptionCode_def = Def
  ("ExceptionCode",Var("ExceptionType",CTy"ExceptionType"),
   Close
     (qVar"state",
      TP[LU,
         ITE(Bop(Lt,Mop(Cast nTy,Var("ExceptionType",CTy"ExceptionType")),
                 LN 12),
             Rupd
               ("CP0",
                TP[qVar"state",
                            ...
                            TP[Dest
                               ...
                               CS(Var("ExceptionType",CTy"ExceptionType"),
                                  [(LC("Int",CTy"ExceptionType"),LW(0,5)),
                                   ...
                                   (AVar(CTy"ExceptionType"),LX(FTy 5))])])])]),
             qVar"state")]))
;
                    ...
                    ("EXL",bTy,
                     Dest
                       ("Status",CTy"StatusRegister",
                        Dest("CP0",CTy"CP0",qVar"state")))),
              ITE(Mop(IsSome,Dest("BranchDelay",OTy F64,qVar"state")),
                  Let(qVar"s",
                      Rupd
                        ("CP0",
                         TP[qVar"state",
     ...
     (qVar"state",
      CS(Var("v0",CTy"instruction"),
         [(Const("BREAK",CTy"instruction"),
          ...
          (Call("SYNC",CTy"instruction",Var("v128",FTy 5)),
           TP[Call("dfn'SYNC",uTy,Var("v128",FTy 5)),qVar"state"]),
   ...
   Let(TP[Var("v",OTy F32),qVar"s"],
       ...
       Let(qVar"s",
           ...
           Let(qVar"s",
               Rupd
                 ("exceptionSignalled",
                  TP[CS(TP[Dest("BranchDelay",OTy F64,qVar"s"),
                           Dest("BranchTo",OTy F64,qVar"s")],
                        [(TP[LO F64,LO F64],
                          ITE(Mop(Not,
                                  Dest("exceptionSignalled",bTy,qVar"s")),
                              Rupd
                                ("PC",
                                 TP[qVar"s",
                         ...
                         (TP[Mop(Some,Var("addr",F64)),LO F64],
                          Rupd
                            ("PC",
                             TP[Rupd("BranchDelay",TP[qVar"s",LO F64]),
                                Var("addr",F64)])),
