(* mipsScript.sml - generated by L<3> - Tue Nov 26 11:03:37 2013 *)
...
val _ = Record
  ("StatusRegister",
   [("BEV",bTy),("ERL",bTy),("EXL",bTy),("IE",bTy),("IM0",bTy),
    ("IM1",bTy),("KSU",FTy 2),("RE",bTy),("statusregister'rst",FTy 23)])
;
val _ = Record
  ("ConfigRegister",[("BE",bTy),("configregister'rst",FTy 31)])
;
val _ = Record
  ("CauseRegister",[("ExcCode",FTy 5),("causeregister'rst",FTy 27)])
;
val _ = Record
  ("CP0",
   [("Cause",CTy"CauseRegister"),("Config",CTy"ConfigRegister"),
    ("Count",F32),("Debug",F32),("EPC",F64),("ErrCtl",F32),
    ("ErrorEPC",F64),("Status",CTy"StatusRegister")])
;
val _ = Construct
  ...
  ("rec'StatusRegister",Var("x",F32),
   Rec(CTy"StatusRegister",
       [Bop(Bit,Var("x",F32),LN 22),Bop(Bit,Var("x",F32),LN 2),
        ...
        EX(Var("x",F32),LN 4,LN 3,FTy 2),Bop(Bit,Var("x",F32),LN 26),
...
val reg'StatusRegister_def = Def
  ("reg'StatusRegister",Var("x",CTy"StatusRegister"),
   CS(Var("x",CTy"StatusRegister"),
      [(Rec(CTy"StatusRegister",
            [bVar"BEV",bVar"ERL",bVar"EXL",bVar"IE",bVar"IM0",bVar"IM1",
             Var("KSU",FTy 2),bVar"RE",Var("statusregister'rst",FTy 23)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 4)),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 3)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 2)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 1)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 0)),
                    (EQ(nVar"i",LN 26),bVar"RE"),
                    (EQ(nVar"i",LN 25),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 7)),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 6)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 5)),
                    (EQ(nVar"i",LN 22),bVar"BEV"),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 19)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 18)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 17)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 16)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 15)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 14)),
                    (EQ(nVar"i",LN 15),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 13)),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 12)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 11)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 10)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 9)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 8)),
                    (EQ(nVar"i",LN 9),bVar"IM1"),
                    (EQ(nVar"i",LN 8),bVar"IM0"),
                    (EQ(nVar"i",LN 7),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 22)),
                    (EQ(nVar"i",LN 6),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 21)),
                    (EQ(nVar"i",LN 5),
                     Bop(Bit,Var("statusregister'rst",FTy 23),LN 20)),
...
val reg'ConfigRegister_def = Def
  ("reg'ConfigRegister",Var("x",CTy"ConfigRegister"),
   CS(Var("x",CTy"ConfigRegister"),
      [(Rec(CTy"ConfigRegister",
            [bVar"BE",Var("configregister'rst",FTy 31)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 15)),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 14)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 13)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 12)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 11)),
                    (EQ(nVar"i",LN 26),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 10)),
                    (EQ(nVar"i",LN 25),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 9)),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 8)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 7)),
                    (EQ(nVar"i",LN 22),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 6)),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 5)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 4)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 3)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 2)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 1)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 0)),
                    (EQ(nVar"i",LN 15),bVar"BE"),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 30)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 29)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 28)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 27)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 26)),
                    (EQ(nVar"i",LN 9),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 25)),
                    (EQ(nVar"i",LN 8),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 24)),
                    (EQ(nVar"i",LN 7),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 23)),
                    (EQ(nVar"i",LN 6),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 22)),
                    (EQ(nVar"i",LN 5),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 21)),
                    (EQ(nVar"i",LN 4),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 20)),
                    (EQ(nVar"i",LN 3),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 19)),
                    (EQ(nVar"i",LN 2),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 18)),
                    (EQ(nVar"i",LN 1),
                     Bop(Bit,Var("configregister'rst",FTy 31),LN 17))],
                   Bop(Bit,Var("configregister'rst",FTy 31),LN 16))),
            LW(0,32)))]))
;
...
val reg'CauseRegister_def = Def
  ("reg'CauseRegister",Var("x",CTy"CauseRegister"),
   CS(Var("x",CTy"CauseRegister"),
      [(Rec(CTy"CauseRegister",
            [Var("ExcCode",FTy 5),Var("causeregister'rst",FTy 27)]),
        Bop(Mdfy,
            Close
              (TP[nVar"i",AVar bTy],
               ITB([(EQ(nVar"i",LN 31),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 24)),
                    (EQ(nVar"i",LN 30),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 23)),
                    (EQ(nVar"i",LN 29),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 22)),
                    (EQ(nVar"i",LN 28),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 21)),
                    (EQ(nVar"i",LN 27),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 20)),
                    (EQ(nVar"i",LN 26),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 19)),
                    (EQ(nVar"i",LN 25),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 18)),
                    (EQ(nVar"i",LN 24),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 17)),
                    (EQ(nVar"i",LN 23),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 16)),
                    (EQ(nVar"i",LN 22),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 15)),
                    (EQ(nVar"i",LN 21),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 14)),
                    (EQ(nVar"i",LN 20),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 13)),
                    (EQ(nVar"i",LN 19),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 12)),
                    (EQ(nVar"i",LN 18),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 11)),
                    (EQ(nVar"i",LN 17),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 10)),
                    (EQ(nVar"i",LN 16),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 9)),
                    (EQ(nVar"i",LN 15),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 8)),
                    (EQ(nVar"i",LN 14),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 7)),
                    (EQ(nVar"i",LN 13),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 6)),
                    (EQ(nVar"i",LN 12),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 5)),
                    (EQ(nVar"i",LN 11),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 4)),
                    (EQ(nVar"i",LN 10),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 3)),
                    (EQ(nVar"i",LN 9),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 2)),
                    (EQ(nVar"i",LN 8),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 1)),
                    (EQ(nVar"i",LN 7),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 0)),
                    ...
                    (EQ(nVar"i",LN 1),
                     Bop(Bit,Var("causeregister'rst",FTy 27),LN 26))],
                   Bop(Bit,Var("causeregister'rst",FTy 27),LN 25))),
            LW(0,32)))]))
;
...
val dfn'MFHI_def = Def
  ("dfn'MFHI",Var("rd",FTy 5),
   Close
     (qVar"state",
      Let(qVar"s",
          ITE(EQ(Dest("HLStatus",CTy"HLStatus",qVar"state"),
          ...
          Let(qVar"s",
              ITE(EQ(Dest("HLStatus",CTy"HLStatus",qVar"s"),
                     LC("HLarith",CTy"HLStatus")),
...
val dfn'MTHI_def = Def
  ("dfn'MTHI",Var("rs",FTy 5),
   Close
     (qVar"state",
      Let(qVar"s",
          ITB([(EQ(Dest("HLStatus",CTy"HLStatus",qVar"state"),
                   LC("HLarith",CTy"HLStatus")),
                Rupd
                  ("HLStatus",TP[qVar"state",LC("HLmthi",CTy"HLStatus")])),
     ...
     (qVar"state",
      Let(qVar"s",
          ITB([(EQ(Dest("HLStatus",CTy"HLStatus",qVar"state"),
                   LC("HLarith",CTy"HLStatus")),
                Rupd
                  ("HLStatus",TP[qVar"state",LC("HLmtlo",CTy"HLStatus")])),
               (EQ(Dest("HLStatus",CTy"HLStatus",qVar"state"),
                   LC("HLmthi",CTy"HLStatus")),
                Rupd("HLStatus",TP[qVar"state",LC("HLok",CTy"HLStatus")]))],
              qVar"state"),
          ...
          (Call("ArithR",CTy"instruction",Var("v12",CTy"ArithR")),
           CS(Var("v12",CTy"ArithR"),
              [(Call
               ...
               (Call
                  ("OR",CTy"ArithR",Var("v21",PTy(FTy 5,PTy(FTy 5,FTy 5)))),
                Apply
                  (Call
          ...
          (Call("Branch",CTy"instruction",Var("v27",CTy"Branch")),
           CS(Var("v27",CTy"Branch"),
              [(Call
               ...
               (Call
                  ("BEQL",CTy"Branch",Var("v29",PTy(FTy 5,PTy(FTy 5,F16)))),
                Apply
                  (Call
               ...
               (Call
                  ("BNEL",CTy"Branch",Var("v43",PTy(FTy 5,PTy(FTy 5,F16)))),
                Apply
                  (Call
          ...
          (Call("Shift",CTy"instruction",Var("v80",CTy"Shift")),
           CS(Var("v80",CTy"Shift"),
              [(Call
               ...
               (Call
                  ("SLL",CTy"Shift",Var("v90",PTy(FTy 5,PTy(FTy 5,FTy 5)))),
                Apply
                  (Call
               ...
               (Call
                  ("SRA",CTy"Shift",Var("v92",PTy(FTy 5,PTy(FTy 5,FTy 5)))),
                Apply
                  (Call
               ...
               (Call
                  ("SRL",CTy"Shift",Var("v94",PTy(FTy 5,PTy(FTy 5,FTy 5)))),
                Apply
                  (Call
...
val Decode_def = Def
  ("Decode",Var("w",F32),
   Let(TP[bVar"b'31",bVar"b'30",bVar"b'29",bVar"b'28",bVar"b'27",
       ...
       BL(32,Var("w",F32)),
       ITB([(bVar"b'28",
             ITE(Bop(And,Mop(Not,bVar"b'31"),bVar"b'27"),
                         ...
                         Let(Var("rt",FTy 5),
                             ...
                             Let(Var("rs",FTy 5),
                                 Mop(Cast(FTy 5),
                                     LL[bVar"b'25",bVar"b'24",bVar"b'23",
                                        bVar"b'22",bVar"b'21"]),
                                 Let(TP[bVar"b'5",bVar"b'4",bVar"b'3",
                                        bVar"b'2",bVar"b'1",bVar"b'0"],
                                     BL(6,
                                        Mop(Cast(FTy 6),
                                            LL[bVar"b'31",bVar"b'30",
                                               bVar"b'29",bVar"b'28",
                                               bVar"b'27",bVar"b'26"])),
                                     ITB([(bVar"b'2",
                                           ITB([(bVar"b'3",
                             ...
                             Let(TP[bVar"b'5",bVar"b'4",bVar"b'3",
                                 ...
                                 ITB([(bVar"b'2",
                                     ...
                                     Const
                                       ("ReservedInstruction",
                                        CTy"instruction")))))))),
            (Bop(And,Mop(Not,bVar"b'31"),Mop(Not,bVar"b'29")),
             ITB([(Bop(And,Mop(Not,bVar"b'30"),
                       Bop(And,Mop(Not,bVar"b'27"),Mop(Not,bVar"b'26"))),
                   Let(TP[bVar"b'25",bVar"b'24",bVar"b'23",bVar"b'22",
                   ...
                   Let(Var("immediate",F16),
                       ...
                       Let(Var("rs",FTy 5),
                           Mop(Cast(FTy 5),
                               LL[bVar"b'25",bVar"b'24",bVar"b'23",
                                  bVar"b'22",bVar"b'21"]),
                           Let(TP[bVar"b'4",bVar"b'3",bVar"b'2",bVar"b'1",
                                  bVar"b'0"],
                               BL(5,
                                  Mop(Cast(FTy 5),
                                      LL[bVar"b'20",bVar"b'19",bVar"b'18",
                                                   ...
                                                   Bop(And,
                                                       ...
                                                       Bop(And,
                                                           ...
                                                           Mop(Not,
                                                               bVar"b'3"))))))))))),
                   Let(Var("sel",FTy 3),
                       Mop(Cast(FTy 3),LL[bVar"b'2",bVar"b'1",bVar"b'0"]),
                       Let(Var("rd",FTy 5),
                           Mop(Cast(FTy 5),
                               LL[bVar"b'15",bVar"b'14",bVar"b'13",
                                  bVar"b'12",bVar"b'11"]),
                           Let(Var("rt",FTy 5),
                               Mop(Cast(FTy 5),
                                   LL[bVar"b'20",bVar"b'19",bVar"b'18",
                                      bVar"b'17",bVar"b'16"]),
                               Let(TP[bVar"b'4",bVar"b'3",bVar"b'2",
                                      bVar"b'1",bVar"b'0"],
                                   BL(5,
                                      Mop(Cast(FTy 5),
                                          LL[bVar"b'25",bVar"b'24",
                   ...
                   Let(Var("rs",FTy 5),
                       Mop(Cast(FTy 5),
                           LL[bVar"b'25",bVar"b'24",bVar"b'23",bVar"b'22",
                              bVar"b'21"]),
                       Let(TP[bVar"b'5",bVar"b'4",bVar"b'3",bVar"b'2",
                              bVar"b'1",bVar"b'0"],
                           BL(6,
                              Mop(Cast(FTy 6),
           ...
           CS(Dest("BranchStatus",OTy F64,qVar"state"),
              [(Mop(Some,Var("addr",F64)),
                ITE(Mop(IsSome,Dest("BranchStatus",OTy F64,qVar"s")),
                    ...
                    Rupd("PC",TP[qVar"s",Var("addr",F64)]))),
               (LO F64,qVar"s")]),
           Let(qVar"s",
               Rupd
                 ("PC",
