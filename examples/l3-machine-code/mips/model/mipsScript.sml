(* mipsScript.sml - generated by L3 - Wed May 03 11:40:06 2017 *)
...
val _ = Construct
  [("COP1",
    [("ABS_D",[PTy(FTy 5,FTy 5)]),("ABS_S",[PTy(FTy 5,FTy 5)]),
     ...
     ("C_fmt_D",[PTy(FTy 5,PTy(FTy 5,FTy 3))]),
     ("C_fmt_S",[PTy(FTy 5,PTy(FTy 5,FTy 3))]),
            ...
            (Call
               ("ConditionalBranchLikely",ATy(qTy,qTy),
                TP[Bop(Bit,
                       ...
                       LN 0),Var("i",F16)]),qVar"state"))))
;
val dfn'C_fmt_D_def = Def
  ("dfn'C_fmt_D",TP[Var("fs",FTy 5),Var("ft",FTy 5),Var("cnd",FTy 3)],
   Close
     (qVar"state",
      ITE(Mop(Not,
              Dest
              ...
              Let(TP[Var("v",PTy(CTy"FCSR",F8)),qVar"s"],
                  Let(TP[bVar"v0",qVar"s0"],
                      ...
                      TP[TP[Dest("fcsr",CTy"FCSR",qVar"state"),
                            BFI(LN 0,LN 0,Mop(Cast F1,bVar"v0"),
                                Dest
                                  ("FCC",F8,
...
;
val dfn'C_fmt_S_def = Def
  ("dfn'C_fmt_S",TP[Var("fs",FTy 5),Var("ft",FTy 5),Var("cnd",FTy 3)],
   Close
     (qVar"state",
      ITE(Mop(Not,
              Dest
          ...
          (Call("COP1",CTy"instruction",Var("v50",CTy"COP1")),
           CS(Var("v50",CTy"COP1"),
              [(Const("UnknownFPInstruction",CTy"COP1"),
               ...
               (Call
                  ("C_fmt_D",CTy"COP1",
                   Var("v75",PTy(FTy 5,PTy(FTy 5,FTy 3)))),
                Apply
                  (Call
                     ("dfn'C_fmt_D",ATy(qTy,qTy),
                      Var("v75",PTy(FTy 5,PTy(FTy 5,FTy 3)))),qVar"state")),
               (Call
                  ("C_fmt_S",CTy"COP1",
                   Var("v76",PTy(FTy 5,PTy(FTy 5,FTy 3)))),
                Apply
                  (Call
                     ("dfn'C_fmt_S",ATy(qTy,qTy),
                      Var("v76",PTy(FTy 5,PTy(FTy 5,FTy 3)))),qVar"state")),
               (Call
                  ("DIV_D",CTy"COP1",
  ...
  ("COP1Encode",Var("j",CTy"COP1"),
   CS(Var("j",CTy"COP1"),
      [(Call("MFC1",CTy"COP1",TP[Var("rt",FTy 5),Var("fs",FTy 5)]),
       ...
       (Call
          ("C_fmt_S",CTy"COP1",
           TP[Var("fs",FTy 5),Var("ft",FTy 5),Var("c",FTy 3)]),
        CC[LW(560,11),Var("ft",FTy 5),Var("fs",FTy 5),LW(6,8),
           Var("c",FTy 3)]),
       (Call
          ("ADD_D",CTy"COP1",
           TP[Var("fd",FTy 5),Var("fs",FTy 5),Var("ft",FTy 5)]),
       ...
       (Call
          ("C_fmt_D",CTy"COP1",
           TP[Var("fs",FTy 5),Var("ft",FTy 5),Var("c",FTy 3)]),
        CC[LW(561,11),Var("ft",FTy 5),Var("fs",FTy 5),LW(6,8),
           Var("c",FTy 3)]),
