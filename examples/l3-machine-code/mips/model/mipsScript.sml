(* mipsScript.sml - generated by L<3> - Wed Sep 17 11:16:47 2014 *)
...
val dfn'ERET_def = Def
  ("dfn'ERET",qVar"state",
   Let(qVar"s",
       Mop(Snd,
           Apply(Const("CheckBranch",ATy(qTy,PTy(uTy,qTy))),qVar"state")),
       ITE(Bop(Or,
               Dest
                 ("CU0",bTy,
                  Dest
               ...
               Mop(Fst,
                   Apply
                     (Const("KernelMode",ATy(qTy,PTy(bTy,qTy))),qVar"s"))),
           TP[LU,
              Rupd
                ("LLbit",
                 TP[ITE(Dest
                    ...
                    TP[qVar"s",
                       Mop(Some,
                           Bop(Add,
                               ...
                               Bop(Lsl,Mop(SE F64,Var("offset",F16)),LN 2)))])],
              Apply(Const("CheckBranch",ATy(qTy,PTy(uTy,qTy))),qVar"s")))))
;
     ...
     (qVar"state",
      ITE(EQ(Mop(Fst,
          ...
          Let(qVar"s",
              Mop(Snd,
                  Apply
                    (Const("CheckBranch",ATy(qTy,PTy(uTy,qTy))),
                     qVar"state")),
              TP[LU,
                 Rupd
                   ("PC",
