(* mipsScript.sml - generated by L<3> - Fri Jun 21 13:50:38 2013 *)

open HolKernel boolLib bossLib Import

val () = Import.start "mips"

val _ = Record("StatusRegister",
...
val _ = Construct[("HLStatus",
    [("HLarith",[]), ("HLok",[]), ("HLmthi",[]), ("HLmtlo",[])])]
;
...
val _ = Construct[("ExceptionType",
    [("AdEL",[]), ("AdES",[]), ("Sys",[]), ("Bp",[]), ("RI",[]),
     ("Ov",[]), ("Tr",[])])]
;

val _ = Construct[("Branch",
    [("BEQ",[PTy(FTy 5,PTy(FTy 5,F16))]),
     ...
     ("BNEL",[PTy(FTy 5,PTy(FTy 5,F16))]), ("J",[FTy 26]),
     ("JAL",[FTy 26]), ("JALR",[PTy(FTy 5,FTy 5)]), ("JR",[FTy 5])])]
;
...
val _ = Construct[("MultDiv",
    [("DDIV",[PTy(FTy 5,FTy 5)]), ("DDIVU",[PTy(FTy 5,FTy 5)]),
     ...
     ("MFHI",[FTy 5]), ("MFLO",[FTy 5]), ("MTHI",[FTy 5]),
     ("MTLO",[FTy 5]), ("MULT",[PTy(FTy 5,FTy 5)]),
     ("MULTU",[PTy(FTy 5,FTy 5)])])]
;

val _ = Construct[("ArithR",
...
val write'CPR_def = Def
  ("write'CPR",
   ...
   Close
     (qVar"state",
      CS
        (TP[nVar"n", Var("reg",FTy 5), Var("sel",FTy 3)],
                   ...
                   ("reg'CauseRegister",F32,
                    Dest
                      ("Cause",CTy"CauseRegister",
                       Dest("CP0",CTy"CP0",qVar"state")))), qVar"state"]),
          (TP[LN 0, LW(14,5), LW(0,3)],
           TP[Dest("EPC",F64,Dest("CP0",CTy"CP0",qVar"state")),
              qVar"state"]),
          (TP[LN 0, LW(16,5), LW(0,3)],
           TP[Mop
                (Cast(F64),
...
val dfn'DADDIU_def = Def
  ("dfn'DADDIU",
   TP[Var("rs",FTy 5), Var("rt",FTy 5), Var("immediate",F16)],
   Close
     (qVar"state",
      Apply
        (Call
     ...
     (qVar"state",
      Let
        (qVar"s",
         ITE
           (EQ
              (Dest("HLStatus",CTy"HLStatus",qVar"state"),
         ...
         Let
           (qVar"s",
            ITE
              (EQ
                 (Dest("HLStatus",CTy"HLStatus",qVar"s"),
                  LC("HLarith",CTy"HLStatus")),
         ...
         Let
           (TP[Var("pAddr",F64), Var("CCA",FTy 3)],
            ...
            Let
              (Var("v0",F64),
               CC[EX
                    (Var("pAddr",F64),Bop(Sub,Const("PSIZE",nTy),LN 1),
                     LN 3,FTy 61),
                  Bop
   ...
   Let
     (qVar"s",
      ...
      Let
        (qVar"s",
         CS
           (Dest("BranchStatus",OTy(F64),qVar"state"),
