(* mipsScript.sml - generated by L3 - Wed Apr 27 16:02:02 2016 *)
  ...
  ("reg'StatusRegister",Var("x",CTy"StatusRegister"),
   CS(Var("x",CTy"StatusRegister"),
      [(Rec(CTy"StatusRegister",
        ...
        CC[EX(Var("statusregister'rst",FTy 12),LN 2,LN 0,FTy 3),
           Mop(Cast F1,bVar"CU0"),
           EX(Var("statusregister'rst",FTy 12),LN 3,LN 3,F1),
           Mop(Cast F1,bVar"FR"),Mop(Cast F1,bVar"RE"),
           EX(Var("statusregister'rst",FTy 12),LN 5,LN 4,FTy 2),
           Mop(Cast F1,bVar"BEV"),
           EX(Var("statusregister'rst",FTy 12),LN 11,LN 6,FTy 6),
  ...
  ("reg'CauseRegister",Var("x",CTy"CauseRegister"),
   CS(Var("x",CTy"CauseRegister"),
      [(Rec(CTy"CauseRegister",
        ...
        CC[Mop(Cast F1,bVar"BD"),Mop(Cast F1,bVar"TI"),
           EX(Var("causeregister'rst",FTy 17),LN 13,LN 0,FTy 14),
           Var("IP",F8),
           EX(Var("causeregister'rst",FTy 17),LN 14,LN 14,F1),
           Var("ExcCode",FTy 5),
           EX(Var("causeregister'rst",FTy 17),LN 16,LN 15,FTy 2)])]))
;
      ...
      Let(Var("a",F64),Bop(BAnd,Var("pAddr",F64),Mop(BNot,LW(7,64))),
          Let(Var("l",FTy 3),EX(Var("pAddr",F64),LN 2,LN 0,FTy 3),
              Let(Var("h",FTy 3),
                  ...
                  ITE(Apply
                        (Const("BigEndianMem",ATy(qTy,bTy)),qVar"state"),
                      Let(qVar"s",
           ...
           Let(TP[Var("pAddr",F64),Var("CCA",FTy 3)],
               ...
               Let(Var("v1",FTy 3),
                   Bop(BXor,EX(Var("v",F64),LN 2,LN 0,FTy 3),
                       CC[Apply
                            (Const("BigEndianCPU",ATy(qTy,F1)),qVar"state"),
                          LW(0,2)]),
                   TP[Mop(Some,
                          EX(Apply
                               (Call
                                  ("LoadMemory",ATy(qTy,F64),
                                   TP[Var("CCA",FTy 3),
                                      Const("WORD",FTy 3),
   ...
   Close
     (qVar"state",
      Let(Var("v",F64),
          ...
          Let(qVar"s",
              ITE(Call("NotWordValue",bTy,Var("v",F64)),
                  Mop(Snd,
                      Apply
                        (Call
                                ...
                                Mop(Snd,
                                    Apply
                                      (Call
                                       ...
                                       qVar"s")),qVar"s")),LN 32,LN 0,
                         FTy 33),Mop(SE(FTy 33),Var("immediate",F16))),
                  ITE(Mop(Not,
              ...
              Let(Var("v",FTy 33),
                  Bop(Add,
                      EX(Apply
                           (Call("GPR",ATy(qTy,F64),Var("rs",FTy 5)),
                            ITE(Bop(Or,
                                    Call("NotWordValue",bTy,Var("v",F64)),
                                    Call
                                      ("NotWordValue",bTy,
                                       Apply
                                         (Call
                          ...
                          Let(Var("v4",F64),
                              Apply
                                (Call
                                   ("LoadMemory",ATy(qTy,F64),
                                    TP[Var("CCA",FTy 3),
                                       CC[LW(0,1),Var("v2",FTy 2)],
                                       ITE(Apply
                                             (Const
                                                ("BigEndianMem",
                                                 ATy(qTy,bTy)),qVar"state"),
                                           Var("v0",F64),
                                           Bop(BAnd,Var("v0",F64),
                                               Mop(BNot,LW(7,64)))),
                              ...
                              Let(TP[Var("v",F32),qVar"s"],
                                  CS(TP[Bop(BXor,
                                        ...
                                        Var("v2",FTy 2)],
                                     [(TP[LW(0,1),LW(0,2)],
                                       TP[CC[EX(Var("v4",F64),LN 7,LN 0,F8),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                      Var("rt",FTy 5)),
                                      ...
                                      (TP[LW(0,1),LW(1,2)],
                                       TP[CC[EX(Var("v4",F64),LN 15,LN 0,
                                                F16),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                LN 0,F16)],qVar"state"]),
                                      (TP[LW(0,1),LW(2,2)],
                                       TP[CC[EX(Var("v4",F64),LN 23,LN 0,
                                                FTy 24),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                F8)],qVar"state"]),
                                      (TP[LW(0,1),LW(3,2)],
                                       TP[EX(Var("v4",F64),LN 31,LN 0,F32),
                                          qVar"state"]),
                                      (TP[LW(1,1),LW(0,2)],
                                       TP[CC[EX(Var("v4",F64),LN 39,LN 32,
                                                F8),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                LN 0,FTy 24)],qVar"state"]),
                                      (TP[LW(1,1),LW(1,2)],
                                       TP[CC[EX(Var("v4",F64),LN 47,LN 32,
                                                F16),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                LN 0,F16)],qVar"state"]),
                                      (TP[LW(1,1),LW(2,2)],
                                       TP[CC[EX(Var("v4",F64),LN 55,LN 32,
                                                FTy 24),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                F8)],qVar"state"]),
                                      (TP[LW(1,1),LW(3,2)],
                                       TP[EX(Var("v4",F64),LN 63,LN 32,F32),
                                          qVar"state"])]),
                                  Rupd
                                    ("LLbit",
                                     TP[Apply
                      ...
                      Let(Var("v2",FTy 3),
                          ...
                          Let(Var("v3",F64),
                              ...
                              Let(TP[Var("v",F64),qVar"s"],
                                  CS(Var("v2",FTy 3),
                                     [(LW(0,3),
                                       TP[CC[EX(Var("v3",F64),LN 7,LN 0,F8),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                      Var("rt",FTy 5)),
                                      ...
                                      (LW(1,3),
                                       TP[CC[EX(Var("v3",F64),LN 15,LN 0,
                                                F16),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                      ...
                                      (LW(2,3),
                                       TP[CC[EX(Var("v3",F64),LN 23,LN 0,
                                                FTy 24),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                      ...
                                      (LW(3,3),
                                       TP[CC[EX(Var("v3",F64),LN 31,LN 0,
                                                F32),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                LN 0,F32)],qVar"state"]),
                                      (LW(4,3),
                                       TP[CC[EX(Var("v3",F64),LN 39,LN 0,
                                                FTy 40),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                LN 0,FTy 24)],qVar"state"]),
                                      (LW(5,3),
                                       TP[CC[EX(Var("v3",F64),LN 47,LN 0,
                                                FTy 48),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                LN 0,F16)],qVar"state"]),
                                      (LW(6,3),
                                       TP[CC[EX(Var("v3",F64),LN 55,LN 0,
                                                FTy 56),
                                             EX(Apply
                                                  (Call
                                                     ("GPR",ATy(qTy,F64),
                                                ...
                                                F8)],qVar"state"]),
                                      (LW(7,3),
                                       TP[EX(Var("v3",F64),LN 63,LN 0,F64),
                                          qVar"state"])]),
                                  Rupd
                                    ("LLbit",
                                     TP[Apply
     ...
     (qVar"state",
      CS(Dest("LLbit",OTy bTy,qVar"state"),
         [(LO bTy,
          ...
          (Mop(Some,LF),
           Apply
             (Call("write'GPR",ATy(qTy,qTy),TP[LW(0,64),Var("rt",FTy 5)]),
              qVar"state")),
          (Mop(Some,LT),
           Apply
             (Call("write'GPR",ATy(qTy,qTy),TP[LW(1,64),Var("rt",FTy 5)]),
              Apply
                (Call
                   ("storeWord",ATy(qTy,qTy),
                    TP[Var("base",FTy 5),Var("rt",FTy 5),Var("offset",F16)]),
                      ...
                      Let(Var("v2",FTy 2),
                          Bop(BXor,EX(Var("v",F64),LN 1,LN 0,FTy 2),
                              REP(Apply
                                    (Const("BigEndianCPU",ATy(qTy,F1)),
                                     qVar"state"),LN 2,FTy 2)),
                          Let(TP[Var("v3",F64),qVar"s0"],
                              CS(TP[Bop(BXor,
                                        EX(Var("v",F64),LN 2,LN 2,F1),
                                        Apply
                                          (Const
                                             ("BigEndianCPU",ATy(qTy,F1)),
                                           qVar"state")),Var("v2",FTy 2)],
                                 [(TP[LW(0,1),LW(0,2)],
                                   TP[Mop(Cast F64,
                                          EX(Apply
                                               (Call
      ...
      CS(Var("v0",CTy"instruction"),
         [(Const("BREAK",CTy"instruction"),
          ...
          (Call("RDHWR",CTy"instruction",Var("v128",PTy(FTy 5,FTy 5))),
           Apply
             (Call("dfn'RDHWR",ATy(qTy,qTy),Var("v128",PTy(FTy 5,FTy 5))),
              qVar"state")),
          (Call("SYNC",CTy"instruction",Var("v129",FTy 5)),qVar"state"),
          ...
          (Call("MultDiv",CTy"instruction",Var("v69",CTy"MultDiv")),
           CS(Var("v69",CTy"MultDiv"),
              [(Call("DDIV",CTy"MultDiv",Var("v70",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'DDIV",ATy(qTy,qTy),Var("v70",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("DDIVU",CTy"MultDiv",Var("v71",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'DDIVU",ATy(qTy,qTy),Var("v71",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("DIV",CTy"MultDiv",Var("v72",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'DIV",ATy(qTy,qTy),Var("v72",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("DIVU",CTy"MultDiv",Var("v73",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'DIVU",ATy(qTy,qTy),Var("v73",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("DMULT",CTy"MultDiv",Var("v74",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'DMULT",ATy(qTy,qTy),Var("v74",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               ...
               (Call("MADD",CTy"MultDiv",Var("v76",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'MADD",ATy(qTy,qTy),Var("v76",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("MADDU",CTy"MultDiv",Var("v77",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'MADDU",ATy(qTy,qTy),Var("v77",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("MFHI",CTy"MultDiv",Var("v78",FTy 5)),
                Apply
                  (Call("dfn'MFHI",ATy(qTy,qTy),Var("v78",FTy 5)),
                   qVar"state")),
               (Call("MFLO",CTy"MultDiv",Var("v79",FTy 5)),
                Apply
                  (Call("dfn'MFLO",ATy(qTy,qTy),Var("v79",FTy 5)),
                   qVar"state")),
               (Call("MSUB",CTy"MultDiv",Var("v80",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'MSUB",ATy(qTy,qTy),Var("v80",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("MSUBU",CTy"MultDiv",Var("v81",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'MSUBU",ATy(qTy,qTy),Var("v81",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("MTHI",CTy"MultDiv",Var("v82",FTy 5)),
                Apply
                  (Call("dfn'MTHI",ATy(qTy,qTy),Var("v82",FTy 5)),
                   qVar"state")),
               (Call("MTLO",CTy"MultDiv",Var("v83",FTy 5)),
                Apply
                  (Call("dfn'MTLO",ATy(qTy,qTy),Var("v83",FTy 5)),
                   qVar"state")),
               (Call
                  ("MUL",CTy"MultDiv",
               ...
               (Call("MULT",CTy"MultDiv",Var("v85",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'MULT",ATy(qTy,qTy),Var("v85",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("MULTU",CTy"MultDiv",Var("v86",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'MULTU",ATy(qTy,qTy),Var("v86",PTy(FTy 5,FTy 5))),
                   qVar"state"))])),
          ...
          (Call("Trap",CTy"instruction",Var("v114",CTy"Trap")),
           CS(Var("v114",CTy"Trap"),
              [(Call("TEQ",CTy"Trap",Var("v115",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'TEQ",ATy(qTy,qTy),Var("v115",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("TEQI",CTy"Trap",Var("v116",PTy(FTy 5,F16))),
                Apply
                  (Call
                     ("dfn'TEQI",ATy(qTy,qTy),Var("v116",PTy(FTy 5,F16))),
                   qVar"state")),
               (Call("TGE",CTy"Trap",Var("v117",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'TGE",ATy(qTy,qTy),Var("v117",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("TGEI",CTy"Trap",Var("v118",PTy(FTy 5,F16))),
                Apply
                  (Call
                     ("dfn'TGEI",ATy(qTy,qTy),Var("v118",PTy(FTy 5,F16))),
                   qVar"state")),
               (Call("TGEIU",CTy"Trap",Var("v119",PTy(FTy 5,F16))),
                Apply
                  (Call
                     ("dfn'TGEIU",ATy(qTy,qTy),Var("v119",PTy(FTy 5,F16))),
                   qVar"state")),
               (Call("TGEU",CTy"Trap",Var("v120",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'TGEU",ATy(qTy,qTy),Var("v120",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("TLT",CTy"Trap",Var("v121",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'TLT",ATy(qTy,qTy),Var("v121",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("TLTI",CTy"Trap",Var("v122",PTy(FTy 5,F16))),
                Apply
                  (Call
                     ("dfn'TLTI",ATy(qTy,qTy),Var("v122",PTy(FTy 5,F16))),
                   qVar"state")),
               (Call("TLTIU",CTy"Trap",Var("v123",PTy(FTy 5,F16))),
                Apply
                  (Call
                     ("dfn'TLTIU",ATy(qTy,qTy),Var("v123",PTy(FTy 5,F16))),
                   qVar"state")),
               (Call("TLTU",CTy"Trap",Var("v124",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'TLTU",ATy(qTy,qTy),Var("v124",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("TNE",CTy"Trap",Var("v125",PTy(FTy 5,FTy 5))),
                Apply
                  (Call
                     ("dfn'TNE",ATy(qTy,qTy),Var("v125",PTy(FTy 5,FTy 5))),
                   qVar"state")),
               (Call("TNEI",CTy"Trap",Var("v126",PTy(FTy 5,F16))),
                Apply
                  (Call
                     ("dfn'TNEI",ATy(qTy,qTy),Var("v126",PTy(FTy 5,F16))),
                   qVar"state"))]))])))
;
val Decode_def = Def
  ("Decode",Var("w",F32),
