...
fun COP1Encode j =
  case j of
   ...
   | LDC1(base,(offset,ft)) =>
     BitsN.concat[BitsN.B(0x31,6),ft,base,offset]
   | LWC1(base,(offset,ft)) =>
     BitsN.concat[BitsN.B(0x39,6),ft,base,offset]
   | SDC1(base,(offset,ft)) =>
     BitsN.concat[BitsN.B(0x35,6),ft,base,offset]
   | SWC1(base,(offset,ft)) =>
     BitsN.concat[BitsN.B(0x3D,6),ft,base,offset]
   | LWXC1(fd,(index,base)) =>
     BitsN.concat
