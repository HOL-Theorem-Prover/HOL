(* mips - generated by L3 - Wed May 03 11:41:18 2017 *)
...
datatype COP1
  ...
  | C_fmt_D of BitsN.nbit * (BitsN.nbit * BitsN.nbit)
  | C_fmt_S of BitsN.nbit * (BitsN.nbit * BitsN.nbit)
  ...
  case v0 of
   ...
   | COP1 v50 =>
     (case v50 of
       ...
       | C_fmt_D v75 => dfn'C_fmt_D v75
       | C_fmt_S v76 => dfn'C_fmt_S v76
                    ...
                    (fs'0,
                     (false,
                      (false,
                       (false,
                        (false,
                         (false,(true,(true,(false,(c'2,(c'1,c'0))))))))))))))))))))))))) =>
        C_fmt_S
          (BitsN.fromBitstring([fs'4,fs'3,fs'2,fs'1,fs'0],5),
           (BitsN.fromBitstring([ft'4,ft'3,ft'2,ft'1,ft'0],5),
            BitsN.fromBitstring([c'2,c'1,c'0],3)))
      | (true,
       (false,
        (false,
         (false,
...
fun COP1Encode j =
  case j of
   ...
   | BC1F i => BitsN.@@(BitsN.B(0x4500,16),i)
   | BC1T i => BitsN.@@(BitsN.B(0x4501,16),i)
   | BC1FL i => BitsN.@@(BitsN.B(0x4502,16),i)
   | BC1TL i => BitsN.@@(BitsN.B(0x4503,16),i)
   | ADD_S(fd,(fs,ft)) =>
   ...
   | C_fmt_S(fs,(ft,c)) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x6,8),c]
   | ADD_D(fd,(fs,ft)) =>
   ...
   | C_fmt_D(fs,(ft,c)) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x6,8),c]
   | CVT_S_D(fd,fs) =>
...
fun COP1InstructionToString j =
  case j of
   ...
   | BC1F i => op1ai 16 ("bc1f",i)
   | BC1FL i => op1lai 16 ("bc1fl",i)
   | BC1T i => op1ai 16 ("bc1t",i)
   | BC1TL i => op1lai 16 ("bc1tl",i)
   | C_fmt_D(fs,(ft,BitsN.B(0x0,3))) => op2fpr("c.f.d",(fs,ft))
   | C_fmt_D(fs,(ft,BitsN.B(0x1,3))) => op2fpr("c.un.d",(fs,ft))
   | C_fmt_D(fs,(ft,BitsN.B(0x2,3))) => op2fpr("c.eq.d",(fs,ft))
   | C_fmt_D(fs,(ft,BitsN.B(0x3,3))) => op2fpr("c.ueq.d",(fs,ft))
   | C_fmt_D(fs,(ft,BitsN.B(0x4,3))) => op2fpr("c.olt.d",(fs,ft))
   | C_fmt_D(fs,(ft,BitsN.B(0x5,3))) => op2fpr("c.ult.d",(fs,ft))
   | C_fmt_D(fs,(ft,BitsN.B(0x6,3))) => op2fpr("c.ole.d",(fs,ft))
   | C_fmt_D(fs,(ft,BitsN.B(0x7,3))) => op2fpr("c.ule.d",(fs,ft))
   | C_fmt_S(fs,(ft,BitsN.B(0x0,3))) => op2fpr("c.f.s",(fs,ft))
   | C_fmt_S(fs,(ft,BitsN.B(0x1,3))) => op2fpr("c.un.s",(fs,ft))
   | C_fmt_S(fs,(ft,BitsN.B(0x2,3))) => op2fpr("c.eq.s",(fs,ft))
   | C_fmt_S(fs,(ft,BitsN.B(0x3,3))) => op2fpr("c.ueq.s",(fs,ft))
   | C_fmt_S(fs,(ft,BitsN.B(0x4,3))) => op2fpr("c.olt.s",(fs,ft))
   | C_fmt_S(fs,(ft,BitsN.B(0x5,3))) => op2fpr("c.ult.s",(fs,ft))
   | C_fmt_S(fs,(ft,BitsN.B(0x6,3))) => op2fpr("c.ole.s",(fs,ft))
   | C_fmt_S(fs,(ft,BitsN.B(0x7,3))) => op2fpr("c.ule.s",(fs,ft))
...
fun p_fpr2 (x,(s,(fd,fs))) =
  case x of
   ...
   | "c.f.d" => OK(COP1(C_fmt_D(fd,(fs,BitsN.B(0x0,3)))))
   | "c.un.d" => OK(COP1(C_fmt_D(fd,(fs,BitsN.B(0x1,3)))))
   | "c.eq.d" => OK(COP1(C_fmt_D(fd,(fs,BitsN.B(0x2,3)))))
   | "c.ueq.d" => OK(COP1(C_fmt_D(fd,(fs,BitsN.B(0x3,3)))))
   | "c.olt.d" => OK(COP1(C_fmt_D(fd,(fs,BitsN.B(0x4,3)))))
   | "c.ult.d" => OK(COP1(C_fmt_D(fd,(fs,BitsN.B(0x5,3)))))
   | "c.ole.d" => OK(COP1(C_fmt_D(fd,(fs,BitsN.B(0x6,3)))))
   | "c.ule.d" => OK(COP1(C_fmt_D(fd,(fs,BitsN.B(0x7,3)))))
   | "c.f.s" => OK(COP1(C_fmt_S(fd,(fs,BitsN.B(0x0,3)))))
   | "c.un.s" => OK(COP1(C_fmt_S(fd,(fs,BitsN.B(0x1,3)))))
   | "c.eq.s" => OK(COP1(C_fmt_S(fd,(fs,BitsN.B(0x2,3)))))
   | "c.ueq.s" => OK(COP1(C_fmt_S(fd,(fs,BitsN.B(0x3,3)))))
   | "c.olt.s" => OK(COP1(C_fmt_S(fd,(fs,BitsN.B(0x4,3)))))
   | "c.ult.s" => OK(COP1(C_fmt_S(fd,(fs,BitsN.B(0x5,3)))))
   | "c.ole.s" => OK(COP1(C_fmt_S(fd,(fs,BitsN.B(0x6,3)))))
   | "c.ule.s" => OK(COP1(C_fmt_S(fd,(fs,BitsN.B(0x7,3)))))
  ...
  case x of
   ...
   | "bc1f" =>
     let
       val (i,e) = imm_ok 16 (Option.SOME false,(n,s))
     in
       if e = "" then OK(COP1(BC1F i)) else FAIL e
     end
   | "bc1fl" =>
     let
       val (i,e) = imm_ok 16 (Option.SOME true,(n,s))
     in
       if e = "" then OK(COP1(BC1FL i)) else FAIL e
     end
   | "bc1t" =>
     let
       val (i,e) = imm_ok 16 (Option.SOME false,(n,s))
     in
       if e = "" then OK(COP1(BC1T i)) else FAIL e
     end
   | "bc1tl" =>
     let
       val (i,e) = imm_ok 16 (Option.SOME true,(n,s))
     in
       if e = "" then OK(COP1(BC1TL i)) else FAIL e
     end
   | "word" =>
     let
