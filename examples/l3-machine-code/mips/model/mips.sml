(* mips - generated by L3 - Mon Feb 15 15:13:46 2016 *)
...
fun CPR (n,(reg,sel)) =
  case (n,(reg,sel)) of
   ...
   | (0,(BitsN.B(0xC,5),BitsN.B(0x0,3))) =>
     BitsN.fromNat(BitsN.toNat(reg'StatusRegister((#Status) (!CP0))),64)
   ...
   | (0,(BitsN.B(0x10,5),BitsN.B(0x0,3))) =>
     BitsN.fromNat(BitsN.toNat(reg'ConfigRegister((#Config) (!CP0))),64)
   | (0,(BitsN.B(0x11,5),BitsN.B(0x0,3))) => (#LLAddr) (!CP0)
                   ...
                   | BitsN.B(0x6,3) =>
                     BitsN.@@
                       (BitsN.bits(55,0) memdoubleword,
                        BitsN.bits(7,0) (GPR rt))
                   | BitsN.B(0x7,3) => BitsN.bits(63,0) memdoubleword
    ...
    if not (!exceptionSignalled)
      then let
           ...
           in
             ( write'GPR
                 (case byte of
                     BitsN.B(0x0,3) => BitsN.bits(63,0) memdoubleword
                   | BitsN.B(0x1,3) =>
                     BitsN.@@
