(* mips - generated by L3 - Tue May 02 14:09:45 2017 *)
...
fun op1r (s,n) = (L3.padRightString(#" ",(8,s ^ " "))) ^ (reg_name n);
...
fun op1fpr (s,n) =
  String.concat
    [L3.padRightString(#" ",(8,s ^ " ")),"$f",Nat.toString(BitsN.toNat n)];
