(* mips - generated by L3 - Tue May 02 15:08:05 2017 *)
...
fun COP1Encode j =
  case j of
   ...
   | C_F_S(fs,ft) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x30,11)]
   | C_UN_S(fs,ft) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x31,11)]
   | C_EQ_S(ft,fs) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x32,11)]
   | C_UEQ_S(fs,ft) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x33,11)]
   | C_OLT_S(fs,ft) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x34,11)]
   | C_ULT_S(fs,ft) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x35,11)]
   | C_OLE_S(fs,ft) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x36,11)]
   | C_ULE_S(fs,ft) =>
     BitsN.concat[BitsN.B(0x230,11),ft,fs,BitsN.B(0x37,11)]
   | ADD_D(fd,(fs,ft)) =>
   ...
   | C_F_D(fs,ft) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x30,11)]
   | C_UN_D(fs,ft) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x31,11)]
   | C_EQ_D(fs,ft) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x32,11)]
   | C_UEQ_D(fs,ft) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x33,11)]
   | C_OLT_D(fs,ft) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x34,11)]
   | C_ULT_D(fs,ft) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x35,11)]
   | C_OLE_D(fs,ft) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x36,11)]
   | C_ULE_D(fs,ft) =>
     BitsN.concat[BitsN.B(0x231,11),ft,fs,BitsN.B(0x37,11)]
   | CVT_S_D(fd,fs) =>
...
fun COP1InstructionToString j =
  case j of
   ...
   | C_F_D(fs,ft) => op2fpr("c.f.d",(fs,ft))
   | C_F_S(fs,ft) => op2fpr("c.f.s",(fs,ft))
   | C_UN_D(fs,ft) => op2fpr("c.un.d",(fs,ft))
   | C_UN_S(fs,ft) => op2fpr("c.un.s",(fs,ft))
   | C_EQ_D(fs,ft) => op2fpr("c.eq.d",(fs,ft))
   | C_EQ_S(fs,ft) => op2fpr("c.eq.s",(fs,ft))
   | C_UEQ_D(fs,ft) => op2fpr("c.ueq.d",(fs,ft))
   | C_UEQ_S(fs,ft) => op2fpr("c.ueq.s",(fs,ft))
   | C_OLT_D(fs,ft) => op2fpr("c.olt.d",(fs,ft))
   | C_OLT_S(fs,ft) => op2fpr("c.olt.s",(fs,ft))
   | C_ULT_D(fs,ft) => op2fpr("c.ult.d",(fs,ft))
   | C_ULT_S(fs,ft) => op2fpr("c.ult.s",(fs,ft))
   | C_OLE_D(fs,ft) => op2fpr("c.ole.d",(fs,ft))
   | C_OLE_S(fs,ft) => op2fpr("c.ole.s",(fs,ft))
   | C_ULE_D(fs,ft) => op2fpr("c.ule.d",(fs,ft))
   | C_ULE_S(fs,ft) => op2fpr("c.ule.s",(fs,ft))
...
fun p_fpr2 (x,(s,(fd,fs))) =
  case x of
   ...
   | "c.f.d" => OK(COP1(C_F_D(fd,fs)))
   | "c.f.s" => OK(COP1(C_F_S(fd,fs)))
   | "c.un.d" => OK(COP1(C_UN_D(fd,fs)))
   | "c.eq.d" => OK(COP1(C_EQ_D(fd,fs)))
   | "c.ueq.d" => OK(COP1(C_UEQ_D(fd,fs)))
   | "c.olt.d" => OK(COP1(C_OLT_D(fd,fs)))
   | "c.ult.d" => OK(COP1(C_ULT_D(fd,fs)))
   | "c.ole.d" => OK(COP1(C_OLE_D(fd,fs)))
   | "c.ule.d" => OK(COP1(C_ULE_D(fd,fs)))
   | "c.un.s" => OK(COP1(C_UN_S(fd,fs)))
   | "c.eq.s" => OK(COP1(C_EQ_S(fd,fs)))
   | "c.ueq.s" => OK(COP1(C_UEQ_S(fd,fs)))
   | "c.olt.s" => OK(COP1(C_OLT_S(fd,fs)))
   | "c.ult.s" => OK(COP1(C_ULT_S(fd,fs)))
   | "c.ole.s" => OK(COP1(C_OLE_S(fd,fs)))
   | "c.ule.s" => OK(COP1(C_ULE_S(fd,fs)))
...
fun bs b = L3.padLeftString(#"0",(2,BitsN.toHexString b));

fun test s =
  let
    val i = (Option.valOf o BitsN.fromHexString) (encodeInstruction s,32)
  in
    (String.concat
       [bs(BitsN.bits(7,0) i)," ",bs(BitsN.bits(15,8) i)," ",
        bs(BitsN.bits(23,16) i)," ",bs(BitsN.bits(31,24) i)],
     instructionToString(Decode i))
  end;
