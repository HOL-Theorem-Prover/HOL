...
Theory VDC
Ancestors
  lim arithmetic real iterate prim_rec real_probability seq
  pred_set res_quan sorting list transc rich_list pair combin
  option extreal real_measure real_lebesgue real_sigma sat num
  RBD
Libs
...
Theorem cloud_server_rv_list_not_null1 :
    !p t a b c  n m. ( !z.
        ...
        ~NULL z) ==>
       !z. MEM z (FLAT (three_dim_rel_event_list p (gen_list [a::b::c] m) t)) ==>
           ~NULL z
Proof
    NTAC 5 GEN_TAC
 >> Induct
...
Proof
    NTAC 6 GEN_TAC
 >> Induct >- (RW_TAC list_ss[gen_list_def])
 >> RW_TAC list_ss[gen_list_def]
QED
