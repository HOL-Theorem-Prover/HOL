...
val tm1 = ``(\:'a. \s. (s:'a))[:'a -> 'b:]``;
val tm2 = subst_type [``:'a -> 'b`` |-> ``:!'a.'a``] tm1; (* automatically raises rank *)
...
val tm18 = ``\:'a. \x. (x[: bool :]:bool->bool, x[: !'b 'c.'c->'b :], x[: 'd:<=4 :])``;
val tm19 = ``\:'a. \x:!'c.'c->'c. (x[: bool :]:bool->bool, x[: !'b 'c.'c->'b :], x[: 'd:<=4 :])``;
