...
val identity_functor = store_thm
  ("identity_functor",
   ...
   SIMP_TAC bool_ss [functor_def,I_THM]
  );
...
val map_map_functor0 = store_thm
  ("map_map_functor0",
   ...
   SIMP_TAC bool_ss [functor_def,o_THM,MAP_I,MAP_o]
  );
...
val functor_o = store_thm
  ("functor_o",
   ...
   SIMP_TAC bool_ss [functor_def,o_THM]
  );
  ...
  ("nattransf_functor_comp1",
   ``nattransf phi1 phi2 (kappa : ('t1,'t2)nattransf) /\
     ...
     nattransf (\:'a 'b. phi1 o psi)
               (\:'a 'b. phi2 o psi)
               (\:'a. kappa[:'a 't3:])``,
   SIMP_TAC bool_ss [nattransf_def,functor_def,o_THM]
  );
  ...
  ("nattransf_functor_comp2",
   ``nattransf phi1 phi2 (kappa : ('t1,'t2)nattransf) /\
     ...
     nattransf (\:'a 'b. psi o phi1)
               (\:'a 'b. psi o phi2)
               (\:'a. psi kappa)``,
   SIMP_TAC bool_ss [nattransf_THM,functor_def,o_THM]
...
val nattransf_comp1 = store_thm
  ("nattransf_comp1",
   ...
   SIMP_TAC bool_ss [nattransf_THM,o_THM]
   THEN REPEAT STRIP_TAC
...
val nattransf_commute1 = store_thm
  ("nattransf_commute1",
   ...
   SIMP_TAC bool_ss [nattransf_THM]
  );
...
val prod_bifunctor = store_thm
  ("prod_bifunctor",
   ...
   SIMP_TAC bool_ss [bifunctor_def,PAIR_I,PAIR_COMPOSE]
  );
...
val sum_bifunctor = store_thm
  ("sum_bifunctor",
   ...
   SIMP_TAC bool_ss [bifunctor_def,SUM_I,SUM_COMPOSE]
  );
