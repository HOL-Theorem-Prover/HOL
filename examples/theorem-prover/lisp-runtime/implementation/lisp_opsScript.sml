...
open lisp_symbolsTheory lisp_sexpTheory lisp_consTheory lisp_invTheory; open lisp_equalTheory;
...
fun X64_LISP_SFIX i = let
  ...
  val pre_tm = ``zLISP ^STAT (x0,x1,x2,x3,x4,x5,xs,xs1,io,xbp,qs,code,amnt,ok) * zPC rip * zS1 Z_ZF (SOME zf) * precond zf``
  val post_tm = ``zLISP ^STAT (x0,x1,x2,x3,x4,x5,xs,xs1,io,xbp,qs,code,amnt,ok) * zPC rip * zS1 Z_ZF (SOME zf)``
...
val X64_LISP_TEST = let
  ...
  val th1 = RW [SEP_CLAUSES] (Q.INST [`zf`|->`T`,`rip`|->`p`] th1)
  val th2 = RW [SEP_CLAUSES] (Q.INST [`zf`|->`F`,`rip`|->`p`] th2)
  (* case 1 *)
  val th = th1
...
val X64_LISP_NOT_TEST = let
  ...
  val th1 = SIMP_RULE (std_ss++sep_cond_ss) [precond_def] pass1
  val th2 = SIMP_RULE (std_ss++sep_cond_ss) [precond_def] pass2
  val th1 = RW [SEP_CLAUSES] (Q.INST [`zf`|->`F`,`rip`|->`p`] th1)
  val th2 = RW [SEP_CLAUSES] (Q.INST [`zf`|->`T`,`rip`|->`p`] th2)
  (* case 1 *)
  val th = th1
  val imp = SPEC_ALL (SIMP_RULE std_ss [LET_DEF] lisp_inv_T)
  val imp2 = Q.INST [`temp`|->`0xBw`] lisp_inv_ignore_tw2
...
val X64_LISP_TEST_CF = let
  ...
  val th1 = SIMP_RULE (std_ss++sep_cond_ss) [precond_def] pass1
  val th2 = SIMP_RULE (std_ss++sep_cond_ss) [precond_def] pass2
  val th1 = RW [SEP_CLAUSES] (Q.INST [`cf`|->`T`,`rip`|->`p`] th1)
  val th2 = RW [SEP_CLAUSES] (Q.INST [`cf`|->`F`,`rip`|->`p`] th2)
  (* case 1 *)
  val th = th1
  val imp = SPEC_ALL (SIMP_RULE std_ss [LET_DEF] lisp_inv_T)
  val imp2 = Q.INST [`temp`|->`0xBw`] lisp_inv_ignore_tw2
