...
Theorem EXPLICIT_ACCEPT_COND_USED_INPUT_VARS_INTER_SUBSET_THM:
...
Theorem EXPLICIT_PROP_ACCEPT_COND_SEM_THM:
...
Theorem EXISTENTIAL_UNIVERSAL_OMEGA_AUTOMATON_SEM_THM:
...
Theorem IS_DET_TOTAL_SEMI_AUTOMATON___EXISTENTIAL_UNIVERSAL_SEM:
...
Theorem EXPLICIT_ACCEPT_COND_SEM___STATE_VAR_RENAMING___NOT_INJ:
      !ac f g S w.
...
Theorem OMEGA_AUTOMATON___STATE_VAR_RENAMING:
     !A ac f g.
