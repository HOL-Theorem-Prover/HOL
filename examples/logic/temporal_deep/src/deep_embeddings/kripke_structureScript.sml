...
Theorem IS_TOTAL_KRIPKE_STRUCTURE___PATH_EXISTS:
...
Theorem IS_TOTAL_KRIPKE_STRUCTURE___INITIAL_PATH_EXISTS:
    !K s. (IS_TOTAL_KRIPKE_STRUCTURE K /\
          IS_REACHABLE_STATE_OF_KRIPKE_STRUCTURE K s) ==>
...
Theorem IS_TOTAL_COMPLETELY_REACHABLE_KRIPKE_STRUCTURE___ALTERNATIVE_DEF:
...
Theorem KRIPKE_STRUCTURE___PATHS_AND_TRACES_PATH_SUBSET:
...
Theorem PRODUCT_KRIPKE_STRUCTURE___IS_WELL_FORMED:
...
Theorem PRODUCT_KRIPKE_STRUCTURES___PATH_IS_PRODUCT_OF_ORIGINAL_PATHS:
  !K1 K2 p.
    IS_PATH_THROUGH_KRIPKE_STRUCTURE (PRODUCT_KRIPKE_STRUCTURE K1 K2) p =
...
Proof
  ...
  SIMP_TAC std_ss [
    prove (“!x y1 y2. (x = (y1, y2)) = ((FST x = y1) /\ (SND x = y2))”,
           Cases_on `x` THEN SIMP_TAC std_ss []), FORALL_AND_THM] THEN
...
Theorem UNIVERSAL_KRIPKE_STRUCTURE___IS_WELL_FORMED:
...
Theorem IS_SIMULATION_RELATION___REFL:
      !K. (IS_WELL_FORMED_KRIPKE_STRUCTURE K) ==>
...
Theorem IS_SIMULATION_RELATION___TRANS:
...
Theorem IS_BISIMULATION_RELATION___SYM:
...
Theorem IS_BISIMULATION_RELATION___REFL:
      !K. (IS_WELL_FORMED_KRIPKE_STRUCTURE K) ==>
...
Theorem IS_BISIMULATION_RELATION___TRANS:
...
Theorem IS_BISIMULATION_RELATION___LABEL_EQ:
...
Theorem SIMULATION_RELATION___PATH_THROUGH_KRIPKE_STRUCTURE:
...
Theorem SIMULATION_RELATION___INITIAL_PATH_THROUGH_KRIPKE_STRUCTURE:
...
Theorem LABEL_RESTRICTED_KRIPKE_STRUCTURE___LANGUAGE:
...
Theorem SIMULATION_RELATION___IMPLIES___SUBLANGUAGE:
...
Theorem BISIMULATION_RELATION___IMPLIES___SUBLANGUAGE:
      !K1 K2. (?P. IS_BISIMULATION_RELATION K1 K2 P)  ==>
...
Theorem BISIMULATION_RELATION___IMPLIES___EQ_LANGUAGE:
      !K1 K2. (?P. IS_BISIMULATION_RELATION K1 K2 P)  ==>
...
Theorem UNIVERSAL_KRIPKE_STRUCTURE___IS_MOST_GENERAL:
      !K. IS_WELL_FORMED_KRIPKE_STRUCTURE K ==>
