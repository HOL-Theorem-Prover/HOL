...
Theorem A_UNIV___LTL_KS_SEM___CONCRETE_THM:
...
Theorem A_UNIV___A_SEM___CONCRETE_THM:
...
Theorem IBM_PROBLEM___REDUCTION_TO_SINGLE_PATHS:
...
Theorem SYMBOLIC_KRIPKE_STRUCTURE_PRODUCT___TO___AUTOMATON:
...
Theorem SYMBOLIC_KRIPKE_STRUCTURE_PRODUCT___CLEAN_STATE_VARS:
...
Theorem A_UNIV___LTL_KS_SEM___THM:
      !A ac l. (IS_TOTAL_DET_SYMBOLIC_SEMI_AUTOMATON A /\ DISJOINT A.S (LTL_USED_VARS l)) ==>
...
Theorem PROBLEM_TO_LTL_KS_SEM___TOTAL:
...
Theorem P_EXISTS___SET_TO_LIST___INTERVAL_SET:
...
Theorem P_FORALL___SET_TO_LIST___INTERVAL_SET:
...
Theorem P_BIGOR___SET_TO_LIST___INTERVAL_SET:
...
Theorem XP_BIGOR___SET_TO_LIST___INTERVAL_SET:
...
Theorem XP_NEXT_EXISTS___SET_TO_LIST___INTERVAL_SET:
...
Theorem XP_CURRENT_EXISTS___SET_TO_LIST___INTERVAL_SET:
...
Theorem XP_NEXT_FORALL___SET_TO_LIST___INTERVAL_SET:
...
Theorem XP_CURRENT_FORALL___SET_TO_LIST___INTERVAL_SET:
...
Theorem IS_EMPTY_FAIR_KRIPKE_STRUCTURE_cong:
...
Theorem XP_COND___XP_NEXT_FORALL___REWRITE:
...
Theorem XP_COND___XP_CURRENT_EXISTS___REWRITE:
...
Theorem VAR_RENAMING_HASHTABLE_LIST___BINARY_ENCODING___CLEAN_OFFSET:
...
Theorem VAR_RENAMING_HASHTABLE_LIST___BINARY_ENCODING___HASHTABLE_LIST:
...
Theorem PROBLEM_TO_KRIPKE_STRUCTURE:
...
Theorem PROBLEM_TO_KRIPKE_STRUCTURE___TOTAL:
