...
val BUECHI_PERIODIC_MODEL = TAC_PROOF(
        ...
        THEN IMP_RES_TAC ZERO_MOD
        THEN ASM_REWRITE_TAC
                [MOD_MOD,(ARITH_PROVE “(x0+l)-x0=l”),
        ...
        THENL[
            ...
            THEN1 (IMP_RES_TAC (ARITH_PROVE “((t+1<=x0)=T)==>(t<=x0)”)
                  THEN ASM_REWRITE_TAC[])
            ...
            THENL[
                ...
                THEN POP_NO_ASSUM 5 (SUBST1_TAC o SYM)
                THEN ASM_TAC 4 REWRITE1_TAC,
                ...
                THENL[
                   ...
                   THEN ASM_REWRITE_TAC[] THEN UNDISCH_NO_TAC 7
                   THEN CONV_TAC ARITH_CONV,
                   ...
                   THEN Q.SPEC_THEN `l` ASSUME_TAC MOD_TIMES
                   THEN LEFT_FORALL_TAC “k:num”
                   THEN LEFT_FORALL_TAC “0:num” THEN UNDISCH_HD_TAC
                   THEN ASM_REWRITE_TAC[ADD_SUB,ADD_CLAUSES,MULT_CLAUSES] THEN DISCH_TAC
...
val BUECHI_PROP_REDUCTION = TAC_PROOF(
  ...
  THEN1 (EXISTS_TAC “\t. if (t<=x0) then p t else p(x0+((t-x0)MOD l)):'state”
        THEN BETA_TAC THEN REWRITE_TAC[])
  THEN STRIP_TAC
  THEN MAP_EVERY EXISTS_TAC [“x0:num”,“l:num”,
  ...
  THENL[
      ...
      THEN IMP_RES_TAC(ARITH_PROVE “(x0<t'+1) ==> (x0=t') \/ (x0<t')”)
      THENL[
