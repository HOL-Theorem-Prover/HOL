...
Theorem IS_FUTURE_LTL___LOGIC_TO_TEMPORAL_DEEP:
...
Theorem LOGIC_TO_TEMPORAL_DEEP___SEM_TIME:
...
Theorem LOGIC_TO_TEMPORAL_DEEP___SEM:
...
Theorem TEMPROAL_DEEP_TO_LOGIC_LOGIC_TO_TEMPORAL_DEEP:
...
Theorem TEMPORAL_DEEP_PROP_TO_LOGIC___SEM_TIME:
...
Theorem TEMPORAL_DEEP_PROP_TO_LOGIC___SEM:
...
Theorem TEMPORAL_DEEP_TO_LOGIC___SEM_TIME:
...
Theorem TEMPORAL_DEEP_TO_LOGIC___SEM:
...
Definition TEMPORAL_DEEP_TO_TEMPORAL_def:
  ...
  TEMPORAL_DEEP_TO_TEMPORAL (LTL_NOT l) w =
     (\a t. ~(a t)) (TEMPORAL_DEEP_TO_TEMPORAL l w) /\
  TEMPORAL_DEEP_TO_TEMPORAL (LTL_NEXT l) w =
     NEXT (TEMPORAL_DEEP_TO_TEMPORAL l w) /\
  TEMPORAL_DEEP_TO_TEMPORAL (LTL_SUNTIL (l1, l2)) w =
    (TEMPORAL_DEEP_TO_TEMPORAL l1 w SUNTIL TEMPORAL_DEEP_TO_TEMPORAL l2 w) /\
  TEMPORAL_DEEP_TO_TEMPORAL (LTL_PSNEXT l) w =
    PSNEXT (TEMPORAL_DEEP_TO_TEMPORAL l w) /\
  TEMPORAL_DEEP_TO_TEMPORAL (LTL_PSUNTIL (l1, l2)) w =
    (TEMPORAL_DEEP_TO_TEMPORAL l1 w PSUNTIL TEMPORAL_DEEP_TO_TEMPORAL l2 w)
End


Theorem TEMPORAL_DEEP_TO_TEMPORAL_THM:
...
Theorem LOGIC_TO_TEMPORAL_ALT_DEF:
