(* -*-sml-*- *)
(* ===================================================================== *)
(* FILE          : Portable-mlton.sml                                    *)
(* DESCRIPTION   : Structure for SML System dependent functions.         *)
(* AUTHOR        : Joe Hurd, University of Cambridge                     *)
(*                 based on code by                                      *)
(*                 Ken Larsen, University of Cambridge (or DTU) and      *)
...
val listDir  = fn _ => raise Fail "Portable.listDir";
fun system s = if OS.Process.system s = OS.Process.success then 0 else 1
