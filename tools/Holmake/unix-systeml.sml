...
in
  ...
  output "# Parse --bare flag\n";
  output "BARE=0\n";
  output "ARGS=\"\"\n";
  output "for arg in \"$@\"; do\n";
  output "  if [ \"$arg\" = \"--bare\" ]; then\n";
  output "    BARE=1\n";
  output "  else\n";
  ...
  output (String.concat["  ", mosml," -quietdec -P full -I ", sigobj, " ",
                        std_prelude, " $ARGS ", protect bare_qend, "\n"]);
  output "else\n";
  output (String.concat["  ", mosml," -quietdec -P full -I ", sigobj, " ",
                        std_prelude, " $ARGS ", protect boss_qend, "\n"]);
  output "fi\n";
...
in
  ...
  output (String.concat["  ", qfilter, " | ", mosml," -quietdec -P full -I ",
                        ...
                        " $ARGS ", protect bare_qend, "\n"]);
  output "else\n";
  output (String.concat["  ", qfilter, " | ", mosml," -quietdec -P full -I ",
                        sigobj, " ", std_prelude, " ", qinit,
                        " $ARGS ", protect boss_qend, "\n"]);
  output "fi\n";
  TextIO.closeOut ostrm;
  mk_xable target
end
