...
\item[\texttt{\$(tee arg1,arg2)}]\index{tee@\texttt{tee}!Holmake function@\texttt{Holmake} function} produces a (moderately complicated) shell command line that behaves like \texttt{arg1~|~tee~arg2}, but whose exit code is \texttt{arg1}'s rather than \texttt{arg2}'s.
