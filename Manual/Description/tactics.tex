...
\index{tactics!sequencing of}%
 by use of the
tactical \ml{>>}\footnote{The \ml{>>} function can also be written as \ml{THEN}.}:\index{THEN@\ml{THEN}}
if $T_1$ and
...
Its alias \ml{THEN} is also an infix.
...
\ml{FIRST\_ASSUM} and \ml{EVERY\_ASSUM}.
