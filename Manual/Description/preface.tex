...
This document presents the \HOL\ logic, and it explains the means by
which meta-language functions can be used to generate proofs in the
logic.  Part~I describes the theoretical underpinnings of the \HOL{}
system, and presents it abstractly.  This part can be skipped by
readers mainly interested in learning how to use the system.  Part~II
describes how this abstract system is actually implemented in the
\ML{} programming language, providing comprehensive descriptions of
the system's major features.
