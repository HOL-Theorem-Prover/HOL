...
\end{alltt}
\end{hol}
which is typically written with the infix apostrophe, so that
\oo{x}{i} denotes the value of \holtxt{x} at position \holtxt{i}.
Note that, in practice, indices are constrained to be less than the
size of \ty{'b}.
