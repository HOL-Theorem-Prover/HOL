...
\end{hol}
where $n$ is the cardinality of the of \holtxt{UNIV:'b set}.  The type \ty{'b} could be
...
\holtxt{dimindex(:\ty{'b})}, where \holtxt{dimindex} has value one when the universe is infinite.  For example, \fcp{'a}{\num} is
