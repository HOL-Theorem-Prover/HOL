...
The theory \theoryimp{words} introduces types for a selection of standard word
sizes \eg{} \ty{word8} and \ty{word32}.  Any additional word types can be
introduced, as needed, with the function \ml{wordsLib.mk\_word\_size}.  Each word
type is an abbreviation for \fcp{bool}{iN}, where $N$ is the word length; for
example, \ty{word32} will print as \fcp{bool}{i32}.
