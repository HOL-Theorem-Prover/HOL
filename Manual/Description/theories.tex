...
and {\small\verb+CURRY+}. These functions are inverses.
%
\begin{hol}
...
({\small\verb+FUNPOW+}) is tail-recursive. A alternative presentation
...
An \adhoc\ but useful collection of over two hundred and fifty
elementary theorems of arithmetic are proved when \HOL{} is built and
stored in the theory {\small\verb%arithmetic%}.  For a complete list
of the available theorems, see \REFERENCE.
