...
the directory \ml{<holdir>/src/n_bit/help}.
...
The \ml{numeral\_bits} theory provides a group of theorems which allow
the \ml{bits} theory functions to be evaluated more efficiently.  This
is done be working with \HOL's internal representation of numerals
...
\\
\theoryimp{sorting} &
List permutations and sorting, including the correctness of quicksort.
\\
\theoryimp{poset} &
Partial orders, leading to the Knaster-Tarski theorem.
\\
\theoryimp{poly} &
...
\\
\theoryimp{prob} &
A foundational construction of probability theory due to Joe Hurd. See
his thesis.
\\
