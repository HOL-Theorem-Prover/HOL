...
notion (\holtxt{SORTED}) can be defined recursively. Then a function
$f:\alpha \to\beta$ is a sorting function with respect to $R$
(\holtxt{SORTS}) if it delivers a permutation of its input, and the
result is $R$-sorted.
%
\begin{hol}
\begin{verbatim}
