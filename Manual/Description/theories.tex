...
The length of a string (\ml{STRLEN}) is defined by primitive
recursion. The concatenation of strings (\ml{STRCAT}) may be expressed
recursively (\ml{STRCAT\_EQNS}) or as a fold (\ml{STRCAT\_EXPLODE}):
\begin{hol}
\begin{verbatim}
   STRLEN_DEF
     |- (STRLEN "" = 0) /\
