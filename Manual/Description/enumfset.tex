...
order-hood. The represention function for the type is called {\tt apto}
...
and the \ML\ function {\tt lextoto_CONV : conv -> conv -> conv}; similarly,
...
{\tt qk_numto_CONV}, should make it feasible to define orders and
conversions as needed for other \HOL\ datatypes.
