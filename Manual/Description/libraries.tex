...
\holtxt{/\bs}, \holtxt{\bs/}, \holtxt{==>}, \holtxt{=},
 \begin{Large}\holtxt{,}\end{Large} (comma\footnote{When \theoryimp{pairTheory} has
...
\paragraph{\ml{pure\_ss}}
%
\index{pure_ss@\ml{pure\_ss}}
%
This \simpset{} (defined in structure \ml{pureSimps}) contains no
...
\simpset, \ml{pure\_ss} is a possible starting point.  The
\ml{pure\_ss} \simpset{} has just two components: congruence rules for
...
\paragraph{\ml{bool\_ss}}
%
\index{bool_ss@\ml{bool\_ss}}
%
This \simpset{} (defined in structure \ml{boolSimps}) is often used
...
constants \holtxt{T} and \holtxt{F} appear as their arguments.  (One
such rule is \holtxt{|- T /\bs{} p = p}.)
...
\paragraph{\ml{std\_ss}}
%
\index{std_ss@\ml{std\_ss}}
%
This \simpset{} is defined in \ml{bossLib}, and adds rewrite rules
pertinent to the types of sums, pairs and options to \ml{bool\_ss}.
