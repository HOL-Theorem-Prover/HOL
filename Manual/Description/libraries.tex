...
The conversion \ml{blastLib.BBLAST\_CONV} performs bit-blasting, converting word expressions into propositions and, whenever possible, deriving true or false. This conversion is suited to reasoning about addition and multiplication (by a word literal) in combination with orderings and bit-field operations (shifts, bitwise logic and so forth).  For example:
\begin{session}
\begin{verbatim}
