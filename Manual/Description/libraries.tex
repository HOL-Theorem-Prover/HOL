...
\HOL{} types and terms are ultimately built by application of the
...
\HOL{} has flexible infrastracture for parsing and prettyprinting 
types and terms.
...
notation for the empty set \verb+{}+ (or \verb+EMPTY+), insertion (the infix \verb+INSERT+), set
...
Thus, if the theories of pairs, sets, numbers, strings, and lists are
...
varstruct is an arbitrarily nested tuple of variables,
