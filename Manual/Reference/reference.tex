...
%\usepackage{amsmath}
\usepackage{amssymb}     % \ggg, \mathbb, \preccurlyeq, \leftrightarrows, etc.,
                         % referenced by ../Description/desc-unicode.sty
\usepackage{alltt}
...
% Packages and definitions emitted (or referenced) by pandoc-generated
% entries.tex.  In particular, Markdown tables become longtables.
\usepackage{array}
...
\makeindex
% Shared Unicode -> LaTeX codepoint mapping (also used by Description
% and Tutorial); the support packages it depends on -- amssymb above,
% stix via layout.sty, stmaryrd via ../LaTeX/commands.tex -- are all
