...
The current edition of all three volumes (\TUTORIAL, \DESCRIPTION\ and
\REFERENCE) has been prepared by Michael Norrish and
...
piece is the semantics by Andy Pitts (in \DESCRIPTION), reflecting the
fact that, although the \HOL\ system has undergone continual
development and improvement, the \HOL\ logic is unchanged since the
first edition (1988).
