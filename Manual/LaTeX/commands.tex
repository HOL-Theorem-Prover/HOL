...
\def\HOL{{\small HOL}}
\def\holn{\textsf{hol98}}  % i.e. hol n(inety-eight), no digits in
                           % macro names is a bit of a pain.
\def\holnversion{Kananaskis-1}
\def\holnsversion{Kananaskis 1} % version with space rather than hyphen
\def\LCF{{\small LCF}}
