...
\def\holn{\HOL}  % i.e. hol n(inety-eight), no digits in
                 ...
                 % write HOL for hol98.
\def\holnversion{Kananaskis-3}
\def\holnsversion{Kananaskis 3} % version with space rather than hyphen
\def\LCF{{\small LCF}}
...
\newcommand{\holquote}[1]{{}^{\backprime\backprime} #1 {}^{\backprime\backprime}}
