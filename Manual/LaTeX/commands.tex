% =====================================================================
%
% Macros for typesetting the HOL-Omega system manual
%
% =====================================================================
...
% \newcommand\HOLOMEGA{{\footnotesize\sl HOL--OMEGA}}
...
\def\holn{\HOL}  % i.e. hol n(inety-eight), no digits in
                 ...
                 % write HOL for hol98.
\def\holnw{\HOLW} % i.e. hol omega (w in Greek)
\def\holnversion{Kananaskis-8}
\def\holnsversion{Kananaskis~8} % version with space rather than hyphen
\def\LCF{{\small LCF}}
...
\newcommand{\utquant}[1]{\forall{:} #1.\ }
\newcommand{\etquant}[1]{\exists{:} #1.\ }
\newcommand{\ltquant}[1]{\lambda{:} #1.\ }

\newcommand{\leave}[1]{\\[#1]\noindent}
\newcommand\entails{\mbox{\rule{.3mm}{4mm}\rule[2mm]{.2in}{.3mm}}}

\def\Rule#1#2{\mbox{${\displaystyle\raise3pt\hbox{$\;\;#1\;\;$}} \over 
