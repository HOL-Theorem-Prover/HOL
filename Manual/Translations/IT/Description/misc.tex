...
\verb+hol --bare+.  If the script was
...
\index{load (ML function)@\ml{load} (\ML{} function)}
\item In the interactive system, one has to explicitly \ml{load} modules; on the other hand, the batch compiler will load modules automatically.
