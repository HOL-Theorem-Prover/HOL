...
e le teorie costruite. Alla fine è prodotto un sistema \HOL{}\footnote{L'eseguibile
  \textsf{hol} supporta \texttt{--bare} per un ambiente minimale.
  Con Moscow~ML, \texttt{--noquote} disabilita il filtro delle quotazioni;
  con Poly/ML, \texttt{--poly} avvia senza stato HOL.} nella
directory \texttt{bin/}.
