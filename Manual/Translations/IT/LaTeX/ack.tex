...
La maggior parte di \HOL\ è basato su codice scritto da---in ordine
alfabetico---%
Hasan Amjad,
Richard Boulton,
Anthony Fox,
...
\DESCRIPTION\ e \REFERENCE) è stata preparata da Michael Norrish e
...
le librerie per le Teorie Modulo Soddisfacibilità~(SMT) e le Formule Booleane
Quantificate~(QBF).
...
alterato è la semantica di Andy Pitts (in \LOGIC), il che riflette il fatto
che, nonostante il sistema \HOL\ abbia subito uno sviluppo e un miglioramento
continuo, la logica di \HOL\ è rimasta inalterata dalla sua prima edizione
(1988).
...
La seconda edizione di \REFERENCE\ è stato uno sforzo congiunto da parte del gruppo
\HOL\ di Cambridge.
...
Smith, che usò una fotografia di una `lanterna da neve' presa da
