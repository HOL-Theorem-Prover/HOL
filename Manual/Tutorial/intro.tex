...
and the theories built.  Eventually, a \HOL{} system\footnote{Two
  \HOL{} executables are produced: \textsf{hol} and \textsf{hol.noquote}.
  The \texttt{--bare} flag can be used for a minimal environment.
  The first of these will be used for most examples in the \TUTORIAL{}.} is produced in
