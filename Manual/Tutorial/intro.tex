...
and the theories built.  Eventually, a \HOL{} system\footnote{The
  \textsf{hol} executable supports \texttt{--bare} for a minimal environment.
  With Moscow~ML, \texttt{--noquote} disables the quotation filter;
  with Poly/ML, \texttt{--poly} starts with no HOL state.} is produced in
