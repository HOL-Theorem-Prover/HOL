...
\newcommand\holn{\textsf{\textbf{hol98}}}

\section{Getting HOL}

The \HOL\ system can be downloaded from
\mbox{\texttt{http://www.ftp.cl.cam.ac.uk/ftp/hvg/}}.  This page on
...
The next step is to run the \textsf{build} program.  This should
