...
performed using the facilities of \ml{bossLib}, one of \HOL's
...
invoke \ml{ARW\_TAC} in both branches of the case split. This can be
...
would be the end of it. However, another class of user would notice
