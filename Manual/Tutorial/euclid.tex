...
\end{verbatim}\end{session}
    ...
    and also makes it easier to turn our script into a theory file, of
    which more later.
...
logical context, and the language accepted by the compiler is not
quite the same as that accepted by the interactive system.
