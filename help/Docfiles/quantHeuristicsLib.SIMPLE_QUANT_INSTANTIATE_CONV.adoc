----------------------------------------------------------------------
SIMPLE_QUANT_INSTANTIATE_CONV                     (quantHeuristicsLib)
----------------------------------------------------------------------
...
SEEALSO
quantHeuristicsLib.QUANT_INSTANTIATE_CONV, unwind.UNWIND_EXISTS_CONV,
unwind.UNWIND_FORALL_CONV, quantHeuristicsLib.SIMPLE_QUANT_INST_ss,
bossLib.SQI_ss.
